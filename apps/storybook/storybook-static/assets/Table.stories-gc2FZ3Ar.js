import{j as o}from"./jsx-runtime-BjG_zV1W.js";import{B as Na}from"./Button-B21ouHNm.js";import{r as d}from"./index-BWu4c2F4.js";import{B as $a}from"./Badge-ZJmMstsz.js";import{within as b,expect as n,userEvent as m,fireEvent as g,waitFor as P}from"./index-DgAF9SIF.js";import{S as w,s as C,a as Ge}from"./storyShowcase-Bw5VyCj0.js";const xa="Enter Space",Ma=`${xa} Home End PageDown PageUp ArrowLeft ArrowRight`,qa="ArrowLeft ArrowRight Home End PageDown PageUp",Oa=48,za=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"}),pt=400;function wt(t,e,a){if(!e)return null;const r=t.find(h=>String(h.key)===e);return r!=null&&r.sortable?{key:e,direction:a}:null}function bt(t,e,a){if(typeof t.sortLabel=="string"&&t.sortLabel.trim().length>0)return t.sortLabel.trim();const r=Pe(Ue(t.header));return r.length>0?r:e}function gt(t,e){const a=Pe(t.trim().replace(/[_-]+/g," ").replace(/([a-z0-9])([A-Z])/g,"$1 $2"));return a.length>0&&/[0-9A-Za-z]/.test(a)?a:e>=0?`Column ${e+1}`:"Column"}function y({columns:t,data:e,rowKey:a,caption:r,ariaLabel:h,ariaLabelledBy:N,loading:B=!1,loadingContent:F="Loading data...",emptyContent:A="No data available.",defaultSortKey:k,defaultSortDirection:$="asc",getSortAriaLabel:Ye=vt,getSortStatusText:Ze=Va,onSortChange:Ne}){var tt;const Je=We(r),Ba=We(F),Ra=We(A),ka=Ba?F:"Loading data...",Ta=Ra?A:"No data available.",G=te(N),Qe=G?void 0:te(h,Je?void 0:"Data table"),M=d.useRef({}),U=d.useRef(null),$e=d.useRef(null),Y=d.useRef(0),q=d.useRef(null),Z=d.useRef(null),O=d.useRef(!0);d.useRef(null),d.useRef(null),d.useRef(null);const[Ha,Me]=d.useState(null),[Da,I]=d.useState(null),[Ea,z]=d.useState(null),[Aa,qe]=d.useState(!1);d.useEffect(()=>{var c;const s=((c=U.current)==null?void 0:c.ownerDocument)??document,l=p=>{p.metaKey||p.altKey||p.ctrlKey||(O.current=!0)},u=p=>{"button"in p&&!_e(p.button)||"ctrlKey"in p&&p.ctrlKey||(O.current=!1)};return s.addEventListener("keydown",l,!0),s.addEventListener("pointerdown",u,!0),s.addEventListener("mousedown",u,!0),s.addEventListener("touchstart",u,!0),()=>{s.removeEventListener("keydown",l,!0),s.removeEventListener("pointerdown",u,!0),s.removeEventListener("mousedown",u,!0),s.removeEventListener("touchstart",u,!0)}},[]);const J=d.useCallback(()=>{$e.current=null,Y.current=0,q.current!==null&&((Z.current??window).clearTimeout(q.current),q.current=null),Z.current=null},[]);d.useEffect(()=>()=>{J()},[J]);const[f,Oe]=d.useState(()=>wt(t,k,$)),Q=d.useMemo(()=>{const s=new Map;return t.map(l=>{const u=String(l.key),c=s.get(u)??0;return s.set(u,c+1),c===0?u:`${u}__duplicate-${c}`})},[t]),K=d.useMemo(()=>B||e.length<=1?[]:t.reduce((s,l,u)=>(l.sortable&&s.push(Q[u]??`${String(l.key)}__index-${u}`),s),[]),[t,e.length,B,Q]);d.useEffect(()=>{if(!f)return;const s=t.find(l=>String(l.key)===f.key);s!=null&&s.sortable||Oe(null)},[t,f]),d.useEffect(()=>{if(f)return;const s=wt(t,k,$);s&&Oe(s)},[t,$,k,f]);const ze=d.useMemo(()=>e.map((s,l)=>String(a?a(s,l):l)),[e,a]),Ca=d.useMemo(()=>{const s=new Map;return ze.map((l,u)=>{const c=s.get(l)??0;return s.set(l,c+1),c===0?l:`${l}__dup-${u}`})},[ze]);d.useEffect(()=>{},[a,ze]),d.useEffect(()=>{},[t]),d.useEffect(()=>{},[t]);const V=d.useMemo(()=>{const s=e.map((c,p)=>({row:c,sourceIndex:p}));if(!f)return s;const l=t.find(c=>String(c.key)===f.key);if(!(l!=null&&l.sortable))return s;const u=l.sortAccessor??(c=>{const p=c[String(l.key)];return p instanceof Date||typeof p=="number"||typeof p=="string"?p:String(p??"")});return s.sort((c,p)=>{const x=u(c.row),H=u(p.row);if(typeof x=="string"&&typeof H=="string"){const j=za.compare(x,H);return j!==0?f.direction==="asc"?j:-j:c.sourceIndex-p.sourceIndex}const T=x instanceof Date?x.getTime():x,W=H instanceof Date?H.getTime():H;return T<W?f.direction==="asc"?-1:1:T>W?f.direction==="asc"?1:-1:c.sourceIndex-p.sourceIndex})},[t,e,f]),Xe=d.useMemo(()=>{var c;if(B||V.length<=1||!f)return"";const s=t.findIndex(p=>String(p.key)===f.key),l=s>=0?t[s]:void 0;if(!(l!=null&&l.sortable))return"";((c=U.current)==null?void 0:c.ownerDocument)??typeof document>"u";const u=bt(l,gt(f.key,s));return Ze({columnKey:f.key,columnHeader:u,direction:f.direction})},[t,Ze,B,f,V.length]),L=!B&&V.length>1&&t.some(s=>s.sortable),et=Math.max(t.length,1);return((tt=U.current)==null?void 0:tt.ownerDocument)??typeof document>"u",d.useEffect(()=>{L||(Me(null),I(null),z(null))},[L]),d.useEffect(()=>{if(L){qe(!1);return}const s=U.current;if(!s){qe(!1);return}const l=s.ownerDocument.defaultView??(typeof window>"u"?void 0:window);if(!l)return;const u=()=>{const p=s.scrollWidth-s.clientWidth>0;qe(x=>x===p?x:p)};u(),l.addEventListener("resize",u);let c=null;return typeof l.ResizeObserver=="function"&&(c=new l.ResizeObserver(u),c.observe(s)),()=>{l.removeEventListener("resize",u),c==null||c.disconnect()}},[t.length,e.length,L,B]),o.jsxs("div",{ref:U,"data-aurora-table-scroll-container":"",role:L?void 0:"region",tabIndex:L?void 0:0,"aria-label":L||G?void 0:Qe??"Data table scroll container","aria-labelledby":L?void 0:G,"aria-keyshortcuts":L||!Aa?void 0:qa,onKeyDown:s=>{if(L||s.defaultPrevented||s.altKey||s.ctrlKey||s.metaKey||s.target!==s.currentTarget)return;const l=s.currentTarget,u=Math.max(0,l.scrollWidth-l.clientWidth);if(u<=0)return;const c=l.clientWidth,p=Math.max(Oa,Math.floor(c*.3)),x=T=>{T!==0&&(s.preventDefault(),Ga(l,T))},H=T=>{s.preventDefault(),Ya(l,T)};switch(s.key){case"ArrowRight":x(p);return;case"ArrowLeft":x(-p);return;case"PageDown":x(c);return;case"PageUp":x(-c);return;case"Home":H(0);return;case"End":H(u);return;default:return}},style:{border:"1px solid var(--aurora-border-default)",borderRadius:"var(--aurora-radius-md)",overflow:"auto"},children:[Xe?o.jsx("p",{role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:Xe}):null,o.jsxs("table",{"aria-label":Qe,"aria-labelledby":G,"aria-busy":B||void 0,style:{width:"100%",borderCollapse:"collapse",minWidth:560},children:[Je?o.jsx("caption",{style:{textAlign:"left",padding:"10px 12px",color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-sm)",borderBottom:"1px solid var(--aurora-border-default)"},children:r}):null,o.jsx("thead",{children:o.jsx("tr",{children:t.map((s,l)=>{const u=String(s.key),c=Q[l]??`${u}__index-${l}`,p=!!s.sortable,x=V.length>1,H=p&&(f==null?void 0:f.key)===u?f.direction:void 0,T=!B&&x?H:void 0,W=T?T==="asc"?"ascending":"descending":void 0,j=s.align??"left",nt=bt(s,gt(u,l)),X=H==="asc"?"desc":"asc",Ia=Ye({columnKey:u,columnHeader:nt,nextDirection:X}),at=te(s.sortLabelledBy),Ka=at?void 0:te(Ia,vt({columnHeader:nt,nextDirection:X})),E=B||!x,La=E?void 0:K.length>1?Ma:xa,ot=!E&&Ha===c,rt=!E&&Da===c,st=!E&&Ea===c,ja=ot||st,it=()=>{E||(Oe({key:u,direction:X}),Ne==null||Ne(u,X))};return o.jsx("th",{scope:"col","aria-sort":W,style:{textAlign:j,color:"var(--aurora-text-secondary)",background:"var(--aurora-surface-elevated)",borderBottom:"1px solid var(--aurora-border-default)",padding:"10px 12px",fontSize:"var(--aurora-font-size-sm)",fontWeight:"var(--aurora-font-weight-medium)",width:s.width},children:p?o.jsxs("button",{"data-aurora-reduced-motion":"transition",type:"button",ref:i=>{M.current[c]=i},"aria-labelledby":at,"aria-label":Ka,"aria-keyshortcuts":La,disabled:E,onClick:i=>{const R=Date.now()-Y.current,ee=i.detail===0&&$e.current===c&&Y.current>0&&R<=pt;J(),!ee&&it()},onMouseEnter:()=>{E||Me(c)},onMouseLeave:()=>{Me(i=>i===c?null:i),I(i=>i===c?null:i)},onPointerDown:i=>{E||i.ctrlKey||_e(i.button)&&(O.current=!1,z(R=>R===c?null:R),I(c))},onPointerUp:i=>{_e(i.button)&&I(R=>R===c?null:R)},onMouseDown:i=>{E||i.button!==0||i.ctrlKey||(O.current=!1,z(R=>R===c?null:R),I(c))},onMouseUp:i=>{i.button===0&&I(R=>R===c?null:R)},onPointerCancel:()=>{I(i=>i===c?null:i)},onFocus:()=>{if(E){z(i=>i===c?null:i);return}z(i=>Ua(M.current[c],O.current)?c:i===c?null:i)},onBlur:()=>{z(i=>i===c?null:i),I(i=>i===c?null:i)},onKeyDown:i=>{var ee,ct,lt,ut,dt;if(O.current=!0,i.defaultPrevented||i.altKey||i.ctrlKey||i.metaKey)return;if(i.key==="Home"){const D=K[0];if(!D)return;i.preventDefault(),(ee=M.current[D])==null||ee.focus();return}if(i.key==="End"){const D=K[K.length-1];if(!D)return;i.preventDefault(),(ct=M.current[D])==null||ct.focus();return}if(i.key==="PageDown"||i.key==="PageUp"){const D=K.indexOf(c);if(D<0)return;const mt=i.key==="PageDown"?1:-1,_=Math.max(0,Math.min(K.length-1,D+mt));if(_===D)return;i.preventDefault();const Ve=K[_];(lt=M.current[Ve])==null||lt.focus();return}if(i.key==="ArrowLeft"||i.key==="ArrowRight"){const D=K.indexOf(c);if(D<0)return;const _=(i.currentTarget.ownerDocument.defaultView??window).getComputedStyle(i.currentTarget).direction,Ve=(ut=i.currentTarget.closest("[dir]"))==null?void 0:ut.getAttribute("dir"),Fa=(_==="rtl"||_==="ltr"?_:Ve==="rtl"?"rtl":"ltr")==="rtl"?"ArrowLeft":"ArrowRight",Wa=i.key===Fa?1:-1,yt=Math.max(0,Math.min(K.length-1,D+Wa));if(yt===D)return;i.preventDefault();const Pa=K[yt];(dt=M.current[Pa])==null||dt.focus();return}if(!ht(i.key)||_a(i)||(i.preventDefault(),i.repeat))return;I(c),$e.current=c,Y.current=Date.now();const R=i.currentTarget.ownerDocument.defaultView??window;q.current!==null&&(Z.current??R).clearTimeout(q.current),Z.current=R,q.current=R.setTimeout(()=>{J()},pt),it()},onKeyUp:i=>{i.altKey||i.ctrlKey||i.metaKey||ht(i.key)&&I(R=>R===c?null:R)},style:{border:ja?"1px solid color-mix(in srgb, var(--aurora-accent-default) 48%, transparent)":"1px solid transparent",borderRadius:"var(--aurora-radius-sm)",background:rt?"color-mix(in srgb, var(--aurora-surface-elevated) 68%, var(--aurora-surface-default))":ot?"color-mix(in srgb, var(--aurora-surface-elevated) 86%, var(--aurora-surface-default))":"transparent",font:"inherit",cursor:E?"not-allowed":"pointer",display:"inline-flex",alignItems:"center",gap:6,padding:"2px 6px",color:E?"color-mix(in srgb, var(--aurora-text-secondary) 88%, var(--aurora-text-primary))":"inherit",boxShadow:st?"0 0 0 3px color-mix(in srgb, var(--aurora-focus-ring) 42%, transparent)":"none",transform:rt?"translateY(1px)":"translateY(0)",transition:"background-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), border-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), box-shadow var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), transform var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard)"},children:[s.header,o.jsx("span",{"aria-hidden":"true",children:T==="asc"?"▲":T==="desc"?"▼":"↕"})]}):s.header},c)})})}),o.jsx("tbody",{children:B?o.jsx("tr",{children:o.jsx("td",{colSpan:et,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:o.jsx("span",{role:"status","aria-live":"polite",children:ka})})}):V.length===0?o.jsx("tr",{children:o.jsx("td",{colSpan:et,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:o.jsx("span",{role:"status","aria-live":"polite",children:Ta})})}):V.map((s,l)=>{const u=s.row,c=String(s.sourceIndex),p=Ca[s.sourceIndex]??c;return o.jsx("tr",{style:{background:l%2===0?"transparent":"var(--aurora-surface-elevated)"},children:t.map((x,H)=>{const T=x.render?x.render(u,l,s.sourceIndex):String(u[String(x.key)]??""),W=Q[H]??`${String(x.key)}__index-${H}`,j={padding:"10px 12px",borderBottom:"1px solid var(--aurora-border-default)",color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",textAlign:x.align??"left"};return x.rowHeader?o.jsx("th",{scope:"row",style:{...j,fontWeight:"var(--aurora-font-weight-medium)"},children:T},W):o.jsx("td",{style:j,children:T},W)})},p)})})]})]})}function vt({columnHeader:t,nextDirection:e}){return`${t} sort ${e==="asc"?"ascending":"descending"}`}function Va({columnHeader:t,direction:e}){return`Sorted by ${t} ${e==="asc"?"ascending":"descending"}.`}function ht(t){return t==="Enter"||t===" "||t==="Space"||t==="Spacebar"}function _a(t){const e=t.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function _e(t){return typeof t!="number"||t<=0}function Ua(t,e){if(!t)return e;try{return t.matches(":focus-visible")||e}catch{return e}}function We(t){return t==null||typeof t=="boolean"?!1:typeof t=="string"?t.trim().length>0:typeof t=="number"?!0:Array.isArray(t)?t.some(e=>We(e)):d.isValidElement(t)}function Ue(t){if(typeof t=="string")return t;if(typeof t=="number")return String(t);if(Array.isArray(t))return Pe(t.map(a=>Ue(a)).filter(a=>a.length>0).join(" "));if(!d.isValidElement(t))return"";const e=t.props;if(e["aria-hidden"]===!0||e["aria-hidden"]==="true")return"";if(typeof e["aria-label"]=="string"){const a=Pe(e["aria-label"]);if(a.length>0)return a}return Ue(e.children)}function Pe(t){return t.replace(/\s+/g," ").trim()}function te(t,e){return typeof t=="string"&&t.trim().length>0?t.trim():e}function Ga(t,e){if(typeof t.scrollBy=="function"){t.scrollBy({left:e,behavior:"auto"});return}t.scrollLeft+=e}function Ya(t,e){if(typeof t.scrollTo=="function"){t.scrollTo({left:e,behavior:"auto"});return}t.scrollLeft=e}y.__docgenInfo={description:"",methods:[],displayName:"Table",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: keyof T | string;
...
}`,...(Ht=(Tt=ae.parameters)==null?void 0:Tt.docs)==null?void 0:Ht.source}}};var Dt,Et,At;oe.parameters={...oe.parameters,docs:{...(Dt=oe.parameters)==null?void 0:Dt.docs,source:{originalSource:`{
  render: () => {
...
}`,...(At=(Et=oe.parameters)==null?void 0:Et.docs)==null?void 0:At.source}}};var Ct,It,Kt;re.parameters={...re.parameters,docs:{...(Ct=re.parameters)==null?void 0:Ct.docs,source:{originalSource:`{
...
}`,...(Kt=(It=re.parameters)==null?void 0:It.docs)==null?void 0:Kt.source}}};var Lt,jt,Ft;se.parameters={...se.parameters,docs:{...(Lt=se.parameters)==null?void 0:Lt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Ft=(jt=se.parameters)==null?void 0:jt.docs)==null?void 0:Ft.source}}};var Wt,Pt,Nt;ie.parameters={...ie.parameters,docs:{...(Wt=ie.parameters)==null?void 0:Wt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "id",
      header: "Issue",
...
}`,...(Nt=(Pt=ie.parameters)==null?void 0:Pt.docs)==null?void 0:Nt.source}}};var $t,Mt,qt;ce.parameters={...ce.parameters,docs:{...($t=ce.parameters)==null?void 0:$t.docs,source:{originalSource:`{
...
}`,...(qt=(Mt=ce.parameters)==null?void 0:Mt.docs)==null?void 0:qt.source}}};var Ot,zt,Vt;le.parameters={...le.parameters,docs:{...(Ot=le.parameters)==null?void 0:Ot.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 840px)" gap={10}>
      <p style={storyMutedTextStyle}>
...
}`,...(Vt=(zt=le.parameters)==null?void 0:zt.docs)==null?void 0:Vt.source}}};var _t,Ut,Gt;ue.parameters={...ue.parameters,docs:{...(_t=ue.parameters)==null?void 0:_t.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 840px)" gap={10}>
      <p style={storyMutedTextStyle}>
...
}`,...(Gt=(Ut=ue.parameters)==null?void 0:Ut.docs)==null?void 0:Gt.source}}};var Yt,Zt,Jt;de.parameters={...de.parameters,docs:{...(Yt=de.parameters)==null?void 0:Yt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Jt=(Zt=de.parameters)==null?void 0:Zt.docs)==null?void 0:Jt.source}}};var Qt,Xt,en;me.parameters={...me.parameters,docs:{...(Qt=me.parameters)==null?void 0:Qt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(en=(Xt=me.parameters)==null?void 0:Xt.docs)==null?void 0:en.source}}};var tn,nn,an;ye.parameters={...ye.parameters,docs:{...(tn=ye.parameters)==null?void 0:tn.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(sn=(rn=pe.parameters)==null?void 0:rn.docs)==null?void 0:sn.source}}};var cn,ln,un;we.parameters={...we.parameters,docs:{...(cn=we.parameters)==null?void 0:cn.docs,source:{originalSource:`{
...
}`,...(un=(ln=we.parameters)==null?void 0:ln.docs)==null?void 0:un.source}}};var dn,mn,yn;be.parameters={...be.parameters,docs:{...(dn=be.parameters)==null?void 0:dn.docs,source:{originalSource:`{
...
}`,...(Dn=(Hn=Se.parameters)==null?void 0:Hn.docs)==null?void 0:Dn.source}}};var En,An,Cn;fe.parameters={...fe.parameters,docs:{...(En=fe.parameters)==null?void 0:En.docs,source:{originalSource:`{
...
}`,...(Cn=(An=fe.parameters)==null?void 0:An.docs)==null?void 0:Cn.source}}};var In,Kn,Ln;Be.parameters={...Be.parameters,docs:{...(In=Be.parameters)==null?void 0:In.docs,source:{originalSource:`{
...
}`,...(Ln=(Kn=Be.parameters)==null?void 0:Kn.docs)==null?void 0:Ln.source}}};var jn,Fn,Wn;Re.parameters={...Re.parameters,docs:{...(jn=Re.parameters)==null?void 0:jn.docs,source:{originalSource:`{
...
}`,...(Wn=(Fn=Re.parameters)==null?void 0:Fn.docs)==null?void 0:Wn.source}}};var Pn,Nn,$n;ke.parameters={...ke.parameters,docs:{...(Pn=ke.parameters)==null?void 0:Pn.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...($n=(Nn=ke.parameters)==null?void 0:Nn.docs)==null?void 0:$n.source}}};var Mn,qn,On;Te.parameters={...Te.parameters,docs:{...(Mn=Te.parameters)==null?void 0:Mn.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "releasedAt",
...
}`,...(On=(qn=Te.parameters)==null?void 0:qn.docs)==null?void 0:On.source}}};var zn,Vn,_n;He.parameters={...He.parameters,docs:{...(zn=He.parameters)==null?void 0:zn.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "status",
      header: <span>
...
}`,...(_n=(Vn=He.parameters)==null?void 0:Vn.docs)==null?void 0:_n.source}}};var Un,Gn,Yn;De.parameters={...De.parameters,docs:{...(Un=De.parameters)==null?void 0:Un.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "status",
...
}`,...(Yn=(Gn=De.parameters)==null?void 0:Gn.docs)==null?void 0:Yn.source}}};var Zn,Jn,Qn;Ee.parameters={...Ee.parameters,docs:{...(Zn=Ee.parameters)==null?void 0:Zn.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "   ",
      header: <span aria-hidden="true">🚦</span>,
...
}`,...(Qn=(Jn=Ee.parameters)==null?void 0:Jn.docs)==null?void 0:Qn.source}}};var Xn,ea,ta;Ae.parameters={...Ae.parameters,docs:{...(Xn=Ae.parameters)==null?void 0:Xn.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
...
}`,...(ta=(ea=Ae.parameters)==null?void 0:ea.docs)==null?void 0:ta.source}}};var na,aa,oa;Ce.parameters={...Ce.parameters,docs:{...(na=Ce.parameters)==null?void 0:na.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)" gap={10}>
...
}`,...(oa=(aa=Ce.parameters)==null?void 0:aa.docs)==null?void 0:oa.source}}};var ra,sa,ia;Ie.parameters={...Ie.parameters,docs:{...(ra=Ie.parameters)==null?void 0:ra.docs,source:{originalSource:`{
  render: () => {
...
}`,...(ia=(sa=Ie.parameters)==null?void 0:sa.docs)==null?void 0:ia.source}}};var ca,la,ua;Ke.parameters={...Ke.parameters,docs:{...(ca=Ke.parameters)==null?void 0:ca.docs,source:{originalSource:`{
...
}`,...(ua=(la=Ke.parameters)==null?void 0:la.docs)==null?void 0:ua.source}}};var da,ma,ya;Le.parameters={...Le.parameters,docs:{...(da=Le.parameters)==null?void 0:da.docs,source:{originalSource:`{
...
}`,...(ya=(ma=Le.parameters)==null?void 0:ma.docs)==null?void 0:ya.source}}};var pa,wa,ba;je.parameters={...je.parameters,docs:{...(pa=je.parameters)==null?void 0:pa.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 720px)">
...
}`,...(ba=(wa=je.parameters)==null?void 0:wa.docs)==null?void 0:ba.source}}};var ga,va,ha;Fe.parameters={...Fe.parameters,docs:{...(ga=Fe.parameters)==null?void 0:ga.docs,source:{originalSource:`{
