import{j as o}from"./jsx-runtime-BjG_zV1W.js";import{r}from"./index-BWu4c2F4.js";import{B as le}from"./Button-BhfMIoQv.js";import{D as Zt}from"./Dialog-DJrTABMX.js";import{I as ea}from"./Input-pKdbw4ss.js";import{within as y,expect as n,userEvent as c,fireEvent as k,waitFor as be}from"./index-DgAF9SIF.js";import{b as x,s as w,a as v}from"./storyShowcase-Bw5VyCj0.js";import"./bodyScrollLock-D0vp0S5S.js";import"./index-DlVbWVVj.js";import"./DismissableLayer-DAyP3iyR.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";function m({open:a,onOpenChange:e,commands:t,title:i="Command Palette",description:l="Quickly search and execute workspace actions.",searchAriaLabel:p="Search commands",resultsAriaLabel:E="Command results",closeOnSelect:f=!0,clearQueryOnEscape:A=!0,closeOnEscape:O=!0,closeOnOutsidePointer:xe=!0,onEscapeKeyDown:ue,onPointerDownOutside:de,closeLabel:Mt,placeholder:Ft="Search commands...",emptyMessage:zt="No commands found.",onQueryChange:B,onCloseReason:D,getResultsStatusText:he=na}){const[R,me]=r.useState(""),[q,C]=r.useState(0),Gt=r.useRef(null),j=r.useRef(null),L=r.useRef(null),fe=r.useRef(a);r.useRef(null),r.useRef(null),r.useRef(null);const H=r.useId(),ke=r.useId(),Ee=r.useRef(null),Qt=$(p,"Search commands"),_t=$(E,"Command results"),Wt=$(Mt,"Close dialog"),N=r.useCallback(s=>{L.current=s,D==null||D(s)},[D]),Be=r.useCallback(s=>{N(s),e(!1),L.current=null},[N,e]),Jt=r.useCallback(s=>{!s&&a&&L.current===null&&(D==null||D("close-button")),L.current=null,e(s)},[D,e,a]);r.useEffect(()=>{!a&&fe.current&&(me(s=>(s.length>0&&(B==null||B("")),"")),C(0)),fe.current=a},[B,a]),r.useEffect(()=>{},[t]),r.useEffect(()=>{},[t]),r.useEffect(()=>{},[t]);const pe=r.useMemo(()=>Re(R.trim()),[R]),d=r.useMemo(()=>pe?t.filter(s=>{const b=[ta(s),...s.keywords??[]].join(" ");return Re(b).includes(pe)}):t,[t,pe]),T=r.useMemo(()=>d.reduce((s,u)=>u.disabled?s:s+1,0),[d]),ye=d.length>0,Xt=r.useMemo(()=>{const s=[];return T>0&&s.push("ArrowDown","ArrowUp","Home","End","PageDown","PageUp","Enter"),(O||A&&R.length>0)&&s.push("Escape"),s.length>0?s.join(" "):void 0},[A,O,T,R.length]),Yt=r.useMemo(()=>he({query:R,visibleCount:d.length,enabledCount:T,totalCount:t.length}),[t.length,T,d.length,he,R]),I=r.useMemo(()=>d.reduce((s,u,b)=>(u.disabled||s.push(b),s),[]),[d]),P=I[0]??-1,Ce=I[I.length-1]??-1,g=r.useMemo(()=>{if(q<0)return-1;const s=d[q];return!s||s.disabled?-1:q},[q,d]);r.useEffect(()=>{var u;if(d.length===0){j.current=null,C(-1);return}const s=j.current;if(s){const b=d.findIndex(S=>!S.disabled&&S.key===s);if(b>=0){C(b);return}}C(P),j.current=P>=0?((u=d[P])==null?void 0:u.key)??null:null},[d,P]),r.useEffect(()=>{var s;if(g<0){j.current=null;return}j.current=((s=d[g])==null?void 0:s.key)??null},[d,g]),r.useEffect(()=>{if(!a||g<0)return;const s=Ee.current;if(!s)return;const u=s.ownerDocument.getElementById(`${H}-option-${g}`);!u||!s.contains(u)||typeof u.scrollIntoView=="function"&&u.scrollIntoView({block:"nearest"})},[H,a,g]);const we=r.useCallback(s=>{var b;const u=d[s];!u||u.disabled||((b=u.onSelect)==null||b.call(u),f&&Be("item-select"))},[f,Be,d]),Te=s=>{var b;if(d.length===0)return;let u=g<0?s===1?-1:0:g;for(let S=0;S<d.length;S+=1)if(u=(u+s+d.length)%d.length,!((b=d[u])!=null&&b.disabled)){C(u);return}},De=s=>{if(I.length===0)return;const u=I.indexOf(g);if(u<0){C(s===1?P:Ce);return}const b=Math.min(I.length-1,Math.max(0,u+s*5));C(I[b]??P)};return o.jsx(Zt,{open:a,onOpenChange:Jt,title:i,description:l,closeLabel:Wt,size:"md",closeOnEscape:O,closeOnOutsidePointer:xe,onEscapeKeyDown:s=>{ue==null||ue(s),!(s.defaultPrevented||!O)&&N("escape-key")},onPointerDownOutside:s=>{de==null||de(s),!(s.defaultPrevented||!xe)&&N("outside-pointer")},children:o.jsxs("div",{style:{display:"grid",gap:10},children:[o.jsx(ea,{ref:Gt,"data-autofocus":"",role:"combobox","aria-expanded":ye,"aria-haspopup":"listbox","aria-autocomplete":"list","aria-controls":ye?H:void 0,"aria-activedescendant":g>=0?`${H}-option-${g}`:void 0,"aria-describedby":ke,"aria-keyshortcuts":Xt,placeholder:Ft,value:R,onChange:s=>{me(s.target.value),B==null||B(s.target.value)},onKeyDown:s=>{if(!aa(s)&&!(s.altKey||s.ctrlKey||s.metaKey)){if(s.key==="Escape"){if(s.repeat)return;A&&R.length>0&&(s.preventDefault(),me(""),B==null||B(""));return}if(s.key==="ArrowDown"){if(T===0)return;s.preventDefault(),Te(1);return}if(s.key==="ArrowUp"){if(T===0)return;s.preventDefault(),Te(-1);return}if(s.key==="Home"){if(T===0)return;s.preventDefault(),C(P);return}if(s.key==="End"){if(T===0)return;s.preventDefault(),C(Ce);return}if(s.key==="PageDown"){if(T===0)return;s.preventDefault(),De(1);return}if(s.key==="PageUp"){if(T===0)return;s.preventDefault(),De(-1);return}if(s.key==="Enter"&&g>=0){if(s.preventDefault(),s.repeat)return;we(g)}}},"aria-label":Qt}),o.jsx("p",{id:ke,role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:Yt}),ye?o.jsx("div",{id:H,ref:Ee,role:"listbox","aria-label":_t,style:{maxHeight:280,overflow:"auto",display:"grid",gap:4},children:d.map((s,u)=>{const b=u===g,S=$(s.ariaLabel);return o.jsx("div",{id:`${H}-option-${u}`,role:"option","aria-selected":b,"aria-disabled":s.disabled||void 0,"aria-label":S,"aria-posinset":u+1,"aria-setsize":d.length,tabIndex:-1,onPointerDown:h=>{h.pointerType==="mouse"||h.button!==0||h.preventDefault()},onMouseDown:h=>{h.button===0&&h.preventDefault()},onMouseEnter:()=>{s.disabled||C(u)},onClick:()=>{s.disabled||we(u)},onKeyDown:h=>{s.disabled||(h.key==="Enter"||h.key===" "||h.key==="Space"||h.key==="Spacebar")&&(h.preventDefault(),we(u))},style:{border:"1px solid var(--aurora-border-default)",background:b?"color-mix(in srgb, var(--aurora-accent-default) 14%, var(--aurora-surface-default))":"var(--aurora-surface-default)",color:s.disabled?"color-mix(in srgb, var(--aurora-text-secondary) 60%, transparent)":"var(--aurora-text-primary)",borderRadius:8,height:36,padding:"0 10px",textAlign:"left",cursor:s.disabled?"not-allowed":"pointer"},children:s.label},s.key)})}):o.jsx("p",{style:{margin:0,color:"var(--aurora-text-secondary)"},children:zt})]})})}function ta(a){if(typeof a.textValue=="string"){const e=ce(a.textValue);if(e.length>0)return e}return ce(ve(a.label))}function Re(a){return a.normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/\s+/g," ").trim().toLowerCase()}function aa(a){const e=a.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function na({query:a,visibleCount:e,enabledCount:t,totalCount:i}){const l=a.trim();return l.length===0?t!==i?`${t} of ${i} command${i===1?"":"s"} available.`:`${i} command${i===1?"":"s"} available.`:e===0?`No commands match "${l}".`:t===0?`No enabled commands match "${l}".`:t!==e?`${t} of ${e} matching command${t===1?"":"s"} available for "${l}".`:`${e} command${e===1?"":"s"} found for "${l}".`}function ve(a){if(typeof a=="string")return a;if(typeof a=="number")return String(a);if(Array.isArray(a))return ce(a.map(t=>ve(t)).filter(t=>t.length>0).join(" "));if(!r.isValidElement(a))return"";const e=a.props;return e["aria-hidden"]===!0||e["aria-hidden"]==="true"?"":typeof e["aria-label"]=="string"&&e["aria-label"].trim().length>0?ce(e["aria-label"]):ve(e.children)}function $(a,e){return typeof a=="string"&&a.trim().length>0?a.trim():e}function ce(a){return a.replace(/\s+/g," ").trim()}m.__docgenInfo={description:"",methods:[],displayName:"CommandPalette",props:{open:{required:!0,tsType:{name:"boolean"},description:""},onOpenChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""},commands:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: string;
...
}`,...(Se=(Pe=U.parameters)==null?void 0:Pe.docs)==null?void 0:Se.source}}};var Ae,He,je;K.parameters={...K.parameters,docs:{...(Ae=K.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
...
}`,...(je=(He=K.parameters)==null?void 0:He.docs)==null?void 0:je.source}}};var Oe,qe,Le;V.parameters={...V.parameters,docs:{...(Oe=V.parameters)==null?void 0:Oe.docs,source:{originalSource:`{
  render: () => <AiFlowPalette />
}`,...(Le=(qe=V.parameters)==null?void 0:qe.docs)==null?void 0:Le.source}}};var Ne,$e,Ue;M.parameters={...M.parameters,docs:{...(Ne=M.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
...
}`,...(Ue=($e=M.parameters)==null?void 0:$e.docs)==null?void 0:Ue.source}}};var Ke,Ve,Me;F.parameters={...F.parameters,docs:{...(Ke=F.parameters)==null?void 0:Ke.docs,source:{originalSource:`{
...
}`,...(Me=(Ve=F.parameters)==null?void 0:Ve.docs)==null?void 0:Me.source}}};var Fe,ze,Ge;z.parameters={...z.parameters,docs:{...(Fe=z.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  render: () => <QueryTelemetryPalette />,
  play: async ({
    canvasElement
  }) => {
...
}`,...(it=(rt=J.parameters)==null?void 0:rt.docs)==null?void 0:it.source}}};var ct,lt,ut;X.parameters={...X.parameters,docs:{...(ct=X.parameters)==null?void 0:ct.docs,source:{originalSource:`{
...
}`,...(ut=(lt=X.parameters)==null?void 0:lt.docs)==null?void 0:ut.source}}};var dt,mt,pt;Y.parameters={...Y.parameters,docs:{...(dt=Y.parameters)==null?void 0:dt.docs,source:{originalSource:`{
...
}`,...(kt=(ft=te.parameters)==null?void 0:ft.docs)==null?void 0:kt.source}}};var Et,Bt,Ct;ae.parameters={...ae.parameters,docs:{...(Et=ae.parameters)==null?void 0:Et.docs,source:{originalSource:`{
...
}`,...(Ct=(Bt=ae.parameters)==null?void 0:Bt.docs)==null?void 0:Ct.source}}};var Tt,Dt,Rt;ne.parameters={...ne.parameters,docs:{...(Tt=ne.parameters)==null?void 0:Tt.docs,source:{originalSource:`{
...
}`,...(Rt=(Dt=ne.parameters)==null?void 0:Dt.docs)==null?void 0:Rt.source}}};var It,Pt,St;oe.parameters={...oe.parameters,docs:{...(It=oe.parameters)==null?void 0:It.docs,source:{originalSource:`{
...
}`,...(St=(Pt=oe.parameters)==null?void 0:Pt.docs)==null?void 0:St.source}}};var At,Ht,jt;se.parameters={...se.parameters,docs:{...(At=se.parameters)==null?void 0:At.docs,source:{originalSource:`{
