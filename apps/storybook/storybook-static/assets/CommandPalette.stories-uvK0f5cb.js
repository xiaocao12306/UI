import{j as n}from"./jsx-runtime-BjG_zV1W.js";import{r}from"./index-BWu4c2F4.js";import{D as Ct}from"./Dialog-CFqGnmxp.js";import{I as Bt}from"./Input-B0g8SV4q.js";import{within as g,expect as s,userEvent as c,fireEvent as te}from"./index-DgAF9SIF.js";import"./bodyScrollLock-DtRy56KP.js";import"./index-DlVbWVVj.js";import"./DismissableLayer-BWoUnDZk.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";function p({open:t,onOpenChange:e,commands:a,title:i="Command Palette",description:l="Quickly search and execute workspace actions.",searchAriaLabel:m="Search commands",resultsAriaLabel:f="Command results",closeOnSelect:v=!0,clearQueryOnEscape:T=!0,closeOnEscape:S=!0,closeOnOutsidePointer:ne=!0,onEscapeKeyDown:J,onPointerDownOutside:X,closeLabel:bt,placeholder:vt="Search commands...",emptyMessage:xt="No commands found.",onQueryChange:x,onCloseReason:k,getResultsStatusText:oe=Rt}){const[E,Y]=r.useState(""),[w,h]=r.useState(0),se=r.useRef(null),D=r.useRef(null),I=r.useRef(null),re=r.useRef(t),R=r.useId(),ce=r.useId(),ie=r.useRef(null),ht=r.useMemo(()=>{const o=["ArrowDown","ArrowUp","Home","End","PageDown","PageUp","Enter"];return(S||T)&&o.push("Escape"),o.join(" ")},[T,S]),P=r.useCallback(o=>{I.current=o,k==null||k(o)},[k]),le=r.useCallback(o=>{P(o),e(!1),I.current=null},[P,e]),ft=r.useCallback(o=>{!o&&t&&I.current===null&&(k==null||k("close-button")),I.current=null,e(o)},[k,e,t]);r.useEffect(()=>{var o;t?(o=se.current)==null||o.focus():re.current&&(Y(d=>(d.length>0&&(x==null||x("")),"")),h(0)),re.current=t},[x,t]);const Z=r.useMemo(()=>ge(E.trim()),[E]),u=r.useMemo(()=>Z?a.filter(o=>{const y=[Tt(o),...o.keywords??[]].join(" ");return ge(y).includes(Z)}):a,[a,Z]),de=r.useMemo(()=>u.reduce((o,d)=>d.disabled?o:o+1,0),[u]),ue=u.length>0,kt=r.useMemo(()=>oe({query:E,visibleCount:u.length,enabledCount:de,totalCount:a.length}),[a.length,de,u.length,oe,E]),C=r.useMemo(()=>u.reduce((o,d,y)=>(d.disabled||o.push(y),o),[]),[u]),B=C[0]??-1,me=C[C.length-1]??-1;r.useEffect(()=>{var d;if(u.length===0){D.current=null,h(-1);return}const o=D.current;if(o){const y=u.findIndex(b=>!b.disabled&&b.key===o);if(y>=0){h(y);return}}h(B),D.current=B>=0?((d=u[B])==null?void 0:d.key)??null:null},[u,B]),r.useEffect(()=>{var o;if(w<0){D.current=null;return}D.current=((o=u[w])==null?void 0:o.key)??null},[w,u]),r.useEffect(()=>{if(!t||w<0)return;const o=ie.current,d=document.getElementById(`${R}-option-${w}`);!o||!d||!o.contains(d)||typeof d.scrollIntoView=="function"&&d.scrollIntoView({block:"nearest"})},[w,R,t]);const ee=r.useCallback(o=>{var y;const d=u[o];!d||d.disabled||((y=d.onSelect)==null||y.call(d),v&&le("item-select"))},[v,le,u]),pe=o=>{var y;if(u.length===0)return;let d=w<0?o===1?-1:0:w;for(let b=0;b<u.length;b+=1)if(d=(d+o+u.length)%u.length,!((y=u[d])!=null&&y.disabled)){h(d);return}},ye=o=>{if(C.length===0)return;const d=C.indexOf(w);if(d<0){h(o===1?B:me);return}const y=Math.min(C.length-1,Math.max(0,d+o*5));h(C[y]??B)};return n.jsx(Ct,{open:t,onOpenChange:ft,title:i,description:l,closeLabel:bt,size:"md",closeOnEscape:S,closeOnOutsidePointer:ne,onEscapeKeyDown:o=>{J==null||J(o),!(o.defaultPrevented||!S)&&P("escape-key")},onPointerDownOutside:o=>{X==null||X(o),!(o.defaultPrevented||!ne)&&P("outside-pointer")},children:n.jsxs("div",{style:{display:"grid",gap:10},children:[n.jsx(Bt,{ref:se,role:"combobox","aria-expanded":t,"aria-haspopup":"listbox","aria-autocomplete":"list","aria-controls":ue?R:void 0,"aria-activedescendant":w>=0?`${R}-option-${w}`:void 0,"aria-describedby":ce,"aria-keyshortcuts":ht,placeholder:vt,value:E,onChange:o=>{Y(o.target.value),x==null||x(o.target.value)},onKeyDown:o=>{if(!Et(o)){if(o.key==="Escape"&&T&&E.length>0){o.preventDefault(),Y(""),x==null||x("");return}if(o.key==="ArrowDown"){o.preventDefault(),pe(1);return}if(o.key==="ArrowUp"){o.preventDefault(),pe(-1);return}if(o.key==="Home"){o.preventDefault(),h(B);return}if(o.key==="End"){o.preventDefault(),h(me);return}if(o.key==="PageDown"){o.preventDefault(),ye(1);return}if(o.key==="PageUp"){o.preventDefault(),ye(-1);return}o.key==="Enter"&&w>=0&&(o.preventDefault(),ee(w))}},"aria-label":m}),n.jsx("p",{id:ce,role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:kt}),ue?n.jsx("div",{id:R,ref:ie,role:"listbox","aria-label":f,style:{maxHeight:280,overflow:"auto",display:"grid",gap:4},children:u.map((o,d)=>{const y=d===w;return n.jsx("div",{id:`${R}-option-${d}`,role:"option","aria-selected":y,"aria-disabled":o.disabled||void 0,"aria-posinset":d+1,"aria-setsize":u.length,tabIndex:-1,onMouseDown:b=>{b.preventDefault()},onMouseEnter:()=>{o.disabled||h(d)},onClick:()=>{o.disabled||ee(d)},onKeyDown:b=>{o.disabled||(b.key==="Enter"||b.key===" "||b.key==="Space"||b.key==="Spacebar")&&(b.preventDefault(),ee(d))},style:{border:"1px solid var(--aurora-border-default)",background:y?"color-mix(in srgb, var(--aurora-accent-default) 14%, var(--aurora-surface-default))":"var(--aurora-surface-default)",color:o.disabled?"color-mix(in srgb, var(--aurora-text-secondary) 60%, transparent)":"var(--aurora-text-primary)",borderRadius:8,height:36,padding:"0 10px",textAlign:"left",cursor:o.disabled?"not-allowed":"pointer"},children:o.label},o.key)})}):n.jsx("p",{style:{margin:0,color:"var(--aurora-text-secondary)"},children:xt})]})})}function Tt(t){return typeof t.textValue=="string"?t.textValue.trim():typeof t.label=="string"?t.label.trim():""}function ge(t){return t.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase()}function Et(t){const e=t.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function Rt({query:t,visibleCount:e,enabledCount:a,totalCount:i}){const l=t.trim();return l.length===0?a!==i?`${a} of ${i} command${i===1?"":"s"} available.`:`${i} command${i===1?"":"s"} available.`:e===0?`No commands match "${l}".`:a===0?`No enabled commands match "${l}".`:a!==e?`${a} of ${e} matching command${a===1?"":"s"} available for "${l}".`:`${e} command${e===1?"":"s"} found for "${l}".`}p.__docgenInfo={description:"",methods:[],displayName:"CommandPalette",props:{open:{required:!0,tsType:{name:"boolean"},description:""},onOpenChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""},commands:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: string;
...
}`,...(ve=(be=A.parameters)==null?void 0:be.docs)==null?void 0:ve.source}}};var xe,he,fe;j.parameters={...j.parameters,docs:{...(xe=j.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  render: () => <AiFlowPalette />
}`,...(fe=(he=j.parameters)==null?void 0:he.docs)==null?void 0:fe.source}}};var ke,Ce,Be;H.parameters={...H.parameters,docs:{...(ke=H.parameters)==null?void 0:ke.docs,source:{originalSource:`{
...
}`,...(Be=(Ce=H.parameters)==null?void 0:Ce.docs)==null?void 0:Be.source}}};var Te,Ee,Re;O.parameters={...O.parameters,docs:{...(Te=O.parameters)==null?void 0:Te.docs,source:{originalSource:`{
...
}`,...(Re=(Ee=O.parameters)==null?void 0:Ee.docs)==null?void 0:Re.source}}};var De,Se,Ie;q.parameters={...q.parameters,docs:{...(De=q.parameters)==null?void 0:De.docs,source:{originalSource:`{
  render: () => <QueryTelemetryPalette />,
  play: async ({
    canvasElement
  }) => {
...
}`,...(Ie=(Se=q.parameters)==null?void 0:Se.docs)==null?void 0:Ie.source}}};var Pe,Ae,je;L.parameters={...L.parameters,docs:{...(Pe=L.parameters)==null?void 0:Pe.docs,source:{originalSource:`{
...
}`,...(je=(Ae=L.parameters)==null?void 0:Ae.docs)==null?void 0:je.source}}};var He,Oe,qe;$.parameters={...$.parameters,docs:{...(He=$.parameters)==null?void 0:He.docs,source:{originalSource:`{
...
}`,...(qe=(Oe=$.parameters)==null?void 0:Oe.docs)==null?void 0:qe.source}}};var Le,$e,Ne;N.parameters={...N.parameters,docs:{...(Le=N.parameters)==null?void 0:Le.docs,source:{originalSource:`{
...
}`,...(Ne=($e=N.parameters)==null?void 0:$e.docs)==null?void 0:Ne.source}}};var Ve,Ue,Ge;V.parameters={...V.parameters,docs:{...(Ve=V.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
...
}`,...(Ge=(Ue=V.parameters)==null?void 0:Ue.docs)==null?void 0:Ge.source}}};var ze,Ke,Me;U.parameters={...U.parameters,docs:{...(ze=U.parameters)==null?void 0:ze.docs,source:{originalSource:`{
...
}`,...(Me=(Ke=U.parameters)==null?void 0:Ke.docs)==null?void 0:Me.source}}};var Fe,Qe,_e;G.parameters={...G.parameters,docs:{...(Fe=G.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
...
}`,...(nt=(at=M.parameters)==null?void 0:at.docs)==null?void 0:nt.source}}};var ot,st,rt;F.parameters={...F.parameters,docs:{...(ot=F.parameters)==null?void 0:ot.docs,source:{originalSource:`{
...
}`,...(rt=(st=F.parameters)==null?void 0:st.docs)==null?void 0:rt.source}}};var ct,it,lt;Q.parameters={...Q.parameters,docs:{...(ct=Q.parameters)==null?void 0:ct.docs,source:{originalSource:`{
...
}`,...(mt=(ut=_.parameters)==null?void 0:ut.docs)==null?void 0:mt.source}}};var pt,yt,gt;W.parameters={...W.parameters,docs:{...(pt=W.parameters)==null?void 0:pt.docs,source:{originalSource:`{
...
}`,...(gt=(yt=W.parameters)==null?void 0:yt.docs)==null?void 0:gt.source}}};const Zt=["SearchCommands","AiInteractionFlow","QueryTelemetry","CloseReasonTelemetry","EmptyStateAriaControlsLifecycle","LocalizedResultsLabel","LocalizedDialogCopy","DisabledOnlyResults","DisabledCommandGuard","TextValueAndAccentSearch","PersistentSelection","NonDismissible","GuardedDismissEvents","EscapeClearsQueryFirst","RefinedSearchKeepsActiveCommand","PagedKeyboardNavigation","ImeCompositionGuard","EscapePreemptedByGlobalHandler"];export{j as AiInteractionFlow,O as CloseReasonTelemetry,V as DisabledCommandGuard,N as DisabledOnlyResults,q as EmptyStateAriaControlsLifecycle,M as EscapeClearsQueryFirst,W as EscapePreemptedByGlobalHandler,K as GuardedDismissEvents,_ as ImeCompositionGuard,$ as LocalizedDialogCopy,L as LocalizedResultsLabel,z as NonDismissible,Q as PagedKeyboardNavigation,G as PersistentSelection,H as QueryTelemetry,F as RefinedSearchKeepsActiveCommand,A as SearchCommands,U as TextValueAndAccentSearch,Zt as __namedExportsOrder,Yt as default};
