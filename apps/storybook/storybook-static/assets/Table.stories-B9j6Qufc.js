import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{B as Da}from"./Button-BMxlc9Nj.js";import{r as u}from"./index-BWu4c2F4.js";import{B as Ha}from"./Badge-ZJmMstsz.js";import{within as y,expect as n,userEvent as l,fireEvent as R,waitFor as $e}from"./index-DgAF9SIF.js";import{S as m,s as E,a as He}from"./storyShowcase-Bw5VyCj0.js";const Ia="Enter Space Home End PageDown PageUp",Aa=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"}),Ve=400;function Me(t,e,o){if(!e)return null;const s=t.find(h=>String(h.key)===e);return s!=null&&s.sortable?{key:e,direction:o}:null}function Oe(t,e){if(typeof t.sortLabel=="string"&&t.sortLabel.trim().length>0)return t.sortLabel.trim();const o=De(ke(t.header));return o.length>0?o:e}function d({columns:t,data:e,rowKey:o,caption:s,ariaLabel:h,ariaLabelledBy:xe,loading:f=!1,loadingContent:I="Loading data...",emptyContent:k="No data available.",defaultSortKey:V,defaultSortDirection:he="asc",getSortAriaLabel:ga=Ue,getSortStatusText:Ie=Ea,onSortChange:Se}){const M=Te(xe),Ae=M?void 0:Te(h,s?void 0:"Data table"),W=u.useRef({}),Ee=u.useRef(null),fe=u.useRef(null),O=u.useRef(0),K=u.useRef(null),U=u.useRef(null),N=u.useRef(!0);u.useRef(null),u.useRef(null),u.useRef(null);const[va,Be]=u.useState(null),[xa,C]=u.useState(null),[ha,P]=u.useState(null);u.useEffect(()=>{var x;const c=((x=Ee.current)==null?void 0:x.ownerDocument)??document,r=p=>{p.metaKey||p.altKey||p.ctrlKey||(N.current=!0)},w=()=>{N.current=!1};return c.addEventListener("keydown",r,!0),c.addEventListener("pointerdown",w,!0),c.addEventListener("mousedown",w,!0),c.addEventListener("touchstart",w,!0),()=>{c.removeEventListener("keydown",r,!0),c.removeEventListener("pointerdown",w,!0),c.removeEventListener("mousedown",w,!0),c.removeEventListener("touchstart",w,!0)}},[]);const z=u.useCallback(()=>{fe.current=null,O.current=0,K.current!==null&&((U.current??window).clearTimeout(K.current),K.current=null),U.current=null},[]);u.useEffect(()=>()=>{z()},[z]);const[b,Re]=u.useState(()=>Me(t,V,he)),F=u.useMemo(()=>f||e.length<=1?[]:t.reduce((c,r)=>(r.sortable&&c.push(String(r.key)),c),[]),[t,e.length,f]);u.useEffect(()=>{if(!b)return;const c=t.find(r=>String(r.key)===b.key);c!=null&&c.sortable||Re(null)},[t,b]),u.useEffect(()=>{if(b)return;const c=Me(t,V,he);c&&Re(c)},[t,he,V,b]);const Sa=u.useMemo(()=>e.map((c,r)=>String(o?o(c,r):r)),[e,o]);u.useEffect(()=>{},[o,Sa]),u.useEffect(()=>{},[t]),u.useEffect(()=>{},[t]);const L=u.useMemo(()=>{const c=e.map((x,p)=>({row:x,sourceIndex:p}));if(!b)return c;const r=t.find(x=>String(x.key)===b.key);if(!(r!=null&&r.sortable))return c;const w=r.sortAccessor??(x=>{const p=x[String(r.key)];return p instanceof Date||typeof p=="number"||typeof p=="string"?p:String(p??"")});return c.sort((x,p)=>{const g=w(x.row),D=w(p.row);if(typeof g=="string"&&typeof D=="string"){const A=Aa.compare(g,D);return A!==0?b.direction==="asc"?A:-A:x.sourceIndex-p.sourceIndex}const j=g instanceof Date?g.getTime():g,$=D instanceof Date?D.getTime():D;return j<$?b.direction==="asc"?-1:1:j>$?b.direction==="asc"?1:-1:x.sourceIndex-p.sourceIndex})},[t,e,b]),Ce=u.useMemo(()=>{if(f||L.length<=1||!b)return"";const c=t.find(w=>String(w.key)===b.key);if(!(c!=null&&c.sortable))return"";const r=Oe(c,String(c.key));return Ie({columnKey:b.key,columnHeader:r,direction:b.direction})},[t,Ie,f,b,L.length]),q=!f&&L.length>1&&t.some(c=>c.sortable),je=Math.max(t.length,1);return u.useEffect(()=>{q||(Be(null),C(null),P(null))},[q]),a.jsxs("div",{ref:Ee,"data-aurora-table-scroll-container":"",tabIndex:q?void 0:0,"aria-label":q||M?void 0:Ae??"Data table scroll container","aria-labelledby":q?void 0:M,style:{border:"1px solid var(--aurora-border-default)",borderRadius:"var(--aurora-radius-md)",overflow:"auto"},children:[Ce?a.jsx("p",{role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:Ce}):null,a.jsxs("table",{"aria-label":Ae,"aria-labelledby":M,"aria-busy":f||void 0,style:{width:"100%",borderCollapse:"collapse",minWidth:560},children:[s?a.jsx("caption",{style:{textAlign:"left",padding:"10px 12px",color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-sm)",borderBottom:"1px solid var(--aurora-border-default)"},children:s}):null,a.jsx("thead",{children:a.jsx("tr",{children:t.map(c=>{const r=String(c.key),w=!!c.sortable,x=L.length>1,p=w&&(b==null?void 0:b.key)===r?b.direction:void 0,g=!f&&x?p:void 0,D=g?g==="asc"?"ascending":"descending":void 0,j=c.align??"left",$=Oe(c,r),A=p==="asc"?"desc":"asc",fa=ga({columnKey:r,columnHeader:$,nextDirection:A}),Ba=Te(fa,Ue({columnHeader:$,nextDirection:A})),T=f||!x,Ke=!T&&va===r,Fe=!T&&xa===r,Le=!T&&ha===r,Ra=Ke||Le,We=()=>{T||(Re({key:r,direction:A}),Se==null||Se(r,A))};return a.jsx("th",{scope:"col","aria-sort":D,style:{textAlign:j,color:"var(--aurora-text-secondary)",background:"var(--aurora-surface-elevated)",borderBottom:"1px solid var(--aurora-border-default)",padding:"10px 12px",fontSize:"var(--aurora-font-size-sm)",fontWeight:"var(--aurora-font-weight-medium)",width:c.width},children:w?a.jsxs("button",{"data-aurora-reduced-motion":"transition",type:"button",ref:i=>{W.current[r]=i},"aria-label":Ba,"aria-keyshortcuts":T?void 0:Ia,disabled:T,onClick:i=>{const B=Date.now()-O.current,G=i.detail===0&&fe.current===r&&O.current>0&&B<=Ve;z(),!G&&We()},onMouseEnter:()=>{T||Be(r)},onMouseLeave:()=>{Be(i=>i===r?null:i),C(i=>i===r?null:i)},onMouseDown:i=>{T||i.button===0&&(N.current=!1,P(B=>B===r?null:B),C(r))},onMouseUp:i=>{i.button===0&&C(B=>B===r?null:B)},onFocus:()=>{if(T){P(i=>i===r?null:i);return}P(i=>ja(W.current[r],N.current)?r:i===r?null:i)},onBlur:()=>{P(i=>i===r?null:i),C(i=>i===r?null:i)},onKeyDown:i=>{var G,Ne,Pe;if(N.current=!0,i.altKey||i.ctrlKey||i.metaKey)return;if(i.key==="Home"){const H=F[0];if(!H)return;i.preventDefault(),(G=W.current[H])==null||G.focus();return}if(i.key==="End"){const H=F[F.length-1];if(!H)return;i.preventDefault(),(Ne=W.current[H])==null||Ne.focus();return}if(i.key==="PageDown"||i.key==="PageUp"){const H=F.indexOf(r);if(H<0)return;const Ta=i.key==="PageDown"?1:-1,qe=Math.max(0,Math.min(F.length-1,H+Ta));if(qe===H)return;i.preventDefault();const ka=F[qe];(Pe=W.current[ka])==null||Pe.focus();return}if(!ze(i.key)||Ca(i)||(i.preventDefault(),i.repeat))return;C(r),fe.current=r,O.current=Date.now();const B=i.currentTarget.ownerDocument.defaultView??window;K.current!==null&&(U.current??B).clearTimeout(K.current),U.current=B,K.current=B.setTimeout(()=>{z()},Ve),We()},onKeyUp:i=>{i.altKey||i.ctrlKey||i.metaKey||ze(i.key)&&C(B=>B===r?null:B)},style:{border:Ra?"1px solid color-mix(in srgb, var(--aurora-accent-default) 48%, transparent)":"1px solid transparent",borderRadius:"var(--aurora-radius-sm)",background:Fe?"color-mix(in srgb, var(--aurora-surface-elevated) 68%, var(--aurora-surface-default))":Ke?"color-mix(in srgb, var(--aurora-surface-elevated) 86%, var(--aurora-surface-default))":"transparent",font:"inherit",cursor:T?"not-allowed":"pointer",display:"inline-flex",alignItems:"center",gap:6,padding:"2px 6px",color:T?"color-mix(in srgb, var(--aurora-text-secondary) 88%, var(--aurora-text-primary))":"inherit",boxShadow:Le?"0 0 0 3px color-mix(in srgb, var(--aurora-focus-ring) 42%, transparent)":"none",transform:Fe?"translateY(1px)":"translateY(0)",transition:"background-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), border-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), box-shadow var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), transform var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard)"},children:[c.header,a.jsx("span",{"aria-hidden":"true",children:g==="asc"?"▲":g==="desc"?"▼":"↕"})]}):c.header},r)})})}),a.jsx("tbody",{children:f?a.jsx("tr",{children:a.jsx("td",{colSpan:je,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:I})})}):L.length===0?a.jsx("tr",{children:a.jsx("td",{colSpan:je,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:k})})}):L.map((c,r)=>{const w=c.row,x=String(c.sourceIndex),p=o?o(w,c.sourceIndex):x;return a.jsx("tr",{style:{background:r%2===0?"transparent":"var(--aurora-surface-elevated)"},children:t.map(g=>{const D=g.render?g.render(w,r,c.sourceIndex):String(w[String(g.key)]??""),j={padding:"10px 12px",borderBottom:"1px solid var(--aurora-border-default)",color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",textAlign:g.align??"left"};return g.rowHeader?a.jsx("th",{scope:"row",style:{...j,fontWeight:"var(--aurora-font-weight-medium)"},children:D},String(g.key)):a.jsx("td",{style:j,children:D},String(g.key))})},p)})})]})]})}function Ue({columnHeader:t,nextDirection:e}){return`${t} sort ${e==="asc"?"ascending":"descending"}`}function Ea({columnHeader:t,direction:e}){return`Sorted by ${t} ${e==="asc"?"ascending":"descending"}.`}function ze(t){return t==="Enter"||t===" "||t==="Space"||t==="Spacebar"}function Ca(t){const e=t.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function ja(t,e){if(!t)return e;try{return t.matches(":focus-visible")}catch{return e}}function ke(t){if(typeof t=="string")return t;if(typeof t=="number")return String(t);if(Array.isArray(t))return De(t.map(o=>ke(o)).filter(o=>o.length>0).join(" "));if(!u.isValidElement(t))return"";const e=t.props;if(e["aria-hidden"]===!0||e["aria-hidden"]==="true")return"";if(typeof e["aria-label"]=="string"){const o=De(e["aria-label"]);if(o.length>0)return o}return ke(e.children)}function De(t){return t.replace(/\s+/g," ").trim()}function Te(t,e){return typeof t=="string"&&t.trim().length>0?t.trim():e}d.__docgenInfo={description:"",methods:[],displayName:"Table",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: keyof T | string;
  ...
  play: async ({
    ...
    await expect(issueSort).toHaveAttribute("aria-keyshortcuts", "Enter Space Home End PageDown PageUp");
    issueSort.focus();
...
}`,...($t=(qt=ue.parameters)==null?void 0:qt.docs)==null?void 0:$t.source}}};var Vt,Mt,Ot;le.parameters={...le.parameters,docs:{...(Vt=le.parameters)==null?void 0:Vt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Ot=(Mt=le.parameters)==null?void 0:Mt.docs)==null?void 0:Ot.source}}};var Ut,zt,Gt;de.parameters={...de.parameters,docs:{...(Ut=de.parameters)==null?void 0:Ut.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "releasedAt",
