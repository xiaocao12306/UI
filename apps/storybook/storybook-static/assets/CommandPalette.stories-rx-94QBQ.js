import{j as o}from"./jsx-runtime-BjG_zV1W.js";import{r}from"./index-BWu4c2F4.js";import{B as ue}from"./Button-DsGPnCUO.js";import{D as ca}from"./Dialog-f89dhpmq.js";import{I as ia}from"./Input-DAgIzluT.js";import{within as y,expect as n,userEvent as i,fireEvent as b,waitFor as ge}from"./index-DgAF9SIF.js";import{b as h,s as w,a as v}from"./storyShowcase-Bw5VyCj0.js";import"./bodyScrollLock-D0vp0S5S.js";import"./index-DlVbWVVj.js";import"./DismissableLayer-DAyP3iyR.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";function m({open:a,onOpenChange:e,commands:t,title:c="Command Palette",description:l="Quickly search and execute workspace actions.",searchAriaLabel:p="Search commands",resultsAriaLabel:k="Command results",closeOnSelect:B=!0,clearQueryOnEscape:A=!0,closeOnEscape:O=!0,closeOnOutsidePointer:fe=!0,onEscapeKeyDown:me,onPointerDownOutside:pe,closeLabel:Xt,placeholder:Yt="Search commands...",emptyMessage:Zt="No commands found.",onQueryChange:T,onCloseReason:D,getResultsStatusText:ke=ua}){const[R,ye]=r.useState(""),[q,E]=r.useState(0),ea=r.useRef(null),j=r.useRef(null),L=r.useRef(null),Be=r.useRef(a);r.useRef(null),r.useRef(null),r.useRef(null);const H=r.useId(),Te=r.useId(),Ee=r.useRef(null),ta=K(p,"Search commands"),aa=K(k,"Command results"),na=K(Xt,"Close dialog"),N=r.useCallback(s=>{L.current=s,D==null||D(s)},[D]),Ce=r.useCallback(s=>{N(s),e(!1),L.current=null},[N,e]),oa=r.useCallback(s=>{!s&&a&&L.current===null&&(D==null||D("close-button")),L.current=null,e(s)},[D,e,a]);r.useEffect(()=>{!a&&Be.current&&(ye(s=>(s.length>0&&(T==null||T("")),"")),E(0)),Be.current=a},[T,a]),r.useEffect(()=>{},[t]),r.useEffect(()=>{},[t]),r.useEffect(()=>{},[t]);const we=r.useMemo(()=>Pe(R.trim()),[R]),u=r.useMemo(()=>we?t.filter(s=>{const g=[la(s),...s.keywords??[]].join(" ");return Pe(g).includes(we)}):t,[t,we]),C=r.useMemo(()=>u.reduce((s,d)=>d.disabled?s:s+1,0),[u]),ve=u.length>0,sa=r.useMemo(()=>{const s=[];return C>0&&s.push("ArrowDown","ArrowUp","Home","End","PageDown","PageUp","Enter"),(O||A&&R.length>0)&&s.push("Escape"),s.length>0?s.join(" "):void 0},[A,O,C,R.length]),ra=r.useMemo(()=>ke({query:R,visibleCount:u.length,enabledCount:C,totalCount:t.length}),[t.length,C,u.length,ke,R]),I=r.useMemo(()=>u.reduce((s,d,g)=>(d.disabled||s.push(g),s),[]),[u]),P=I[0]??-1,De=I[I.length-1]??-1,f=r.useMemo(()=>{if(q<0)return-1;const s=u[q];return!s||s.disabled?-1:q},[q,u]);r.useEffect(()=>{var d;if(u.length===0){j.current=null,E(-1);return}const s=j.current;if(s){const g=u.findIndex(S=>!S.disabled&&S.key===s);if(g>=0){E(g);return}}E(P),j.current=P>=0?((d=u[P])==null?void 0:d.key)??null:null},[u,P]),r.useEffect(()=>{var s;if(f<0){j.current=null;return}j.current=((s=u[f])==null?void 0:s.key)??null},[u,f]),r.useEffect(()=>{if(!a||f<0)return;const s=Ee.current;if(!s)return;const d=s.ownerDocument.getElementById(`${H}-option-${f}`);!d||!s.contains(d)||typeof d.scrollIntoView=="function"&&d.scrollIntoView({block:"nearest"})},[H,a,f]);const be=r.useCallback(s=>{var g;const d=u[s];!d||d.disabled||((g=d.onSelect)==null||g.call(d),B&&Ce("item-select"))},[B,Ce,u]),Re=s=>{var g;if(u.length===0)return;let d=f<0?s===1?-1:0:f;for(let S=0;S<u.length;S+=1)if(d=(d+s+u.length)%u.length,!((g=u[d])!=null&&g.disabled)){E(d);return}},Ie=s=>{if(I.length===0)return;const d=I.indexOf(f);if(d<0){E(s===1?P:De);return}const g=Math.min(I.length-1,Math.max(0,d+s*5));E(I[g]??P)};return o.jsx(ca,{open:a,onOpenChange:oa,title:c,description:l,closeLabel:na,size:"md",closeOnEscape:O,closeOnOutsidePointer:fe,onEscapeKeyDown:s=>{me==null||me(s),!(s.defaultPrevented||!O)&&N("escape-key")},onPointerDownOutside:s=>{pe==null||pe(s),!(s.defaultPrevented||!fe)&&N("outside-pointer")},children:o.jsxs("div",{style:{display:"grid",gap:10},children:[o.jsx(ia,{ref:ea,"data-autofocus":"",role:"combobox","aria-expanded":ve,"aria-haspopup":"listbox","aria-autocomplete":"list","aria-controls":ve?H:void 0,"aria-activedescendant":f>=0?`${H}-option-${f}`:void 0,"aria-describedby":Te,"aria-keyshortcuts":sa,placeholder:Yt,value:R,onChange:s=>{ye(s.target.value),T==null||T(s.target.value)},onKeyDown:s=>{if(!da(s)&&!(s.altKey||s.ctrlKey||s.metaKey)){if(s.key==="Escape"){if(s.repeat)return;A&&R.length>0&&(s.preventDefault(),ye(""),T==null||T(""));return}if(s.key==="ArrowDown"){if(C===0)return;s.preventDefault(),Re(1);return}if(s.key==="ArrowUp"){if(C===0)return;s.preventDefault(),Re(-1);return}if(s.key==="Home"){if(C===0)return;s.preventDefault(),E(P);return}if(s.key==="End"){if(C===0)return;s.preventDefault(),E(De);return}if(s.key==="PageDown"){if(C===0)return;s.preventDefault(),Ie(1);return}if(s.key==="PageUp"){if(C===0)return;s.preventDefault(),Ie(-1);return}if(s.key==="Enter"&&f>=0){if(s.preventDefault(),s.repeat)return;be(f)}}},"aria-label":ta}),o.jsx("p",{id:Te,role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:ra}),ve?o.jsx("div",{id:H,ref:Ee,role:"listbox","aria-label":aa,style:{maxHeight:280,overflow:"auto",display:"grid",gap:4},children:u.map((s,d)=>{const g=d===f,S=K(s.ariaLabel);return o.jsx("div",{id:`${H}-option-${d}`,role:"option","aria-selected":g,"aria-disabled":s.disabled||void 0,"aria-label":S,"aria-posinset":d+1,"aria-setsize":u.length,tabIndex:-1,onPointerDown:x=>{x.pointerType==="mouse"||x.button!==0||x.preventDefault()},onMouseDown:x=>{x.button===0&&x.preventDefault()},onMouseEnter:()=>{s.disabled||E(d)},onClick:()=>{s.disabled||be(d)},onKeyDown:x=>{if(!s.disabled&&!(x.altKey||x.ctrlKey||x.metaKey)&&(x.key==="Enter"||x.key===" "||x.key==="Space"||x.key==="Spacebar")){if(x.preventDefault(),x.repeat)return;be(d)}},style:{border:"1px solid var(--aurora-border-default)",background:g?"color-mix(in srgb, var(--aurora-accent-default) 14%, var(--aurora-surface-default))":"var(--aurora-surface-default)",color:s.disabled?"color-mix(in srgb, var(--aurora-text-secondary) 60%, transparent)":"var(--aurora-text-primary)",borderRadius:8,height:36,padding:"0 10px",textAlign:"left",cursor:s.disabled?"not-allowed":"pointer"},children:s.label},s.key)})}):o.jsx("p",{style:{margin:0,color:"var(--aurora-text-secondary)"},children:Zt})]})})}function la(a){if(typeof a.textValue=="string"){const e=de(a.textValue);if(e.length>0)return e}return de(xe(a.label))}function Pe(a){return a.normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/\s+/g," ").trim().toLowerCase()}function da(a){const e=a.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function ua({query:a,visibleCount:e,enabledCount:t,totalCount:c}){const l=a.trim();return l.length===0?t!==c?`${t} of ${c} command${c===1?"":"s"} available.`:`${c} command${c===1?"":"s"} available.`:e===0?`No commands match "${l}".`:t===0?`No enabled commands match "${l}".`:t!==e?`${t} of ${e} matching command${t===1?"":"s"} available for "${l}".`:`${e} command${e===1?"":"s"} found for "${l}".`}function xe(a){if(typeof a=="string")return a;if(typeof a=="number")return String(a);if(Array.isArray(a))return de(a.map(t=>xe(t)).filter(t=>t.length>0).join(" "));if(!r.isValidElement(a))return"";const e=a.props;return e["aria-hidden"]===!0||e["aria-hidden"]==="true"?"":typeof e["aria-label"]=="string"&&e["aria-label"].trim().length>0?de(e["aria-label"]):xe(e.children)}function K(a,e){return typeof a=="string"&&a.trim().length>0?a.trim():e}function de(a){return a.replace(/\s+/g," ").trim()}m.__docgenInfo={description:"",methods:[],displayName:"CommandPalette",props:{open:{required:!0,tsType:{name:"boolean"},description:""},onOpenChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""},commands:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: string;
...
}`,...(qe=(Oe=U.parameters)==null?void 0:Oe.docs)==null?void 0:qe.source}}};var Le,Ne,Ke;V.parameters={...V.parameters,docs:{...(Le=V.parameters)==null?void 0:Le.docs,source:{originalSource:`{
  render: () => <AiFlowPalette />
}`,...(Ke=(Ne=V.parameters)==null?void 0:Ne.docs)==null?void 0:Ke.source}}};var $e,Ue,Ve;M.parameters={...M.parameters,docs:{...($e=M.parameters)==null?void 0:$e.docs,source:{originalSource:`{
...
}`,...(Ve=(Ue=M.parameters)==null?void 0:Ue.docs)==null?void 0:Ve.source}}};var Me,Ge,Fe;G.parameters={...G.parameters,docs:{...(Me=G.parameters)==null?void 0:Me.docs,source:{originalSource:`{
...
}`,...(Tt=(Bt=te.parameters)==null?void 0:Bt.docs)==null?void 0:Tt.source}}};var Et,Ct,Dt;ae.parameters={...ae.parameters,docs:{...(Et=ae.parameters)==null?void 0:Et.docs,source:{originalSource:`{
...
}`,...(Dt=(Ct=ae.parameters)==null?void 0:Ct.docs)==null?void 0:Dt.source}}};var Rt,It,Pt;ne.parameters={...ne.parameters,docs:{...(Rt=ne.parameters)==null?void 0:Rt.docs,source:{originalSource:`{
...
}`,...(Pt=(It=ne.parameters)==null?void 0:It.docs)==null?void 0:Pt.source}}};var St,At,Ht;oe.parameters={...oe.parameters,docs:{...(St=oe.parameters)==null?void 0:St.docs,source:{originalSource:`{
...
}`,...(Kt=(Nt=re.parameters)==null?void 0:Nt.docs)==null?void 0:Kt.source}}};var $t,Ut,Vt;ce.parameters={...ce.parameters,docs:{...($t=ce.parameters)==null?void 0:$t.docs,source:{originalSource:`{
...
}`,...(Vt=(Ut=ce.parameters)==null?void 0:Ut.docs)==null?void 0:Vt.source}}};var Mt,Gt,Ft;ie.parameters={...ie.parameters,docs:{...(Mt=ie.parameters)==null?void 0:Mt.docs,source:{originalSource:`{
