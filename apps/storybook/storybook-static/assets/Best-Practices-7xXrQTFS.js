import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{useMDXComponents as r}from"./index-CHKtz2QT.js";import{M as t,T as a,S as l,D as d,C as s}from"./index-DbwIC-4v.js";import{VariantMatrix as c,IconOnlyAccessibleName as h}from"./Button.stories-DALeeEQW.js";import{WithInputControl as p}from"./FormField.stories-BTuhsucQ.js";import{Interactive as x,CloseReasonTelemetry as m,FocusTrapKeyboardCycle as u,EscapeIgnoresImeComposition as j,EscapePreemptedByGlobalHandler as f,DismissGuardHooks as b}from"./Dialog.stories-CxkmX2QO.js";import{CloseReasonTelemetry as y,FocusTrapKeyboardCycle as g,EscapePreemptedByGlobalHandler as v,DismissGuardHooks as w}from"./Drawer.stories-DTacDeQQ.js";import{CloseReasonTelemetry as k,EscapePreemptedByGlobalHandler as E,DismissGuardHooks as C}from"./Popover.stories-Z0Bg9_Om.js";import{OutsideDismissFocusTransfer as D,EscapeDismissFocusReturn as K,EscapePreemptedByGlobalHandler as P,TabDismissToNextControl as F,CloseReasonTelemetry as A,ControlledOpenContract as I,TypeaheadNavigation as S,IconItemNaming as L,TypeaheadIgnoresImeComposition as R,DismissGuardHooks as T}from"./Dropdown.stories-n8-e2MrL.js";import{DescribedByLifecycle as O}from"./Tooltip.stories-bEfmviDE.js";import{AiInteractionFlow as H,QueryTelemetry as G,CloseReasonTelemetry as M,DisabledCommandGuard as U,TextValueAndAccentSearch as B,IconOnlyCommandNaming as q,PersistentSelection as $,RefinedSearchKeepsActiveCommand as z,PagedKeyboardNavigation as V,LocalizedResultsLabel as N,LocalizedDialogCopy as W,ImeCompositionGuard as Q,EscapePreemptedByGlobalHandler as J,GuardedDismissEvents as X,EscapeClearsQueryFirst as _}from"./CommandPalette.stories-DtEk9Jiy.js";import{WithAiRequestState as Y}from"./PromptInput.stories-Dg4GIpmM.js";import{Conversation as Z}from"./MessageBubble.stories-XtWuqyRv.js";import{Default as ee}from"./ReasoningPanel.stories-ll9aUG-c.js";import{Default as ne}from"./StreamingCodeBlock.stories-52CajPJL.js";import{ActionRequired as se,ActionRequiredDanger as oe,CloseReasonTelemetry as ie,EscapeStackOrder as re,EscapeShortcutSync as te,StackedViewportOffset as ae,FocusedToastEscapesFirst as le,CloseButtonPrimaryPointerOnly as de,EscapePreemptedByGlobalHandler as ce,EscapePreemptedSkipsToastHook as he,EscapeGuardedByToastHandler as pe,EscapeIgnoresImeComposition as xe,LiveRegionOff as me}from"./Toast.stories-HtmRTT4G.js";import{KeyboardNavigationGuide as ue,NoLoopNavigation as je,Vertical as fe,RtlKeyboardNavigation as be,LabelledByHeading as ye,ManualActivation as ge,ManualVerticalActivation as ve,PrimaryPointerOnlyPressedState as we}from"./Tabs.stories-BCQj6BJc.js";import{ReleaseChecklist as ke,SortTelemetry as Ee,LocalizedSortLabels as Ce,SortLabelForCustomHeader as De,RichTextHeaderAutoSortLabel as Ke,AriaLabelHeaderAutoSortLabel as Pe,SingleRowSortDisabled as Fe,PrimaryPointerOnlySortPress as Ae,WithRowAction as Ie,InvalidDefaultSortKeyFallback as Se,RowHeaderSemantics as Le,AccessibleNameFallback as Re}from"./Table.stories-R7bgsTUW.js";import{KeyboardShortcuts as Te,RtlKeyboardShortcuts as Oe,LabelledByHeading as He}from"./Pagination.stories-LaCM9y5E.js";import"./index-BWu4c2F4.js";import"./iframe-BsEIsXSX.js";import"./index-DlVbWVVj.js";import"./index-4adcsI43.js";import"./index-DrFu-skq.js";import"./Button-BhfMIoQv.js";import"./Tag-Dmp9Dfgr.js";import"./Badge-ZJmMstsz.js";import"./index-DgAF9SIF.js";import"./storyShowcase-Bw5VyCj0.js";import"./Input-pKdbw4ss.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";import"./FormField-ZaHPw_tE.js";import"./Textarea-C2HCxZDO.js";import"./Dialog-DJrTABMX.js";import"./bodyScrollLock-D0vp0S5S.js";import"./DismissableLayer-DAyP3iyR.js";import"./Dropdown-CAW9LzpQ.js";import"./Popover-DfqdphH1.js";function i(o){const n={code:"code",h2:"h2",li:"li",p:"p",ul:"ul",...r(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Docs/Best Practices"}),`
`,e.jsx(a,{}),`
`,e.jsx(l,{children:"Design + Engineering Checklist"}),`
`,e.jsx(d,{children:e.jsx(n.p,{children:"Use these rules to keep components consistent with the Aurora plan and avoid regressions in accessibility or theming."})}),`
...
`,e.jsxs(n.li,{children:["Keep ",e.jsx(n.code,{children:"Ctrl/Meta/Alt + Home/End/Page/Enter/Escape"})," on native input behavior; do not hijack modified shortcuts for command navigation or dismiss."]}),`
...
`,e.jsxs(n.li,{children:["Keep toast Escape dismissal scoped to unmodified keys; ",e.jsx(n.code,{children:"Ctrl/Meta/Alt + Escape"})," should stay on host/app shortcut behavior."]}),`
...
`,e.jsxs(n.li,{children:["Support sortable-header focus traversal with ",e.jsx(n.code,{children:"Home"})," / ",e.jsx(n.code,{children:"End"})," / ",e.jsx(n.code,{children:"PageUp"})," / ",e.jsx(n.code,{children:"PageDown"})," so keyboard users can move between columns without forcing sort changes."]}),`
`,e.jsxs(n.li,{children:["Keep modified shortcuts (",e.jsx(n.code,{children:"Ctrl/Meta/Alt + Home/End/PageUp/PageDown/Enter/Space"}),") on host/browser behavior; sortable headers should only react to unmodified focus/activation keys."]}),`
...
`,e.jsx(s,{of:Te}),`
`,e.jsx(s,{of:Oe}),`
`,e.jsx(s,{of:He})]})}function En(o={}){const{wrapper:n}={...r(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(i,{...o})}):i(o)}export{En as default};
