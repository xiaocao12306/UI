import{j as n}from"./jsx-runtime-BjG_zV1W.js";import{B as Ya}from"./Button-COG9o64O.js";import{r as l}from"./index-BWu4c2F4.js";import{B as _a}from"./Badge-ZJmMstsz.js";import{within as y,expect as a,userEvent as u,fireEvent as h,waitFor as _e}from"./index-DgAF9SIF.js";import{S as m,s as I,a as Ke}from"./storyShowcase-Bw5VyCj0.js";const Ka="Enter Space",Ja=`${Ka} Home End PageDown PageUp ArrowLeft ArrowRight`,Qa=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"}),Je=400;function Qe(t,e,o){if(!e)return null;const r=t.find(f=>String(f.key)===e);return r!=null&&r.sortable?{key:e,direction:o}:null}function Xe(t,e){if(typeof t.sortLabel=="string"&&t.sortLabel.trim().length>0)return t.sortLabel.trim();const o=Ce(Ee(t.header));return o.length>0?o:e}function d({columns:t,data:e,rowKey:o,caption:r,ariaLabel:f,ariaLabelledBy:Re,loading:T=!1,loadingContent:F="Loading data...",emptyContent:E="No data available.",defaultSortKey:B,defaultSortDirection:O="asc",getSortAriaLabel:La=Ze,getSortStatusText:je=Xa,onSortChange:ke}){const U=Ie(Re),Fe=U?void 0:Ie(f,r?void 0:"Data table"),L=l.useRef({}),Le=l.useRef(null),Te=l.useRef(null),z=l.useRef(0),W=l.useRef(null),G=l.useRef(null),q=l.useRef(!0);l.useRef(null),l.useRef(null),l.useRef(null);const[Wa,De]=l.useState(null),[Pa,K]=l.useState(null),[Na,$]=l.useState(null);l.useEffect(()=>{var x;const c=((x=Le.current)==null?void 0:x.ownerDocument)??document,i=p=>{p.metaKey||p.altKey||p.ctrlKey||(q.current=!0)},g=()=>{q.current=!1};return c.addEventListener("keydown",i,!0),c.addEventListener("pointerdown",g,!0),c.addEventListener("mousedown",g,!0),c.addEventListener("touchstart",g,!0),()=>{c.removeEventListener("keydown",i,!0),c.removeEventListener("pointerdown",g,!0),c.removeEventListener("mousedown",g,!0),c.removeEventListener("touchstart",g,!0)}},[]);const Y=l.useCallback(()=>{Te.current=null,z.current=0,W.current!==null&&((G.current??window).clearTimeout(W.current),W.current=null),G.current=null},[]);l.useEffect(()=>()=>{Y()},[Y]);const[b,He]=l.useState(()=>Qe(t,B,O)),H=l.useMemo(()=>T||e.length<=1?[]:t.reduce((c,i)=>(i.sortable&&c.push(String(i.key)),c),[]),[t,e.length,T]);l.useEffect(()=>{if(!b)return;const c=t.find(i=>String(i.key)===b.key);c!=null&&c.sortable||He(null)},[t,b]),l.useEffect(()=>{if(b)return;const c=Qe(t,B,O);c&&He(c)},[t,O,B,b]);const qa=l.useMemo(()=>e.map((c,i)=>String(o?o(c,i):i)),[e,o]);l.useEffect(()=>{},[o,qa]),l.useEffect(()=>{},[t]),l.useEffect(()=>{},[t]);const P=l.useMemo(()=>{const c=e.map((x,p)=>({row:x,sourceIndex:p}));if(!b)return c;const i=t.find(x=>String(x.key)===b.key);if(!(i!=null&&i.sortable))return c;const g=i.sortAccessor??(x=>{const p=x[String(i.key)];return p instanceof Date||typeof p=="number"||typeof p=="string"?p:String(p??"")});return c.sort((x,p)=>{const v=g(x.row),A=g(p.row);if(typeof v=="string"&&typeof A=="string"){const C=Qa.compare(v,A);return C!==0?b.direction==="asc"?C:-C:x.sourceIndex-p.sourceIndex}const j=v instanceof Date?v.getTime():v,V=A instanceof Date?A.getTime():A;return j<V?b.direction==="asc"?-1:1:j>V?b.direction==="asc"?1:-1:x.sourceIndex-p.sourceIndex})},[t,e,b]),We=l.useMemo(()=>{if(T||P.length<=1||!b)return"";const c=t.find(g=>String(g.key)===b.key);if(!(c!=null&&c.sortable))return"";const i=Xe(c,String(c.key));return je({columnKey:b.key,columnHeader:i,direction:b.direction})},[t,je,T,b,P.length]),M=!T&&P.length>1&&t.some(c=>c.sortable),Pe=Math.max(t.length,1);return l.useEffect(()=>{M||(De(null),K(null),$(null))},[M]),n.jsxs("div",{ref:Le,"data-aurora-table-scroll-container":"",tabIndex:M?void 0:0,"aria-label":M||U?void 0:Fe??"Data table scroll container","aria-labelledby":M?void 0:U,style:{border:"1px solid var(--aurora-border-default)",borderRadius:"var(--aurora-radius-md)",overflow:"auto"},children:[We?n.jsx("p",{role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:We}):null,n.jsxs("table",{"aria-label":Fe,"aria-labelledby":U,"aria-busy":T||void 0,style:{width:"100%",borderCollapse:"collapse",minWidth:560},children:[r?n.jsx("caption",{style:{textAlign:"left",padding:"10px 12px",color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-sm)",borderBottom:"1px solid var(--aurora-border-default)"},children:r}):null,n.jsx("thead",{children:n.jsx("tr",{children:t.map(c=>{const i=String(c.key),g=!!c.sortable,x=P.length>1,p=g&&(b==null?void 0:b.key)===i?b.direction:void 0,v=!T&&x?p:void 0,A=v?v==="asc"?"ascending":"descending":void 0,j=c.align??"left",V=Xe(c,i),C=p==="asc"?"desc":"asc",$a=La({columnKey:i,columnHeader:V,nextDirection:C}),Ma=Ie($a,Ze({columnHeader:V,nextDirection:C})),D=T||!x,Va=D?void 0:H.length>1?Ja:Ka,Ne=!D&&Wa===i,qe=!D&&Pa===i,$e=!D&&Na===i,Oa=Ne||$e,Me=()=>{D||(He({key:i,direction:C}),ke==null||ke(i,C))};return n.jsx("th",{scope:"col","aria-sort":A,style:{textAlign:j,color:"var(--aurora-text-secondary)",background:"var(--aurora-surface-elevated)",borderBottom:"1px solid var(--aurora-border-default)",padding:"10px 12px",fontSize:"var(--aurora-font-size-sm)",fontWeight:"var(--aurora-font-weight-medium)",width:c.width},children:g?n.jsxs("button",{"data-aurora-reduced-motion":"transition",type:"button",ref:s=>{L.current[i]=s},"aria-label":Ma,"aria-keyshortcuts":Va,disabled:D,onClick:s=>{const R=Date.now()-z.current,_=s.detail===0&&Te.current===i&&z.current>0&&R<=Je;Y(),!_&&Me()},onMouseEnter:()=>{D||De(i)},onMouseLeave:()=>{De(s=>s===i?null:s),K(s=>s===i?null:s)},onMouseDown:s=>{D||s.button===0&&(q.current=!1,$(R=>R===i?null:R),K(i))},onMouseUp:s=>{s.button===0&&K(R=>R===i?null:R)},onFocus:()=>{if(D){$(s=>s===i?null:s);return}$(s=>en(L.current[i],q.current)?i:s===i?null:s)},onBlur:()=>{$(s=>s===i?null:s),K(s=>s===i?null:s)},onKeyDown:s=>{var _,Ve,Oe,Ue,ze;if(q.current=!0,s.altKey||s.ctrlKey||s.metaKey)return;if(s.key==="Home"){const k=H[0];if(!k)return;s.preventDefault(),(_=L.current[k])==null||_.focus();return}if(s.key==="End"){const k=H[H.length-1];if(!k)return;s.preventDefault(),(Ve=L.current[k])==null||Ve.focus();return}if(s.key==="PageDown"||s.key==="PageUp"){const k=H.indexOf(i);if(k<0)return;const Ge=s.key==="PageDown"?1:-1,N=Math.max(0,Math.min(H.length-1,k+Ge));if(N===k)return;s.preventDefault();const Ae=H[N];(Oe=L.current[Ae])==null||Oe.focus();return}if(s.key==="ArrowLeft"||s.key==="ArrowRight"){const k=H.indexOf(i);if(k<0)return;const N=(s.currentTarget.ownerDocument.defaultView??window).getComputedStyle(s.currentTarget).direction,Ae=(Ue=s.currentTarget.closest("[dir]"))==null?void 0:Ue.getAttribute("dir"),Ua=(N==="rtl"||N==="ltr"?N:Ae==="rtl"?"rtl":"ltr")==="rtl"?"ArrowLeft":"ArrowRight",za=s.key===Ua?1:-1,Ye=Math.max(0,Math.min(H.length-1,k+za));if(Ye===k)return;s.preventDefault();const Ga=H[Ye];(ze=L.current[Ga])==null||ze.focus();return}if(!et(s.key)||Za(s)||(s.preventDefault(),s.repeat))return;K(i),Te.current=i,z.current=Date.now();const R=s.currentTarget.ownerDocument.defaultView??window;W.current!==null&&(G.current??R).clearTimeout(W.current),G.current=R,W.current=R.setTimeout(()=>{Y()},Je),Me()},onKeyUp:s=>{s.altKey||s.ctrlKey||s.metaKey||et(s.key)&&K(R=>R===i?null:R)},style:{border:Oa?"1px solid color-mix(in srgb, var(--aurora-accent-default) 48%, transparent)":"1px solid transparent",borderRadius:"var(--aurora-radius-sm)",background:qe?"color-mix(in srgb, var(--aurora-surface-elevated) 68%, var(--aurora-surface-default))":Ne?"color-mix(in srgb, var(--aurora-surface-elevated) 86%, var(--aurora-surface-default))":"transparent",font:"inherit",cursor:D?"not-allowed":"pointer",display:"inline-flex",alignItems:"center",gap:6,padding:"2px 6px",color:D?"color-mix(in srgb, var(--aurora-text-secondary) 88%, var(--aurora-text-primary))":"inherit",boxShadow:$e?"0 0 0 3px color-mix(in srgb, var(--aurora-focus-ring) 42%, transparent)":"none",transform:qe?"translateY(1px)":"translateY(0)",transition:"background-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), border-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), box-shadow var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), transform var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard)"},children:[c.header,n.jsx("span",{"aria-hidden":"true",children:v==="asc"?"▲":v==="desc"?"▼":"↕"})]}):c.header},i)})})}),n.jsx("tbody",{children:T?n.jsx("tr",{children:n.jsx("td",{colSpan:Pe,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:n.jsx("span",{role:"status","aria-live":"polite",children:F})})}):P.length===0?n.jsx("tr",{children:n.jsx("td",{colSpan:Pe,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:n.jsx("span",{role:"status","aria-live":"polite",children:E})})}):P.map((c,i)=>{const g=c.row,x=String(c.sourceIndex),p=o?o(g,c.sourceIndex):x;return n.jsx("tr",{style:{background:i%2===0?"transparent":"var(--aurora-surface-elevated)"},children:t.map(v=>{const A=v.render?v.render(g,i,c.sourceIndex):String(g[String(v.key)]??""),j={padding:"10px 12px",borderBottom:"1px solid var(--aurora-border-default)",color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",textAlign:v.align??"left"};return v.rowHeader?n.jsx("th",{scope:"row",style:{...j,fontWeight:"var(--aurora-font-weight-medium)"},children:A},String(v.key)):n.jsx("td",{style:j,children:A},String(v.key))})},p)})})]})]})}function Ze({columnHeader:t,nextDirection:e}){return`${t} sort ${e==="asc"?"ascending":"descending"}`}function Xa({columnHeader:t,direction:e}){return`Sorted by ${t} ${e==="asc"?"ascending":"descending"}.`}function et(t){return t==="Enter"||t===" "||t==="Space"||t==="Spacebar"}function Za(t){const e=t.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function en(t,e){if(!t)return e;try{return t.matches(":focus-visible")}catch{return e}}function Ee(t){if(typeof t=="string")return t;if(typeof t=="number")return String(t);if(Array.isArray(t))return Ce(t.map(o=>Ee(o)).filter(o=>o.length>0).join(" "));if(!l.isValidElement(t))return"";const e=t.props;if(e["aria-hidden"]===!0||e["aria-hidden"]==="true")return"";if(typeof e["aria-label"]=="string"){const o=Ce(e["aria-label"]);if(o.length>0)return o}return Ee(e.children)}function Ce(t){return t.replace(/\s+/g," ").trim()}function Ie(t,e){return typeof t=="string"&&t.trim().length>0?t.trim():e}d.__docgenInfo={description:"",methods:[],displayName:"Table",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: keyof T | string;
...
}`,...(ct=(it=Q.parameters)==null?void 0:it.docs)==null?void 0:ct.source}}};var ut,lt,dt;X.parameters={...X.parameters,docs:{...(ut=X.parameters)==null?void 0:ut.docs,source:{originalSource:`{
  render: () => {
...
}`,...(dt=(lt=X.parameters)==null?void 0:lt.docs)==null?void 0:dt.source}}};var mt,yt,pt;Z.parameters={...Z.parameters,docs:{...(mt=Z.parameters)==null?void 0:mt.docs,source:{originalSource:`{
...
}`,...(pt=(yt=Z.parameters)==null?void 0:yt.docs)==null?void 0:pt.source}}};var wt,bt,gt;ee.parameters={...ee.parameters,docs:{...(wt=ee.parameters)==null?void 0:wt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(gt=(bt=ee.parameters)==null?void 0:bt.docs)==null?void 0:gt.source}}};var vt,ht,xt;te.parameters={...te.parameters,docs:{...(vt=te.parameters)==null?void 0:vt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "id",
      header: "Issue",
...
}`,...(xt=(ht=te.parameters)==null?void 0:ht.docs)==null?void 0:xt.source}}};var St,ft,Bt;ae.parameters={...ae.parameters,docs:{...(St=ae.parameters)==null?void 0:St.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 840px)" gap={10}>
      <Table columns={[{
      key: "id",
      header: "Issue"
...
}`,...(Bt=(ft=ae.parameters)==null?void 0:ft.docs)==null?void 0:Bt.source}}};var Rt,kt,Tt;ne.parameters={...ne.parameters,docs:{...(Rt=ne.parameters)==null?void 0:Rt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 840px)" gap={10}>
...
}`,...(Tt=(kt=ne.parameters)==null?void 0:kt.docs)==null?void 0:Tt.source}}};var Dt,Ht,At;oe.parameters={...oe.parameters,docs:{...(Dt=oe.parameters)==null?void 0:Dt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 840px)" gap={10}>
      <p style={storyMutedTextStyle}>
...
}`,...(At=(Ht=oe.parameters)==null?void 0:Ht.docs)==null?void 0:At.source}}};var It,Et,Ct;re.parameters={...re.parameters,docs:{...(It=re.parameters)==null?void 0:It.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Ct=(Et=re.parameters)==null?void 0:Et.docs)==null?void 0:Ct.source}}};var Kt,jt,Ft;se.parameters={...se.parameters,docs:{...(Kt=se.parameters)==null?void 0:Kt.docs,source:{originalSource:`{
...
}`,...(Ft=(jt=se.parameters)==null?void 0:jt.docs)==null?void 0:Ft.source}}};var Lt,Wt,Pt;ie.parameters={...ie.parameters,docs:{...(Lt=ie.parameters)==null?void 0:Lt.docs,source:{originalSource:`{
...
}`,...(Pt=(Wt=ie.parameters)==null?void 0:Wt.docs)==null?void 0:Pt.source}}};var Nt,qt,$t;ce.parameters={...ce.parameters,docs:{...(Nt=ce.parameters)==null?void 0:Nt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...($t=(qt=ce.parameters)==null?void 0:qt.docs)==null?void 0:$t.source}}};var Mt,Vt,Ot;ue.parameters={...ue.parameters,docs:{...(Mt=ue.parameters)==null?void 0:Mt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Ot=(Vt=ue.parameters)==null?void 0:Vt.docs)==null?void 0:Ot.source}}};var Ut,zt,Gt;le.parameters={...le.parameters,docs:{...(Ut=le.parameters)==null?void 0:Ut.docs,source:{originalSource:`{
...
}`,...(Gt=(zt=le.parameters)==null?void 0:zt.docs)==null?void 0:Gt.source}}};var Yt,_t,Jt;de.parameters={...de.parameters,docs:{...(Yt=de.parameters)==null?void 0:Yt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "component",
      header: "Component",
...
}`,...(Jt=(_t=de.parameters)==null?void 0:_t.docs)==null?void 0:Jt.source}}};var Qt,Xt,Zt;me.parameters={...me.parameters,docs:{...(Qt=me.parameters)==null?void 0:Qt.docs,source:{originalSource:`{
...
}`,...(Zt=(Xt=me.parameters)==null?void 0:Xt.docs)==null?void 0:Zt.source}}};var ea,ta,aa;ye.parameters={...ye.parameters,docs:{...(ea=ye.parameters)==null?void 0:ea.docs,source:{originalSource:`{
...
}`,...(aa=(ta=ye.parameters)==null?void 0:ta.docs)==null?void 0:aa.source}}};var na,oa,ra;pe.parameters={...pe.parameters,docs:{...(na=pe.parameters)==null?void 0:na.docs,source:{originalSource:`{
...
}`,...(ra=(oa=pe.parameters)==null?void 0:oa.docs)==null?void 0:ra.source}}};var sa,ia,ca;we.parameters={...we.parameters,docs:{...(sa=we.parameters)==null?void 0:sa.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(ca=(ia=we.parameters)==null?void 0:ia.docs)==null?void 0:ca.source}}};var ua,la,da;be.parameters={...be.parameters,docs:{...(ua=be.parameters)==null?void 0:ua.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "releasedAt",
...
}`,...(da=(la=be.parameters)==null?void 0:la.docs)==null?void 0:da.source}}};var ma,ya,pa;ge.parameters={...ge.parameters,docs:{...(ma=ge.parameters)==null?void 0:ma.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "status",
      header: <span>
...
}`,...(pa=(ya=ge.parameters)==null?void 0:ya.docs)==null?void 0:pa.source}}};var wa,ba,ga;ve.parameters={...ve.parameters,docs:{...(wa=ve.parameters)==null?void 0:wa.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "status",
...
}`,...(ga=(ba=ve.parameters)==null?void 0:ba.docs)==null?void 0:ga.source}}};var va,ha,xa;he.parameters={...he.parameters,docs:{...(va=he.parameters)==null?void 0:va.docs,source:{originalSource:`{
  render: () => {
...
}`,...(xa=(ha=he.parameters)==null?void 0:ha.docs)==null?void 0:xa.source}}};var Sa,fa,Ba;xe.parameters={...xe.parameters,docs:{...(Sa=xe.parameters)==null?void 0:Sa.docs,source:{originalSource:`{
...
}`,...(Ba=(fa=xe.parameters)==null?void 0:fa.docs)==null?void 0:Ba.source}}};var Ra,ka,Ta;Se.parameters={...Se.parameters,docs:{...(Ra=Se.parameters)==null?void 0:Ra.docs,source:{originalSource:`{
...
}`,...(Ta=(ka=Se.parameters)==null?void 0:ka.docs)==null?void 0:Ta.source}}};var Da,Ha,Aa;fe.parameters={...fe.parameters,docs:{...(Da=fe.parameters)==null?void 0:Da.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 720px)">
...
}`,...(Aa=(Ha=fe.parameters)==null?void 0:Ha.docs)==null?void 0:Aa.source}}};var Ia,Ea,Ca;Be.parameters={...Be.parameters,docs:{...(Ia=Be.parameters)==null?void 0:Ia.docs,source:{originalSource:`{
