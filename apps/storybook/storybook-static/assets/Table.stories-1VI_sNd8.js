import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{B as st}from"./Button-DeQ1OHWt.js";import{r as h}from"./index-BWu4c2F4.js";import{B as it}from"./Badge-fH5xjxKG.js";import{within as y,expect as n,userEvent as f,fireEvent as ct}from"./index-DgAF9SIF.js";const lt=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"});function dt(e,t,o){if(!t)return null;const l=e.find(S=>String(S.key)===t);return l!=null&&l.sortable?{key:t,direction:o}:null}function m({columns:e,data:t,rowKey:o,caption:l,ariaLabel:S,ariaLabelledBy:P,loading:T=!1,loadingContent:Qe="Loading data...",emptyContent:Xe="No data available.",defaultSortKey:Je,defaultSortDirection:Ze="asc",getSortAriaLabel:et=ut,getSortStatusText:_=mt,onSortChange:M}){const tt=P?void 0:S??(l?void 0:"Data table"),U=h.useRef({}),W=h.useRef(!0),[at,Y]=h.useState(null),[nt,k]=h.useState(null),[rt,I]=h.useState(null),[d,Q]=h.useState(()=>dt(e,Je,Ze));h.useEffect(()=>{if(!d)return;const i=e.find(r=>String(r.key)===d.key);i!=null&&i.sortable||Q(null)},[e,d]);const B=h.useMemo(()=>{const i=t.map((u,c)=>({row:u,sourceIndex:c}));if(!d)return i;const r=e.find(u=>String(u.key)===d.key);if(!(r!=null&&r.sortable))return i;const g=r.sortAccessor??(u=>{const c=u[String(r.key)];return c instanceof Date||typeof c=="number"||typeof c=="string"?c:String(c??"")});return i.sort((u,c)=>{const b=g(u.row),w=g(c.row);if(typeof b=="string"&&typeof w=="string"){const p=lt.compare(b,w);return p!==0?d.direction==="asc"?p:-p:u.sourceIndex-c.sourceIndex}const R=b instanceof Date?b.getTime():b,D=w instanceof Date?w.getTime():w;return R<D?d.direction==="asc"?-1:1:R>D?d.direction==="asc"?1:-1:u.sourceIndex-c.sourceIndex})},[e,t,d]),X=h.useMemo(()=>{if(T||B.length<=1||!d)return"";const i=e.find(g=>String(g.key)===d.key);if(!(i!=null&&i.sortable))return"";const r=typeof i.header=="string"?i.header:String(i.key);return _({columnKey:d.key,columnHeader:r,direction:d.direction})},[e,_,T,d,B.length]),J=Math.max(e.length,1);return a.jsxs("div",{style:{border:"1px solid var(--aurora-border-default)",borderRadius:"var(--aurora-radius-md)",overflow:"auto"},children:[X?a.jsx("p",{role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:X}):null,a.jsxs("table",{"aria-label":tt,"aria-labelledby":P,"aria-busy":T||void 0,style:{width:"100%",borderCollapse:"collapse",minWidth:560},children:[l?a.jsx("caption",{style:{textAlign:"left",padding:"10px 12px",color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-sm)",borderBottom:"1px solid var(--aurora-border-default)"},children:l}):null,a.jsx("thead",{children:a.jsx("tr",{children:e.map(i=>{const r=String(i.key),g=!!i.sortable,u=g&&(d==null?void 0:d.key)===r&&B.length>1?d.direction:void 0,c=u?u==="asc"?"ascending":"descending":void 0,b=i.align??"left",w=typeof i.header=="string"?i.header:r,R=u==="asc"?"desc":"asc",D=et({columnKey:r,columnHeader:w,nextDirection:R}),p=T||B.length<=1,Z=at===r,ee=nt===r,te=rt===r,ot=Z||te,ae=()=>{p||(Q({key:r,direction:R}),M==null||M(r,R))};return a.jsx("th",{scope:"col","aria-sort":c,style:{textAlign:b,color:"var(--aurora-text-secondary)",background:"var(--aurora-surface-elevated)",borderBottom:"1px solid var(--aurora-border-default)",padding:"10px 12px",fontSize:"var(--aurora-font-size-sm)",fontWeight:"var(--aurora-font-weight-medium)",width:i.width},children:g?a.jsxs("button",{type:"button",ref:s=>{U.current[r]=s},"aria-label":D,"aria-keyshortcuts":p?void 0:"Enter Space",disabled:p,onClick:ae,onMouseEnter:()=>{p||Y(r)},onMouseLeave:()=>{Y(s=>s===r?null:s),k(s=>s===r?null:s)},onMouseDown:()=>{p||(W.current=!1,I(s=>s===r?null:s),k(r))},onMouseUp:()=>{k(s=>s===r?null:s)},onFocus:()=>{if(p){I(s=>s===r?null:s);return}I(s=>pt(U.current[r],W.current)?r:s===r?null:s)},onBlur:()=>{I(s=>s===r?null:s),k(s=>s===r?null:s)},onKeyDown:s=>{W.current=!0,yt(s.key)&&(s.preventDefault(),!s.repeat&&ae())},style:{border:ot?"1px solid color-mix(in srgb, var(--aurora-accent-default) 48%, transparent)":"1px solid transparent",borderRadius:"var(--aurora-radius-sm)",background:ee?"color-mix(in srgb, var(--aurora-surface-elevated) 68%, var(--aurora-surface-default))":Z?"color-mix(in srgb, var(--aurora-surface-elevated) 86%, var(--aurora-surface-default))":"transparent",color:"inherit",font:"inherit",cursor:p?"not-allowed":"pointer",display:"inline-flex",alignItems:"center",gap:6,padding:"2px 6px",opacity:p?.64:1,boxShadow:te?"0 0 0 3px color-mix(in srgb, var(--aurora-focus-ring) 42%, transparent)":"none",transform:ee?"translateY(1px)":"translateY(0)",transition:"background-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), border-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), box-shadow var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), transform var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard)"},children:[i.header,a.jsx("span",{"aria-hidden":"true",children:u==="asc"?"▲":u==="desc"?"▼":"↕"})]}):i.header},r)})})}),a.jsx("tbody",{children:T?a.jsx("tr",{children:a.jsx("td",{colSpan:J,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:Qe})})}):B.length===0?a.jsx("tr",{children:a.jsx("td",{colSpan:J,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:Xe})})}):B.map((i,r)=>{const g=i.row,u=String(i.sourceIndex);return a.jsx("tr",{style:{background:r%2===0?"transparent":"var(--aurora-surface-elevated)"},children:e.map(c=>{const b=c.render?c.render(g,r,i.sourceIndex):String(g[String(c.key)]??""),w={padding:"10px 12px",borderBottom:"1px solid var(--aurora-border-default)",color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",textAlign:c.align??"left"};return c.rowHeader?a.jsx("th",{scope:"row",style:{...w,fontWeight:"var(--aurora-font-weight-medium)"},children:b},String(c.key)):a.jsx("td",{style:w,children:b},String(c.key))})},o?o(g,i.sourceIndex):u)})})]})]})}function ut({columnHeader:e,nextDirection:t}){return`${e} sort ${t==="asc"?"ascending":"descending"}`}function mt({columnHeader:e,direction:t}){return`Sorted by ${e} ${t==="asc"?"ascending":"descending"}.`}function yt(e){return e===" "||e==="Space"||e==="Spacebar"}function pt(e,t){if(!e)return t;try{return e.matches(":focus-visible")}catch{return t}}m.__docgenInfo={description:"",methods:[],displayName:"Table",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: keyof T | string;
...
}`,...(pe=(ye=E.parameters)==null?void 0:ye.docs)==null?void 0:pe.source}}};var ge,ve,be;K.parameters={...K.parameters,docs:{...(ge=K.parameters)==null?void 0:ge.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 780
  }}>
...
}`,...(be=(ve=K.parameters)==null?void 0:ve.docs)==null?void 0:be.source}}};var we,he,xe;C.parameters={...C.parameters,docs:{...(we=C.parameters)==null?void 0:we.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 780
  }}>
...
}`,...(xe=(he=C.parameters)==null?void 0:he.docs)==null?void 0:xe.source}}};var fe,Se,Be;N.parameters={...N.parameters,docs:{...(fe=N.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 780
  }}>
...
}`,...(Ee=(je=L.parameters)==null?void 0:je.docs)==null?void 0:Ee.source}}};var Ke,Ce,Ne;V.parameters={...V.parameters,docs:{...(Ke=V.parameters)==null?void 0:Ke.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 780
  }}>
...
}`,...(Ne=(Ce=V.parameters)==null?void 0:Ce.docs)==null?void 0:Ne.source}}};var qe,$e,Le;z.parameters={...z.parameters,docs:{...(qe=z.parameters)==null?void 0:qe.docs,source:{originalSource:`{
  render: () => {
