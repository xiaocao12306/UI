import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{r as j}from"./index-BWu4c2F4.js";import{B as pe}from"./Button-B21ouHNm.js";import{I as o}from"./Input-D3V7c3Pn.js";import{F as i}from"./FormField-CHmEmU2O.js";import{within as d,expect as a,userEvent as u,fireEvent as l,waitFor as b}from"./index-DgAF9SIF.js";import{S as c,a as D,s as y}from"./storyShowcase-DlKirntE.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";const Be={title:"Form/Input",component:o,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:"Input uses shared field tokens and is suitable for search, filters, and AI prompt prefill interactions."}}},args:{placeholder:"Search release notes..."}},v={},h={render:()=>e.jsxs(c,{maxWidth:"min(100%, 560px)",gap:8,children:[e.jsx("label",{htmlFor:"prompt",style:{fontWeight:600},children:"Prompt Draft"}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr auto",gap:8},children:[e.jsx(o,{id:"prompt",placeholder:"Ask Aurora AI to scaffold a new dialog flow...","aria-label":"AI prompt"}),e.jsx(pe,{children:"Send"})]}),e.jsx("small",{style:D,children:"Tip: switch theme in toolbar to validate input token contrast."})]})},x={render:()=>e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:12,children:[e.jsx(i,{label:"Default",description:"Hover and focus to verify border and ring states.",children:e.jsx(o,{placeholder:"Type project name..."})}),e.jsx(i,{label:"Error",error:"Please provide a valid email address.",required:!0,children:e.jsx(o,{placeholder:"name@company.com",defaultValue:"invalid-email"})}),e.jsx(i,{label:"Required inherited from control",children:e.jsx(o,{placeholder:"Inherited required field",required:!0})}),e.jsx(i,{label:"Disabled",description:"Disabled fields remain readable with lower emphasis.",disabled:!0,children:e.jsx(o,{placeholder:"Disabled field"})}),e.jsx(i,{label:"Read-only",description:"Read-only fields are focusable but not editable.",children:e.jsx(o,{value:"release/0.1.0",readOnly:!0,"aria-label":"Release branch"})})]})},w={render:()=>e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:12,children:[e.jsx(i,{label:"Keyboard interaction",description:"Tab focus should show ring; Enter feedback is suppressed during IME composition.",children:e.jsx(o,{defaultValue:"release-notes"})}),e.jsx(i,{label:"Read-only propagated",children:e.jsx(o,{"aria-label":"Read-only propagated input",readOnly:!0,defaultValue:"stable"})}),e.jsx(i,{label:"Disabled interaction guard",disabled:!0,children:e.jsx(o,{"aria-label":"Disabled interaction guard input",placeholder:"Disabled input"})})]}),play:async({canvasElement:r})=>{const n=d(r),t=await n.findByRole("textbox",{name:"Keyboard interaction"}),s=n.getByText("Keyboard interaction").closest("label");await u.click(t),await a(t).toHaveAttribute("data-focused","true"),await a(s).toHaveAttribute("id"),await a(t.getAttribute("aria-labelledby")??"").toContain((s==null?void 0:s.id)??""),l.keyDown(t,{key:"Enter",isComposing:!0,keyCode:229,which:229}),await a(t).not.toHaveAttribute("data-active"),l.keyDown(t,{key:"Enter",ctrlKey:!0}),await a(t).not.toHaveAttribute("data-active"),l.keyDown(t,{key:"Enter",metaKey:!0}),await a(t).not.toHaveAttribute("data-active"),l.keyDown(t,{key:"Enter",altKey:!0}),await a(t).not.toHaveAttribute("data-active"),l.keyDown(t,{key:"Enter",shiftKey:!0}),l.keyUp(t,{key:"Enter",shiftKey:!0}),await a(t).not.toHaveAttribute("data-active"),l.keyDown(t,{key:"Enter"}),l.keyUp(t,{key:"Enter"}),await a(t).not.toHaveAttribute("data-active"),t.dispatchEvent(new PointerEvent("pointerdown",{bubbles:!0,cancelable:!0,pointerType:"touch",button:0})),await b(()=>{a(t).toHaveAttribute("data-active","true")}),l.pointerCancel(t),await b(()=>{a(t).not.toHaveAttribute("data-active")}),t.dispatchEvent(new PointerEvent("pointerdown",{bubbles:!0,cancelable:!0,pointerType:"touch",button:0})),await b(()=>{a(t).toHaveAttribute("data-active","true")}),t.dispatchEvent(new PointerEvent("pointerup",{bubbles:!0,cancelable:!0,pointerType:"touch",button:0})),await b(()=>{a(t).not.toHaveAttribute("data-active")});const p=n.getByRole("textbox",{name:"Read-only propagated input"});await a(p).toHaveAttribute("readonly"),p.focus(),l.keyDown(p,{key:"Enter"}),l.keyUp(p,{key:"Enter"}),await a(p).not.toHaveAttribute("data-active");const m=n.getByRole("textbox",{name:"Disabled interaction guard input"});await a(m).toBeDisabled(),await u.hover(m),await a(m).not.toHaveAttribute("data-hovered")}};function me(){const[r,n]=j.useState(0);return e.jsx("div",{onKeyDownCapture:t=>{t.key==="Enter"&&t.preventDefault()},children:e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:12,children:[e.jsx(i,{label:"Preempted enter input",description:"Global key guards can preempt Enter before local active-feedback handlers.",children:e.jsx(o,{onKeyDown:t=>{!t.defaultPrevented&&t.key==="Enter"&&n(s=>s+1)}})}),e.jsxs("p",{style:y,children:["Enter handler calls:"," ",e.jsx("strong",{"data-testid":"input-preempted-enter-calls",style:D,children:r})]})]})})}const k={render:()=>e.jsx(me,{}),play:async({canvasElement:r})=>{const n=d(r),t=await n.findByRole("textbox",{name:/^Preempted enter input/});l.keyDown(t,{key:"Enter"}),await a(t).not.toHaveAttribute("data-active"),await a(n.getByTestId("input-preempted-enter-calls")).toHaveTextContent("0")}};function ye(){const[r,n]=j.useState(0);return e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:12,children:[e.jsx(i,{label:"Locally preempted enter input",description:"Input-level key guards can preempt Enter before local active-feedback handlers.",children:e.jsx(o,{onKeyDown:t=>{t.key==="Enter"&&(t.preventDefault(),n(s=>s+1))}})}),e.jsxs("p",{style:y,children:["Enter handler calls:"," ",e.jsx("strong",{"data-testid":"input-local-preempted-enter-calls",style:D,children:r})]})]})}const f={render:()=>e.jsx(ye,{}),play:async({canvasElement:r})=>{const n=d(r),t=await n.findByRole("textbox",{name:/^Locally preempted enter input/});l.keyDown(t,{key:"Enter"}),await a(t).not.toHaveAttribute("data-active"),await a(n.getByTestId("input-local-preempted-enter-calls")).toHaveTextContent("1")}},g={render:()=>e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:12,children:[e.jsx(i,{label:"Actionable shortcut input",description:"Actionable inputs should expose Enter shortcut hints.",children:e.jsx(o,{})}),e.jsx(i,{label:"Read-only shortcut input",description:"Read-only inputs should not advertise keyboard shortcuts.",children:e.jsx(o,{readOnly:!0,defaultValue:"release/0.1.0"})}),e.jsx(i,{label:"Disabled shortcut input",description:"Disabled inputs should not advertise keyboard shortcuts.",disabled:!0,children:e.jsx(o,{})}),e.jsx(i,{label:"Date shortcut input",description:"Non-text input types should not expose default Enter shortcut hints.",children:e.jsx(o,{type:"date","aria-label":"Date shortcut input control"})})]}),play:async({canvasElement:r})=>{const n=d(r);await a(n.getByRole("textbox",{name:/^Actionable shortcut input/})).toHaveAttribute("aria-keyshortcuts","Enter"),await a(n.getByRole("textbox",{name:/^Read-only shortcut input/})).not.toHaveAttribute("aria-keyshortcuts"),await a(n.getByRole("textbox",{name:/^Disabled shortcut input/})).not.toHaveAttribute("aria-keyshortcuts"),await a(n.getByLabelText("Date shortcut input control")).not.toHaveAttribute("aria-keyshortcuts")}},E={render:()=>e.jsx(c,{maxWidth:"min(100%, 600px)",gap:12,children:e.jsx(i,{label:"Blank type fallback input",description:"Blank input type should normalize to text semantics with Enter shortcut hints.",children:e.jsx(o,{type:"   ","aria-label":"Blank type fallback input control"})})}),play:async({canvasElement:r})=>{const t=d(r).getByRole("textbox",{name:"Blank type fallback input control"});await a(t).toHaveAttribute("type","text"),await a(t).toHaveAttribute("aria-keyshortcuts","Enter")}};function be(){return e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:10,children:[e.jsxs("p",{style:y,children:["Click first, then press ",e.jsx("kbd",{children:"Tab"})," to verify keyboard re-entry restores focus-visible state on input."]}),e.jsx("button",{type:"button",children:"Before input"}),e.jsx(o,{"aria-label":"Focus intent re-entry input",placeholder:"Tab back into this field"})]})}const F={render:()=>e.jsx(be,{}),play:async({canvasElement:r})=>{const n=d(r),t=await n.findByRole("button",{name:"Before input"}),s=n.getByRole("textbox",{name:"Focus intent re-entry input"});await u.click(s),await a(s).toHaveAttribute("data-focused","true"),await u.click(t),await u.tab(),await a(s).toHaveFocus(),await a(s).toHaveAttribute("data-focus-visible","true"),l.mouseDown(s,{button:0,ctrlKey:!0}),await a(s).toHaveAttribute("data-focus-visible","true")}};function ve(){const[r,n]=j.useState(""),[t,s]=j.useState(!1),p=t&&r.trim().length===0;return e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:10,children:[e.jsx(i,{label:"Prompt",error:p?"Prompt is required.":void 0,children:e.jsx(o,{"aria-label":"Prompt input",value:r,placeholder:"Describe release note summary...",onChange:m=>n(m.target.value),onBlur:()=>s(!0)})}),e.jsxs("small",{style:D,"data-testid":"char-count",children:[r.length," chars"]}),e.jsx(pe,{disabled:r.trim().length===0,children:"Submit Prompt"})]})}const I={render:()=>e.jsx(ve,{}),play:async({canvasElement:r})=>{const n=d(r),t=await n.findByRole("textbox",{name:"Prompt input"});await u.click(t),await u.tab(),await a(n.getByRole("alert")).toHaveTextContent("Prompt is required."),await a(n.getByRole("button",{name:"Submit Prompt"})).toBeDisabled(),await u.type(t,"Release summary"),await a(n.queryByRole("alert")).not.toBeInTheDocument(),await a(n.getByTestId("char-count")).toHaveTextContent("15 chars"),await a(n.getByRole("button",{name:"Submit Prompt"})).not.toBeDisabled()}},B={render:()=>e.jsxs(c,{maxWidth:"min(100%, 560px)",gap:8,children:[e.jsx(i,{label:"Grammar review",children:e.jsx(o,{"aria-label":"Grammar review input","aria-invalid":"grammar",defaultValue:"Needs grammar check"})}),e.jsxs("small",{style:y,children:["Preserves ",e.jsx("code",{children:'aria-invalid="grammar"'})," for assistive-tech integrations that distinguish grammar/spelling corrections."]})]}),play:async({canvasElement:r})=>{const t=await d(r).findByRole("textbox",{name:"Grammar review input"});await a(t).toHaveAttribute("aria-invalid","grammar")}},A={render:()=>e.jsxs(c,{maxWidth:"min(100%, 560px)",gap:8,children:[e.jsx(i,{label:"Release scope",children:e.jsx(o,{"aria-label":"   ",defaultValue:"stable"})}),e.jsxs("small",{style:y,children:["Blank ",e.jsx("code",{children:"aria-label"})," values are ignored so visible label association remains the accessible name source."]})]}),play:async({canvasElement:r})=>{const t=await d(r).findByRole("textbox",{name:"Release scope"});await a(t).not.toHaveAttribute("aria-label")}};var H,S,R;v.parameters={...v.parameters,docs:{...(H=v.parameters)==null?void 0:H.docs,source:{originalSource:"{}",...(R=(S=v.parameters)==null?void 0:S.docs)==null?void 0:R.source}}};var T,P,K;h.parameters={...h.parameters,docs:{...(T=h.parameters)==null?void 0:T.docs,source:{originalSource:`{
...
}`,...(K=(P=h.parameters)==null?void 0:P.docs)==null?void 0:K.source}}};var C,W,V;x.parameters={...x.parameters,docs:{...(C=x.parameters)==null?void 0:C.docs,source:{originalSource:`{
...
}`,...(V=(W=x.parameters)==null?void 0:W.docs)==null?void 0:V.source}}};var q,M,O;w.parameters={...w.parameters,docs:{...(q=w.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 600px)" gap={12}>
...
}`,...(O=(M=w.parameters)==null?void 0:M.docs)==null?void 0:O.source}}};var L,G,U;k.parameters={...k.parameters,docs:{...(L=k.parameters)==null?void 0:L.docs,source:{originalSource:`{
...
}`,...(U=(G=k.parameters)==null?void 0:G.docs)==null?void 0:U.source}}};var N,z,_;f.parameters={...f.parameters,docs:{...(N=f.parameters)==null?void 0:N.docs,source:{originalSource:`{
...
}`,...(_=(z=f.parameters)==null?void 0:z.docs)==null?void 0:_.source}}};var J,Q,X;g.parameters={...g.parameters,docs:{...(J=g.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 600px)" gap={12}>
...
}`,...(X=(Q=g.parameters)==null?void 0:Q.docs)==null?void 0:X.source}}};var Y,Z,$;E.parameters={...E.parameters,docs:{...(Y=E.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 600px)" gap={12}>
...
}`,...($=(Z=E.parameters)==null?void 0:Z.docs)==null?void 0:$.source}}};var ee,te,ae;F.parameters={...F.parameters,docs:{...(ee=F.parameters)==null?void 0:ee.docs,source:{originalSource:`{
...
}`,...(ae=(te=F.parameters)==null?void 0:te.docs)==null?void 0:ae.source}}};var ne,re,oe;I.parameters={...I.parameters,docs:{...(ne=I.parameters)==null?void 0:ne.docs,source:{originalSource:`{
...
}`,...(oe=(re=I.parameters)==null?void 0:re.docs)==null?void 0:oe.source}}};var ie,se,le;B.parameters={...B.parameters,docs:{...(ie=B.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 560px)" gap={8}>
...
}`,...(le=(se=B.parameters)==null?void 0:se.docs)==null?void 0:le.source}}};var ce,de,ue;A.parameters={...A.parameters,docs:{...(ce=A.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 560px)" gap={8}>
...
}`,...(ue=(de=A.parameters)==null?void 0:de.docs)==null?void 0:ue.source}}};const Ae=["Default","AiPromptStyle","StateMatrix","InteractionA11yParity","ManagedKeysPreemptedByGlobalHandler","ManagedKeysPreemptedByLocalHandler","ShortcutHintPrecision","BlankTypeFallback","FocusIntentReentry","ValidationFlow","InvalidTokenSemantics","BlankAriaLabelFallback"];export{h as AiPromptStyle,A as BlankAriaLabelFallback,E as BlankTypeFallback,v as Default,F as FocusIntentReentry,w as InteractionA11yParity,B as InvalidTokenSemantics,k as ManagedKeysPreemptedByGlobalHandler,f as ManagedKeysPreemptedByLocalHandler,g as ShortcutHintPrecision,x as StateMatrix,I as ValidationFlow,Ae as __namedExportsOrder,Be as default};
