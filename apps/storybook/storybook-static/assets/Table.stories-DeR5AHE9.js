import{j as o}from"./jsx-runtime-BjG_zV1W.js";import{B as jo}from"./Button-DvJUO9m9.js";import{r as y}from"./index-BWu4c2F4.js";import{B as uo}from"./Badge-Cvc2u0v9.js";import{within as u,expect as a,userEvent as p,fireEvent as v,waitFor as M}from"./index-DgAF9SIF.js";import{S as w,s as H,a as Q}from"./storyShowcase-DlKirntE.js";const mo="Enter Space",Fo=`${mo} Home End PageDown PageUp ArrowLeft ArrowRight`,Wo="ArrowLeft ArrowRight Home End PageDown PageUp",Po=48,No=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"}),Et=400;function Ct(e,t,n,r){if(!n)return null;const b=e.findIndex(D=>String(D.key)===n&&N(D));return b<0?null:{key:n,direction:r,renderKey:t[b]??`${n}__index-${b}`}}function At(e,t,n){if(typeof e.sortLabel=="string"&&e.sortLabel.trim().length>0)return e.sortLabel.trim();const r=Z(dt(e.header));return r.length>0?r:t}function It(e,t){const n=Z(e.trim().replace(/[_-]+/g," ").replace(/([a-z0-9])([A-Z])/g,"$1 $2"));return n.length>0&&/[0-9A-Za-z]/.test(n)?n:t>=0?`Column ${t+1}`:"Column"}function d({columns:e,data:t,rowKey:n,minTableWidth:r,caption:b,ariaLabel:D,ariaLabelledBy:k,loading:O=!1,loadingContent:j="Loading data...",emptyContent:C="No data available.",defaultSortKey:$,defaultSortDirection:mt="asc",getSortAriaLabel:bo=Lt,getSortStatusText:yt=Kt,onSortKeyDown:et,onSortChange:tt}){const pt=Xe(b),go=Xe(j),vo=Xe(C),ho=go?j:"Loading data...",xo=vo?C:"No data available.",F=yo(O,!1),nt=zo(mt,"asc"),X=ce(k),wt=X?void 0:ce(D,pt?void 0:"Data table"),So=qo(r),q=y.useRef({}),at=y.useRef(null),ot=y.useRef(null),ee=y.useRef(0),z=y.useRef(null),te=y.useRef(null),V=y.useRef(!0);y.useRef(null),y.useRef(null),y.useRef(null);const fo=y.useRef(!1),Bo=y.useRef(!1),[Ro,rt]=y.useState(null),[ko,W]=y.useState(null),[To,_]=y.useState(null),[Ho,st]=y.useState(!1);y.useEffect(()=>{var i;const s=((i=at.current)==null?void 0:i.ownerDocument)??document,l=f=>{f.metaKey||f.altKey||f.ctrlKey||(V.current=!0)},m=f=>{"button"in f&&!ut(f.button)||"ctrlKey"in f&&f.ctrlKey||(V.current=!1)};return s.addEventListener("keydown",l,!0),s.addEventListener("pointerdown",m,!0),s.addEventListener("mousedown",m,!0),s.addEventListener("touchstart",m,!0),()=>{s.removeEventListener("keydown",l,!0),s.removeEventListener("pointerdown",m,!0),s.removeEventListener("mousedown",m,!0),s.removeEventListener("touchstart",m,!0)}},[]);const ne=y.useCallback(()=>{ot.current=null,ee.current=0,z.current!==null&&((te.current??window).clearTimeout(z.current),z.current=null),te.current=null},[]);y.useEffect(()=>()=>{ne()},[ne]);const A=y.useMemo(()=>{const s=new Map;return e.map(l=>{const m=String(l.key),i=s.get(m)??0;return s.set(m,i+1),i===0?m:`${m}__duplicate-${i}`})},[e]),Do=y.useMemo(()=>e.map(s=>Vo(s.width)),[e]),[x,ae]=y.useState(()=>Ct(e,A,$,nt)),P=y.useMemo(()=>F||t.length<=1?[]:e.reduce((s,l,m)=>(N(l)&&s.push(A[m]??`${String(l.key)}__index-${m}`),s),[]),[e,t.length,A,F]);y.useEffect(()=>{if(!x)return;const s=A.findIndex(i=>i===x.renderKey);if(s>=0&&N(e[s]))return;const l=e.findIndex(i=>N(i)&&String(i.key)===x.key);if(l<0){ae(null);return}const m=A[l]??`${x.key}__index-${l}`;m!==x.renderKey&&ae(i=>i&&{...i,renderKey:m})},[e,A,x]),y.useEffect(()=>{if(x)return;const s=Ct(e,A,$,nt);s&&ae(s)},[e,$,A,nt,x]);const it=y.useMemo(()=>t.map((s,l)=>String(n?n(s,l):l)),[t,n]),Eo=y.useMemo(()=>{const s=new Map;return it.map((l,m)=>{const i=s.get(l)??0;return s.set(l,i+1),i===0?l:`${l}__dup-${m}`})},[it]);y.useEffect(()=>{},[n,it]),y.useEffect(()=>{},[e]),y.useEffect(()=>{},[e]);const U=y.useMemo(()=>{const s=t.map((h,B)=>({row:h,sourceIndex:B}));if(!x)return s;const l=A.findIndex(h=>h===x.renderKey),m=l>=0?l:e.findIndex(h=>String(h.key)===x.key),i=m>=0?e[m]:void 0;if(!i||!N(i))return s;const f=i.sortAccessor??(h=>{const B=h[String(i.key)];return B instanceof Date||typeof B=="number"||typeof B=="string"?B:String(B??"")});return s.sort((h,B)=>{const T=f(h.row),E=f(B.row);if(typeof T=="string"&&typeof E=="string"){const J=No.compare(T,E);return J!==0?x.direction==="asc"?J:-J:h.sourceIndex-B.sourceIndex}const L=T instanceof Date?T.getTime():T,oe=E instanceof Date?E.getTime():E;return L<oe?x.direction==="asc"?-1:1:L>oe?x.direction==="asc"?1:-1:h.sourceIndex-B.sourceIndex})},[e,t,A,x]),Co=typeof document>"u"?void 0:document,bt=y.useMemo(()=>{if(F||U.length<=1||!x)return"";const s=A.findIndex(T=>T===x.renderKey),l=s>=0?s:e.findIndex(T=>String(T.key)===x.key),m=l>=0?e[l]:void 0;if(!m||!N(m))return"";const i=At(m,It(x.key,l)),f={columnKey:x.key,columnHeader:i,direction:x.direction},h=Kt(f);let B;try{B=yt(f),Bo.current=!1}catch{B=void 0}return Mo(B,h)},[e,yt,Co,A,F,x,U.length]),Y=!F&&U.length>1&&e.some(s=>N(s)),G=!Y&&Ho,gt=Math.max(e.length,1);return y.useEffect(()=>{Y||(rt(null),W(null),_(null))},[Y]),y.useEffect(()=>{if(Y){st(!1);return}const s=at.current;if(!s){st(!1);return}const l=s.ownerDocument.defaultView??(typeof window>"u"?void 0:window);if(!l)return;const m=()=>{const f=s.scrollWidth-s.clientWidth>0;st(h=>h===f?h:f)};m(),l.addEventListener("resize",m);let i=null;return typeof l.ResizeObserver=="function"&&(i=new l.ResizeObserver(m),i.observe(s)),()=>{l.removeEventListener("resize",m),i==null||i.disconnect()}},[e.length,t.length,Y,F]),o.jsxs("div",{ref:at,"data-aurora-table-scroll-container":"",role:G?"region":void 0,tabIndex:G?0:void 0,"aria-label":G?X?void 0:wt??"Data table scroll container":void 0,"aria-labelledby":G?X:void 0,"aria-keyshortcuts":G?Wo:void 0,onKeyDown:s=>{if(!G||s.defaultPrevented||s.altKey||s.ctrlKey||s.metaKey||s.target!==s.currentTarget)return;const l=s.currentTarget,m=Math.max(0,l.scrollWidth-l.clientWidth);if(m<=0)return;const i=l.clientWidth,f=Math.max(Po,Math.floor(i*.3)),h=Ft(l),B=h==="rtl"?"ArrowLeft":"ArrowRight",T=L=>{L!==0&&(s.preventDefault(),_o(l,L))},E=L=>{s.preventDefault(),Uo(l,L)};switch(s.key){case"ArrowLeft":case"ArrowRight":T(s.key===B?f:-f);return;case"PageDown":T(i);return;case"PageUp":T(-i);return;case"Home":E(h==="rtl"?m:0);return;case"End":E(h==="rtl"?0:m);return;default:return}},style:{border:"1px solid var(--aurora-border-default)",borderRadius:"var(--aurora-radius-md)",overflow:"auto"},children:[bt?o.jsx("p",{role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:bt}):null,o.jsxs("table",{"aria-label":wt,"aria-labelledby":X,"aria-busy":F||void 0,style:{width:"100%",borderCollapse:"collapse",minWidth:So},children:[pt?o.jsx("caption",{style:{textAlign:"left",padding:"10px 12px",color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-sm)",borderBottom:"1px solid var(--aurora-border-default)"},children:b}):null,o.jsx("thead",{children:o.jsx("tr",{children:e.map((s,l)=>{const m=String(s.key),i=A[l]??`${m}__index-${l}`,f=N(s),h=U.length>1,B=f&&(x==null?void 0:x.key)===m?x.direction:void 0,T=B&&(x==null?void 0:x.renderKey)===i?B:void 0,E=!F&&h?T:void 0,L=E?E==="asc"?"ascending":"descending":void 0,oe=s.align??"left",J=At(s,It(m,l)),ct=B==="asc"?"desc":"asc",vt={columnKey:m,columnHeader:J,nextDirection:ct};let re;try{re=bo(vt),fo.current=!1}catch{re=void 0}const ht=ce(s.sortLabelledBy),Ao=ht?void 0:ce(typeof re=="string"?re:void 0,Lt(vt)),K=F||!h,Io=K?void 0:P.length>1?Fo:mo,xt=!K&&Ro===i,St=!K&&ko===i,ft=!K&&To===i,Lo=xt||ft,Bt=()=>{K||(ae({key:m,direction:ct,renderKey:i}),tt==null||tt(m,ct))};return o.jsx("th",{scope:"col","aria-sort":L,style:{textAlign:oe,color:"var(--aurora-text-secondary)",background:"var(--aurora-surface-elevated)",borderBottom:"1px solid var(--aurora-border-default)",padding:"10px 12px",fontSize:"var(--aurora-font-size-sm)",fontWeight:"var(--aurora-font-weight-medium)",width:Do[l]},children:f?o.jsxs("button",{"data-aurora-reduced-motion":"transition",type:"button",ref:c=>{q.current[i]=c},"aria-labelledby":ht,"aria-label":Ao,"aria-keyshortcuts":Io,disabled:K,onClick:c=>{const R=Date.now()-ee.current,se=c.detail===0&&ot.current===i&&ee.current>0&&R<=Et;ne(),!se&&Bt()},onMouseEnter:()=>{K||rt(i)},onMouseLeave:()=>{rt(c=>c===i?null:c),W(c=>c===i?null:c)},onPointerDown:c=>{K||c.ctrlKey||ut(c.button)&&(V.current=!1,_(R=>R===i?null:R),W(i))},onPointerUp:c=>{ut(c.button)&&W(R=>R===i?null:R)},onMouseDown:c=>{K||c.button!==0||c.ctrlKey||(V.current=!1,_(R=>R===i?null:R),W(i))},onMouseUp:c=>{c.button===0&&W(R=>R===i?null:R)},onPointerCancel:()=>{W(c=>c===i?null:c)},onFocus:()=>{if(K){_(c=>c===i?null:c);return}_(c=>$o(q.current[i],V.current)?i:c===i?null:c)},onBlur:()=>{_(c=>c===i?null:c),W(c=>c===i?null:c)},onKeyDown:c=>{var se,Rt,kt,Tt;if(V.current=!0,et==null||et(c),c.defaultPrevented||c.altKey||c.ctrlKey||c.metaKey)return;if(c.key==="Home"){const I=P[0];if(!I)return;c.preventDefault(),(se=q.current[I])==null||se.focus();return}if(c.key==="End"){const I=P[P.length-1];if(!I)return;c.preventDefault(),(Rt=q.current[I])==null||Rt.focus();return}if(c.key==="PageDown"||c.key==="PageUp"){const I=P.indexOf(i);if(I<0)return;const Ht=c.key==="PageDown"?1:-1,ie=Math.max(0,Math.min(P.length-1,I+Ht));if(ie===I)return;c.preventDefault();const lt=P[ie];(kt=q.current[lt])==null||kt.focus();return}if(c.key==="ArrowLeft"||c.key==="ArrowRight"){const I=P.indexOf(i);if(I<0)return;const ie=Ft(c.currentTarget)==="rtl"?"ArrowLeft":"ArrowRight",lt=c.key===ie?1:-1,Dt=Math.max(0,Math.min(P.length-1,I+lt));if(Dt===I)return;c.preventDefault();const Ko=P[Dt];(Tt=q.current[Ko])==null||Tt.focus();return}if(!jt(c.key)||Oo(c)||(c.preventDefault(),c.repeat))return;W(i),ot.current=i,ee.current=Date.now();const R=c.currentTarget.ownerDocument.defaultView??window;z.current!==null&&(te.current??R).clearTimeout(z.current),te.current=R,z.current=R.setTimeout(()=>{ne()},Et),Bt()},onKeyUp:c=>{c.altKey||c.ctrlKey||c.metaKey||jt(c.key)&&W(R=>R===i?null:R)},style:{border:Lo?"1px solid color-mix(in srgb, var(--aurora-accent-default) 48%, transparent)":"1px solid transparent",borderRadius:"var(--aurora-radius-sm)",background:St?"color-mix(in srgb, var(--aurora-surface-elevated) 68%, var(--aurora-surface-default))":xt?"color-mix(in srgb, var(--aurora-surface-elevated) 86%, var(--aurora-surface-default))":"transparent",font:"inherit",cursor:K?"not-allowed":"pointer",display:"inline-flex",alignItems:"center",gap:6,padding:"2px 6px",color:K?"color-mix(in srgb, var(--aurora-text-secondary) 88%, var(--aurora-text-primary))":"inherit",boxShadow:ft?"0 0 0 3px color-mix(in srgb, var(--aurora-focus-ring) 42%, transparent)":"none",transform:St?"translateY(1px)":"translateY(0)",transition:"background-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), border-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), box-shadow var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), transform var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard)"},children:[s.header,o.jsx("span",{"aria-hidden":"true",children:E==="asc"?"▲":E==="desc"?"▼":"↕"})]}):s.header},i)})})}),o.jsx("tbody",{children:F?o.jsx("tr",{children:o.jsx("td",{colSpan:gt,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:o.jsx("span",{role:"status","aria-live":"polite",children:ho})})}):U.length===0?o.jsx("tr",{children:o.jsx("td",{colSpan:gt,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:o.jsx("span",{role:"status","aria-live":"polite",children:xo})})}):U.map((s,l)=>{const m=s.row,i=String(s.sourceIndex),f=Eo[s.sourceIndex]??i;return o.jsx("tr",{style:{background:l%2===0?"transparent":"var(--aurora-surface-elevated)"},children:e.map((h,B)=>{const T=h.render?h.render(m,l,s.sourceIndex):String(m[String(h.key)]??""),E=A[B]??`${String(h.key)}__index-${B}`,L={padding:"10px 12px",borderBottom:"1px solid var(--aurora-border-default)",color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",textAlign:h.align??"left"};return h.rowHeader?o.jsx("th",{scope:"row",style:{...L,fontWeight:"var(--aurora-font-weight-medium)"},children:T},E):o.jsx("td",{style:L,children:T},E)})},f)})})]})]})}function Lt({columnHeader:e,nextDirection:t}){return`${e} sort ${t==="asc"?"ascending":"descending"}`}function Kt({columnHeader:e,direction:t}){return`Sorted by ${e} ${t==="asc"?"ascending":"descending"}.`}function Mo(e,t){if(typeof e=="string"){const n=Z(e);if(n.length>0)return n}return t}function jt(e){return e==="Enter"||e===" "||e==="Space"||e==="Spacebar"}function Oo(e){const t=e.nativeEvent;return t.isComposing?!0:typeof t.keyCode=="number"&&t.keyCode===229}function ut(e){return typeof e!="number"||e<=0}function $o(e,t){if(!e)return t;try{return e.matches(":focus-visible")||t}catch{return t}}function Ft(e){var b;const n=(e.ownerDocument.defaultView??window).getComputedStyle(e).direction;return n==="rtl"||n==="ltr"?n:((b=e.closest("[dir]"))==null?void 0:b.getAttribute("dir"))==="rtl"?"rtl":"ltr"}function qo(e){if(typeof e=="number")return Number.isFinite(e)&&e>0?e:560;if(typeof e=="string"){const t=e.trim();if(t.length>0)return t}return 560}function zo(e,t){if(typeof e=="string"){const n=e.trim().toLowerCase();if(n==="asc"||n==="desc")return n}return t}function Vo(e){if(typeof e=="number")return Number.isFinite(e)&&e>=0?e:void 0;if(typeof e=="string"){const t=e.trim();if(t.length>0)return t}}function yo(e,t){return typeof e!="boolean"?t:e}function N(e){return yo(e==null?void 0:e.sortable,!1)}function Xe(e){return e==null||typeof e=="boolean"?!1:typeof e=="string"?e.trim().length>0:typeof e=="number"?!0:Array.isArray(e)?e.some(t=>Xe(t)):y.isValidElement(e)}function dt(e){if(typeof e=="string")return e;if(typeof e=="number")return String(e);if(Array.isArray(e))return Z(e.map(n=>dt(n)).filter(n=>n.length>0).join(" "));if(!y.isValidElement(e))return"";const t=e.props;if(t["aria-hidden"]===!0||t["aria-hidden"]==="true")return"";if(typeof t["aria-label"]=="string"){const n=Z(t["aria-label"]);if(n.length>0)return n}return dt(t.children)}function Z(e){return e.replace(/\s+/g," ").trim()}function ce(e,t){return typeof e=="string"&&e.trim().length>0?e.trim():t}function _o(e,t){if(typeof e.scrollBy=="function"){e.scrollBy({left:t,behavior:"auto"});return}e.scrollLeft+=t}function Uo(e,t){if(typeof e.scrollTo=="function"){e.scrollTo({left:t,behavior:"auto"});return}e.scrollLeft=t}d.__docgenInfo={description:"",methods:[],displayName:"Table",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: keyof T | string;
...
}`,...(Ut=(_t=de.parameters)==null?void 0:_t.docs)==null?void 0:Ut.source}}};var Gt,Yt,Jt;me.parameters={...me.parameters,docs:{...(Gt=me.parameters)==null?void 0:Gt.docs,source:{originalSource:`{
  render: () => {
...
}`,...(Jt=(Yt=me.parameters)==null?void 0:Yt.docs)==null?void 0:Jt.source}}};var Zt,Qt,Xt;ye.parameters={...ye.parameters,docs:{...(Zt=ye.parameters)==null?void 0:Zt.docs,source:{originalSource:`{
...
}`,...(Rn=(Bn=Se.parameters)==null?void 0:Bn.docs)==null?void 0:Rn.source}}};var kn,Tn,Hn;fe.parameters={...fe.parameters,docs:{...(kn=fe.parameters)==null?void 0:kn.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Hn=(Tn=fe.parameters)==null?void 0:Tn.docs)==null?void 0:Hn.source}}};var Dn,En,Cn;Be.parameters={...Be.parameters,docs:{...(Dn=Be.parameters)==null?void 0:Dn.docs,source:{originalSource:`{
  render: () => {
...
}`,...(Cn=(En=Be.parameters)==null?void 0:En.docs)==null?void 0:Cn.source}}};var An,In,Ln;Re.parameters={...Re.parameters,docs:{...(An=Re.parameters)==null?void 0:An.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Ln=(In=Re.parameters)==null?void 0:In.docs)==null?void 0:Ln.source}}};var Kn,jn,Fn;ke.parameters={...ke.parameters,docs:{...(Kn=ke.parameters)==null?void 0:Kn.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Fn=(jn=ke.parameters)==null?void 0:jn.docs)==null?void 0:Fn.source}}};var Wn,Pn,Nn;Te.parameters={...Te.parameters,docs:{...(Wn=Te.parameters)==null?void 0:Wn.docs,source:{originalSource:`{
...
}`,...(Gn=(Un=Ee.parameters)==null?void 0:Un.docs)==null?void 0:Gn.source}}};var Yn,Jn,Zn;Ce.parameters={...Ce.parameters,docs:{...(Yn=Ce.parameters)==null?void 0:Yn.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Zn=(Jn=Ce.parameters)==null?void 0:Jn.docs)==null?void 0:Zn.source}}};var Qn,Xn,ea;Ae.parameters={...Ae.parameters,docs:{...(Qn=Ae.parameters)==null?void 0:Qn.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(va=(ga=We.parameters)==null?void 0:ga.docs)==null?void 0:va.source}}};var ha,xa,Sa;Pe.parameters={...Pe.parameters,docs:{...(ha=Pe.parameters)==null?void 0:ha.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Sa=(xa=Pe.parameters)==null?void 0:xa.docs)==null?void 0:Sa.source}}};var fa,Ba,Ra;Ne.parameters={...Ne.parameters,docs:{...(fa=Ne.parameters)==null?void 0:fa.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={columns} data={rows} defaultSortKey="id" getSortAriaLabel={() => {
...
}`,...(Ra=(Ba=Ne.parameters)==null?void 0:Ba.docs)==null?void 0:Ra.source}}};var ka,Ta,Ha;Me.parameters={...Me.parameters,docs:{...(ka=Me.parameters)==null?void 0:ka.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(La=(Ia=$e.parameters)==null?void 0:Ia.docs)==null?void 0:La.source}}};var Ka,ja,Fa;qe.parameters={...qe.parameters,docs:{...(Ka=qe.parameters)==null?void 0:Ka.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "status",
      header: <span>
...
}`,...(Fa=(ja=qe.parameters)==null?void 0:ja.docs)==null?void 0:Fa.source}}};var Wa,Pa,Na;ze.parameters={...ze.parameters,docs:{...(Wa=ze.parameters)==null?void 0:Wa.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "status",
...
}`,...(Na=(Pa=ze.parameters)==null?void 0:Pa.docs)==null?void 0:Na.source}}};var Ma,Oa,$a;Ve.parameters={...Ve.parameters,docs:{...(Ma=Ve.parameters)==null?void 0:Ma.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "   ",
      header: <span aria-hidden="true">🚦</span>,
...
}`,...($a=(Oa=Ve.parameters)==null?void 0:Oa.docs)==null?void 0:$a.source}}};var qa,za,Va;_e.parameters={..._e.parameters,docs:{...(qa=_e.parameters)==null?void 0:qa.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
...
}`,...(Va=(za=_e.parameters)==null?void 0:za.docs)==null?void 0:Va.source}}};var _a,Ua,Ga;Ue.parameters={...Ue.parameters,docs:{...(_a=Ue.parameters)==null?void 0:_a.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)" gap={10}>
...
}`,...(Ga=(Ua=Ue.parameters)==null?void 0:Ua.docs)==null?void 0:Ga.source}}};var Ya,Ja,Za;Ge.parameters={...Ge.parameters,docs:{...(Ya=Ge.parameters)==null?void 0:Ya.docs,source:{originalSource:`{
  render: () => {
...
}`,...(Za=(Ja=Ge.parameters)==null?void 0:Ja.docs)==null?void 0:Za.source}}};var Qa,Xa,eo;Ye.parameters={...Ye.parameters,docs:{...(Qa=Ye.parameters)==null?void 0:Qa.docs,source:{originalSource:`{
...
}`,...(eo=(Xa=Ye.parameters)==null?void 0:Xa.docs)==null?void 0:eo.source}}};var to,no,ao;Je.parameters={...Je.parameters,docs:{...(to=Je.parameters)==null?void 0:to.docs,source:{originalSource:`{
...
}`,...(ao=(no=Je.parameters)==null?void 0:no.docs)==null?void 0:ao.source}}};var oo,ro,so;Ze.parameters={...Ze.parameters,docs:{...(oo=Ze.parameters)==null?void 0:oo.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 720px)">
...
}`,...(so=(ro=Ze.parameters)==null?void 0:ro.docs)==null?void 0:so.source}}};var io,co,lo;Qe.parameters={...Qe.parameters,docs:{...(io=Qe.parameters)==null?void 0:io.docs,source:{originalSource:`{
