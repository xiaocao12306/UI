import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{B as Ta}from"./Button-DsGPnCUO.js";import{r as u}from"./index-BWu4c2F4.js";import{B as ka}from"./Badge-ZJmMstsz.js";import{within as y,expect as n,userEvent as d,fireEvent as B}from"./index-DgAF9SIF.js";import{S as m,s as E,a as He}from"./storyShowcase-Bw5VyCj0.js";const Da=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"}),$e=400;function Ve(t,e,o){if(!e)return null;const r=t.find(h=>String(h.key)===e);return r!=null&&r.sortable?{key:e,direction:o}:null}function Me(t,e){if(typeof t.sortLabel=="string"&&t.sortLabel.trim().length>0)return t.sortLabel.trim();const o=De(ke(t.header));return o.length>0?o:e}function l({columns:t,data:e,rowKey:o,caption:r,ariaLabel:h,ariaLabelledBy:xe,loading:f=!1,loadingContent:I="Loading data...",emptyContent:R="No data available.",defaultSortKey:L,defaultSortDirection:he="asc",getSortAriaLabel:ba=Oe,getSortStatusText:Ie=Ha,onSortChange:Se}){const M=Te(xe),Ae=M?void 0:Te(h,r?void 0:"Data table"),W=u.useRef({}),Ee=u.useRef(null),fe=u.useRef(null),O=u.useRef(0),j=u.useRef(null),z=u.useRef(null),N=u.useRef(!0);u.useRef(null),u.useRef(null),u.useRef(null);const[wa,Be]=u.useState(null),[ga,q]=u.useState(null),[va,P]=u.useState(null);u.useEffect(()=>{var x;const i=((x=Ee.current)==null?void 0:x.ownerDocument)??document,s=p=>{p.metaKey||p.altKey||p.ctrlKey||(N.current=!0)},w=()=>{N.current=!1};return i.addEventListener("keydown",s,!0),i.addEventListener("pointerdown",w,!0),i.addEventListener("mousedown",w,!0),i.addEventListener("touchstart",w,!0),()=>{i.removeEventListener("keydown",s,!0),i.removeEventListener("pointerdown",w,!0),i.removeEventListener("mousedown",w,!0),i.removeEventListener("touchstart",w,!0)}},[]);const G=u.useCallback(()=>{fe.current=null,O.current=0,j.current!==null&&((z.current??window).clearTimeout(j.current),j.current=null),z.current=null},[]);u.useEffect(()=>()=>{G()},[G]);const[b,Re]=u.useState(()=>Ve(t,L,he)),K=u.useMemo(()=>f||e.length<=1?[]:t.reduce((i,s)=>(s.sortable&&i.push(String(s.key)),i),[]),[t,e.length,f]);u.useEffect(()=>{if(!b)return;const i=t.find(s=>String(s.key)===b.key);i!=null&&i.sortable||Re(null)},[t,b]),u.useEffect(()=>{if(b)return;const i=Ve(t,L,he);i&&Re(i)},[t,he,L,b]);const xa=u.useMemo(()=>e.map((i,s)=>String(o?o(i,s):s)),[e,o]);u.useEffect(()=>{},[o,xa]),u.useEffect(()=>{},[t]),u.useEffect(()=>{},[t]);const F=u.useMemo(()=>{const i=e.map((x,p)=>({row:x,sourceIndex:p}));if(!b)return i;const s=t.find(x=>String(x.key)===b.key);if(!(s!=null&&s.sortable))return i;const w=s.sortAccessor??(x=>{const p=x[String(s.key)];return p instanceof Date||typeof p=="number"||typeof p=="string"?p:String(p??"")});return i.sort((x,p)=>{const g=w(x.row),D=w(p.row);if(typeof g=="string"&&typeof D=="string"){const A=Da.compare(g,D);return A!==0?b.direction==="asc"?A:-A:x.sourceIndex-p.sourceIndex}const C=g instanceof Date?g.getTime():g,V=D instanceof Date?D.getTime():D;return C<V?b.direction==="asc"?-1:1:C>V?b.direction==="asc"?1:-1:x.sourceIndex-p.sourceIndex})},[t,e,b]),Ce=u.useMemo(()=>{if(f||F.length<=1||!b)return"";const i=t.find(w=>String(w.key)===b.key);if(!(i!=null&&i.sortable))return"";const s=Me(i,String(i.key));return Ie({columnKey:b.key,columnHeader:s,direction:b.direction})},[t,Ie,f,b,F.length]),$=!f&&F.length>1&&t.some(i=>i.sortable),je=Math.max(t.length,1);return u.useEffect(()=>{$||(Be(null),q(null),P(null))},[$]),a.jsxs("div",{ref:Ee,"data-aurora-table-scroll-container":"",tabIndex:$?void 0:0,"aria-label":$||M?void 0:Ae??"Data table scroll container","aria-labelledby":$?void 0:M,style:{border:"1px solid var(--aurora-border-default)",borderRadius:"var(--aurora-radius-md)",overflow:"auto"},children:[Ce?a.jsx("p",{role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:Ce}):null,a.jsxs("table",{"aria-label":Ae,"aria-labelledby":M,"aria-busy":f||void 0,style:{width:"100%",borderCollapse:"collapse",minWidth:560},children:[r?a.jsx("caption",{style:{textAlign:"left",padding:"10px 12px",color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-sm)",borderBottom:"1px solid var(--aurora-border-default)"},children:r}):null,a.jsx("thead",{children:a.jsx("tr",{children:t.map(i=>{const s=String(i.key),w=!!i.sortable,x=F.length>1,p=w&&(b==null?void 0:b.key)===s?b.direction:void 0,g=!f&&x?p:void 0,D=g?g==="asc"?"ascending":"descending":void 0,C=i.align??"left",V=Me(i,s),A=p==="asc"?"desc":"asc",ha=ba({columnKey:s,columnHeader:V,nextDirection:A}),Sa=Te(ha,Oe({columnHeader:V,nextDirection:A})),T=f||!x,Ke=!T&&wa===s,Fe=!T&&ga===s,Le=!T&&va===s,fa=Ke||Le,We=()=>{T||(Re({key:s,direction:A}),Se==null||Se(s,A))};return a.jsx("th",{scope:"col","aria-sort":D,style:{textAlign:C,color:"var(--aurora-text-secondary)",background:"var(--aurora-surface-elevated)",borderBottom:"1px solid var(--aurora-border-default)",padding:"10px 12px",fontSize:"var(--aurora-font-size-sm)",fontWeight:"var(--aurora-font-weight-medium)",width:i.width},children:w?a.jsxs("button",{"data-aurora-reduced-motion":"transition",type:"button",ref:c=>{W.current[s]=c},"aria-label":Sa,"aria-keyshortcuts":T?void 0:"Enter Space",disabled:T,onClick:c=>{const k=Date.now()-O.current,U=c.detail===0&&fe.current===s&&O.current>0&&k<=$e;G(),!U&&We()},onMouseEnter:()=>{T||Be(s)},onMouseLeave:()=>{Be(c=>c===s?null:c),q(c=>c===s?null:c)},onMouseDown:c=>{T||c.button===0&&(N.current=!1,P(k=>k===s?null:k),q(s))},onMouseUp:c=>{c.button===0&&q(k=>k===s?null:k)},onFocus:()=>{if(T){P(c=>c===s?null:c);return}P(c=>Ea(W.current[s],N.current)?s:c===s?null:c)},onBlur:()=>{P(c=>c===s?null:c),q(c=>c===s?null:c)},onKeyDown:c=>{var U,Ne,qe;if(N.current=!0,c.altKey||c.ctrlKey||c.metaKey)return;if(c.key==="Home"){const H=K[0];if(!H)return;c.preventDefault(),(U=W.current[H])==null||U.focus();return}if(c.key==="End"){const H=K[K.length-1];if(!H)return;c.preventDefault(),(Ne=W.current[H])==null||Ne.focus();return}if(c.key==="PageDown"||c.key==="PageUp"){const H=K.indexOf(s);if(H<0)return;const Ba=c.key==="PageDown"?1:-1,Pe=Math.max(0,Math.min(K.length-1,H+Ba));if(Pe===H)return;c.preventDefault();const Ra=K[Pe];(qe=W.current[Ra])==null||qe.focus();return}if(!Ia(c.key)||Aa(c)||(c.preventDefault(),c.repeat))return;fe.current=s,O.current=Date.now();const k=c.currentTarget.ownerDocument.defaultView??window;j.current!==null&&(z.current??k).clearTimeout(j.current),z.current=k,j.current=k.setTimeout(()=>{G()},$e),We()},style:{border:fa?"1px solid color-mix(in srgb, var(--aurora-accent-default) 48%, transparent)":"1px solid transparent",borderRadius:"var(--aurora-radius-sm)",background:Fe?"color-mix(in srgb, var(--aurora-surface-elevated) 68%, var(--aurora-surface-default))":Ke?"color-mix(in srgb, var(--aurora-surface-elevated) 86%, var(--aurora-surface-default))":"transparent",font:"inherit",cursor:T?"not-allowed":"pointer",display:"inline-flex",alignItems:"center",gap:6,padding:"2px 6px",color:T?"color-mix(in srgb, var(--aurora-text-secondary) 88%, var(--aurora-text-primary))":"inherit",boxShadow:Le?"0 0 0 3px color-mix(in srgb, var(--aurora-focus-ring) 42%, transparent)":"none",transform:Fe?"translateY(1px)":"translateY(0)",transition:"background-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), border-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), box-shadow var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), transform var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard)"},children:[i.header,a.jsx("span",{"aria-hidden":"true",children:g==="asc"?"▲":g==="desc"?"▼":"↕"})]}):i.header},s)})})}),a.jsx("tbody",{children:f?a.jsx("tr",{children:a.jsx("td",{colSpan:je,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:I})})}):F.length===0?a.jsx("tr",{children:a.jsx("td",{colSpan:je,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:R})})}):F.map((i,s)=>{const w=i.row,x=String(i.sourceIndex),p=o?o(w,i.sourceIndex):x;return a.jsx("tr",{style:{background:s%2===0?"transparent":"var(--aurora-surface-elevated)"},children:t.map(g=>{const D=g.render?g.render(w,s,i.sourceIndex):String(w[String(g.key)]??""),C={padding:"10px 12px",borderBottom:"1px solid var(--aurora-border-default)",color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",textAlign:g.align??"left"};return g.rowHeader?a.jsx("th",{scope:"row",style:{...C,fontWeight:"var(--aurora-font-weight-medium)"},children:D},String(g.key)):a.jsx("td",{style:C,children:D},String(g.key))})},p)})})]})]})}function Oe({columnHeader:t,nextDirection:e}){return`${t} sort ${e==="asc"?"ascending":"descending"}`}function Ha({columnHeader:t,direction:e}){return`Sorted by ${t} ${e==="asc"?"ascending":"descending"}.`}function Ia(t){return t==="Enter"||t===" "||t==="Space"||t==="Spacebar"}function Aa(t){const e=t.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function Ea(t,e){if(!t)return e;try{return t.matches(":focus-visible")}catch{return e}}function ke(t){if(typeof t=="string")return t;if(typeof t=="number")return String(t);if(Array.isArray(t))return De(t.map(o=>ke(o)).filter(o=>o.length>0).join(" "));if(!u.isValidElement(t))return"";const e=t.props;if(e["aria-hidden"]===!0||e["aria-hidden"]==="true")return"";if(typeof e["aria-label"]=="string"){const o=De(e["aria-label"]);if(o.length>0)return o}return ke(e.children)}function De(t){return t.replace(/\s+/g," ").trim()}function Te(t,e){return typeof t=="string"&&t.trim().length>0?t.trim():e}l.__docgenInfo={description:"",methods:[],displayName:"Table",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: keyof T | string;
...
}`,...(Qe=(Je=_.parameters)==null?void 0:Je.docs)==null?void 0:Qe.source}}};var Xe,Ze,et;J.parameters={...J.parameters,docs:{...(Xe=J.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
  render: () => {
...
}`,...(et=(Ze=J.parameters)==null?void 0:Ze.docs)==null?void 0:et.source}}};var tt,at,nt;Q.parameters={...Q.parameters,docs:{...(tt=Q.parameters)==null?void 0:tt.docs,source:{originalSource:`{
...
}`,...(nt=(at=Q.parameters)==null?void 0:at.docs)==null?void 0:nt.source}}};var ot,rt,st;X.parameters={...X.parameters,docs:{...(ot=X.parameters)==null?void 0:ot.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(st=(rt=X.parameters)==null?void 0:rt.docs)==null?void 0:st.source}}};var it,ct,ut;Z.parameters={...Z.parameters,docs:{...(it=Z.parameters)==null?void 0:it.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 840px)" gap={10}>
      <Table columns={[{
      key: "id",
      header: "Issue"
...
}`,...(ut=(ct=Z.parameters)==null?void 0:ct.docs)==null?void 0:ut.source}}};var lt,dt,mt;ee.parameters={...ee.parameters,docs:{...(lt=ee.parameters)==null?void 0:lt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 840px)" gap={10}>
...
}`,...(mt=(dt=ee.parameters)==null?void 0:dt.docs)==null?void 0:mt.source}}};var yt,pt,bt;te.parameters={...te.parameters,docs:{...(yt=te.parameters)==null?void 0:yt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(bt=(pt=te.parameters)==null?void 0:pt.docs)==null?void 0:bt.source}}};var wt,gt,vt;ae.parameters={...ae.parameters,docs:{...(wt=ae.parameters)==null?void 0:wt.docs,source:{originalSource:`{
...
}`,...(vt=(gt=ae.parameters)==null?void 0:gt.docs)==null?void 0:vt.source}}};var xt,ht,St;ne.parameters={...ne.parameters,docs:{...(xt=ne.parameters)==null?void 0:xt.docs,source:{originalSource:`{
...
}`,...(St=(ht=ne.parameters)==null?void 0:ht.docs)==null?void 0:St.source}}};var ft,Bt,Rt;oe.parameters={...oe.parameters,docs:{...(ft=oe.parameters)==null?void 0:ft.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Rt=(Bt=oe.parameters)==null?void 0:Bt.docs)==null?void 0:Rt.source}}};var Tt,kt,Dt;re.parameters={...re.parameters,docs:{...(Tt=re.parameters)==null?void 0:Tt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Dt=(kt=re.parameters)==null?void 0:kt.docs)==null?void 0:Dt.source}}};var Ht,It,At;se.parameters={...se.parameters,docs:{...(Ht=se.parameters)==null?void 0:Ht.docs,source:{originalSource:`{
...
}`,...(At=(It=se.parameters)==null?void 0:It.docs)==null?void 0:At.source}}};var Et,Ct,jt;ie.parameters={...ie.parameters,docs:{...(Et=ie.parameters)==null?void 0:Et.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "component",
      header: "Component",
...
}`,...(jt=(Ct=ie.parameters)==null?void 0:Ct.docs)==null?void 0:jt.source}}};var Kt,Ft,Lt;ce.parameters={...ce.parameters,docs:{...(Kt=ce.parameters)==null?void 0:Kt.docs,source:{originalSource:`{
  ...
  play: async ({
    ...
    fireEvent.keyDown(issueSortAscAfterShift, {
      key: " ",
      shiftKey: true
    });
    await expect(canvas.getByText("id asc")).toBeInTheDocument();
...
}`,...(Lt=(Ft=ce.parameters)==null?void 0:Ft.docs)==null?void 0:Lt.source}}};var Wt,Nt,qt;ue.parameters={...ue.parameters,docs:{...(Wt=ue.parameters)==null?void 0:Wt.docs,source:{originalSource:`{
...
}`,...(qt=(Nt=ue.parameters)==null?void 0:Nt.docs)==null?void 0:qt.source}}};var Pt,$t,Vt;le.parameters={...le.parameters,docs:{...(Pt=le.parameters)==null?void 0:Pt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Vt=($t=le.parameters)==null?void 0:$t.docs)==null?void 0:Vt.source}}};var Mt,Ot,zt;de.parameters={...de.parameters,docs:{...(Mt=de.parameters)==null?void 0:Mt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "releasedAt",
...
}`,...(zt=(Ot=de.parameters)==null?void 0:Ot.docs)==null?void 0:zt.source}}};var Gt,Ut,Yt;me.parameters={...me.parameters,docs:{...(Gt=me.parameters)==null?void 0:Gt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "status",
      header: <span>
...
}`,...(Yt=(Ut=me.parameters)==null?void 0:Ut.docs)==null?void 0:Yt.source}}};var _t,Jt,Qt;ye.parameters={...ye.parameters,docs:{...(_t=ye.parameters)==null?void 0:_t.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
      <Table columns={[{
      key: "status",
...
}`,...(Qt=(Jt=ye.parameters)==null?void 0:Jt.docs)==null?void 0:Qt.source}}};var Xt,Zt,ea;pe.parameters={...pe.parameters,docs:{...(Xt=pe.parameters)==null?void 0:Xt.docs,source:{originalSource:`{
  render: () => {
...
}`,...(ea=(Zt=pe.parameters)==null?void 0:Zt.docs)==null?void 0:ea.source}}};var ta,aa,na;be.parameters={...be.parameters,docs:{...(ta=be.parameters)==null?void 0:ta.docs,source:{originalSource:`{
...
}`,...(na=(aa=be.parameters)==null?void 0:aa.docs)==null?void 0:na.source}}};var oa,ra,sa;we.parameters={...we.parameters,docs:{...(oa=we.parameters)==null?void 0:oa.docs,source:{originalSource:`{
...
}`,...(ua=(ca=ge.parameters)==null?void 0:ca.docs)==null?void 0:ua.source}}};var la,da,ma;ve.parameters={...ve.parameters,docs:{...(la=ve.parameters)==null?void 0:la.docs,source:{originalSource:`{
