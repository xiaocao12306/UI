import{j as o}from"./jsx-runtime-BjG_zV1W.js";import{r as c}from"./index-BWu4c2F4.js";import{B as P}from"./Button-B21ouHNm.js";import{P as to}from"./Popover-DUXRDylQ.js";import{D as no}from"./Dialog-Cbs75tsL.js";import{I as ao}from"./Input-DCFTlK0_.js";import{within as d,userEvent as i,expect as n,fireEvent as g,waitFor as A}from"./index-DgAF9SIF.js";import{b as v,s as y,a as b}from"./storyShowcase-DlKirntE.js";import"./focusTabbable-gnwmp6b7.js";import"./bodyScrollLock-DU3WNas9.js";import"./index-DlVbWVVj.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";function u({open:a,onOpenChange:e,commands:t,title:s="Command Palette",description:l="Quickly search and execute workspace actions.",ariaLabel:p,ariaLabelledBy:w,searchAriaLabel:B="Search commands",resultsAriaLabel:U="Command results",closeOnSelect:Je=!0,clearQueryOnEscape:Ne=!0,closeOnEscape:V=!0,closeOnOutsidePointer:Xe=!0,onEscapeKeyDown:Me,onSearchKeyDown:Fe,onCloseButtonKeyDown:Ka,onPointerDownOutside:$e,closeLabel:Na,placeholder:Ma="Search commands...",loading:E=!1,loadingContent:G="Loading commands...",emptyMessage:Ze="No commands found.",disabledResultsMessage:et="Matching commands are currently unavailable.",onQueryChange:C,onCloseReason:D,getResultsStatusText:tt=oo}){const[S,Ue]=c.useState(""),[z,T]=c.useState(0),Fa=c.useRef(null),M=c.useRef(null),Q=c.useRef(null),nt=c.useRef(a);c.useRef(null),c.useRef(null),c.useRef(null);const q=c.useId(),Ve=c.useId(),at=c.useId(),ot=c.useRef(null),$a=H(B,"Search commands"),Ua=H(U,"Command results"),Va=H(Na,"Close command palette"),Ga=H(Ma,"Search commands..."),st=H(w),za=st===void 0?H(p):void 0,rt=c.useMemo(()=>so(G),[G]),Qa=_e(G)?G:"Loading commands...",Wa=_e(Ze)?Ze:"No commands found.",_a=_e(et)?et:"Matching commands are currently unavailable.",W=c.useCallback(r=>{Q.current=r,D==null||D(r)},[D]),ct=c.useCallback(r=>{W(r),e(!1),Q.current=null},[W,e]),Ya=c.useCallback(r=>{!r&&a&&Q.current===null&&(D==null||D("close-button")),Q.current=null,e(r)},[D,e,a]);c.useEffect(()=>{!a&&nt.current&&(Ue(r=>(r.length>0&&(C==null||C("")),"")),T(0)),nt.current=a},[C,a]),c.useEffect(()=>{},[t]),c.useEffect(()=>{},[t]),c.useEffect(()=>{},[t]);const Ge=c.useMemo(()=>yt(S.trim()),[S]),ze=c.useMemo(()=>{const r=new Map;t.forEach(h=>{r.set(h.key,(r.get(h.key)??0)+1)});const m=new Map;return t.map(h=>{const R=r.get(h.key)??0,L=m.get(h.key)??0;return m.set(h.key,L+1),{item:h,renderKey:R>1?`${h.key}__duplicate-${L}`:h.key}})},[t]),_=c.useMemo(()=>Ge?ze.filter(({item:r})=>{const h=[pt(r),...r.keywords??[]].join(" ");return yt(h).includes(Ge)}):ze,[ze,Ge]),x=c.useMemo(()=>_.map(r=>r.item),[_]),K=c.useMemo(()=>_.map(r=>r.renderKey),[_]),F=c.useMemo(()=>x.reduce((r,m)=>m.disabled?r:r+1,0),[x]),it=!E&&x.length>0&&F===0,I=!E&&F>1,lt=!E&&F>0,Qe=!E&&x.length>0,Ja=c.useMemo(()=>{const r=[];return I&&r.push("ArrowDown","ArrowUp","Home","End","PageDown","PageUp"),lt&&r.push("Enter"),(V||Ne&&S.length>0)&&r.push("Escape"),r.length>0?r.join(" "):void 0},[lt,I,Ne,V,S.length]),Xa=c.useMemo(()=>E?rt:tt({query:S,visibleCount:x.length,enabledCount:F,totalCount:t.length}),[t.length,F,x.length,tt,E,S,rt]),Za=it?`${Ve} ${at}`:Ve,O=c.useMemo(()=>x.reduce((r,m,h)=>(m.disabled||r.push(h),r),[]),[x]),j=O[0]??-1,dt=O[O.length-1]??-1,f=c.useMemo(()=>{if(z<0)return-1;const r=x[z];return!r||r.disabled?-1:z},[z,x]);c.useEffect(()=>{if(x.length===0){M.current=null,T(-1);return}const r=M.current;if(r){const m=K.findIndex((h,R)=>{var L;return!((L=x[R])!=null&&L.disabled)&&h===r});if(m>=0){T(m);return}}T(j),M.current=j>=0?K[j]??null:null},[x,K,j]),c.useEffect(()=>{if(f<0){M.current=null;return}M.current=K[f]??null},[K,f]),c.useEffect(()=>{if(!a||f<0)return;const r=ot.current;if(!r)return;const m=r.ownerDocument.getElementById(`${q}-option-${f}`);!m||!r.contains(m)||typeof m.scrollIntoView=="function"&&m.scrollIntoView({block:"nearest"})},[q,a,f]);const We=c.useCallback(r=>{const m=x[r];!m||m.disabled||m.onSelect&&(m.onSelect(),Je&&ct("item-select"))},[Je,ct,x]),ut=r=>{var h;if(x.length===0)return;let m=f<0?r===1?-1:0:f;for(let R=0;R<x.length;R+=1)if(m=(m+r+x.length)%x.length,!((h=x[m])!=null&&h.disabled)){T(m);return}},mt=r=>{if(O.length===0)return;const m=O.indexOf(f);if(m<0){T(r===1?j:dt);return}const h=Math.min(O.length-1,Math.max(0,m+r*5));T(O[h]??j)};return o.jsx(no,{open:a,onOpenChange:Ya,title:s,description:l,ariaLabel:za,ariaLabelledBy:st,closeLabel:Va,size:"md",closeOnEscape:V,closeOnOutsidePointer:Xe,onCloseButtonKeyDown:Ka,onEscapeKeyDown:r=>{Me==null||Me(r),!(r.defaultPrevented||!V)&&W("escape-key")},onPointerDownOutside:r=>{$e==null||$e(r),!(r.defaultPrevented||!Xe)&&W("outside-pointer")},children:o.jsxs("div",{style:{display:"grid",gap:10},children:[o.jsx(ao,{ref:Fa,"data-autofocus":"",role:"combobox","aria-busy":E||void 0,"aria-expanded":Qe,"aria-haspopup":"listbox","aria-autocomplete":"list","aria-controls":Qe?q:void 0,"aria-activedescendant":!E&&f>=0?`${q}-option-${f}`:void 0,"aria-describedby":Za,"aria-keyshortcuts":Ja,placeholder:Ga,value:S,onChange:r=>{Ue(r.target.value),C==null||C(r.target.value)},onKeyDown:r=>{if(Fe==null||Fe(r),!wt(r)&&!r.defaultPrevented&&!(r.altKey||r.ctrlKey||r.metaKey)){if(r.key==="Escape"){if(r.repeat)return;Ne&&S.length>0&&(r.preventDefault(),Ue(""),C==null||C(""));return}if(r.key==="ArrowDown"){if(!I)return;r.preventDefault(),ut(1);return}if(r.key==="ArrowUp"){if(!I)return;r.preventDefault(),ut(-1);return}if(r.key==="Home"){if(!I||!bt(r))return;r.preventDefault(),T(j);return}if(r.key==="End"){if(!I||!bt(r))return;r.preventDefault(),T(dt);return}if(r.key==="PageDown"){if(!I)return;r.preventDefault(),mt(1);return}if(r.key==="PageUp"){if(!I)return;r.preventDefault(),mt(-1);return}if(r.key==="Enter"&&!E&&f>=0){if(r.preventDefault(),r.repeat)return;We(f)}}},"aria-label":$a}),o.jsx("p",{id:Ve,role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:Xa}),E?o.jsx("p",{"data-testid":"command-palette-loading-content",style:{margin:0,color:"var(--aurora-text-secondary)"},children:Qa}):Qe?o.jsxs(o.Fragment,{children:[o.jsx("div",{id:q,ref:ot,role:"listbox","aria-label":Ua,style:{maxHeight:280,overflow:"auto",display:"grid",gap:4},children:x.map((r,m)=>{const h=m===f,R=H(r.ariaLabelledBy),L=$(r.label).trim().length>0,eo=R?void 0:H(r.ariaLabel,L?void 0:pt(r));return o.jsx("div",{id:`${q}-option-${m}`,role:"option","aria-selected":h,"aria-disabled":r.disabled||void 0,"aria-labelledby":R,"aria-label":eo,"aria-keyshortcuts":r.disabled?void 0:"Enter Space","aria-posinset":m+1,"aria-setsize":x.length,tabIndex:-1,onPointerDown:k=>{k.pointerType==="mouse"||!ro(k.button)||k.ctrlKey||k.preventDefault()},onMouseDown:k=>{k.button!==0||k.ctrlKey||k.preventDefault()},onMouseEnter:()=>{r.disabled||T(m)},onClick:()=>{r.disabled||We(m)},onKeyDown:k=>{if(!r.disabled&&!k.defaultPrevented&&!wt(k)&&!(k.altKey||k.ctrlKey||k.metaKey)&&(k.key==="Enter"||k.key===" "||k.key==="Space"||k.key==="Spacebar")){if(k.preventDefault(),k.repeat)return;We(m)}},style:{border:"1px solid var(--aurora-border-default)",background:h?"color-mix(in srgb, var(--aurora-accent-default) 14%, var(--aurora-surface-default))":"var(--aurora-surface-default)",color:r.disabled?"color-mix(in srgb, var(--aurora-text-secondary) 60%, transparent)":"var(--aurora-text-primary)",borderRadius:8,height:36,padding:"0 10px",textAlign:"left",cursor:r.disabled?"not-allowed":"pointer"},children:r.label},K[m]??`${r.key}__source-fallback-${m}`)})}),it?o.jsx("p",{id:at,"data-testid":"command-palette-disabled-results-message",style:{margin:0,color:"var(--aurora-text-secondary)",fontSize:13},children:_a}):null]}):o.jsx("p",{style:{margin:0,color:"var(--aurora-text-secondary)"},children:Wa})]})})}function pt(a){if(typeof a.textValue=="string"){const e=N(a.textValue);if(e.length>0)return e}if(typeof a.ariaLabel=="string"){const e=N(a.ariaLabel);if(e.length>0)return e}return N($(a.label))}function yt(a){return a.normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/\s+/g," ").trim().toLowerCase()}function wt(a){const e=a.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function bt(a){if(a.key!=="Home"&&a.key!=="End")return!0;const e=a.currentTarget,t=e.selectionStart,s=e.selectionEnd;return t===null||s===null?!0:t!==s?!1:a.key==="Home"?t===0:s===e.value.length}function oo({query:a,visibleCount:e,enabledCount:t,totalCount:s}){const l=a.trim();return l.length===0?t!==s?`${t} of ${s} command${s===1?"":"s"} available.`:`${s} command${s===1?"":"s"} available.`:e===0?`No commands match "${l}".`:t===0?`No enabled commands match "${l}".`:t!==e?`${t} of ${e} matching command${t===1?"":"s"} available for "${l}".`:`${e} command${e===1?"":"s"} found for "${l}".`}function so(a){const e=N($(a));return e.length>0?e:"Loading commands..."}function _e(a){return a==null||typeof a=="boolean"?!1:typeof a=="string"?a.trim().length>0:!0}function $(a){if(typeof a=="string")return a;if(typeof a=="number")return String(a);if(Array.isArray(a))return N(a.map(t=>$(t)).filter(t=>t.length>0).join(" "));if(!c.isValidElement(a))return"";const e=a.props;return e["aria-hidden"]===!0||e["aria-hidden"]==="true"?"":typeof e["aria-label"]=="string"&&e["aria-label"].trim().length>0?N(e["aria-label"]):$(e.children)}function H(a,e){return typeof a=="string"&&a.trim().length>0?a.trim():e}function ro(a){return typeof a!="number"||a<=0}function N(a){return a.replace(/\s+/g," ").trim()}u.__docgenInfo={description:"",methods:[],displayName:"CommandPalette",props:{open:{required:!0,tsType:{name:"boolean"},description:""},onOpenChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""},commands:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: string;
...
}`,...(Ht=(It=ee.parameters)==null?void 0:It.docs)==null?void 0:Ht.source}}};var Pt,At,Ot;te.parameters={...te.parameters,docs:{...(Pt=te.parameters)==null?void 0:Pt.docs,source:{originalSource:`{
  args: {
    open: true,
    loading: true,
    loadingContent: "   ",
...
}`,...(Ot=(At=te.parameters)==null?void 0:At.docs)==null?void 0:Ot.source}}};var jt,Lt,qt;ne.parameters={...ne.parameters,docs:{...(jt=ne.parameters)==null?void 0:jt.docs,source:{originalSource:`{
  args: {
    open: true,
    emptyMessage: "   ",
    onOpenChange: () => {},
...
}`,...(Sn=(Dn=ge.parameters)==null?void 0:Dn.docs)==null?void 0:Sn.source}}};var In,Hn,Pn;ve.parameters={...ve.parameters,docs:{...(In=ve.parameters)==null?void 0:In.docs,source:{originalSource:`{
...
}`,...(Pn=(Hn=ve.parameters)==null?void 0:Hn.docs)==null?void 0:Pn.source}}};var An,On,jn;he.parameters={...he.parameters,docs:{...(An=he.parameters)==null?void 0:An.docs,source:{originalSource:`{
...
}`,...(ga=(ba=He.parameters)==null?void 0:ba.docs)==null?void 0:ga.source}}};var va,ha,xa;Pe.parameters={...Pe.parameters,docs:{...(va=Pe.parameters)==null?void 0:va.docs,source:{originalSource:`{
...
}`,...(xa=(ha=Pe.parameters)==null?void 0:ha.docs)==null?void 0:xa.source}}};var ka,Ba,fa;Ae.parameters={...Ae.parameters,docs:{...(ka=Ae.parameters)==null?void 0:ka.docs,source:{originalSource:`{
...
}`,...(fa=(Ba=Ae.parameters)==null?void 0:Ba.docs)==null?void 0:fa.source}}};var Ea,Ca,Ta;Oe.parameters={...Oe.parameters,docs:{...(Ea=Oe.parameters)==null?void 0:Ea.docs,source:{originalSource:`{
...
}`,...(Sa=(Da=je.parameters)==null?void 0:Da.docs)==null?void 0:Sa.source}}};var Ia,Ha,Pa;Le.parameters={...Le.parameters,docs:{...(Ia=Le.parameters)==null?void 0:Ia.docs,source:{originalSource:`{
...
}`,...(Pa=(Ha=Le.parameters)==null?void 0:Ha.docs)==null?void 0:Pa.source}}};var Aa,Oa,ja;qe.parameters={...qe.parameters,docs:{...(Aa=qe.parameters)==null?void 0:Aa.docs,source:{originalSource:`{
