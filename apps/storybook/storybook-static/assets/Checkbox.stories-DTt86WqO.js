import{j as t}from"./jsx-runtime-BjG_zV1W.js";import{r as o}from"./index-BWu4c2F4.js";import{a as me}from"./a11y-CU5SQrEA.js";import{B as ye}from"./Badge-ZJmMstsz.js";import{within as S,userEvent as T,expect as i}from"./index-DgAF9SIF.js";const c=o.forwardRef(function({label:a,description:n,invalid:p,indeterminate:C=!1,disabled:u,style:ce,onFocus:E,onBlur:B,onMouseDown:j,onPointerDown:R,onKeyDown:I,"aria-invalid":se,"aria-label":ie,"aria-labelledby":le,"aria-keyshortcuts":de,...A},b){const[F,H]=o.useState(!1),[z,h]=o.useState(!1),m=o.useRef(null),l=o.useRef(!1),N=o.useId(),V=me(p,se),q=V!==void 0,y=!!u,K=L(le),ue=K?void 0:L(ie),be=y?void 0:L(de)??"Space",he=[A["aria-describedby"],n?N:void 0].filter(Boolean).join(" ")||void 0;o.useEffect(()=>{y&&(H(!1),h(!1))},[y]),o.useEffect(()=>{var Y;const e=((Y=m.current)==null?void 0:Y.ownerDocument)??document,_=s=>{s.metaKey||s.altKey||s.ctrlKey||(l.current=!0)},d=s=>{"button"in s&&typeof s.button=="number"&&s.button!==0||(l.current=!1)};return e.addEventListener("keydown",_,!0),e.addEventListener("pointerdown",d,!0),e.addEventListener("mousedown",d,!0),e.addEventListener("touchstart",d,!0),()=>{e.removeEventListener("keydown",_,!0),e.removeEventListener("pointerdown",d,!0),e.removeEventListener("mousedown",d,!0),e.removeEventListener("touchstart",d,!0)}},[]),o.useEffect(()=>{m.current&&(m.current.indeterminate=C)},[C]);const pe=o.useCallback(e=>{m.current=e,typeof b=="function"?b(e):b&&(b.current=e)},[b]);return t.jsxs("label",{style:{display:"inline-flex",alignItems:"flex-start",gap:10,color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",cursor:u?"not-allowed":"pointer",opacity:u?.75:1,...ce},children:[t.jsx("input",{...A,ref:pe,type:"checkbox",disabled:u,"aria-label":ue,"aria-labelledby":K,"aria-invalid":V,"aria-checked":C?"mixed":A["aria-checked"],"aria-describedby":he,"aria-keyshortcuts":be,"data-focused":F?"true":void 0,"data-focus-visible":z?"true":void 0,style:{margin:"2px 0 0",width:16,height:16,accentColor:q?"var(--aurora-color-red-500)":"var(--aurora-accent-default)",cursor:u?"not-allowed":"pointer",boxShadow:F&&z&&!y?`0 0 0 3px ${q?"color-mix(in srgb, var(--aurora-color-red-500) 24%, transparent)":"color-mix(in srgb, var(--aurora-accent-default) 24%, transparent)"}`:"none"},onFocus:e=>{H(!0),h(xe(e.currentTarget,l.current)),E==null||E(e)},onBlur:e=>{H(!1),h(!1),B==null||B(e)},onMouseDown:e=>{e.button===0&&(l.current=!1,h(!1)),j==null||j(e)},onPointerDown:e=>{e.button===0&&(l.current=!1,h(!1)),R==null||R(e)},onKeyDown:e=>{l.current=!0,I==null||I(e)}}),a||n?t.jsxs("span",{style:{display:"grid",gap:n?2:0},children:[a?t.jsx("span",{children:a}):null,n?t.jsx("span",{id:N,style:{color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-xs)"},children:n}):null]}):null]})});function L(r){if(typeof r!="string")return;const a=r.trim();return a.length>0?a:void 0}function xe(r,a){try{return r.matches(":focus-visible")||a}catch{return a}}c.__docgenInfo={description:"",methods:[],displayName:"Checkbox",props:{label:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},description:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},invalid:{required:!1,tsType:{name:"boolean"},description:""},indeterminate:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const Ce={title:"Form/Checkbox",component:c,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:"Checkbox supports label/description narration, indeterminate state, and invalid/disabled visual semantics."}}}};function ke(){const[r,a]=o.useState(!0);return t.jsxs("div",{style:{width:320,display:"grid",gap:10},children:[t.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[t.jsx("span",{style:{color:"var(--aurora-text-primary)"},children:"Current state"}),t.jsx(ye,{tone:r?"success":"danger",children:r?"Enabled":"Disabled"})]}),t.jsx(c,{"aria-label":"Enable AI memory",label:"Enable AI memory",description:"Persist short-term context between prompts.",checked:r,onChange:n=>a(n.currentTarget.checked)})]})}const x={render:()=>t.jsx(ke,{}),play:async({canvasElement:r})=>{const n=S(r).getByRole("checkbox",{name:"Enable AI memory"});await T.click(n),await i(n).not.toBeChecked()}},k={args:{"aria-label":"Select all rows",label:"Select all rows",description:"Some rows are already selected.",indeterminate:!0}},v={render:()=>t.jsxs("div",{style:{width:320,display:"grid",gap:14},children:[t.jsx(c,{"aria-label":"Terms agreement",label:"Terms agreement",description:"You must accept terms before continuing.",invalid:!0}),t.jsx(c,{"aria-label":"System lock",label:"System lock",description:"Controlled by organization policy.",disabled:!0,defaultChecked:!0})]})},f={render:()=>t.jsxs("div",{style:{width:320,display:"grid",gap:14},children:[t.jsx(c,{label:"Shortcut metadata checkbox",description:"Actionable checkboxes should expose Space shortcut hints."}),t.jsx(c,{label:"Blocked shortcut metadata checkbox",description:"Disabled checkboxes should not advertise keyboard shortcuts.",disabled:!0,defaultChecked:!0})]}),play:async({canvasElement:r})=>{const a=S(r);await i(a.getByRole("checkbox",{name:/^Shortcut metadata checkbox/})).toHaveAttribute("aria-keyshortcuts","Space"),await i(a.getByRole("checkbox",{name:/^Blocked shortcut metadata checkbox/})).not.toHaveAttribute("aria-keyshortcuts")}},g={render:()=>t.jsxs("div",{style:{width:320,display:"grid",gap:10},children:[t.jsx("p",{id:"checkbox-story-heading",style:{margin:0,color:"var(--aurora-text-primary)"},children:"Checkbox heading"}),t.jsx(c,{"aria-label":"Fallback checkbox name","aria-labelledby":"checkbox-story-heading",label:"Release gate",description:"aria-labelledby should remain canonical."})]}),play:async({canvasElement:r})=>{const n=S(r).getByRole("checkbox",{name:"Checkbox heading"});await i(n).toHaveAttribute("aria-labelledby","checkbox-story-heading"),await i(n).not.toHaveAttribute("aria-label")}},w={render:()=>t.jsxs("div",{style:{width:320,display:"grid",gap:10},children:[t.jsx("p",{style:{margin:0,color:"var(--aurora-text-secondary)",fontSize:13},children:"Click the trigger first, then press Tab to verify keyboard re-entry restores checkbox focus-visible state."}),t.jsx("button",{type:"button",children:"Before checkbox"}),t.jsx(c,{label:"Focus intent checkbox",description:"Keyboard re-entry should restore focus ring semantics."})]}),play:async({canvasElement:r})=>{const a=S(r),n=await a.findByRole("button",{name:"Before checkbox"}),p=a.getByRole("checkbox",{name:/^Focus intent checkbox/});await T.click(n),await T.tab(),await i(p).toHaveFocus(),await i(p).toHaveAttribute("data-focus-visible","true")}};var O,P,$;x.parameters={...x.parameters,docs:{...(O=x.parameters)==null?void 0:O.docs,source:{originalSource:`{
...
}`,...(ae=(te=g.parameters)==null?void 0:te.docs)==null?void 0:ae.source}}};var re,ne,oe;w.parameters={...w.parameters,docs:{...(re=w.parameters)==null?void 0:re.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 320,
    display: "grid",
    gap: 10
