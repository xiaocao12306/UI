...
}`,computed:!1}},onSortChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(key: string, direction: TableSortDirection) => void",signature:{arguments:[{type:{name:"string"},name:"key"},{type:{name:"union",raw:'"asc" | "desc"',elements:[{name:"literal",value:'"asc"'},{name:"literal",value:'"desc"'}]},name:"direction"}],return:{name:"void"}}},description:""}}};const g=[{id:"BTN-102",component:"Button",owner:"Design System",status:"ready"},{id:"DLG-210",component:"Dialog",owner:"Platform UI",status:"review"},{id:"AIP-501",component:"PromptInput",owner:"AI UX",status:"blocked"}],h=[{key:"id",header:"Issue",width:120,sortable:!0,rowHeader:!0},{key:"component",header:"Component",sortable:!0},{key:"owner",header:"Owner",sortable:!0},{key:"status",header:"Status",width:140,sortable:!0,sortAccessor:e=>e.status,render:e=>{const t=e.status==="ready"?"success":e.status==="review"?"default":"danger";return a.jsx(dt,{tone:t,children:e.status})}}],Rt={title:"Data/Table",tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:"Table accepts typed column definitions and custom cell renderers for status-heavy ops screens."}}}},A={render:()=>a.jsx("div",{style:{width:"min(100%, 780px)",display:"grid",gap:10},children:a.jsx(u,{caption:"Release readiness board",columns:h,data:g,rowKey:e=>e.id,defaultSortKey:"id"})})},j={render:()=>{const e=[...h,{key:"action",header:"Action",width:160,render:t=>a.jsx(lt,{size:"sm",variant:"outline",onClick:o=>o.preventDefault(),"aria-label":`Open ${t.id}`,children:"Open Ticket"})}];return a.jsx(u,{columns:e,data:g,rowKey:t=>t.id})}},E={render:()=>a.jsx("div",{style:{width:"min(100%, 780px)"},children:a.jsx(u,{columns:h,data:[],emptyContent:"No release items yet."})}),play:async({canvasElement:e})=>{const t=p(e),o=t.getByRole("button",{name:"Issue sort ascending"});await n(t.getByText("No release items yet.")).toBeInTheDocument(),await n(t.getByRole("status")).toHaveTextContent("No release items yet."),await n(o).toBeDisabled(),await n(o).not.toHaveAttribute("aria-keyshortcuts")}},K={render:()=>a.jsx("div",{style:{width:"min(100%, 780px)"},children:a.jsx(u,{columns:h,data:[{id:"BTN-102",component:"Button",owner:"Design System",status:"ready"}],defaultSortKey:"id"})}),play:async({canvasElement:e})=>{const t=p(e),o=t.getByRole("columnheader",{name:/Issue/});await n(o).not.toHaveAttribute("aria-sort"),await n(t.queryByRole("status")).not.toBeInTheDocument(),await n(t.getByRole("button",{name:"Issue sort descending"})).toBeDisabled()}},C={render:()=>a.jsx("div",{style:{width:"min(100%, 780px)"},children:a.jsx(u,{columns:h,data:g,loading:!0,loadingContent:"Syncing release feed...",defaultSortKey:"id"})}),play:async({canvasElement:e})=>{const t=p(e),o=t.getByRole("table",{name:"Data table"}),l=t.getByRole("button",{name:"Issue sort descending"}),w=t.getByRole("columnheader",{name:/Issue/});await n(o).toHaveAttribute("aria-busy","true"),await n(t.getByText("Syncing release feed...")).toBeInTheDocument(),await n(t.queryByRole("rowheader",{name:"BTN-102"})).not.toBeInTheDocument(),await n(l).toBeDisabled(),await n(l).not.toHaveAttribute("aria-keyshortcuts"),await n(w).not.toHaveAttribute("aria-sort")}},N={render:()=>a.jsx("div",{style:{width:"min(100%, 780px)"},children:a.jsx(u,{ariaLabel:"Release checklist table",columns:h,data:g,rowKey:e=>e.id})}),play:async({canvasElement:e})=>{const t=p(e);await n(t.getByRole("table",{name:"Release checklist table"})).toBeInTheDocument()}},q={render:()=>a.jsx("div",{style:{width:"min(100%, 780px)"},children:a.jsx(u,{columns:h,data:g,rowKey:e=>e.id})}),play:async({canvasElement:e})=>{const t=p(e);await n(t.getByRole("table",{name:"Data table"})).toBeInTheDocument()}},$={render:()=>a.jsxs("div",{style:{width:"min(100%, 780px)",display:"grid",gap:10},children:[a.jsx("h3",{id:"release-board-heading",style:{margin:0},children:"Release board metrics"}),a.jsx(u,{ariaLabelledBy:"release-board-heading",ariaLabel:"Fallback table label",columns:h,data:g,rowKey:e=>e.id})]}),play:async({canvasElement:e})=>{const o=p(e).getByRole("table",{name:"Release board metrics"});await n(o).toHaveAttribute("aria-labelledby","release-board-heading"),await n(o).not.toHaveAttribute("aria-label")}},L={render:()=>a.jsx("div",{style:{width:"min(100%, 780px)"},children:a.jsx(u,{columns:[{key:"component",header:"Component",rowHeader:!0,sortable:!0},{key:"owner",header:"Owner",sortable:!0},{key:"status",header:"Status",sortable:!0}],data:g,rowKey:e=>e.id,defaultSortKey:"component"})}),play:async({canvasElement:e})=>{const t=p(e);await n(t.getByRole("rowheader",{name:"Button"})).toBeInTheDocument(),await n(t.getByRole("rowheader",{name:"Dialog"})).toBeInTheDocument()}};function wt(){const[e,t]=x.useState("id asc");return a.jsxs("div",{style:{width:"min(100%, 780px)",display:"grid",gap:8},children:[a.jsxs("p",{style:{margin:0,color:"var(--aurora-text-secondary)"},children:["Active sort: ",a.jsx("strong",{style:{color:"var(--aurora-text-primary)"},children:e})]}),a.jsx(u,{columns:h,data:g,defaultSortKey:"id",onSortChange:(o,l)=>t(`${o} ${l}`)})]})}const V={render:()=>a.jsx(wt,{}),play:async({canvasElement:e})=>{const t=p(e),o=t.getByRole("button",{name:"Issue sort descending"});await n(o).toHaveAttribute("aria-keyshortcuts","Enter Space"),o.focus(),await S.keyboard("{Enter}"),await n(t.getByText("id desc")).toBeInTheDocument(),await n(t.getByRole("status")).toHaveTextContent("Sorted by Issue descending.");const l=t.getByRole("button",{name:"Issue sort ascending"}),w=l.closest("th");await n(w).toHaveAttribute("aria-sort","descending"),re.keyDown(l,{key:"Enter",repeat:!0}),await n(t.getByText("id desc")).toBeInTheDocument(),await n(w).toHaveAttribute("aria-sort","descending"),l.focus(),re.keyDown(l,{key:"Space",repeat:!0}),await n(t.getByText("id desc")).toBeInTheDocument(),await n(w).toHaveAttribute("aria-sort","descending"),await S.keyboard("{Space}"),await n(t.getByText("id asc")).toBeInTheDocument(),await n(w).toHaveAttribute("aria-sort","ascending"),await n(t.getByRole("status")).toHaveTextContent("Sorted by Issue ascending.")}},z={render:()=>a.jsx("div",{style:{width:"min(100%, 780px)"},children:a.jsx(u,{columns:h,data:g,defaultSortKey:"id",getSortAriaLabel:({columnHeader:e,nextDirection:t})=>`按${t==="asc"?"升序":"降序"}排序：${e}`,getSortStatusText:({columnHeader:e,direction:t})=>`当前排序：${e}（${t==="asc"?"升序":"降序"}）`})}),play:async({canvasElement:e})=>{const t=p(e),o=t.getByRole("button",{name:"按降序排序：Issue"});await n(t.getByRole("status")).toHaveTextContent("当前排序：Issue（升序）"),await S.click(o),await n(t.getByRole("button",{name:"按升序排序：Issue"})).toBeInTheDocument(),await n(t.getByRole("status")).toHaveTextContent("当前排序：Issue（降序）")}},F={render:()=>{const e=[{key:"component",header:"Component",sortable:!0},{key:"status",header:"Status",width:140}];return a.jsx("div",{style:{width:"min(100%, 620px)"},children:a.jsx(u,{columns:e,data:g,defaultSortKey:"status"})})},play:async({canvasElement:e})=>{const t=p(e),o=t.getByRole("columnheader",{name:"Component"}),l=t.getByRole("columnheader",{name:"Status"});await n(o).not.toHaveAttribute("aria-sort"),await n(l).not.toHaveAttribute("aria-sort"),await n(t.queryByRole("button",{name:/Status sort/})).not.toBeInTheDocument(),await n(t.getAllByRole("cell")[0]).toHaveTextContent("Button")}},Qe=g.map(e=>({...e,note:""})),Xe=[{key:"component",header:"Component",sortable:!0},{key:"note",header:"QA Note",render:e=>a.jsx("input",{defaultValue:e.note,"aria-label":`${e.id} note`,style:{width:"100%",borderRadius:6,border:"1px solid var(--aurora-border-default)",background:"var(--aurora-surface-default)",color:"var(--aurora-text-primary)",padding:"6px 8px"}})}],G={render:()=>a.jsx("div",{style:{width:"min(100%, 720px)"},children:a.jsx(u,{columns:Xe,data:Qe,defaultSortKey:"component"})}),play:async({canvasElement:e})=>{const t=p(e),o=t.getByRole("textbox",{name:"BTN-102 note"});await S.type(o,"persist me"),await S.click(t.getByRole("button",{name:"Component sort descending"})),await n(t.getByRole("textbox",{name:"BTN-102 note"})).toHaveValue("persist me")}},M={render:()=>a.jsx("div",{style:{width:"min(100%, 720px)"},children:a.jsx(u,{columns:Xe,data:Qe,defaultSortKey:"component",rowKey:(e,t)=>`${t}-${e.id}`})}),play:async({canvasElement:e})=>{const t=p(e),o=t.getByRole("textbox",{name:"BTN-102 note"});await S.type(o,"persist me"),await S.click(t.getByRole("button",{name:"Component sort descending"})),await n(t.getByRole("textbox",{name:"BTN-102 note"})).toHaveValue("persist me")}},bt=[{key:"Alpha",score:1},{key:"Beta",score:2},{key:"Gamma",score:3}],O={render:()=>a.jsxs("div",{style:{width:"min(100%, 720px)",display:"grid",gap:8},children:[a.jsx("p",{style:{margin:0,color:"var(--aurora-text-secondary)"},children:"`render(row, rowIndex, sourceIndex)` exposes both sorted row position and source-data position."}),a.jsx(u,{columns:[{key:"key",header:"Item",sortable:!0,render:(e,t,o)=>`${e.key} (visual:${t}, source:${o})`},{key:"score",header:"Score",sortable:!0}],data:bt,defaultSortKey:"score"})]}),play:async({canvasElement:e})=>{const t=p(e);await S.click(t.getByRole("button",{name:"Score sort descending"})),await n(t.getByRole("cell",{name:"Gamma (visual:0, source:2)"})).toBeInTheDocument(),await n(t.getByRole("cell",{name:"Alpha (visual:2, source:0)"})).toBeInTheDocument()}};var oe,se,ie;A.parameters={...A.parameters,docs:{...(oe=A.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render: () => <div style={{
    width: "min(100%, 780px)",
    display: "grid",
    gap: 10
...
}`,...(ge=(ve=K.parameters)==null?void 0:ve.docs)==null?void 0:ge.source}}};var we,be,xe;C.parameters={...C.parameters,docs:{...(we=C.parameters)==null?void 0:we.docs,source:{originalSource:`{
  render: () => <div style={{
    width: "min(100%, 780px)"
  }}>
...
}`,...(xe=(be=C.parameters)==null?void 0:be.docs)==null?void 0:xe.source}}};var he,fe,Se;N.parameters={...N.parameters,docs:{...(he=N.parameters)==null?void 0:he.docs,source:{originalSource:`{
  render: () => <div style={{
    width: "min(100%, 780px)"
  }}>
