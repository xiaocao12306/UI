import{j as o}from"./jsx-runtime-BjG_zV1W.js";import{r}from"./index-BWu4c2F4.js";import{B as H}from"./Button-COG9o64O.js";import{P as Ia}from"./Popover-D0i9U560.js";import{D as Sa}from"./Dialog-I_j2Ms3q.js";import{I as Aa}from"./Input-o58Aer5Z.js";import{within as p,userEvent as i,expect as a,fireEvent as x,waitFor as L}from"./index-DgAF9SIF.js";import{b as h,s as w,a as v}from"./storyShowcase-Bw5VyCj0.js";import"./DismissableLayer-CvOMiBFU.js";import"./bodyScrollLock-D0vp0S5S.js";import"./index-DlVbWVVj.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";function m({open:n,onOpenChange:e,commands:t,title:c="Command Palette",description:l="Quickly search and execute workspace actions.",searchAriaLabel:u="Search commands",resultsAriaLabel:b="Command results",closeOnSelect:B=!0,clearQueryOnEscape:j=!0,closeOnEscape:K=!0,closeOnOutsidePointer:Ie=!0,onEscapeKeyDown:he,onPointerDownOutside:fe,closeLabel:xa,placeholder:ha="Search commands...",loading:T=!1,loadingContent:ke="Loading commands...",emptyMessage:fa="No commands found.",onQueryChange:E,onCloseReason:D,getResultsStatusText:Se=ja}){const[R,Be]=r.useState(""),[U,C]=r.useState(0),ka=r.useRef(null),q=r.useRef(null),$=r.useRef(null),Ae=r.useRef(n);r.useRef(null),r.useRef(null),r.useRef(null);const O=r.useId(),Pe=r.useId(),He=r.useRef(null),Ba=V(u,"Search commands"),Ea=V(b,"Command results"),Ca=V(xa,"Close dialog"),je=r.useMemo(()=>Oa(ke),[ke]),F=r.useCallback(s=>{$.current=s,D==null||D(s)},[D]),Oe=r.useCallback(s=>{F(s),e(!1),$.current=null},[F,e]),Ta=r.useCallback(s=>{!s&&n&&$.current===null&&(D==null||D("close-button")),$.current=null,e(s)},[D,e,n]);r.useEffect(()=>{!n&&Ae.current&&(Be(s=>(s.length>0&&(E==null||E("")),"")),C(0)),Ae.current=n},[E,n]),r.useEffect(()=>{},[t]),r.useEffect(()=>{},[t]),r.useEffect(()=>{},[t]);const Ee=r.useMemo(()=>Ue(R.trim()),[R]),y=r.useMemo(()=>Ee?t.filter(s=>{const g=[Pa(s),...s.keywords??[]].join(" ");return Ue(g).includes(Ee)}):t,[t,Ee]),M=r.useMemo(()=>y.reduce((s,d)=>d.disabled?s:s+1,0),[y]),I=!T&&M>1,qe=!T&&M>0,Ce=!T&&y.length>0,Da=r.useMemo(()=>{const s=[];return I&&s.push("ArrowDown","ArrowUp","Home","End","PageDown","PageUp"),qe&&s.push("Enter"),(K||j&&R.length>0)&&s.push("Escape"),s.length>0?s.join(" "):void 0},[qe,I,j,K,R.length]),Ra=r.useMemo(()=>T?je:Se({query:R,visibleCount:y.length,enabledCount:M,totalCount:t.length}),[t.length,M,y.length,Se,T,R,je]),S=r.useMemo(()=>y.reduce((s,d,g)=>(d.disabled||s.push(g),s),[]),[y]),A=S[0]??-1,Le=S[S.length-1]??-1,k=r.useMemo(()=>{if(U<0)return-1;const s=y[U];return!s||s.disabled?-1:U},[U,y]);r.useEffect(()=>{var d;if(y.length===0){q.current=null,C(-1);return}const s=q.current;if(s){const g=y.findIndex(P=>!P.disabled&&P.key===s);if(g>=0){C(g);return}}C(A),q.current=A>=0?((d=y[A])==null?void 0:d.key)??null:null},[y,A]),r.useEffect(()=>{var s;if(k<0){q.current=null;return}q.current=((s=y[k])==null?void 0:s.key)??null},[y,k]),r.useEffect(()=>{if(!n||k<0)return;const s=He.current;if(!s)return;const d=s.ownerDocument.getElementById(`${O}-option-${k}`);!d||!s.contains(d)||typeof d.scrollIntoView=="function"&&d.scrollIntoView({block:"nearest"})},[O,n,k]);const Te=r.useCallback(s=>{var g;const d=y[s];!d||d.disabled||((g=d.onSelect)==null||g.call(d),B&&Oe("item-select"))},[B,Oe,y]),Ne=s=>{var g;if(y.length===0)return;let d=k<0?s===1?-1:0:k;for(let P=0;P<y.length;P+=1)if(d=(d+s+y.length)%y.length,!((g=y[d])!=null&&g.disabled)){C(d);return}},Ke=s=>{if(S.length===0)return;const d=S.indexOf(k);if(d<0){C(s===1?A:Le);return}const g=Math.min(S.length-1,Math.max(0,d+s*5));C(S[g]??A)};return o.jsx(Sa,{open:n,onOpenChange:Ta,title:c,description:l,closeLabel:Ca,size:"md",closeOnEscape:K,closeOnOutsidePointer:Ie,onEscapeKeyDown:s=>{he==null||he(s),!(s.defaultPrevented||!K)&&F("escape-key")},onPointerDownOutside:s=>{fe==null||fe(s),!(s.defaultPrevented||!Ie)&&F("outside-pointer")},children:o.jsxs("div",{style:{display:"grid",gap:10},children:[o.jsx(Aa,{ref:ka,"data-autofocus":"",role:"combobox","aria-busy":T||void 0,"aria-expanded":Ce,"aria-haspopup":"listbox","aria-autocomplete":"list","aria-controls":Ce?O:void 0,"aria-activedescendant":!T&&k>=0?`${O}-option-${k}`:void 0,"aria-describedby":Pe,"aria-keyshortcuts":Da,placeholder:ha,value:R,onChange:s=>{Be(s.target.value),E==null||E(s.target.value)},onKeyDown:s=>{if(!Ha(s)&&!(s.altKey||s.ctrlKey||s.metaKey)){if(s.key==="Escape"){if(s.repeat)return;j&&R.length>0&&(s.preventDefault(),Be(""),E==null||E(""));return}if(s.key==="ArrowDown"){if(!I)return;s.preventDefault(),Ne(1);return}if(s.key==="ArrowUp"){if(!I)return;s.preventDefault(),Ne(-1);return}if(s.key==="Home"){if(!I)return;s.preventDefault(),C(A);return}if(s.key==="End"){if(!I)return;s.preventDefault(),C(Le);return}if(s.key==="PageDown"){if(!I)return;s.preventDefault(),Ke(1);return}if(s.key==="PageUp"){if(!I)return;s.preventDefault(),Ke(-1);return}if(s.key==="Enter"&&!T&&k>=0){if(s.preventDefault(),s.repeat)return;Te(k)}}},"aria-label":Ba}),o.jsx("p",{id:Pe,role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:Ra}),T?o.jsx("p",{"data-testid":"command-palette-loading-content",style:{margin:0,color:"var(--aurora-text-secondary)"},children:ke}):Ce?o.jsx("div",{id:O,ref:He,role:"listbox","aria-label":Ea,style:{maxHeight:280,overflow:"auto",display:"grid",gap:4},children:y.map((s,d)=>{const g=d===k,P=V(s.ariaLabel);return o.jsx("div",{id:`${O}-option-${d}`,role:"option","aria-selected":g,"aria-disabled":s.disabled||void 0,"aria-label":P,"aria-keyshortcuts":s.disabled?void 0:"Enter Space","aria-posinset":d+1,"aria-setsize":y.length,tabIndex:-1,onPointerDown:f=>{f.pointerType==="mouse"||f.button!==0||f.preventDefault()},onMouseDown:f=>{f.button===0&&f.preventDefault()},onMouseEnter:()=>{s.disabled||C(d)},onClick:()=>{s.disabled||Te(d)},onKeyDown:f=>{if(!s.disabled&&!(f.altKey||f.ctrlKey||f.metaKey)&&(f.key==="Enter"||f.key===" "||f.key==="Space"||f.key==="Spacebar")){if(f.preventDefault(),f.repeat)return;Te(d)}},style:{border:"1px solid var(--aurora-border-default)",background:g?"color-mix(in srgb, var(--aurora-accent-default) 14%, var(--aurora-surface-default))":"var(--aurora-surface-default)",color:s.disabled?"color-mix(in srgb, var(--aurora-text-secondary) 60%, transparent)":"var(--aurora-text-primary)",borderRadius:8,height:36,padding:"0 10px",textAlign:"left",cursor:s.disabled?"not-allowed":"pointer"},children:s.label},s.key)})}):o.jsx("p",{style:{margin:0,color:"var(--aurora-text-secondary)"},children:fa})]})})}function Pa(n){if(typeof n.textValue=="string"){const e=N(n.textValue);if(e.length>0)return e}return N(xe(n.label))}function Ue(n){return n.normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/\s+/g," ").trim().toLowerCase()}function Ha(n){const e=n.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function ja({query:n,visibleCount:e,enabledCount:t,totalCount:c}){const l=n.trim();return l.length===0?t!==c?`${t} of ${c} command${c===1?"":"s"} available.`:`${c} command${c===1?"":"s"} available.`:e===0?`No commands match "${l}".`:t===0?`No enabled commands match "${l}".`:t!==e?`${t} of ${e} matching command${t===1?"":"s"} available for "${l}".`:`${e} command${e===1?"":"s"} found for "${l}".`}function Oa(n){const e=N(xe(n));return e.length>0?e:"Loading commands..."}function xe(n){if(typeof n=="string")return n;if(typeof n=="number")return String(n);if(Array.isArray(n))return N(n.map(t=>xe(t)).filter(t=>t.length>0).join(" "));if(!r.isValidElement(n))return"";const e=n.props;return e["aria-hidden"]===!0||e["aria-hidden"]==="true"?"":typeof e["aria-label"]=="string"&&e["aria-label"].trim().length>0?N(e["aria-label"]):xe(e.children)}function V(n,e){return typeof n=="string"&&n.trim().length>0?n.trim():e}function N(n){return n.replace(/\s+/g," ").trim()}m.__docgenInfo={description:"",methods:[],displayName:"CommandPalette",props:{open:{required:!0,tsType:{name:"boolean"},description:""},onOpenChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""},commands:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: string;
...
}`,...(Lt=(qt=ce.parameters)==null?void 0:qt.docs)==null?void 0:Lt.source}}};var Nt,Kt,Ut;ie.parameters={...ie.parameters,docs:{...(Nt=ie.parameters)==null?void 0:Nt.docs,source:{originalSource:`{
...
}`,...(Ut=(Kt=ie.parameters)==null?void 0:Kt.docs)==null?void 0:Ut.source}}};var $t,Ft,Mt;le.parameters={...le.parameters,docs:{...($t=le.parameters)==null?void 0:$t.docs,source:{originalSource:`{
