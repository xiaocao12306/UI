import{j as t}from"./jsx-runtime-BjG_zV1W.js";import{r as c}from"./index-BWu4c2F4.js";import{a as me}from"./a11y-CU5SQrEA.js";import{B as ye}from"./Badge-ZJmMstsz.js";import{within as S,userEvent as T,expect as i,fireEvent as xe}from"./index-DgAF9SIF.js";const s=c.forwardRef(function({label:a,description:n,invalid:l,indeterminate:C=!1,disabled:b,style:oe,onFocus:E,onBlur:B,onMouseDown:j,onPointerDown:R,onKeyDown:A,"aria-invalid":se,"aria-label":ie,"aria-labelledby":le,"aria-keyshortcuts":de,...I},h){const[F,H]=c.useState(!1),[K,p]=c.useState(!1),m=c.useRef(null),d=c.useRef(!1),z=c.useId(),N=me(l,se),V=N!==void 0,y=!!b,q=L(le),ue=q?void 0:L(ie),be=y?void 0:L(de)??"Space",he=[I["aria-describedby"],n?z:void 0].filter(Boolean).join(" ")||void 0;c.useEffect(()=>{y&&(H(!1),p(!1))},[y]),c.useEffect(()=>{var Y;const e=((Y=m.current)==null?void 0:Y.ownerDocument)??document,_=o=>{o.metaKey||o.altKey||o.ctrlKey||(d.current=!0)},u=o=>{"button"in o&&typeof o.button=="number"&&o.button!==0||"ctrlKey"in o&&o.ctrlKey||(d.current=!1)};return e.addEventListener("keydown",_,!0),e.addEventListener("pointerdown",u,!0),e.addEventListener("mousedown",u,!0),e.addEventListener("touchstart",u,!0),()=>{e.removeEventListener("keydown",_,!0),e.removeEventListener("pointerdown",u,!0),e.removeEventListener("mousedown",u,!0),e.removeEventListener("touchstart",u,!0)}},[]),c.useEffect(()=>{m.current&&(m.current.indeterminate=C)},[C]);const pe=c.useCallback(e=>{m.current=e,typeof h=="function"?h(e):h&&(h.current=e)},[h]);return t.jsxs("label",{style:{display:"inline-flex",alignItems:"flex-start",gap:10,color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",cursor:b?"not-allowed":"pointer",opacity:b?.75:1,...oe},children:[t.jsx("input",{...I,ref:pe,type:"checkbox",disabled:b,"aria-label":ue,"aria-labelledby":q,"aria-invalid":N,"aria-checked":C?"mixed":I["aria-checked"],"aria-describedby":he,"aria-keyshortcuts":be,"data-focused":F?"true":void 0,"data-focus-visible":K?"true":void 0,style:{margin:"2px 0 0",width:16,height:16,accentColor:V?"var(--aurora-color-red-500)":"var(--aurora-accent-default)",cursor:b?"not-allowed":"pointer",boxShadow:F&&K&&!y?`0 0 0 3px ${V?"color-mix(in srgb, var(--aurora-color-red-500) 24%, transparent)":"color-mix(in srgb, var(--aurora-accent-default) 24%, transparent)"}`:"none"},onFocus:e=>{H(!0),p(ke(e.currentTarget,d.current)),E==null||E(e)},onBlur:e=>{H(!1),p(!1),B==null||B(e)},onMouseDown:e=>{e.button===0&&!e.ctrlKey&&(d.current=!1,p(!1)),j==null||j(e)},onPointerDown:e=>{e.button===0&&!e.ctrlKey&&(d.current=!1,p(!1)),R==null||R(e)},onKeyDown:e=>{d.current=!0,A==null||A(e)}}),a||n?t.jsxs("span",{style:{display:"grid",gap:n?2:0},children:[a?t.jsx("span",{children:a}):null,n?t.jsx("span",{id:z,style:{color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-xs)"},children:n}):null]}):null]})});function L(r){if(typeof r!="string")return;const a=r.trim();return a.length>0?a:void 0}function ke(r,a){try{return r.matches(":focus-visible")||a}catch{return a}}s.__docgenInfo={description:"",methods:[],displayName:"Checkbox",props:{label:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},description:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},invalid:{required:!1,tsType:{name:"boolean"},description:""},indeterminate:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const Ee={title:"Form/Checkbox",component:s,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:"Checkbox supports label/description narration, indeterminate state, and invalid/disabled visual semantics."}}}};function ve(){const[r,a]=c.useState(!0);return t.jsxs("div",{style:{width:320,display:"grid",gap:10},children:[t.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[t.jsx("span",{style:{color:"var(--aurora-text-primary)"},children:"Current state"}),t.jsx(ye,{tone:r?"success":"danger",children:r?"Enabled":"Disabled"})]}),t.jsx(s,{"aria-label":"Enable AI memory",label:"Enable AI memory",description:"Persist short-term context between prompts.",checked:r,onChange:n=>a(n.currentTarget.checked)})]})}const x={render:()=>t.jsx(ve,{}),play:async({canvasElement:r})=>{const n=S(r).getByRole("checkbox",{name:"Enable AI memory"});await T.click(n),await i(n).not.toBeChecked()}},k={args:{"aria-label":"Select all rows",label:"Select all rows",description:"Some rows are already selected.",indeterminate:!0}},v={render:()=>t.jsxs("div",{style:{width:320,display:"grid",gap:14},children:[t.jsx(s,{"aria-label":"Terms agreement",label:"Terms agreement",description:"You must accept terms before continuing.",invalid:!0}),t.jsx(s,{"aria-label":"System lock",label:"System lock",description:"Controlled by organization policy.",disabled:!0,defaultChecked:!0})]})},f={render:()=>t.jsxs("div",{style:{width:320,display:"grid",gap:14},children:[t.jsx(s,{label:"Shortcut metadata checkbox",description:"Actionable checkboxes should expose Space shortcut hints."}),t.jsx(s,{label:"Blocked shortcut metadata checkbox",description:"Disabled checkboxes should not advertise keyboard shortcuts.",disabled:!0,defaultChecked:!0})]}),play:async({canvasElement:r})=>{const a=S(r);await i(a.getByRole("checkbox",{name:/^Shortcut metadata checkbox/})).toHaveAttribute("aria-keyshortcuts","Space"),await i(a.getByRole("checkbox",{name:/^Blocked shortcut metadata checkbox/})).not.toHaveAttribute("aria-keyshortcuts")}},g={render:()=>t.jsxs("div",{style:{width:320,display:"grid",gap:10},children:[t.jsx("p",{id:"checkbox-story-heading",style:{margin:0,color:"var(--aurora-text-primary)"},children:"Checkbox heading"}),t.jsx(s,{"aria-label":"Fallback checkbox name","aria-labelledby":"checkbox-story-heading",label:"Release gate",description:"aria-labelledby should remain canonical."})]}),play:async({canvasElement:r})=>{const n=S(r).getByRole("checkbox",{name:"Checkbox heading"});await i(n).toHaveAttribute("aria-labelledby","checkbox-story-heading"),await i(n).not.toHaveAttribute("aria-label")}},w={render:()=>t.jsxs("div",{style:{width:320,display:"grid",gap:10},children:[t.jsx("p",{style:{margin:0,color:"var(--aurora-text-secondary)",fontSize:13},children:"Click the trigger first, then press Tab to verify keyboard re-entry restores checkbox focus-visible state."}),t.jsx("button",{type:"button",children:"Before checkbox"}),t.jsx(s,{label:"Focus intent checkbox",description:"Keyboard re-entry should restore focus ring semantics."})]}),play:async({canvasElement:r})=>{const a=S(r),n=await a.findByRole("button",{name:"Before checkbox"}),l=a.getByRole("checkbox",{name:/^Focus intent checkbox/});await T.click(n),await T.tab(),await i(l).toHaveFocus(),await i(l).toHaveAttribute("data-focus-visible","true"),xe.mouseDown(l,{button:0,ctrlKey:!0}),await i(l).toHaveAttribute("data-focus-visible","true")}};var D,O,P;x.parameters={...x.parameters,docs:{...(D=x.parameters)==null?void 0:D.docs,source:{originalSource:`{
...
}`,...(P=(O=x.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};var $,G,J;k.parameters={...k.parameters,docs:{...($=k.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
...
}`,...(M=(Z=f.parameters)==null?void 0:Z.docs)==null?void 0:M.source}}};var ee,te,ae;g.parameters={...g.parameters,docs:{...(ee=g.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 320,
    display: "grid",
    gap: 10
