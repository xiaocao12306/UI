import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{B as Wa}from"./Button-BMxlc9Nj.js";import{r as u}from"./index-BWu4c2F4.js";import{B as Na}from"./Badge-ZJmMstsz.js";import{within as y,expect as n,userEvent as l,fireEvent as h,waitFor as Ge}from"./index-DgAF9SIF.js";import{S as m,s as E,a as Ee}from"./storyShowcase-Bw5VyCj0.js";const Pa="Enter Space Home End PageDown PageUp ArrowLeft ArrowRight",qa=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"}),Ye=400;function _e(t,e,o){if(!e)return null;const s=t.find(S=>String(S.key)===e);return s!=null&&s.sortable?{key:e,direction:o}:null}function Je(t,e){if(typeof t.sortLabel=="string"&&t.sortLabel.trim().length>0)return t.sortLabel.trim();const o=Ie(Ae(t.header));return o.length>0?o:e}function d({columns:t,data:e,rowKey:o,caption:s,ariaLabel:S,ariaLabelledBy:fe,loading:T=!1,loadingContent:F="Loading data...",emptyContent:A="No data available.",defaultSortKey:B,defaultSortDirection:O="asc",getSortAriaLabel:Ta=Qe,getSortStatusText:Ce=$a,onSortChange:Be}){const U=He(fe),Ke=U?void 0:He(S,s?void 0:"Data table"),L=u.useRef({}),je=u.useRef(null),Re=u.useRef(null),z=u.useRef(0),W=u.useRef(null),G=u.useRef(null),q=u.useRef(!0);u.useRef(null),u.useRef(null),u.useRef(null);const[Da,ke]=u.useState(null),[Ha,K]=u.useState(null),[Aa,$]=u.useState(null);u.useEffect(()=>{var x;const c=((x=je.current)==null?void 0:x.ownerDocument)??document,i=p=>{p.metaKey||p.altKey||p.ctrlKey||(q.current=!0)},b=()=>{q.current=!1};return c.addEventListener("keydown",i,!0),c.addEventListener("pointerdown",b,!0),c.addEventListener("mousedown",b,!0),c.addEventListener("touchstart",b,!0),()=>{c.removeEventListener("keydown",i,!0),c.removeEventListener("pointerdown",b,!0),c.removeEventListener("mousedown",b,!0),c.removeEventListener("touchstart",b,!0)}},[]);const Y=u.useCallback(()=>{Re.current=null,z.current=0,W.current!==null&&((G.current??window).clearTimeout(W.current),W.current=null),G.current=null},[]);u.useEffect(()=>()=>{Y()},[Y]);const[w,Te]=u.useState(()=>_e(t,B,O)),I=u.useMemo(()=>T||e.length<=1?[]:t.reduce((c,i)=>(i.sortable&&c.push(String(i.key)),c),[]),[t,e.length,T]);u.useEffect(()=>{if(!w)return;const c=t.find(i=>String(i.key)===w.key);c!=null&&c.sortable||Te(null)},[t,w]),u.useEffect(()=>{if(w)return;const c=_e(t,B,O);c&&Te(c)},[t,O,B,w]);const Ia=u.useMemo(()=>e.map((c,i)=>String(o?o(c,i):i)),[e,o]);u.useEffect(()=>{},[o,Ia]),u.useEffect(()=>{},[t]),u.useEffect(()=>{},[t]);const N=u.useMemo(()=>{const c=e.map((x,p)=>({row:x,sourceIndex:p}));if(!w)return c;const i=t.find(x=>String(x.key)===w.key);if(!(i!=null&&i.sortable))return c;const b=i.sortAccessor??(x=>{const p=x[String(i.key)];return p instanceof Date||typeof p=="number"||typeof p=="string"?p:String(p??"")});return c.sort((x,p)=>{const v=b(x.row),H=b(p.row);if(typeof v=="string"&&typeof H=="string"){const C=qa.compare(v,H);return C!==0?w.direction==="asc"?C:-C:x.sourceIndex-p.sourceIndex}const j=v instanceof Date?v.getTime():v,V=H instanceof Date?H.getTime():H;return j<V?w.direction==="asc"?-1:1:j>V?w.direction==="asc"?1:-1:x.sourceIndex-p.sourceIndex})},[t,e,w]),Fe=u.useMemo(()=>{if(T||N.length<=1||!w)return"";const c=t.find(b=>String(b.key)===w.key);if(!(c!=null&&c.sortable))return"";const i=Je(c,String(c.key));return Ce({columnKey:w.key,columnHeader:i,direction:w.direction})},[t,Ce,T,w,N.length]),M=!T&&N.length>1&&t.some(c=>c.sortable),Le=Math.max(t.length,1);return u.useEffect(()=>{M||(ke(null),K(null),$(null))},[M]),a.jsxs("div",{ref:je,"data-aurora-table-scroll-container":"",tabIndex:M?void 0:0,"aria-label":M||U?void 0:Ke??"Data table scroll container","aria-labelledby":M?void 0:U,style:{border:"1px solid var(--aurora-border-default)",borderRadius:"var(--aurora-radius-md)",overflow:"auto"},children:[Fe?a.jsx("p",{role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:Fe}):null,a.jsxs("table",{"aria-label":Ke,"aria-labelledby":U,"aria-busy":T||void 0,style:{width:"100%",borderCollapse:"collapse",minWidth:560},children:[s?a.jsx("caption",{style:{textAlign:"left",padding:"10px 12px",color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-sm)",borderBottom:"1px solid var(--aurora-border-default)"},children:s}):null,a.jsx("thead",{children:a.jsx("tr",{children:t.map(c=>{const i=String(c.key),b=!!c.sortable,x=N.length>1,p=b&&(w==null?void 0:w.key)===i?w.direction:void 0,v=!T&&x?p:void 0,H=v?v==="asc"?"ascending":"descending":void 0,j=c.align??"left",V=Je(c,i),C=p==="asc"?"desc":"asc",Ea=Ta({columnKey:i,columnHeader:V,nextDirection:C}),Ca=He(Ea,Qe({columnHeader:V,nextDirection:C})),D=T||!x,We=!D&&Da===i,Ne=!D&&Ha===i,Pe=!D&&Aa===i,Ka=We||Pe,qe=()=>{D||(Te({key:i,direction:C}),Be==null||Be(i,C))};return a.jsx("th",{scope:"col","aria-sort":H,style:{textAlign:j,color:"var(--aurora-text-secondary)",background:"var(--aurora-surface-elevated)",borderBottom:"1px solid var(--aurora-border-default)",padding:"10px 12px",fontSize:"var(--aurora-font-size-sm)",fontWeight:"var(--aurora-font-weight-medium)",width:c.width},children:b?a.jsxs("button",{"data-aurora-reduced-motion":"transition",type:"button",ref:r=>{L.current[i]=r},"aria-label":Ca,"aria-keyshortcuts":D?void 0:Pa,disabled:D,onClick:r=>{const R=Date.now()-z.current,_=r.detail===0&&Re.current===i&&z.current>0&&R<=Ye;Y(),!_&&qe()},onMouseEnter:()=>{D||ke(i)},onMouseLeave:()=>{ke(r=>r===i?null:r),K(r=>r===i?null:r)},onMouseDown:r=>{D||r.button===0&&(q.current=!1,$(R=>R===i?null:R),K(i))},onMouseUp:r=>{r.button===0&&K(R=>R===i?null:R)},onFocus:()=>{if(D){$(r=>r===i?null:r);return}$(r=>Va(L.current[i],q.current)?i:r===i?null:r)},onBlur:()=>{$(r=>r===i?null:r),K(r=>r===i?null:r)},onKeyDown:r=>{var _,$e,Me,Ve,Oe;if(q.current=!0,r.altKey||r.ctrlKey||r.metaKey)return;if(r.key==="Home"){const k=I[0];if(!k)return;r.preventDefault(),(_=L.current[k])==null||_.focus();return}if(r.key==="End"){const k=I[I.length-1];if(!k)return;r.preventDefault(),($e=L.current[k])==null||$e.focus();return}if(r.key==="PageDown"||r.key==="PageUp"){const k=I.indexOf(i);if(k<0)return;const Ue=r.key==="PageDown"?1:-1,P=Math.max(0,Math.min(I.length-1,k+Ue));if(P===k)return;r.preventDefault();const De=I[P];(Me=L.current[De])==null||Me.focus();return}if(r.key==="ArrowLeft"||r.key==="ArrowRight"){const k=I.indexOf(i);if(k<0)return;const P=(r.currentTarget.ownerDocument.defaultView??window).getComputedStyle(r.currentTarget).direction,De=(Ve=r.currentTarget.closest("[dir]"))==null?void 0:Ve.getAttribute("dir"),ja=(P==="rtl"||P==="ltr"?P:De==="rtl"?"rtl":"ltr")==="rtl"?"ArrowLeft":"ArrowRight",Fa=r.key===ja?1:-1,ze=Math.max(0,Math.min(I.length-1,k+Fa));if(ze===k)return;r.preventDefault();const La=I[ze];(Oe=L.current[La])==null||Oe.focus();return}if(!Xe(r.key)||Ma(r)||(r.preventDefault(),r.repeat))return;K(i),Re.current=i,z.current=Date.now();const R=r.currentTarget.ownerDocument.defaultView??window;W.current!==null&&(G.current??R).clearTimeout(W.current),G.current=R,W.current=R.setTimeout(()=>{Y()},Ye),qe()},onKeyUp:r=>{r.altKey||r.ctrlKey||r.metaKey||Xe(r.key)&&K(R=>R===i?null:R)},style:{border:Ka?"1px solid color-mix(in srgb, var(--aurora-accent-default) 48%, transparent)":"1px solid transparent",borderRadius:"var(--aurora-radius-sm)",background:Ne?"color-mix(in srgb, var(--aurora-surface-elevated) 68%, var(--aurora-surface-default))":We?"color-mix(in srgb, var(--aurora-surface-elevated) 86%, var(--aurora-surface-default))":"transparent",font:"inherit",cursor:D?"not-allowed":"pointer",display:"inline-flex",alignItems:"center",gap:6,padding:"2px 6px",color:D?"color-mix(in srgb, var(--aurora-text-secondary) 88%, var(--aurora-text-primary))":"inherit",boxShadow:Pe?"0 0 0 3px color-mix(in srgb, var(--aurora-focus-ring) 42%, transparent)":"none",transform:Ne?"translateY(1px)":"translateY(0)",transition:"background-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), border-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), box-shadow var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), transform var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard)"},children:[c.header,a.jsx("span",{"aria-hidden":"true",children:v==="asc"?"▲":v==="desc"?"▼":"↕"})]}):c.header},i)})})}),a.jsx("tbody",{children:T?a.jsx("tr",{children:a.jsx("td",{colSpan:Le,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:F})})}):N.length===0?a.jsx("tr",{children:a.jsx("td",{colSpan:Le,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:A})})}):N.map((c,i)=>{const b=c.row,x=String(c.sourceIndex),p=o?o(b,c.sourceIndex):x;return a.jsx("tr",{style:{background:i%2===0?"transparent":"var(--aurora-surface-elevated)"},children:t.map(v=>{const H=v.render?v.render(b,i,c.sourceIndex):String(b[String(v.key)]??""),j={padding:"10px 12px",borderBottom:"1px solid var(--aurora-border-default)",color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",textAlign:v.align??"left"};return v.rowHeader?a.jsx("th",{scope:"row",style:{...j,fontWeight:"var(--aurora-font-weight-medium)"},children:H},String(v.key)):a.jsx("td",{style:j,children:H},String(v.key))})},p)})})]})]})}function Qe({columnHeader:t,nextDirection:e}){return`${t} sort ${e==="asc"?"ascending":"descending"}`}function $a({columnHeader:t,direction:e}){return`Sorted by ${t} ${e==="asc"?"ascending":"descending"}.`}function Xe(t){return t==="Enter"||t===" "||t==="Space"||t==="Spacebar"}function Ma(t){const e=t.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function Va(t,e){if(!t)return e;try{return t.matches(":focus-visible")}catch{return e}}function Ae(t){if(typeof t=="string")return t;if(typeof t=="number")return String(t);if(Array.isArray(t))return Ie(t.map(o=>Ae(o)).filter(o=>o.length>0).join(" "));if(!u.isValidElement(t))return"";const e=t.props;if(e["aria-hidden"]===!0||e["aria-hidden"]==="true")return"";if(typeof e["aria-label"]=="string"){const o=Ie(e["aria-label"]);if(o.length>0)return o}return Ae(e.children)}function Ie(t){return t.replace(/\s+/g," ").trim()}function He(t,e){return typeof t=="string"&&t.trim().length>0?t.trim():e}d.__docgenInfo={description:"",methods:[],displayName:"Table",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: keyof T | string;
...
}`,...(Ct=(Et=se.parameters)==null?void 0:Et.docs)==null?void 0:Ct.source}}};var Kt,jt,Ft;ie.parameters={...ie.parameters,docs:{...(Kt=ie.parameters)==null?void 0:Kt.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 780px)">
...
}`,...(Ft=(jt=ie.parameters)==null?void 0:jt.docs)==null?void 0:Ft.source}}};var Lt,Wt,Nt;ce.parameters={...ce.parameters,docs:{...(Lt=ce.parameters)==null?void 0:Lt.docs,source:{originalSource:`{
