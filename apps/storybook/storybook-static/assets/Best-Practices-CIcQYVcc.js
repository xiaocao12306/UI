...
`,e.jsxs(s.li,{children:["Keep ",e.jsx(s.code,{children:"items[].key"})," stable across rerenders/reordering; tab and panel id refs are key-derived, so changing keys at runtime forces new accessibility relationships."]}),`
...
`,e.jsx(o,{of:Ts}),`
`,e.jsx(o,{of:Ps}),`
`,e.jsx(o,{of:Rs})]})}function wo(n={}){const{wrapper:s}={...r(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(i,{...n})}):i(n)}export{wo as default};
