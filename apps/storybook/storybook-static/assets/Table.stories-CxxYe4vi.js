import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{B as yt}from"./Button-BNFQVefv.js";import{r as h}from"./index-BWu4c2F4.js";import{B as pt}from"./Badge-ZJmMstsz.js";import{within as y,expect as n,userEvent as S,fireEvent as oe}from"./index-DgAF9SIF.js";const vt=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"});function gt(e,t,o){if(!t)return null;const l=e.find(b=>String(b.key)===t);return l!=null&&l.sortable?{key:t,direction:o}:null}function u({columns:e,data:t,rowKey:o,caption:l,ariaLabel:b,ariaLabelledBy:U,loading:R=!1,loadingContent:at="Loading data...",emptyContent:nt="No data available.",defaultSortKey:rt,defaultSortDirection:ot="asc",getSortAriaLabel:st=wt,getSortStatusText:Y=bt,onSortChange:P}){const it=U?void 0:b??(l?void 0:"Data table"),Q=h.useRef({}),_=h.useRef(!0),[ct,X]=h.useState(null),[lt,k]=h.useState(null),[dt,I]=h.useState(null),[d,J]=h.useState(()=>gt(e,rt,ot));h.useEffect(()=>{if(!d)return;const i=e.find(r=>String(r.key)===d.key);i!=null&&i.sortable||J(null)},[e,d]);const T=h.useMemo(()=>{const i=t.map((m,c)=>({row:m,sourceIndex:c}));if(!d)return i;const r=e.find(m=>String(m.key)===d.key);if(!(r!=null&&r.sortable))return i;const g=r.sortAccessor??(m=>{const c=m[String(r.key)];return c instanceof Date||typeof c=="number"||typeof c=="string"?c:String(c??"")});return i.sort((m,c)=>{const p=g(m.row),x=g(c.row);if(typeof p=="string"&&typeof x=="string"){const B=vt.compare(p,x);return B!==0?d.direction==="asc"?B:-B:m.sourceIndex-c.sourceIndex}const D=p instanceof Date?p.getTime():p,H=x instanceof Date?x.getTime():x;return D<H?d.direction==="asc"?-1:1:D>H?d.direction==="asc"?1:-1:m.sourceIndex-c.sourceIndex})},[e,t,d]),Z=h.useMemo(()=>{if(R||T.length<=1||!d)return"";const i=e.find(g=>String(g.key)===d.key);if(!(i!=null&&i.sortable))return"";const r=typeof i.header=="string"?i.header:String(i.key);return Y({columnKey:d.key,columnHeader:r,direction:d.direction})},[e,Y,R,d,T.length]),ee=Math.max(e.length,1);return a.jsxs("div",{style:{border:"1px solid var(--aurora-border-default)",borderRadius:"var(--aurora-radius-md)",overflow:"auto"},children:[Z?a.jsx("p",{role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:Z}):null,a.jsxs("table",{"aria-label":it,"aria-labelledby":U,"aria-busy":R||void 0,style:{width:"100%",borderCollapse:"collapse",minWidth:560},children:[l?a.jsx("caption",{style:{textAlign:"left",padding:"10px 12px",color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-sm)",borderBottom:"1px solid var(--aurora-border-default)"},children:l}):null,a.jsx("thead",{children:a.jsx("tr",{children:e.map(i=>{const r=String(i.key),g=!!i.sortable,m=T.length>1,c=g&&(d==null?void 0:d.key)===r?d.direction:void 0,p=!R&&m?c:void 0,x=p?p==="asc"?"ascending":"descending":void 0,D=i.align??"left",H=typeof i.header=="string"?i.header:r,B=c==="asc"?"desc":"asc",ut=st({columnKey:r,columnHeader:H,nextDirection:B}),f=R||!m,te=ct===r,ae=lt===r,ne=dt===r,mt=te||ne,re=()=>{f||(J({key:r,direction:B}),P==null||P(r,B))};return a.jsx("th",{scope:"col","aria-sort":x,style:{textAlign:D,color:"var(--aurora-text-secondary)",background:"var(--aurora-surface-elevated)",borderBottom:"1px solid var(--aurora-border-default)",padding:"10px 12px",fontSize:"var(--aurora-font-size-sm)",fontWeight:"var(--aurora-font-weight-medium)",width:i.width},children:g?a.jsxs("button",{type:"button",ref:s=>{Q.current[r]=s},"aria-label":ut,"aria-keyshortcuts":f?void 0:"Enter Space",disabled:f,onClick:re,onMouseEnter:()=>{f||X(r)},onMouseLeave:()=>{X(s=>s===r?null:s),k(s=>s===r?null:s)},onMouseDown:()=>{f||(_.current=!1,I(s=>s===r?null:s),k(r))},onMouseUp:()=>{k(s=>s===r?null:s)},onFocus:()=>{if(f){I(s=>s===r?null:s);return}I(s=>ft(Q.current[r],_.current)?r:s===r?null:s)},onBlur:()=>{I(s=>s===r?null:s),k(s=>s===r?null:s)},onKeyDown:s=>{_.current=!0,xt(s.key)&&(ht(s)||(s.preventDefault(),!s.repeat&&re()))},style:{border:mt?"1px solid color-mix(in srgb, var(--aurora-accent-default) 48%, transparent)":"1px solid transparent",borderRadius:"var(--aurora-radius-sm)",background:ae?"color-mix(in srgb, var(--aurora-surface-elevated) 68%, var(--aurora-surface-default))":te?"color-mix(in srgb, var(--aurora-surface-elevated) 86%, var(--aurora-surface-default))":"transparent",font:"inherit",cursor:f?"not-allowed":"pointer",display:"inline-flex",alignItems:"center",gap:6,padding:"2px 6px",color:f?"color-mix(in srgb, var(--aurora-text-secondary) 88%, var(--aurora-text-primary))":"inherit",boxShadow:ne?"0 0 0 3px color-mix(in srgb, var(--aurora-focus-ring) 42%, transparent)":"none",transform:ae?"translateY(1px)":"translateY(0)",transition:"background-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), border-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), box-shadow var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), transform var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard)"},children:[i.header,a.jsx("span",{"aria-hidden":"true",children:p==="asc"?"▲":p==="desc"?"▼":"↕"})]}):i.header},r)})})}),a.jsx("tbody",{children:R?a.jsx("tr",{children:a.jsx("td",{colSpan:ee,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:at})})}):T.length===0?a.jsx("tr",{children:a.jsx("td",{colSpan:ee,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:nt})})}):T.map((i,r)=>{const g=i.row,m=String(i.sourceIndex);return a.jsx("tr",{style:{background:r%2===0?"transparent":"var(--aurora-surface-elevated)"},children:e.map(c=>{const p=c.render?c.render(g,r,i.sourceIndex):String(g[String(c.key)]??""),x={padding:"10px 12px",borderBottom:"1px solid var(--aurora-border-default)",color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",textAlign:c.align??"left"};return c.rowHeader?a.jsx("th",{scope:"row",style:{...x,fontWeight:"var(--aurora-font-weight-medium)"},children:p},String(c.key)):a.jsx("td",{style:x,children:p},String(c.key))})},o?o(g,i.sourceIndex):m)})})]})]})}function wt({columnHeader:e,nextDirection:t}){return`${e} sort ${t==="asc"?"ascending":"descending"}`}function bt({columnHeader:e,direction:t}){return`Sorted by ${e} ${t==="asc"?"ascending":"descending"}.`}function xt(e){return e==="Enter"||e===" "||e==="Space"||e==="Spacebar"}function ht(e){const t=e.nativeEvent;return t.isComposing?!0:typeof t.keyCode=="number"&&t.keyCode===229}function ft(e,t){if(!e)return t;try{return e.matches(":focus-visible")}catch{return t}}u.__docgenInfo={description:"",methods:[],displayName:"Table",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: keyof T | string;
