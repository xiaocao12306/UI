...
`,e.jsxs(i.li,{children:["For dropdown typeahead, set ",e.jsx(i.code,{children:"textValue"})," when item labels are non-string or need locale-friendly matching aliases."]}),`
