import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{r}from"./index-BWu4c2F4.js";import{D as yt}from"./Dialog-Num8nDMQ.js";import{I as gt}from"./Input-B0g8SV4q.js";import{within as y,expect as s,userEvent as i,fireEvent as W}from"./index-DgAF9SIF.js";import"./bodyScrollLock-DtRy56KP.js";import"./index-DlVbWVVj.js";import"./DismissableLayer-DGNgq5OX.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";function m({open:t,onOpenChange:e,commands:n,title:c="Command Palette",description:l="Quickly search and execute workspace actions.",searchAriaLabel:p="Search commands",resultsAriaLabel:K="Command results",closeOnSelect:X=!0,clearQueryOnEscape:ct=!0,closeOnEscape:Y=!0,closeOnOutsidePointer:Z=!0,onEscapeKeyDown:F,onPointerDownOutside:Q,placeholder:lt="Search commands...",emptyMessage:dt="No commands found.",onQueryChange:w,onCloseReason:b,getResultsStatusText:ee=bt}){const[f,U]=r.useState(""),[v,x]=r.useState(0),te=r.useRef(null),k=r.useRef(null),B=r.useRef(null),ae=r.useRef(t),R=r.useId(),ne=r.useId(),T=r.useCallback(o=>{B.current=o,b==null||b(o)},[b]),oe=r.useCallback(o=>{T(o),e(!1),B.current=null},[T,e]),ut=r.useCallback(o=>{!o&&t&&B.current===null&&(b==null||b("close-button")),B.current=null,e(o)},[b,e,t]);r.useEffect(()=>{var o;t?(o=te.current)==null||o.focus():ae.current&&(U(d=>(d.length>0&&(w==null||w("")),"")),x(0)),ae.current=t},[w,t]);const _=r.useMemo(()=>le(f.trim()),[f]),u=r.useMemo(()=>_?n.filter(o=>{const g=[wt(o),...o.keywords??[]].join(" ");return le(g).includes(_)}):n,[n,_]),se=r.useMemo(()=>u.reduce((o,d)=>d.disabled?o:o+1,0),[u]),re=u.length>0,mt=r.useMemo(()=>ee({query:f,visibleCount:u.length,enabledCount:se,totalCount:n.length}),[n.length,se,u.length,ee,f]),C=r.useMemo(()=>u.findIndex(o=>!o.disabled),[u]),pt=r.useMemo(()=>{var o;for(let d=u.length-1;d>=0;d-=1)if(!((o=u[d])!=null&&o.disabled))return d;return-1},[u]);r.useEffect(()=>{var d;if(u.length===0){k.current=null,x(-1);return}const o=k.current;if(o){const g=u.findIndex(h=>!h.disabled&&h.key===o);if(g>=0){x(g);return}}x(C),k.current=C>=0?((d=u[C])==null?void 0:d.key)??null:null},[u,C]),r.useEffect(()=>{var o;if(v<0){k.current=null;return}k.current=((o=u[v])==null?void 0:o.key)??null},[v,u]);const ie=r.useCallback(o=>{var g;const d=u[o];!d||d.disabled||((g=d.onSelect)==null||g.call(d),X&&oe("item-select"))},[X,oe,u]),ce=o=>{var g;if(u.length===0)return;let d=v<0?o===1?-1:0:v;for(let h=0;h<u.length;h+=1)if(d=(d+o+u.length)%u.length,!((g=u[d])!=null&&g.disabled)){x(d);return}};return a.jsx(yt,{open:t,onOpenChange:ut,title:c,description:l,size:"md",closeOnEscape:Y,closeOnOutsidePointer:Z,onEscapeKeyDown:o=>{F==null||F(o),!(o.defaultPrevented||!Y)&&T("escape-key")},onPointerDownOutside:o=>{Q==null||Q(o),!(o.defaultPrevented||!Z)&&T("outside-pointer")},children:a.jsxs("div",{style:{display:"grid",gap:10},children:[a.jsx(gt,{ref:te,role:"combobox","aria-expanded":t,"aria-haspopup":"listbox","aria-autocomplete":"list","aria-controls":re?R:void 0,"aria-activedescendant":v>=0?`${R}-option-${v}`:void 0,"aria-describedby":ne,placeholder:lt,value:f,onChange:o=>{U(o.target.value),w==null||w(o.target.value)},onKeyDown:o=>{if(!vt(o)){if(o.key==="Escape"&&ct&&f.length>0){o.preventDefault(),U(""),w==null||w("");return}if(o.key==="ArrowDown"){o.preventDefault(),ce(1);return}if(o.key==="ArrowUp"){o.preventDefault(),ce(-1);return}if(o.key==="Home"){o.preventDefault(),x(C);return}if(o.key==="End"){o.preventDefault(),x(pt);return}o.key==="Enter"&&v>=0&&(o.preventDefault(),ie(v))}},"aria-label":p}),a.jsx("p",{id:ne,role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:mt}),re?a.jsx("div",{id:R,role:"listbox","aria-label":K,style:{maxHeight:280,overflow:"auto",display:"grid",gap:4},children:u.map((o,d)=>{const g=d===v;return a.jsx("div",{id:`${R}-option-${d}`,role:"option","aria-selected":g,"aria-disabled":o.disabled||void 0,"aria-posinset":d+1,"aria-setsize":u.length,tabIndex:-1,onMouseDown:h=>{h.preventDefault()},onMouseEnter:()=>{o.disabled||x(d)},onClick:()=>{o.disabled||ie(d)},style:{border:"1px solid var(--aurora-border-default)",background:g?"color-mix(in srgb, var(--aurora-accent-default) 14%, var(--aurora-surface-default))":"var(--aurora-surface-default)",color:o.disabled?"color-mix(in srgb, var(--aurora-text-secondary) 60%, transparent)":"var(--aurora-text-primary)",borderRadius:8,height:36,padding:"0 10px",textAlign:"left",cursor:o.disabled?"not-allowed":"pointer"},children:o.label},o.key)})}):a.jsx("p",{style:{margin:0,color:"var(--aurora-text-secondary)"},children:dt})]})})}function wt(t){return typeof t.textValue=="string"?t.textValue.trim():typeof t.label=="string"?t.label.trim():""}function le(t){return t.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase()}function vt(t){const e=t.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function bt({query:t,visibleCount:e,enabledCount:n,totalCount:c}){const l=t.trim();return l.length===0?n!==c?`${n} of ${c} command${c===1?"":"s"} available.`:`${c} command${c===1?"":"s"} available.`:e===0?`No commands match "${l}".`:n===0?`No enabled commands match "${l}".`:n!==e?`${n} of ${e} matching command${n===1?"":"s"} available for "${l}".`:`${e} command${e===1?"":"s"} found for "${l}".`}m.__docgenInfo={description:"",methods:[],displayName:"CommandPalette",props:{open:{required:!0,tsType:{name:"boolean"},description:""},onOpenChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""},commands:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: string;
...
}`,...(ge=(ye=D.parameters)==null?void 0:ye.docs)==null?void 0:ge.source}}};var we,ve,be;S.parameters={...S.parameters,docs:{...(we=S.parameters)==null?void 0:we.docs,source:{originalSource:`{
...
}`,...(be=(ve=S.parameters)==null?void 0:ve.docs)==null?void 0:be.source}}};var xe,he,fe;I.parameters={...I.parameters,docs:{...(xe=I.parameters)==null?void 0:xe.docs,source:{originalSource:`{
...
}`,...(ze=(Ge=L.parameters)==null?void 0:Ge.docs)==null?void 0:ze.source}}};var Me,Ke,Fe;$.parameters={...$.parameters,docs:{...(Me=$.parameters)==null?void 0:Me.docs,source:{originalSource:`{
...
}`,...(Fe=(Ke=$.parameters)==null?void 0:Ke.docs)==null?void 0:Fe.source}}};var Qe,Ue,_e;N.parameters={...N.parameters,docs:{...(Qe=N.parameters)==null?void 0:Qe.docs,source:{originalSource:`{
...
}`,...(nt=(at=z.parameters)==null?void 0:at.docs)==null?void 0:nt.source}}};var ot,st,rt;M.parameters={...M.parameters,docs:{...(ot=M.parameters)==null?void 0:ot.docs,source:{originalSource:`{
