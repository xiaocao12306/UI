import{j as n}from"./jsx-runtime-BjG_zV1W.js";import{r as u}from"./index-BWu4c2F4.js";import{B as S}from"./Badge-ZJmMstsz.js";import{within as h,expect as s,userEvent as p}from"./index-DgAF9SIF.js";function T(t,e,r){return Math.min(Math.max(t,e),r)}function Z(t,e){const r=e-t+1;return Array.from({length:r},(i,g)=>t+g)}function We(t,e,r,i){const g=i*2+r*2+3;if(e<=g)return Z(1,e);const l=Math.max(t-r,i+2),C=Math.min(t+r,e-i-1),m=[],U=Z(1,i),K=Z(e-i+1,e);m.push(...U),l>i+2?m.push("ellipsis-left"):i+1<l&&m.push(i+1);for(let b=l;b<=C;b+=1)m.push(b);return C<e-i-1?m.push("ellipsis-right"):C+1<e-i+1&&m.push(e-i),m.push(...K),m}function w({page:t,pageCount:e,onPageChange:r,siblingCount:i=1,boundaryCount:g=1,disabled:l=!1,showFirstLast:C=!0,ariaLabel:m="Pagination",ariaLabelledBy:U,getItemAriaLabel:K=re}){const b=u.useRef(null),j=u.useRef(null),R=u.useRef(!1),[x,X]=u.useState(null),[B,L]=u.useState(null),qe=ee(m,"Pagination"),te=ee(U),P=Math.max(e,1),d=T(t,1,P),Ve=e<=1?[]:We(d,e,i,g),ae=T(d-1,1,P),ne=T(d+1,1,P),y=!l&&e>1&&d>1,f=!l&&e>1&&d<e,D=u.useMemo(()=>{if(l||e<=1)return;const a=[];return y&&a.push("Home"),f&&a.push("End"),(y||f)&&a.push("ArrowLeft","ArrowRight"),a.length>0?a.join(" "):void 0},[f,y,l,e]),H=u.useCallback((a,o)=>ee(K(a,o),re(a,o)),[K]);u.useEffect(()=>{l&&(X(null),L(null))},[l]),u.useEffect(()=>{var A;const a=((A=b.current)==null?void 0:A.ownerDocument)??document,o=v=>{v.metaKey||v.altKey||v.ctrlKey||(R.current=!0)},c=v=>{"button"in v&&typeof v.button=="number"&&v.button!==0||"ctrlKey"in v&&v.ctrlKey||(R.current=!1)};return a.addEventListener("keydown",o,!0),a.addEventListener("pointerdown",c,!0),a.addEventListener("mousedown",c,!0),a.addEventListener("touchstart",c,!0),()=>{a.removeEventListener("keydown",o,!0),a.removeEventListener("pointerdown",c,!0),a.removeEventListener("mousedown",c,!0),a.removeEventListener("touchstart",c,!0)}},[]);const E=a=>{if(l||e<=1)return;const o=T(a,1,e);o!==d&&r(o)};u.useEffect(()=>{var c;if(j.current===null)return;const a=j.current;j.current=null;const o=(c=b.current)==null?void 0:c.querySelector(`button[data-aurora-pagination-page="${a}"]`);o==null||o.focus()},[d]);const Y=a=>{const o=T(a,1,e);if(o===d){j.current=null;return}j.current=o,E(o)},I=a=>{if(R.current=!0,l||(a.altKey||a.ctrlKey||a.metaKey)&&_e(a.key))return;if(a.key==="Home"){if(d===1)return;a.preventDefault(),Y(1);return}if(a.key==="End"){if(d===P)return;a.preventDefault(),Y(P);return}const o=ze(a.key,a.currentTarget);if(o===void 0)return;const c=T(d+o,1,P);c!==d&&(a.preventDefault(),Y(c))},F=u.useCallback(a=>({"data-focus-visible":x===a&&B===a?"true":void 0,onFocus:o=>{X(a),L(Je(o.currentTarget,R.current)?a:null)},onBlur:()=>{X(o=>o===a?null:o),L(o=>o===a?null:o)},onMouseDown:o=>{o.button===0&&(R.current=!1,L(c=>c===a?null:c))},onPointerDown:o=>{o.button===0&&(R.current=!1,L(c=>c===a?null:c))}}),[x,B]);return e<=1?null:n.jsx("nav",{ref:b,"aria-label":te?void 0:qe,"aria-labelledby":te,children:n.jsxs("ul",{style:{listStyle:"none",padding:0,margin:0,display:"flex",flexWrap:"wrap",gap:6,alignItems:"center"},children:[C?n.jsx("li",{children:n.jsx("button",{...F("first"),type:"button",disabled:!y,onClick:()=>E(1),onKeyDown:I,"aria-label":H("first",1),"aria-keyshortcuts":y?D:void 0,style:k(!1,!y,x==="first"&&B==="first"),children:"«"})}):null,n.jsx("li",{children:n.jsx("button",{...F("previous"),type:"button",disabled:!y,onClick:()=>E(ae),onKeyDown:I,"aria-label":H("previous",ae),"aria-keyshortcuts":y?D:void 0,style:k(!1,!y,x==="previous"&&B==="previous"),children:"‹"})}),Ve.map((a,o)=>{if(typeof a!="number")return n.jsx("li",{"aria-hidden":"true",style:{color:"var(--aurora-text-secondary)",minWidth:32,textAlign:"center"},children:"…"},`${a}-${o}`);const c=a===d,A=`page-${a}`;return n.jsx("li",{children:n.jsx("button",{...F(A),type:"button",onClick:()=>E(a),disabled:l,onKeyDown:I,"data-aurora-pagination-page":a,"aria-current":c?"page":void 0,"aria-label":H(c?"current":"page",a),"aria-keyshortcuts":l?void 0:D,style:k(c,l,x===A&&B===A),children:a})},a)}),n.jsx("li",{children:n.jsx("button",{...F("next"),type:"button",disabled:!f,onClick:()=>E(ne),onKeyDown:I,"aria-label":H("next",ne),"aria-keyshortcuts":f?D:void 0,style:k(!1,!f,x==="next"&&B==="next"),children:"›"})}),C?n.jsx("li",{children:n.jsx("button",{...F("last"),type:"button",disabled:!f,onClick:()=>E(e),onKeyDown:I,"aria-label":H("last",e),"aria-keyshortcuts":f?D:void 0,style:k(!1,!f,x==="last"&&B==="last"),children:"»"})}):null]})})}function _e(t){return t==="Home"||t==="End"||t==="ArrowLeft"||t==="ArrowRight"}function ze(t,e){if(!(t!=="ArrowLeft"&&t!=="ArrowRight"))return Ne(t,Oe(e))}function Ne(t,e){return t==="ArrowRight"?e?-1:1:e?1:-1}function Oe(t){if(!t)return!1;const e=t.closest("[dir]");if((e==null?void 0:e.dir)==="rtl")return!0;if((e==null?void 0:e.dir)==="ltr")return!1;const r=t.ownerDocument.defaultView??(typeof window<"u"?window:null);return r?r.getComputedStyle(t).direction==="rtl":!1}function re(t,e){switch(t){case"first":return"Go to first page";case"last":return"Go to last page";case"previous":return"Go to previous page";case"next":return"Go to next page";case"current":return`Current page, ${e}`;default:return`Go to page ${e}`}}function k(t,e,r){return{minWidth:32,height:32,padding:"0 8px",borderRadius:"var(--aurora-radius-sm)",border:t?"1px solid var(--aurora-accent-default)":"1px solid var(--aurora-border-default)",background:t?"color-mix(in srgb, var(--aurora-accent-default) 12%, var(--aurora-surface-default))":"var(--aurora-surface-default)",color:e?"color-mix(in srgb, var(--aurora-text-secondary) 65%, transparent)":"var(--aurora-text-primary)",cursor:e?"not-allowed":"pointer",font:"inherit",boxShadow:!e&&r?"0 0 0 3px color-mix(in srgb, var(--aurora-accent-default) 24%, transparent)":"none"}}function ee(t,e){return typeof t=="string"&&t.trim().length>0?t.trim():e}function Je(t,e){try{return t.matches(":focus-visible")||e}catch{return e}}w.__docgenInfo={description:"",methods:[],displayName:"Pagination",props:{page:{required:!0,tsType:{name:"number"},description:""},pageCount:{required:!0,tsType:{name:"number"},description:""},onPageChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(page: number) => void",signature:{arguments:[{type:{name:"number"},name:"page"}],return:{name:"void"}}},description:""},siblingCount:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},boundaryCount:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},showFirstLast:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},ariaLabel:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"Pagination"',computed:!1}},ariaLabelledBy:{required:!1,tsType:{name:"string"},description:""},getItemAriaLabel:{required:!1,tsType:{name:"signature",type:"function",raw:`(
...
}`,...(ie=(se=G.parameters)==null?void 0:se.docs)==null?void 0:ie.source}}};var ce,ue,le;M.parameters={...M.parameters,docs:{...(ce=M.parameters)==null?void 0:ce.docs,source:{originalSource:`{
...
}`,...(le=(ue=M.parameters)==null?void 0:ue.docs)==null?void 0:le.source}}};var de,pe,ge;$.parameters={...$.parameters,docs:{...(de=$.parameters)==null?void 0:de.docs,source:{originalSource:`{
