import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{useMDXComponents as r}from"./index-CHKtz2QT.js";import{M as t,T as a,S as l,D as c,C as n}from"./index-BwMLKh4h.js";import{VariantMatrix as d,IconOnlyAccessibleName as h}from"./Button.stories-CMH9-ssQ.js";import{WithInputControl as p}from"./FormField.stories-DGMlf6c5.js";import{Interactive as x,CloseReasonTelemetry as j,FocusTrapKeyboardCycle as m,EscapeIgnoresImeComposition as u,EscapePreemptedByGlobalHandler as f,DismissGuardHooks as y}from"./Dialog.stories-D_0u8X_i.js";import{CloseReasonTelemetry as b,FocusTrapKeyboardCycle as g,EscapePreemptedByGlobalHandler as v,DismissGuardHooks as w}from"./Drawer.stories-BPOTq3hm.js";import{CloseReasonTelemetry as k,EscapePreemptedByGlobalHandler as E,DismissGuardHooks as C}from"./Popover.stories-CVm_TYHF.js";import{OutsideDismissFocusTransfer as D,EscapeDismissFocusReturn as K,EscapePreemptedByGlobalHandler as P,TabDismissToNextControl as I,CloseReasonTelemetry as S,ControlledOpenContract as R,TypeaheadNavigation as A,TypeaheadIgnoresImeComposition as T,DismissGuardHooks as F}from"./Dropdown.stories-DAdHkW1D.js";import{DescribedByLifecycle as O}from"./Tooltip.stories-wYPBljUw.js";import{AiInteractionFlow as L,QueryTelemetry as H,CloseReasonTelemetry as G,DisabledCommandGuard as B,TextValueAndAccentSearch as M,PersistentSelection as U,RefinedSearchKeepsActiveCommand as $,PagedKeyboardNavigation as z,LocalizedResultsLabel as q,LocalizedDialogCopy as V,ImeCompositionGuard as N,EscapePreemptedByGlobalHandler as W,GuardedDismissEvents as Q,EscapeClearsQueryFirst as J}from"./CommandPalette.stories-DjStZsKw.js";import{WithAiRequestState as X}from"./PromptInput.stories-Bqq8ha6n.js";import{Conversation as _}from"./MessageBubble.stories-DrAyQ9MX.js";import{Default as Y}from"./ReasoningPanel.stories-ll9aUG-c.js";import{Default as Z}from"./StreamingCodeBlock.stories-Jd4VPz8N.js";import{ActionRequired as ee,ActionRequiredDanger as se,CloseReasonTelemetry as ne,EscapeStackOrder as oe,EscapeShortcutSync as ie,StackedViewportOffset as re,FocusedToastEscapesFirst as te,CloseButtonPrimaryPointerOnly as ae,EscapePreemptedByGlobalHandler as le,EscapePreemptedSkipsToastHook as ce,EscapeGuardedByToastHandler as de,EscapeIgnoresImeComposition as he,LiveRegionOff as pe}from"./Toast.stories-wGsUY2JW.js";import{KeyboardNavigationGuide as xe,NoLoopNavigation as je,Vertical as me,RtlKeyboardNavigation as ue,LabelledByHeading as fe,ManualActivation as ye,ManualVerticalActivation as be,PrimaryPointerOnlyPressedState as ge}from"./Tabs.stories-CgNtOX_Y.js";import{ReleaseChecklist as ve,SortTelemetry as we,LocalizedSortLabels as ke,SingleRowSortDisabled as Ee,PrimaryPointerOnlySortPress as Ce,WithRowAction as De,InvalidDefaultSortKeyFallback as Ke,RowHeaderSemantics as Pe,AccessibleNameFallback as Ie}from"./Table.stories-DIc80jTK.js";import{KeyboardShortcuts as Se,RtlKeyboardShortcuts as Re,LabelledByHeading as Ae}from"./Pagination.stories-8AthCQmC.js";import"./index-BWu4c2F4.js";import"./iframe-YA7vZtGl.js";import"./index-DlVbWVVj.js";import"./index-4adcsI43.js";import"./index-DrFu-skq.js";import"./Button-DS9RTxKh.js";import"./Tag-Dmp9Dfgr.js";import"./Badge-ZJmMstsz.js";import"./index-DgAF9SIF.js";import"./storyShowcase-r-xztSD8.js";import"./Input-pKdbw4ss.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";import"./FormField-DYhF-Rf9.js";import"./Textarea-C2HCxZDO.js";import"./Dialog-B2OlqLN0.js";import"./bodyScrollLock-CnEUF6y7.js";import"./DismissableLayer-BWoUnDZk.js";import"./Dropdown-CeymbwOM.js";import"./Popover-DXsesf5W.js";function i(o){const s={code:"code",h2:"h2",li:"li",p:"p",ul:"ul",...r(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Docs/Best Practices"}),`
`,e.jsx(a,{}),`
...
`,e.jsxs(s.li,{children:["For icon-only buttons, always provide ",e.jsx(s.code,{children:"aria-label"})," or ",e.jsx(s.code,{children:"aria-labelledby"}),"; do not rely on decorative glyph text."]}),`
...
`,e.jsxs(s.li,{children:["Keep ",e.jsx(s.code,{children:"Ctrl/Meta/Alt + Home/End/Page/Enter"})," on native input behavior; do not hijack modified shortcuts for command navigation."]}),`
...
`,e.jsxs(s.li,{children:["Keep modified shortcuts (",e.jsx(s.code,{children:"Ctrl/Meta/Alt + Enter/Space"}),") on host/browser behavior; sortable headers should only react to unmodified activation keys."]}),`
...
`,e.jsxs(s.li,{children:["Keep modified shortcuts (",e.jsx(s.code,{children:"Ctrl/Meta/Alt + Arrow/Home/End/Enter/Space"}),") on host/browser behavior; tabs should only react to unmodified navigation/activation keys."]}),`
...
`,e.jsx(n,{of:Se}),`
`,e.jsx(n,{of:Re}),`
`,e.jsx(n,{of:Ae})]})}function ys(o={}){const{wrapper:s}={...r(),...o.components};return s?e.jsx(s,{...o,children:e.jsx(i,{...o})}):i(o)}export{ys as default};
