import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{B as qe}from"./Button-BCHo91JE.js";import{r as z}from"./index-BWu4c2F4.js";import{B as $e}from"./Badge-Dkm8CRgf.js";import{within as m,expect as n,userEvent as v}from"./index-DgAF9SIF.js";function Le(e,t,r){if(!t)return null;const c=e.find(h=>String(h.key)===t);return c!=null&&c.sortable?{key:t,direction:r}:null}function l({columns:e,data:t,rowKey:r,caption:c,ariaLabel:h,loading:q=!1,loadingContent:je="Loading data...",emptyContent:Ae="No data available.",defaultSortKey:He,defaultSortDirection:Ke="asc",getSortAriaLabel:Ee=ze,onSortChange:$}){const Ce=h??(c?void 0:"Data table"),[p,Ne]=z.useState(()=>Le(e,He,Ke)),L=z.useMemo(()=>{const s=t.map((u,o)=>({row:u,sourceIndex:o}));if(!p)return s;const i=e.find(u=>String(u.key)===p.key);if(!(i!=null&&i.sortable))return s;const d=i.sortAccessor??(u=>{const o=u[String(i.key)];return o instanceof Date||typeof o=="number"||typeof o=="string"?o:String(o??"")});return s.sort((u,o)=>{const w=d(u.row),g=d(o.row),x=w instanceof Date?w.getTime():w,f=g instanceof Date?g.getTime():g;return x<f?p.direction==="asc"?-1:1:x>f?p.direction==="asc"?1:-1:u.sourceIndex-o.sourceIndex})},[e,t,p]);return a.jsx("div",{style:{border:"1px solid var(--aurora-border-default)",borderRadius:"var(--aurora-radius-md)",overflow:"auto"},children:a.jsxs("table",{"aria-label":Ce,"aria-busy":q||void 0,style:{width:"100%",borderCollapse:"collapse",minWidth:560},children:[c?a.jsx("caption",{style:{textAlign:"left",padding:"10px 12px",color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-sm)",borderBottom:"1px solid var(--aurora-border-default)"},children:c}):null,a.jsx("thead",{children:a.jsx("tr",{children:e.map(s=>{const i=String(s.key),d=(p==null?void 0:p.key)===i?p.direction:void 0,u=!!s.sortable,o=d?d==="asc"?"ascending":"descending":void 0,w=s.align??"left",g=typeof s.header=="string"?s.header:i,x=d==="asc"?"desc":"asc",f=Ee({columnKey:i,columnHeader:g,nextDirection:x}),S=q||L.length===0,V=()=>{S||(Ne({key:i,direction:x}),$==null||$(i,x))};return a.jsx("th",{scope:"col","aria-sort":o,style:{textAlign:w,color:"var(--aurora-text-secondary)",background:"var(--aurora-surface-elevated)",borderBottom:"1px solid var(--aurora-border-default)",padding:"10px 12px",fontSize:"var(--aurora-font-size-sm)",fontWeight:"var(--aurora-font-weight-medium)",width:s.width},children:u?a.jsxs("button",{type:"button","aria-label":f,disabled:S,onClick:V,onKeyDown:O=>{Ve(O.key)&&(O.preventDefault(),V())},style:{border:0,background:"transparent",color:"inherit",font:"inherit",cursor:S?"not-allowed":"pointer",display:"inline-flex",alignItems:"center",gap:6,padding:0,opacity:S?.64:1},children:[s.header,a.jsx("span",{"aria-hidden":"true",children:d==="asc"?"▲":d==="desc"?"▼":"↕"})]}):s.header},i)})})}),a.jsx("tbody",{children:q?a.jsx("tr",{children:a.jsx("td",{colSpan:e.length,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:je})})}):L.length===0?a.jsx("tr",{children:a.jsx("td",{colSpan:e.length,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:Ae})})}):L.map((s,i)=>{const d=s.row,u=String(s.sourceIndex);return a.jsx("tr",{style:{background:i%2===0?"transparent":"var(--aurora-surface-elevated)"},children:e.map(o=>{const w=o.render?o.render(d,i,s.sourceIndex):String(d[String(o.key)]??""),g={padding:"10px 12px",borderBottom:"1px solid var(--aurora-border-default)",color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",textAlign:o.align??"left"};return o.rowHeader?a.jsx("th",{scope:"row",style:{...g,fontWeight:"var(--aurora-font-weight-medium)"},children:w},String(o.key)):a.jsx("td",{style:g,children:w},String(o.key))})},r?r(d,s.sourceIndex):u)})})]})})}function ze({columnHeader:e,nextDirection:t}){return`${e} sort ${t==="asc"?"ascending":"descending"}`}function Ve(e){return e===" "||e==="Spacebar"}l.__docgenInfo={description:"",methods:[],displayName:"Table",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: keyof T | string;
