import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{r as D}from"./index-BWu4c2F4.js";import{B as ke}from"./Button-DvJUO9m9.js";import{I as o}from"./Input-B9xcXif8.js";import{F as i}from"./FormField-CqOIZQNx.js";import{within as d,expect as a,userEvent as p,fireEvent as l,waitFor as y}from"./index-DgAF9SIF.js";import{S as c,a as R,s as b}from"./storyShowcase-DlKirntE.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";const Ce={title:"Form/Input",component:o,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:"Input uses shared field tokens and is suitable for search, filters, and AI prompt prefill interactions."}}},args:{placeholder:"Search release notes..."}},v={},h={render:()=>e.jsxs(c,{maxWidth:"min(100%, 560px)",gap:8,children:[e.jsx("label",{htmlFor:"prompt",style:{fontWeight:600},children:"Prompt Draft"}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr auto",gap:8},children:[e.jsx(o,{id:"prompt",placeholder:"Ask Aurora AI to scaffold a new dialog flow...","aria-label":"AI prompt"}),e.jsx(ke,{children:"Send"})]}),e.jsx("small",{style:R,children:"Tip: switch theme in toolbar to validate input token contrast."})]})},x={render:()=>e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:12,children:[e.jsx(i,{label:"Default",description:"Hover and focus to verify border and ring states.",children:e.jsx(o,{placeholder:"Type project name..."})}),e.jsx(i,{label:"Error",error:"Please provide a valid email address.",required:!0,children:e.jsx(o,{placeholder:"name@company.com",defaultValue:"invalid-email"})}),e.jsx(i,{label:"Required inherited from control",children:e.jsx(o,{placeholder:"Inherited required field",required:!0})}),e.jsx(i,{label:"Disabled",description:"Disabled fields remain readable with lower emphasis.",disabled:!0,children:e.jsx(o,{placeholder:"Disabled field"})}),e.jsx(i,{label:"Read-only",description:"Read-only fields are focusable but not editable.",children:e.jsx(o,{value:"release/0.1.0",readOnly:!0,"aria-label":"Release branch"})})]})},w={render:()=>e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:12,children:[e.jsx(i,{label:"Keyboard interaction",description:"Tab focus should show ring; Enter feedback is suppressed during IME composition.",children:e.jsx(o,{defaultValue:"release-notes"})}),e.jsx(i,{label:"Read-only propagated",children:e.jsx(o,{"aria-label":"Read-only propagated input",readOnly:!0,defaultValue:"stable"})}),e.jsx(i,{label:"Disabled interaction guard",disabled:!0,children:e.jsx(o,{"aria-label":"Disabled interaction guard input",placeholder:"Disabled input"})})]}),play:async({canvasElement:r})=>{const n=d(r),t=await n.findByRole("textbox",{name:"Keyboard interaction"}),s=n.getByText("Keyboard interaction").closest("label");await p.click(t),await a(t).toHaveAttribute("data-focused","true"),await a(s).toHaveAttribute("id"),await a(t.getAttribute("aria-labelledby")??"").toContain((s==null?void 0:s.id)??""),l.keyDown(t,{key:"Enter",isComposing:!0,keyCode:229,which:229}),await a(t).not.toHaveAttribute("data-active"),l.keyDown(t,{key:"Enter",ctrlKey:!0}),await a(t).not.toHaveAttribute("data-active"),l.keyDown(t,{key:"Enter",metaKey:!0}),await a(t).not.toHaveAttribute("data-active"),l.keyDown(t,{key:"Enter",altKey:!0}),await a(t).not.toHaveAttribute("data-active"),l.keyDown(t,{key:"Enter",shiftKey:!0}),l.keyUp(t,{key:"Enter",shiftKey:!0}),await a(t).not.toHaveAttribute("data-active"),l.keyDown(t,{key:"Enter"}),l.keyUp(t,{key:"Enter"}),await a(t).not.toHaveAttribute("data-active"),t.dispatchEvent(new PointerEvent("pointerdown",{bubbles:!0,cancelable:!0,pointerType:"touch",button:0})),await y(()=>{a(t).toHaveAttribute("data-active","true")}),l.pointerCancel(t),await y(()=>{a(t).not.toHaveAttribute("data-active")}),t.dispatchEvent(new PointerEvent("pointerdown",{bubbles:!0,cancelable:!0,pointerType:"touch",button:0})),await y(()=>{a(t).toHaveAttribute("data-active","true")}),t.dispatchEvent(new PointerEvent("pointerup",{bubbles:!0,cancelable:!0,pointerType:"touch",button:0})),await y(()=>{a(t).not.toHaveAttribute("data-active")});const u=n.getByRole("textbox",{name:"Read-only propagated input"});await a(u).toHaveAttribute("readonly"),u.focus(),l.keyDown(u,{key:"Enter"}),l.keyUp(u,{key:"Enter"}),await a(u).not.toHaveAttribute("data-active");const m=n.getByRole("textbox",{name:"Disabled interaction guard input"});await a(m).toBeDisabled(),await p.hover(m),await a(m).not.toHaveAttribute("data-hovered")}};function fe(){const[r,n]=D.useState(0);return e.jsx("div",{onKeyDownCapture:t=>{t.key==="Enter"&&t.preventDefault()},children:e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:12,children:[e.jsx(i,{label:"Preempted enter input",description:"Global key guards can preempt Enter before local active-feedback handlers.",children:e.jsx(o,{onKeyDown:t=>{!t.defaultPrevented&&t.key==="Enter"&&n(s=>s+1)}})}),e.jsxs("p",{style:b,children:["Enter handler calls:"," ",e.jsx("strong",{"data-testid":"input-preempted-enter-calls",style:R,children:r})]})]})})}const k={render:()=>e.jsx(fe,{}),play:async({canvasElement:r})=>{const n=d(r),t=await n.findByRole("textbox",{name:/^Preempted enter input/});l.keyDown(t,{key:"Enter"}),await a(t).not.toHaveAttribute("data-active"),await a(n.getByTestId("input-preempted-enter-calls")).toHaveTextContent("0")}};function ge(){const[r,n]=D.useState(0);return e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:12,children:[e.jsx(i,{label:"Locally preempted enter input",description:"Input-level key guards can preempt Enter before local active-feedback handlers.",children:e.jsx(o,{onKeyDown:t=>{t.key==="Enter"&&(t.preventDefault(),n(s=>s+1))}})}),e.jsxs("p",{style:b,children:["Enter handler calls:"," ",e.jsx("strong",{"data-testid":"input-local-preempted-enter-calls",style:R,children:r})]})]})}const f={render:()=>e.jsx(ge,{}),play:async({canvasElement:r})=>{const n=d(r),t=await n.findByRole("textbox",{name:/^Locally preempted enter input/});l.keyDown(t,{key:"Enter"}),await a(t).not.toHaveAttribute("data-active"),await a(n.getByTestId("input-local-preempted-enter-calls")).toHaveTextContent("1")}},g={render:()=>e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:12,children:[e.jsx(i,{label:"Actionable shortcut input",description:"Actionable inputs should expose Enter shortcut hints.",children:e.jsx(o,{})}),e.jsx(i,{label:"Read-only shortcut input",description:"Read-only inputs should not advertise keyboard shortcuts.",children:e.jsx(o,{readOnly:!0,defaultValue:"release/0.1.0"})}),e.jsx(i,{label:"Disabled shortcut input",description:"Disabled inputs should not advertise keyboard shortcuts.",disabled:!0,children:e.jsx(o,{})}),e.jsx(i,{label:"Date shortcut input",description:"Non-text input types should not expose default Enter shortcut hints.",children:e.jsx(o,{type:"date","aria-label":"Date shortcut input control"})})]}),play:async({canvasElement:r})=>{const n=d(r);await a(n.getByRole("textbox",{name:/^Actionable shortcut input/})).toHaveAttribute("aria-keyshortcuts","Enter"),await a(n.getByRole("textbox",{name:/^Read-only shortcut input/})).not.toHaveAttribute("aria-keyshortcuts"),await a(n.getByRole("textbox",{name:/^Disabled shortcut input/})).not.toHaveAttribute("aria-keyshortcuts"),await a(n.getByLabelText("Date shortcut input control")).not.toHaveAttribute("aria-keyshortcuts")}};function Ee(){return e.jsx(c,{maxWidth:"min(100%, 600px)",gap:12,children:e.jsx(i,{label:"Runtime boolean fallback input",description:"Invalid runtime disabled/readOnly config should degrade to actionable input behavior.",children:e.jsx(o,{"aria-label":"Runtime boolean fallback input control",disabled:"true",readOnly:"true"})})})}const E={render:()=>e.jsx(Ee,{}),play:async({canvasElement:r})=>{const t=await d(r).findByRole("textbox",{name:"Runtime boolean fallback input control"});await a(t).not.toBeDisabled(),await a(t).not.toHaveAttribute("readonly"),await a(t).not.toHaveAttribute("data-disabled"),await a(t).toHaveAttribute("aria-keyshortcuts","Enter"),l.keyDown(t,{key:"Enter"}),await y(()=>{a(t).toHaveAttribute("data-active","true")})}},F={render:()=>e.jsx(c,{maxWidth:"min(100%, 600px)",gap:12,children:e.jsx(i,{label:"Blank type fallback input",description:"Blank input type should normalize to text semantics with Enter shortcut hints.",children:e.jsx(o,{type:"   ","aria-label":"Blank type fallback input control"})})}),play:async({canvasElement:r})=>{const t=d(r).getByRole("textbox",{name:"Blank type fallback input control"});await a(t).toHaveAttribute("type","text"),await a(t).toHaveAttribute("aria-keyshortcuts","Enter")}},I={render:()=>e.jsx(c,{maxWidth:"min(100%, 600px)",gap:12,children:e.jsx(i,{label:"Uppercase type normalization input",description:"Uppercase and padded type tokens should normalize to lowercase text-like semantics.",children:e.jsx(o,{type:" EMAIL ","aria-label":"Uppercase type normalization input control"})})}),play:async({canvasElement:r})=>{const t=d(r).getByRole("textbox",{name:"Uppercase type normalization input control"});await a(t).toHaveAttribute("type","email"),await a(t).toHaveAttribute("aria-keyshortcuts","Enter")}};function Fe(){return e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:10,children:[e.jsxs("p",{style:b,children:["Click first, then press ",e.jsx("kbd",{children:"Tab"})," to verify keyboard re-entry restores focus-visible state on input."]}),e.jsx("button",{type:"button",children:"Before input"}),e.jsx(o,{"aria-label":"Focus intent re-entry input",placeholder:"Tab back into this field"})]})}const A={render:()=>e.jsx(Fe,{}),play:async({canvasElement:r})=>{const n=d(r),t=await n.findByRole("button",{name:"Before input"}),s=n.getByRole("textbox",{name:"Focus intent re-entry input"});await p.click(s),await a(s).toHaveAttribute("data-focused","true"),await p.click(t),await p.tab(),await a(s).toHaveFocus(),await a(s).toHaveAttribute("data-focus-visible","true"),l.mouseDown(s,{button:0,ctrlKey:!0}),await a(s).toHaveAttribute("data-focus-visible","true")}};function Ie(){const[r,n]=D.useState(""),[t,s]=D.useState(!1),u=t&&r.trim().length===0;return e.jsxs(c,{maxWidth:"min(100%, 600px)",gap:10,children:[e.jsx(i,{label:"Prompt",error:u?"Prompt is required.":void 0,children:e.jsx(o,{"aria-label":"Prompt input",value:r,placeholder:"Describe release note summary...",onChange:m=>n(m.target.value),onBlur:()=>s(!0)})}),e.jsxs("small",{style:R,"data-testid":"char-count",children:[r.length," chars"]}),e.jsx(ke,{disabled:r.trim().length===0,children:"Submit Prompt"})]})}const B={render:()=>e.jsx(Ie,{}),play:async({canvasElement:r})=>{const n=d(r),t=await n.findByRole("textbox",{name:"Prompt input"});await p.click(t),await p.tab(),await a(n.getByRole("alert")).toHaveTextContent("Prompt is required."),await a(n.getByRole("button",{name:"Submit Prompt"})).toBeDisabled(),await p.type(t,"Release summary"),await a(n.queryByRole("alert")).not.toBeInTheDocument(),await a(n.getByTestId("char-count")).toHaveTextContent("15 chars"),await a(n.getByRole("button",{name:"Submit Prompt"})).not.toBeDisabled()}},H={render:()=>e.jsxs(c,{maxWidth:"min(100%, 560px)",gap:8,children:[e.jsx(i,{label:"Grammar review",children:e.jsx(o,{"aria-label":"Grammar review input","aria-invalid":"grammar",defaultValue:"Needs grammar check"})}),e.jsxs("small",{style:b,children:["Preserves ",e.jsx("code",{children:'aria-invalid="grammar"'})," for assistive-tech integrations that distinguish grammar/spelling corrections."]})]}),play:async({canvasElement:r})=>{const t=await d(r).findByRole("textbox",{name:"Grammar review input"});await a(t).toHaveAttribute("aria-invalid","grammar")}},j={render:()=>e.jsxs(c,{maxWidth:"min(100%, 560px)",gap:8,children:[e.jsx(i,{label:"Release scope",children:e.jsx(o,{"aria-label":"   ",defaultValue:"stable"})}),e.jsxs("small",{style:b,children:["Blank ",e.jsx("code",{children:"aria-label"})," values are ignored so visible label association remains the accessible name source."]})]}),play:async({canvasElement:r})=>{const t=await d(r).findByRole("textbox",{name:"Release scope"});await a(t).not.toHaveAttribute("aria-label")}};var S,T,P;v.parameters={...v.parameters,docs:{...(S=v.parameters)==null?void 0:S.docs,source:{originalSource:"{}",...(P=(T=v.parameters)==null?void 0:T.docs)==null?void 0:P.source}}};var C,K,W;h.parameters={...h.parameters,docs:{...(C=h.parameters)==null?void 0:C.docs,source:{originalSource:`{
...
}`,...(W=(K=h.parameters)==null?void 0:K.docs)==null?void 0:W.source}}};var M,V,z;x.parameters={...x.parameters,docs:{...(M=x.parameters)==null?void 0:M.docs,source:{originalSource:`{
...
}`,...(z=(V=x.parameters)==null?void 0:V.docs)==null?void 0:z.source}}};var O,U,q;w.parameters={...w.parameters,docs:{...(O=w.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 600px)" gap={12}>
...
}`,...(q=(U=w.parameters)==null?void 0:U.docs)==null?void 0:q.source}}};var L,N,G;k.parameters={...k.parameters,docs:{...(L=k.parameters)==null?void 0:L.docs,source:{originalSource:`{
...
}`,...(G=(N=k.parameters)==null?void 0:N.docs)==null?void 0:G.source}}};var _,J,Q;f.parameters={...f.parameters,docs:{...(_=f.parameters)==null?void 0:_.docs,source:{originalSource:`{
...
}`,...(Q=(J=f.parameters)==null?void 0:J.docs)==null?void 0:Q.source}}};var X,Y,Z;g.parameters={...g.parameters,docs:{...(X=g.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 600px)" gap={12}>
...
}`,...(Z=(Y=g.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var $,ee,te;E.parameters={...E.parameters,docs:{...($=E.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...
  play: async ({
    ...
    const canvas = within(canvasElement);
    const input = await canvas.findByRole("textbox", {
      name: "Runtime boolean fallback input control"
    });
...
}`,...(te=(ee=E.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var ae,ne,re;F.parameters={...F.parameters,docs:{...(ae=F.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 600px)" gap={12}>
...
}`,...(re=(ne=F.parameters)==null?void 0:ne.docs)==null?void 0:re.source}}};var oe,ie,se;I.parameters={...I.parameters,docs:{...(oe=I.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 600px)" gap={12}>
...
}`,...(se=(ie=I.parameters)==null?void 0:ie.docs)==null?void 0:se.source}}};var le,ce,de;A.parameters={...A.parameters,docs:{...(le=A.parameters)==null?void 0:le.docs,source:{originalSource:`{
...
}`,...(de=(ce=A.parameters)==null?void 0:ce.docs)==null?void 0:de.source}}};var pe,ue,me;B.parameters={...B.parameters,docs:{...(pe=B.parameters)==null?void 0:pe.docs,source:{originalSource:`{
...
}`,...(me=(ue=B.parameters)==null?void 0:ue.docs)==null?void 0:me.source}}};var ye,be,ve;H.parameters={...H.parameters,docs:{...(ye=H.parameters)==null?void 0:ye.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 560px)" gap={8}>
...
}`,...(ve=(be=H.parameters)==null?void 0:be.docs)==null?void 0:ve.source}}};var he,xe,we;j.parameters={...j.parameters,docs:{...(he=j.parameters)==null?void 0:he.docs,source:{originalSource:`{
  render: () => <StoryShowcaseFrame maxWidth="min(100%, 560px)" gap={8}>
...
}`,...(we=(xe=j.parameters)==null?void 0:xe.docs)==null?void 0:we.source}}};const Ke=["Default","AiPromptStyle","StateMatrix","InteractionA11yParity","ManagedKeysPreemptedByGlobalHandler","ManagedKeysPreemptedByLocalHandler","ShortcutHintPrecision","RuntimeBooleanConfigNormalization","BlankTypeFallback","UppercaseTypeNormalization","FocusIntentReentry","ValidationFlow","InvalidTokenSemantics","BlankAriaLabelFallback"];export{h as AiPromptStyle,j as BlankAriaLabelFallback,F as BlankTypeFallback,v as Default,A as FocusIntentReentry,w as InteractionA11yParity,H as InvalidTokenSemantics,k as ManagedKeysPreemptedByGlobalHandler,f as ManagedKeysPreemptedByLocalHandler,E as RuntimeBooleanConfigNormalization,g as ShortcutHintPrecision,x as StateMatrix,I as UppercaseTypeNormalization,B as ValidationFlow,Ke as __namedExportsOrder,Ce as default};
