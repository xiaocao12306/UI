import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{B as _t}from"./Button-DS9RTxKh.js";import{r as u}from"./index-BWu4c2F4.js";import{B as Jt}from"./Badge-ZJmMstsz.js";import{within as p,expect as n,userEvent as x,fireEvent as k}from"./index-DgAF9SIF.js";import{S as m,s as I,a as ye}from"./storyShowcase-CGhlt2ZW.js";const Qt=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"});function Re(t,e,o){if(!e)return null;const r=t.find(b=>String(b.key)===e);return r!=null&&r.sortable?{key:e,direction:o}:null}function l({columns:t,data:e,rowKey:o,caption:r,ariaLabel:b,ariaLabelledBy:B,loading:R=!1,loadingContent:$t="Loading data...",emptyContent:Pt="No data available.",defaultSortKey:ie,defaultSortDirection:ce="asc",getSortAriaLabel:Vt=Xt,getSortStatusText:pe=Zt,onSortChange:ue}){const be=B?void 0:b??(r?void 0:"Data table"),we=u.useRef({}),ge=u.useRef(null),N=u.useRef(null),D=u.useRef(null),j=u.useRef(!0);u.useRef(null);const[Mt,le]=u.useState(null),[Ot,K]=u.useState(null),[Gt,F]=u.useState(null);u.useEffect(()=>{var h;const s=((h=ge.current)==null?void 0:h.ownerDocument)??document,i=d=>{d.metaKey||d.altKey||d.ctrlKey||(j.current=!0)},w=()=>{j.current=!1};return s.addEventListener("keydown",i,!0),s.addEventListener("pointerdown",w,!0),s.addEventListener("mousedown",w,!0),s.addEventListener("touchstart",w,!0),()=>{s.removeEventListener("keydown",i,!0),s.removeEventListener("pointerdown",w,!0),s.removeEventListener("mousedown",w,!0),s.removeEventListener("touchstart",w,!0)}},[]);const de=u.useCallback(()=>{N.current=null,D.current!==null&&(window.clearTimeout(D.current),D.current=null)},[]);u.useEffect(()=>()=>{de()},[de]);const[y,me]=u.useState(()=>Re(t,ie,ce));u.useEffect(()=>{if(!y)return;const s=t.find(i=>String(i.key)===y.key);s!=null&&s.sortable||me(null)},[t,y]),u.useEffect(()=>{if(y)return;const s=Re(t,ie,ce);s&&me(s)},[t,ce,ie,y]);const zt=u.useMemo(()=>e.map((s,i)=>String(o?o(s,i):i)),[e,o]);u.useEffect(()=>{},[o,zt]);const C=u.useMemo(()=>{const s=e.map((h,d)=>({row:h,sourceIndex:d}));if(!y)return s;const i=t.find(h=>String(h.key)===y.key);if(!(i!=null&&i.sortable))return s;const w=i.sortAccessor??(h=>{const d=h[String(i.key)];return d instanceof Date||typeof d=="number"||typeof d=="string"?d:String(d??"")});return s.sort((h,d)=>{const g=w(h.row),T=w(d.row);if(typeof g=="string"&&typeof T=="string"){const A=Qt.compare(g,T);return A!==0?y.direction==="asc"?A:-A:h.sourceIndex-d.sourceIndex}const H=g instanceof Date?g.getTime():g,W=T instanceof Date?T.getTime():T;return H<W?y.direction==="asc"?-1:1:H>W?y.direction==="asc"?1:-1:h.sourceIndex-d.sourceIndex})},[t,e,y]),xe=u.useMemo(()=>{if(R||C.length<=1||!y)return"";const s=t.find(w=>String(w.key)===y.key);if(!(s!=null&&s.sortable))return"";const i=typeof s.header=="string"?s.header:String(s.key);return pe({columnKey:y.key,columnHeader:i,direction:y.direction})},[t,pe,R,y,C.length]),L=!R&&C.length>1&&t.some(s=>s.sortable),ve=Math.max(t.length,1);return u.useEffect(()=>{L||(le(null),K(null),F(null))},[L]),a.jsxs("div",{ref:ge,"data-aurora-table-scroll-container":"",tabIndex:L?void 0:0,"aria-label":L||B?void 0:be??"Data table scroll container","aria-labelledby":L?void 0:B,style:{border:"1px solid var(--aurora-border-default)",borderRadius:"var(--aurora-radius-md)",overflow:"auto"},children:[xe?a.jsx("p",{role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:xe}):null,a.jsxs("table",{"aria-label":be,"aria-labelledby":B,"aria-busy":R||void 0,style:{width:"100%",borderCollapse:"collapse",minWidth:560},children:[r?a.jsx("caption",{style:{textAlign:"left",padding:"10px 12px",color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-sm)",borderBottom:"1px solid var(--aurora-border-default)"},children:r}):null,a.jsx("thead",{children:a.jsx("tr",{children:t.map(s=>{const i=String(s.key),w=!!s.sortable,h=C.length>1,d=w&&(y==null?void 0:y.key)===i?y.direction:void 0,g=!R&&h?d:void 0,T=g?g==="asc"?"ascending":"descending":void 0,H=s.align??"left",W=typeof s.header=="string"?s.header:i,A=d==="asc"?"desc":"asc",Ut=Vt({columnKey:i,columnHeader:W,nextDirection:A}),f=R||!h,he=!f&&Mt===i,Se=!f&&Ot===i,fe=!f&&Gt===i,Yt=he||fe,Be=()=>{f||(me({key:i,direction:A}),ue==null||ue(i,A))};return a.jsx("th",{scope:"col","aria-sort":T,style:{textAlign:H,color:"var(--aurora-text-secondary)",background:"var(--aurora-surface-elevated)",borderBottom:"1px solid var(--aurora-border-default)",padding:"10px 12px",fontSize:"var(--aurora-font-size-sm)",fontWeight:"var(--aurora-font-weight-medium)",width:s.width},children:w?a.jsxs("button",{type:"button",ref:c=>{we.current[i]=c},"aria-label":Ut,"aria-keyshortcuts":f?void 0:"Enter Space",disabled:f,onClick:c=>{const E=c.detail===0&&N.current===i;de(),!E&&Be()},onMouseEnter:()=>{f||le(i)},onMouseLeave:()=>{le(c=>c===i?null:c),K(c=>c===i?null:c)},onMouseDown:c=>{f||c.button===0&&(j.current=!1,F(E=>E===i?null:E),K(i))},onMouseUp:c=>{c.button===0&&K(E=>E===i?null:E)},onFocus:()=>{if(f){F(c=>c===i?null:c);return}F(c=>aa(we.current[i],j.current)?i:c===i?null:c)},onBlur:()=>{F(c=>c===i?null:c),K(c=>c===i?null:c)},onKeyDown:c=>{j.current=!0,!(c.altKey||c.ctrlKey||c.metaKey)&&ea(c.key)&&(ta(c)||(c.preventDefault(),!c.repeat&&(N.current=i,D.current!==null&&window.clearTimeout(D.current),D.current=window.setTimeout(()=>{N.current=null,D.current=null},0),Be())))},style:{border:Yt?"1px solid color-mix(in srgb, var(--aurora-accent-default) 48%, transparent)":"1px solid transparent",borderRadius:"var(--aurora-radius-sm)",background:Se?"color-mix(in srgb, var(--aurora-surface-elevated) 68%, var(--aurora-surface-default))":he?"color-mix(in srgb, var(--aurora-surface-elevated) 86%, var(--aurora-surface-default))":"transparent",font:"inherit",cursor:f?"not-allowed":"pointer",display:"inline-flex",alignItems:"center",gap:6,padding:"2px 6px",color:f?"color-mix(in srgb, var(--aurora-text-secondary) 88%, var(--aurora-text-primary))":"inherit",boxShadow:fe?"0 0 0 3px color-mix(in srgb, var(--aurora-focus-ring) 42%, transparent)":"none",transform:Se?"translateY(1px)":"translateY(0)",transition:"background-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), border-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), box-shadow var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), transform var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard)"},children:[s.header,a.jsx("span",{"aria-hidden":"true",children:g==="asc"?"▲":g==="desc"?"▼":"↕"})]}):s.header},i)})})}),a.jsx("tbody",{children:R?a.jsx("tr",{children:a.jsx("td",{colSpan:ve,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:$t})})}):C.length===0?a.jsx("tr",{children:a.jsx("td",{colSpan:ve,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:Pt})})}):C.map((s,i)=>{const w=s.row,h=String(s.sourceIndex),d=o?o(w,s.sourceIndex):h;return a.jsx("tr",{style:{background:i%2===0?"transparent":"var(--aurora-surface-elevated)"},children:t.map(g=>{const T=g.render?g.render(w,i,s.sourceIndex):String(w[String(g.key)]??""),H={padding:"10px 12px",borderBottom:"1px solid var(--aurora-border-default)",color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",textAlign:g.align??"left"};return g.rowHeader?a.jsx("th",{scope:"row",style:{...H,fontWeight:"var(--aurora-font-weight-medium)"},children:T},String(g.key)):a.jsx("td",{style:H,children:T},String(g.key))})},d)})})]})]})}function Xt({columnHeader:t,nextDirection:e}){return`${t} sort ${e==="asc"?"ascending":"descending"}`}function Zt({columnHeader:t,direction:e}){return`Sorted by ${t} ${e==="asc"?"ascending":"descending"}.`}function ea(t){return t==="Enter"||t===" "||t==="Space"||t==="Spacebar"}function ta(t){const e=t.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function aa(t,e){if(!t)return e;try{return t.matches(":focus-visible")}catch{return e}}l.__docgenInfo={description:"",methods:[],displayName:"Table",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: keyof T | string;
