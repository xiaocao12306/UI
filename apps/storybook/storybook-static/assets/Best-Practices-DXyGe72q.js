...
`,e.jsxs(s.li,{children:["Keep pagination shortcut hints (",e.jsx(s.code,{children:'aria-keyshortcuts="Home End ArrowLeft ArrowRight"'}),") on enabled controls so keyboard affordances are discoverable in AT/QA, and omit them on disabled controls."]}),`
...
`,e.jsx(n,{of:Ss}),`
`,e.jsx(n,{of:Ts}),`
`,e.jsx(n,{of:Ps})]})}function vn(o={}){const{wrapper:s}={...r(),...o.components};return s?e.jsx(s,{...o,children:e.jsx(i,{...o})}):i(o)}export{vn as default};
