import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{r as u}from"./index-BWu4c2F4.js";import{B as P}from"./Button-DKyBbf41.js";import{I as r}from"./Input-CK-2zJ6Z.js";import{F as n}from"./FormField-tjrV3Sij.js";import{within as T,expect as l,userEvent as p}from"./index-DgAF9SIF.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";const _={title:"Form/Input",component:r,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:"Input uses shared field tokens and is suitable for search, filters, and AI prompt prefill interactions."}}},args:{placeholder:"Search release notes..."}},o={},s={render:()=>e.jsxs("div",{style:{width:520,display:"grid",gap:8},children:[e.jsx("label",{htmlFor:"prompt",style:{fontWeight:600},children:"Prompt Draft"}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr auto",gap:8},children:[e.jsx(r,{id:"prompt",placeholder:"Ask Aurora AI to scaffold a new dialog flow...","aria-label":"AI prompt"}),e.jsx(P,{children:"Send"})]}),e.jsx("small",{style:{color:"var(--aurora-text-secondary)"},children:"Tip: switch theme in toolbar to validate input token contrast."})]})},d={render:()=>e.jsxs("div",{style:{width:560,display:"grid",gap:12},children:[e.jsx(n,{label:"Default",description:"Hover and focus to verify border and ring states.",children:e.jsx(r,{placeholder:"Type project name..."})}),e.jsx(n,{label:"Error",error:"Please provide a valid email address.",required:!0,children:e.jsx(r,{placeholder:"name@company.com",defaultValue:"invalid-email"})}),e.jsx(n,{label:"Required inherited from control",children:e.jsx(r,{placeholder:"Inherited required field",required:!0})}),e.jsx(n,{label:"Disabled",description:"Disabled fields remain readable with lower emphasis.",disabled:!0,children:e.jsx(r,{placeholder:"Disabled field"})}),e.jsx(n,{label:"Read-only",description:"Read-only fields are focusable but not editable.",children:e.jsx(r,{value:"release/0.1.0",readOnly:!0,"aria-label":"Release branch"})})]})};function k(){const[t,a]=u.useState(""),[i,E]=u.useState(!1),q=i&&t.trim().length===0;return e.jsxs("div",{style:{width:560,display:"grid",gap:10},children:[e.jsx(n,{label:"Prompt",error:q?"Prompt is required.":void 0,children:e.jsx(r,{"aria-label":"Prompt input",value:t,placeholder:"Describe release note summary...",onChange:A=>a(A.target.value),onBlur:()=>E(!0)})}),e.jsxs("small",{style:{color:"var(--aurora-text-secondary)"},"data-testid":"char-count",children:[t.length," chars"]}),e.jsx(P,{disabled:t.trim().length===0,children:"Submit Prompt"})]})}const c={render:()=>e.jsx(k,{}),play:async({canvasElement:t})=>{const a=T(t),i=await a.findByRole("textbox",{name:"Prompt input"});await p.click(i),await p.tab(),await l(a.getByRole("alert")).toHaveTextContent("Prompt is required."),await l(a.getByRole("button",{name:"Submit Prompt"})).toBeDisabled(),await p.type(i,"Release summary"),await l(a.queryByRole("alert")).not.toBeInTheDocument(),await l(a.getByTestId("char-count")).toHaveTextContent("15 chars"),await l(a.getByRole("button",{name:"Submit Prompt"})).not.toBeDisabled()}},m={render:()=>e.jsxs("div",{style:{width:520,display:"grid",gap:8},children:[e.jsx(n,{label:"Grammar review",children:e.jsx(r,{"aria-label":"Grammar review input","aria-invalid":"grammar",defaultValue:"Needs grammar check"})}),e.jsx("small",{style:{color:"var(--aurora-text-secondary)"},children:'Preserves `aria-invalid="grammar"` for assistive-tech integrations that distinguish grammar/spelling corrections.'})]}),play:async({canvasElement:t})=>{const i=await T(t).findByRole("textbox",{name:"Grammar review input"});await l(i).toHaveAttribute("aria-invalid","grammar")}};var h,v,y;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:"{}",...(y=(v=o.parameters)==null?void 0:v.docs)==null?void 0:y.source}}};var b,g,x;s.parameters={...s.parameters,docs:{...(b=s.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 520,
    display: "grid",
    gap: 8
...
}`,...(S=(D=m.parameters)==null?void 0:D.docs)==null?void 0:S.source}}};const z=["Default","AiPromptStyle","StateMatrix","ValidationFlow","InvalidTokenSemantics"];export{s as AiPromptStyle,o as Default,m as InvalidTokenSemantics,d as StateMatrix,c as ValidationFlow,z as __namedExportsOrder,_ as default};
