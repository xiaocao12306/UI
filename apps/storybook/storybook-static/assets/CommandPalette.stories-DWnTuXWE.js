import{j as o}from"./jsx-runtime-BjG_zV1W.js";import{r as s}from"./index-BWu4c2F4.js";import{B as ae}from"./Button-DS9RTxKh.js";import{D as $t}from"./Dialog-B2OlqLN0.js";import{I as Ut}from"./Input-pKdbw4ss.js";import{within as y,expect as n,userEvent as c,fireEvent as C,waitFor as le}from"./index-DgAF9SIF.js";import"./bodyScrollLock-CnEUF6y7.js";import"./index-DlVbWVVj.js";import"./DismissableLayer-BWoUnDZk.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";function p({open:a,onOpenChange:e,commands:t,title:i="Command Palette",description:l="Quickly search and execute workspace actions.",searchAriaLabel:m="Search commands",resultsAriaLabel:x="Command results",closeOnSelect:b=!0,clearQueryOnEscape:R=!0,closeOnEscape:S=!0,closeOnOutsidePointer:ue=!0,onEscapeKeyDown:ne,onPointerDownOutside:oe,closeLabel:At,placeholder:Ht="Search commands...",emptyMessage:jt="No commands found.",onQueryChange:h,onCloseReason:E,getResultsStatusText:me=Vt}){const[B,re]=s.useState(""),[A,f]=s.useState(0),Ot=s.useRef(null),P=s.useRef(null),H=s.useRef(null),pe=s.useRef(a);s.useRef(null);const I=s.useId(),ye=s.useId(),we=s.useRef(null),j=s.useCallback(r=>{H.current=r,E==null||E(r)},[E]),ve=s.useCallback(r=>{j(r),e(!1),H.current=null},[j,e]),qt=s.useCallback(r=>{!r&&a&&H.current===null&&(E==null||E("close-button")),H.current=null,e(r)},[E,e,a]);s.useEffect(()=>{!a&&pe.current&&(re(r=>(r.length>0&&(h==null||h("")),"")),f(0)),pe.current=a},[h,a]),s.useEffect(()=>{},[t]);const se=s.useMemo(()=>he(B.trim()),[B]),u=s.useMemo(()=>se?t.filter(r=>{const v=[Kt(r),...r.keywords??[]].join(" ");return he(v).includes(se)}):t,[t,se]),k=s.useMemo(()=>u.reduce((r,d)=>d.disabled?r:r+1,0),[u]),ie=u.length>0,Nt=s.useMemo(()=>{const r=[];return k>0&&r.push("ArrowDown","ArrowUp","Home","End","PageDown","PageUp","Enter"),(S||R&&B.length>0)&&r.push("Escape"),r.length>0?r.join(" "):void 0},[R,S,k,B.length]),Lt=s.useMemo(()=>me({query:B,visibleCount:u.length,enabledCount:k,totalCount:t.length}),[t.length,k,u.length,me,B]),T=s.useMemo(()=>u.reduce((r,d,v)=>(d.disabled||r.push(v),r),[]),[u]),D=T[0]??-1,ge=T[T.length-1]??-1,g=s.useMemo(()=>{if(A<0)return-1;const r=u[A];return!r||r.disabled?-1:A},[A,u]);s.useEffect(()=>{var d;if(u.length===0){P.current=null,f(-1);return}const r=P.current;if(r){const v=u.findIndex(w=>!w.disabled&&w.key===r);if(v>=0){f(v);return}}f(D),P.current=D>=0?((d=u[D])==null?void 0:d.key)??null:null},[u,D]),s.useEffect(()=>{var r;if(g<0){P.current=null;return}P.current=((r=u[g])==null?void 0:r.key)??null},[u,g]),s.useEffect(()=>{if(!a||g<0)return;const r=we.current,d=document.getElementById(`${I}-option-${g}`);!r||!d||!r.contains(d)||typeof d.scrollIntoView=="function"&&d.scrollIntoView({block:"nearest"})},[I,a,g]);const ce=s.useCallback(r=>{var v;const d=u[r];!d||d.disabled||((v=d.onSelect)==null||v.call(d),b&&ve("item-select"))},[b,ve,u]),be=r=>{var v;if(u.length===0)return;let d=g<0?r===1?-1:0:g;for(let w=0;w<u.length;w+=1)if(d=(d+r+u.length)%u.length,!((v=u[d])!=null&&v.disabled)){f(d);return}},xe=r=>{if(T.length===0)return;const d=T.indexOf(g);if(d<0){f(r===1?D:ge);return}const v=Math.min(T.length-1,Math.max(0,d+r*5));f(T[v]??D)};return o.jsx($t,{open:a,onOpenChange:qt,title:i,description:l,closeLabel:At,size:"md",closeOnEscape:S,closeOnOutsidePointer:ue,onEscapeKeyDown:r=>{ne==null||ne(r),!(r.defaultPrevented||!S)&&j("escape-key")},onPointerDownOutside:r=>{oe==null||oe(r),!(r.defaultPrevented||!ue)&&j("outside-pointer")},children:o.jsxs("div",{style:{display:"grid",gap:10},children:[o.jsx(Ut,{ref:Ot,"data-autofocus":"",role:"combobox","aria-expanded":ie,"aria-haspopup":"listbox","aria-autocomplete":"list","aria-controls":ie?I:void 0,"aria-activedescendant":g>=0?`${I}-option-${g}`:void 0,"aria-describedby":ye,"aria-keyshortcuts":Nt,placeholder:Ht,value:B,onChange:r=>{re(r.target.value),h==null||h(r.target.value)},onKeyDown:r=>{if(!Mt(r)&&!(r.altKey||r.ctrlKey||r.metaKey)){if(r.key==="Escape"&&R&&B.length>0){r.preventDefault(),re(""),h==null||h("");return}if(r.key==="ArrowDown"){if(k===0)return;r.preventDefault(),be(1);return}if(r.key==="ArrowUp"){if(k===0)return;r.preventDefault(),be(-1);return}if(r.key==="Home"){if(k===0)return;r.preventDefault(),f(D);return}if(r.key==="End"){if(k===0)return;r.preventDefault(),f(ge);return}if(r.key==="PageDown"){if(k===0)return;r.preventDefault(),xe(1);return}if(r.key==="PageUp"){if(k===0)return;r.preventDefault(),xe(-1);return}if(r.key==="Enter"&&g>=0){if(r.preventDefault(),r.repeat)return;ce(g)}}},"aria-label":m}),o.jsx("p",{id:ye,role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:Lt}),ie?o.jsx("div",{id:I,ref:we,role:"listbox","aria-label":x,style:{maxHeight:280,overflow:"auto",display:"grid",gap:4},children:u.map((r,d)=>{const v=d===g;return o.jsx("div",{id:`${I}-option-${d}`,role:"option","aria-selected":v,"aria-disabled":r.disabled||void 0,"aria-posinset":d+1,"aria-setsize":u.length,tabIndex:-1,onPointerDown:w=>{w.pointerType==="mouse"||w.button!==0||w.preventDefault()},onMouseDown:w=>{w.button===0&&w.preventDefault()},onMouseEnter:()=>{r.disabled||f(d)},onClick:()=>{r.disabled||ce(d)},onKeyDown:w=>{r.disabled||(w.key==="Enter"||w.key===" "||w.key==="Space"||w.key==="Spacebar")&&(w.preventDefault(),ce(d))},style:{border:"1px solid var(--aurora-border-default)",background:v?"color-mix(in srgb, var(--aurora-accent-default) 14%, var(--aurora-surface-default))":"var(--aurora-surface-default)",color:r.disabled?"color-mix(in srgb, var(--aurora-text-secondary) 60%, transparent)":"var(--aurora-text-primary)",borderRadius:8,height:36,padding:"0 10px",textAlign:"left",cursor:r.disabled?"not-allowed":"pointer"},children:r.label},r.key)})}):o.jsx("p",{style:{margin:0,color:"var(--aurora-text-secondary)"},children:jt})]})})}function Kt(a){return typeof a.textValue=="string"?a.textValue.trim():typeof a.label=="string"?a.label.trim():""}function he(a){return a.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase()}function Mt(a){const e=a.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function Vt({query:a,visibleCount:e,enabledCount:t,totalCount:i}){const l=a.trim();return l.length===0?t!==i?`${t} of ${i} command${i===1?"":"s"} available.`:`${i} command${i===1?"":"s"} available.`:e===0?`No commands match "${l}".`:t===0?`No enabled commands match "${l}".`:t!==e?`${t} of ${e} matching command${t===1?"":"s"} available for "${l}".`:`${e} command${e===1?"":"s"} found for "${l}".`}p.__docgenInfo={description:"",methods:[],displayName:"CommandPalette",props:{open:{required:!0,tsType:{name:"boolean"},description:""},onOpenChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""},commands:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: string;
...
}`,...(Le=(Ne=U.parameters)==null?void 0:Ne.docs)==null?void 0:Le.source}}};var $e,Ue,Ke;K.parameters={...K.parameters,docs:{...($e=K.parameters)==null?void 0:$e.docs,source:{originalSource:`{
...
}`,...(Ke=(Ue=K.parameters)==null?void 0:Ue.docs)==null?void 0:Ke.source}}};var Me,Ve,Fe;M.parameters={...M.parameters,docs:{...(Me=M.parameters)==null?void 0:Me.docs,source:{originalSource:`{
...
}`,...(Fe=(Ve=M.parameters)==null?void 0:Ve.docs)==null?void 0:Fe.source}}};var ze,Ge,Qe;V.parameters={...V.parameters,docs:{...(ze=V.parameters)==null?void 0:ze.docs,source:{originalSource:`{
...
}`,...(Qe=(Ge=V.parameters)==null?void 0:Ge.docs)==null?void 0:Qe.source}}};var _e,We,Je;F.parameters={...F.parameters,docs:{...(_e=F.parameters)==null?void 0:_e.docs,source:{originalSource:`{
...
}`,...(Je=(We=F.parameters)==null?void 0:We.docs)==null?void 0:Je.source}}};var Xe,Ye,Ze;z.parameters={...z.parameters,docs:{...(Xe=z.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
  render: () => <OpenPalette />,
  play: async ({
    canvasElement
  }) => {
...
}`,...(Ze=(Ye=z.parameters)==null?void 0:Ye.docs)==null?void 0:Ze.source}}};var et,tt,at;G.parameters={...G.parameters,docs:{...(et=G.parameters)==null?void 0:et.docs,source:{originalSource:`{
...
}`,...(at=(tt=G.parameters)==null?void 0:tt.docs)==null?void 0:at.source}}};var nt,ot,rt;Q.parameters={...Q.parameters,docs:{...(nt=Q.parameters)==null?void 0:nt.docs,source:{originalSource:`{
...
}`,...(yt=(pt=J.parameters)==null?void 0:pt.docs)==null?void 0:yt.source}}};var wt,vt,gt;X.parameters={...X.parameters,docs:{...(wt=X.parameters)==null?void 0:wt.docs,source:{originalSource:`{
...
}`,...(gt=(vt=X.parameters)==null?void 0:vt.docs)==null?void 0:gt.source}}};var bt,xt,ht;Y.parameters={...Y.parameters,docs:{...(bt=Y.parameters)==null?void 0:bt.docs,source:{originalSource:`{
