...
| `,e.jsx(n.code,{children:"defaultSortKey"})," / ",e.jsx(n.code,{children:"defaultSortDirection"})," | ",e.jsx(n.code,{children:"string"})," / ",e.jsx(n.code,{children:"'asc' \\| 'desc'"})," | Sets initial data order and marks the active sorted header with ",e.jsx(n.code,{children:"aria-sort"}),`. |
...
| sort interaction guard | loading/empty/single-row auto-disabled | Sort buttons disable automatically when sorting would be no-op (`,e.jsx(n.code,{children:"loading"}),`, zero rows, or one row). |
...
| IME safety | composition key guard | Arrow/Enter handling is ignored while `,e.jsx(n.code,{children:"isComposing"})," (or legacy ",e.jsx(n.code,{children:"keyCode=229"}),`) to prevent accidental command execution during CJK input. |
...
| `,e.jsx(n.code,{children:"speed"})," | ",e.jsx(n.code,{children:"number"})," | Milliseconds per character; ",e.jsx(n.code,{children:"0"})," renders immediately. |"]})]})}function $o(i={}){const{wrapper:n}={...C(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(w,{...i})}):w(i)}export{$o as default};
