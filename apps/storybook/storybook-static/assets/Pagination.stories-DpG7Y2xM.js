import{j as n}from"./jsx-runtime-BjG_zV1W.js";import{r as c}from"./index-BWu4c2F4.js";import{B as k}from"./Badge-ZJmMstsz.js";import{within as h,expect as s,userEvent as p,fireEvent as _e}from"./index-DgAF9SIF.js";function j(t,e,o){return Math.min(Math.max(t,e),o)}function ee(t,e){const o=e-t+1;return Array.from({length:o},(i,g)=>t+g)}function ze(t,e,o,i){const g=i*2+o*2+3;if(e<=g)return ee(1,e);const l=Math.max(t-o,i+2),R=Math.min(t+o,e-i-1),f=[],Y=ee(1,i),K=ee(e-i+1,e);f.push(...Y),l>i+2?f.push("ellipsis-left"):i+1<l&&f.push(i+1);for(let b=l;b<=R;b+=1)f.push(b);return R<e-i-1?f.push("ellipsis-right"):R+1<e-i+1&&f.push(e-i),f.push(...K),f}function w({page:t,pageCount:e,onPageChange:o,siblingCount:i=1,boundaryCount:g=1,disabled:l=!1,showFirstLast:R=!0,ariaLabel:f="Pagination",ariaLabelledBy:Y,getItemAriaLabel:K=oe}){const b=c.useRef(null),L=c.useRef(null),G=c.useRef(!1),x=c.useRef(!1),[B,M]=c.useState(null),[C,P]=c.useState(null),Ve=te(f,"Pagination"),ae=te(Y),H=Math.max(e,1),d=j(t,1,H),We=e<=1?[]:ze(d,e,i,g),ne=j(d-1,1,H),re=j(d+1,1,H),y=!l&&e>1&&d>1,m=!l&&e>1&&d<e,D=c.useMemo(()=>{if(l||e<=1)return;const a=[];return y&&a.push("Home"),m&&a.push("End"),(y||m)&&a.push("ArrowLeft","ArrowRight"),a.length>0?a.join(" "):void 0},[m,y,l,e]),E=c.useCallback((a,r)=>te(K(a,r),oe(a,r)),[K]);c.useEffect(()=>{l&&(M(null),P(null))},[l]),c.useEffect(()=>{var T;const a=((T=b.current)==null?void 0:T.ownerDocument)??document,r=v=>{v.metaKey||v.altKey||v.ctrlKey||(x.current=!0)},u=v=>{"button"in v&&typeof v.button=="number"&&v.button!==0||"ctrlKey"in v&&v.ctrlKey||(x.current=!1)};return a.addEventListener("keydown",r,!0),a.addEventListener("pointerdown",u,!0),a.addEventListener("mousedown",u,!0),a.addEventListener("touchstart",u,!0),()=>{a.removeEventListener("keydown",r,!0),a.removeEventListener("pointerdown",u,!0),a.removeEventListener("mousedown",u,!0),a.removeEventListener("touchstart",u,!0)}},[]);const A=a=>{if(l||e<=1)return;const r=j(a,1,e);r!==d&&o(r)};c.useLayoutEffect(()=>{var u;if(L.current===null)return;const a=L.current;L.current=null;const r=(u=b.current)==null?void 0:u.querySelector(`button[data-aurora-pagination-page="${a}"]`);r&&(G.current=!0,r.focus(),G.current=!1)},[d]);const Z=a=>{const r=j(a,1,e);if(r===d){L.current=null;return}const u=`page-${r}`;M(u),P(x.current?u:null),L.current=r,A(r)},I=a=>{if(x.current=!0,l||(a.altKey||a.ctrlKey||a.metaKey)&&Ne(a.key))return;if(a.key==="Home"){if(d===1)return;a.preventDefault(),Z(1);return}if(a.key==="End"){if(d===H)return;a.preventDefault(),Z(H);return}const r=Oe(a.key,a.currentTarget);if(r===void 0)return;const u=j(d+r,1,H);u!==d&&(a.preventDefault(),Z(u))},F=c.useCallback(a=>({"data-focus-visible":B===a&&C===a?"true":void 0,onFocus:r=>{G.current||(M(a),P(Ue(r.currentTarget,x.current)?a:null))},onBlur:()=>{G.current||(M(r=>r===a?null:r),P(r=>r===a?null:r))},onMouseDown:r=>{r.button!==0||r.ctrlKey||(x.current=!1,P(u=>u===a?null:u))},onPointerDown:r=>{r.button!==0||r.ctrlKey||(x.current=!1,P(u=>u===a?null:u))}}),[B,C]);return e<=1?null:n.jsx("nav",{ref:b,"aria-label":ae?void 0:Ve,"aria-labelledby":ae,children:n.jsxs("ul",{style:{listStyle:"none",padding:0,margin:0,display:"flex",flexWrap:"wrap",gap:6,alignItems:"center"},children:[R?n.jsx("li",{children:n.jsx("button",{...F("first"),type:"button",disabled:!y,onClick:()=>A(1),onKeyDown:I,"aria-label":E("first",1),"aria-keyshortcuts":y?D:void 0,style:S(!1,!y,B==="first"&&C==="first"),children:"«"})}):null,n.jsx("li",{children:n.jsx("button",{...F("previous"),type:"button",disabled:!y,onClick:()=>A(ne),onKeyDown:I,"aria-label":E("previous",ne),"aria-keyshortcuts":y?D:void 0,style:S(!1,!y,B==="previous"&&C==="previous"),children:"‹"})}),We.map((a,r)=>{if(typeof a!="number")return n.jsx("li",{"aria-hidden":"true",style:{color:"var(--aurora-text-secondary)",minWidth:32,textAlign:"center"},children:"…"},`${a}-${r}`);const u=a===d,T=`page-${a}`;return n.jsx("li",{children:n.jsx("button",{...F(T),type:"button",onClick:()=>A(a),disabled:l,onKeyDown:I,"data-aurora-pagination-page":a,"aria-current":u?"page":void 0,"aria-label":E(u?"current":"page",a),"aria-keyshortcuts":l?void 0:D,style:S(u,l,B===T&&C===T),children:a})},a)}),n.jsx("li",{children:n.jsx("button",{...F("next"),type:"button",disabled:!m,onClick:()=>A(re),onKeyDown:I,"aria-label":E("next",re),"aria-keyshortcuts":m?D:void 0,style:S(!1,!m,B==="next"&&C==="next"),children:"›"})}),R?n.jsx("li",{children:n.jsx("button",{...F("last"),type:"button",disabled:!m,onClick:()=>A(e),onKeyDown:I,"aria-label":E("last",e),"aria-keyshortcuts":m?D:void 0,style:S(!1,!m,B==="last"&&C==="last"),children:"»"})}):null]})})}function Ne(t){return t==="Home"||t==="End"||t==="ArrowLeft"||t==="ArrowRight"}function Oe(t,e){if(!(t!=="ArrowLeft"&&t!=="ArrowRight"))return Je(t,Qe(e))}function Je(t,e){return t==="ArrowRight"?e?-1:1:e?1:-1}function Qe(t){if(!t)return!1;const e=t.closest("[dir]");if((e==null?void 0:e.dir)==="rtl")return!0;if((e==null?void 0:e.dir)==="ltr")return!1;const o=t.ownerDocument.defaultView??(typeof window<"u"?window:null);return o?o.getComputedStyle(t).direction==="rtl":!1}function oe(t,e){switch(t){case"first":return"Go to first page";case"last":return"Go to last page";case"previous":return"Go to previous page";case"next":return"Go to next page";case"current":return`Current page, ${e}`;default:return`Go to page ${e}`}}function S(t,e,o){return{minWidth:32,height:32,padding:"0 8px",borderRadius:"var(--aurora-radius-sm)",border:t?"1px solid var(--aurora-accent-default)":"1px solid var(--aurora-border-default)",background:t?"color-mix(in srgb, var(--aurora-accent-default) 12%, var(--aurora-surface-default))":"var(--aurora-surface-default)",color:e?"color-mix(in srgb, var(--aurora-text-secondary) 65%, transparent)":"var(--aurora-text-primary)",cursor:e?"not-allowed":"pointer",font:"inherit",boxShadow:!e&&o?"0 0 0 3px color-mix(in srgb, var(--aurora-accent-default) 24%, transparent)":"none"}}function te(t,e){return typeof t=="string"&&t.trim().length>0?t.trim():e}function Ue(t,e){try{return t.matches(":focus-visible")||e}catch{return e}}w.__docgenInfo={description:"",methods:[],displayName:"Pagination",props:{page:{required:!0,tsType:{name:"number"},description:""},pageCount:{required:!0,tsType:{name:"number"},description:""},onPageChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(page: number) => void",signature:{arguments:[{type:{name:"number"},name:"page"}],return:{name:"void"}}},description:""},siblingCount:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},boundaryCount:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},showFirstLast:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},ariaLabel:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"Pagination"',computed:!1}},ariaLabelledBy:{required:!1,tsType:{name:"string"},description:""},getItemAriaLabel:{required:!1,tsType:{name:"signature",type:"function",raw:`(
...
}`,...(de=(le=q.parameters)==null?void 0:le.docs)==null?void 0:de.source}}};var pe,ge,fe;V.parameters={...V.parameters,docs:{...(pe=V.parameters)==null?void 0:pe.docs,source:{originalSource:`{
...
}`,...(fe=(ge=V.parameters)==null?void 0:ge.docs)==null?void 0:fe.source}}};var ye,me,ve;W.parameters={...W.parameters,docs:{...(ye=W.parameters)==null?void 0:ye.docs,source:{originalSource:`{
...
}`,...(ve=(me=W.parameters)==null?void 0:me.docs)==null?void 0:ve.source}}};var we,he,be;_.parameters={..._.parameters,docs:{...(we=_.parameters)==null?void 0:we.docs,source:{originalSource:`{
  args: {
    page: 9,
    pageCount: 48,
    onPageChange: () => {}
...
}`,...(qe=($e=X.parameters)==null?void 0:$e.docs)==null?void 0:qe.source}}};const it=["Controlled","KeyboardShortcuts","ModifierKeyGuard","RtlKeyboardShortcuts","CompactRange","WithoutFirstLast","DisabledPagination","CustomAriaLabels","BoundaryAriaLabels","BoundaryShortcutHints","LabelledByHeading","FocusIntentReentry"];export{J as BoundaryAriaLabels,Q as BoundaryShortcutHints,_ as CompactRange,$ as Controlled,O as CustomAriaLabels,N as DisabledPagination,X as FocusIntentReentry,q as KeyboardShortcuts,U as LabelledByHeading,V as ModifierKeyGuard,W as RtlKeyboardShortcuts,z as WithoutFirstLast,it as __namedExportsOrder,st as default};
