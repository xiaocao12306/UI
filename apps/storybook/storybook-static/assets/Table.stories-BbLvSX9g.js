import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{B as Zn}from"./Button--WiRqiCc.js";import{r as u}from"./index-BWu4c2F4.js";import{B as ea}from"./Badge-ZJmMstsz.js";import{within as b,expect as n,userEvent as l,fireEvent as g,waitFor as Ze}from"./index-DgAF9SIF.js";import{S as w,s as C,a as Le}from"./storyShowcase-Bw5VyCj0.js";const Pn="Enter Space",ta=`${Pn} Home End PageDown PageUp ArrowLeft ArrowRight`,na=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"}),et=400;function tt(t,e,o){if(!e)return null;const s=t.find(S=>String(S.key)===e);return s!=null&&s.sortable?{key:e,direction:o}:null}function nt(t,e){if(typeof t.sortLabel=="string"&&t.sortLabel.trim().length>0)return t.sortLabel.trim();const o=Fe(je(t.header));return o.length>0?o:e}function y({columns:t,data:e,rowKey:o,caption:s,ariaLabel:S,ariaLabelledBy:Te,loading:D=!1,loadingContent:L="Loading data...",emptyContent:K="No data available.",defaultSortKey:R,defaultSortDirection:O="asc",getSortAriaLabel:qn=at,getSortStatusText:We=aa,onSortChange:De}){const U=Ke(Te),Pe=U?void 0:Ke(S,s?void 0:"Data table"),W=u.useRef({}),Ne=u.useRef(null),He=u.useRef(null),z=u.useRef(0),P=u.useRef(null),G=u.useRef(null),N=u.useRef(!0);u.useRef(null),u.useRef(null),u.useRef(null);const[Mn,Ae]=u.useState(null),[Vn,A]=u.useState(null),[On,$]=u.useState(null);u.useEffect(()=>{var c;const i=((c=Ne.current)==null?void 0:c.ownerDocument)??document,d=p=>{p.metaKey||p.altKey||p.ctrlKey||(N.current=!0)},m=p=>{"button"in p&&typeof p.button=="number"&&p.button!==0||"ctrlKey"in p&&p.ctrlKey||(N.current=!1)};return i.addEventListener("keydown",d,!0),i.addEventListener("pointerdown",m,!0),i.addEventListener("mousedown",m,!0),i.addEventListener("touchstart",m,!0),()=>{i.removeEventListener("keydown",d,!0),i.removeEventListener("pointerdown",m,!0),i.removeEventListener("mousedown",m,!0),i.removeEventListener("touchstart",m,!0)}},[]);const _=u.useCallback(()=>{He.current=null,z.current=0,P.current!==null&&((G.current??window).clearTimeout(P.current),P.current=null),G.current=null},[]);u.useEffect(()=>()=>{_()},[_]);const[h,Ie]=u.useState(()=>tt(t,R,O)),Y=u.useMemo(()=>{const i=new Map;return t.map(d=>{const m=String(d.key),c=i.get(m)??0;return i.set(m,c+1),c===0?m:`${m}__duplicate-${c}`})},[t]),I=u.useMemo(()=>D||e.length<=1?[]:t.reduce((i,d,m)=>(d.sortable&&i.push(Y[m]??`${String(d.key)}__index-${m}`),i),[]),[t,e.length,D,Y]);u.useEffect(()=>{if(!h)return;const i=t.find(d=>String(d.key)===h.key);i!=null&&i.sortable||Ie(null)},[t,h]),u.useEffect(()=>{if(h)return;const i=tt(t,R,O);i&&Ie(i)},[t,O,R,h]);const Ee=u.useMemo(()=>e.map((i,d)=>String(o?o(i,d):d)),[e,o]),Un=u.useMemo(()=>{const i=new Map;return Ee.map((d,m)=>{const c=i.get(d)??0;return i.set(d,c+1),c===0?d:`${d}__dup-${m}`})},[Ee]);u.useEffect(()=>{},[o,Ee]),u.useEffect(()=>{},[t]),u.useEffect(()=>{},[t]);const q=u.useMemo(()=>{const i=e.map((c,p)=>({row:c,sourceIndex:p}));if(!h)return i;const d=t.find(c=>String(c.key)===h.key);if(!(d!=null&&d.sortable))return i;const m=d.sortAccessor??(c=>{const p=c[String(d.key)];return p instanceof Date||typeof p=="number"||typeof p=="string"?p:String(p??"")});return i.sort((c,p)=>{const B=m(c.row),H=m(p.row);if(typeof B=="string"&&typeof H=="string"){const j=na.compare(B,H);return j!==0?h.direction==="asc"?j:-j:c.sourceIndex-p.sourceIndex}const E=B instanceof Date?B.getTime():B,F=H instanceof Date?H.getTime():H;return E<F?h.direction==="asc"?-1:1:E>F?h.direction==="asc"?1:-1:c.sourceIndex-p.sourceIndex})},[t,e,h]),$e=u.useMemo(()=>{if(D||q.length<=1||!h)return"";const i=t.find(m=>String(m.key)===h.key);if(!(i!=null&&i.sortable))return"";const d=nt(i,String(i.key));return We({columnKey:h.key,columnHeader:d,direction:h.direction})},[t,We,D,h,q.length]),V=!D&&q.length>1&&t.some(i=>i.sortable),qe=Math.max(t.length,1);return u.useEffect(()=>{V||(Ae(null),A(null),$(null))},[V]),a.jsxs("div",{ref:Ne,"data-aurora-table-scroll-container":"",tabIndex:V?void 0:0,"aria-label":V||U?void 0:Pe??"Data table scroll container","aria-labelledby":V?void 0:U,style:{border:"1px solid var(--aurora-border-default)",borderRadius:"var(--aurora-radius-md)",overflow:"auto"},children:[$e?a.jsx("p",{role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:$e}):null,a.jsxs("table",{"aria-label":Pe,"aria-labelledby":U,"aria-busy":D||void 0,style:{width:"100%",borderCollapse:"collapse",minWidth:560},children:[s?a.jsx("caption",{style:{textAlign:"left",padding:"10px 12px",color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-sm)",borderBottom:"1px solid var(--aurora-border-default)"},children:s}):null,a.jsx("thead",{children:a.jsx("tr",{children:t.map((i,d)=>{const m=String(i.key),c=Y[d]??`${m}__index-${d}`,p=!!i.sortable,B=q.length>1,H=p&&(h==null?void 0:h.key)===m?h.direction:void 0,E=!D&&B?H:void 0,F=E?E==="asc"?"ascending":"descending":void 0,j=i.align??"left",Me=nt(i,m),J=H==="asc"?"desc":"asc",zn=qn({columnKey:m,columnHeader:Me,nextDirection:J}),Gn=Ke(zn,at({columnHeader:Me,nextDirection:J})),T=D||!B,_n=T?void 0:I.length>1?ta:Pn,Ve=!T&&Mn===c,Oe=!T&&Vn===c,Ue=!T&&On===c,Yn=Ve||Ue,ze=()=>{T||(Ie({key:m,direction:J}),De==null||De(m,J))};return a.jsx("th",{scope:"col","aria-sort":F,style:{textAlign:j,color:"var(--aurora-text-secondary)",background:"var(--aurora-surface-elevated)",borderBottom:"1px solid var(--aurora-border-default)",padding:"10px 12px",fontSize:"var(--aurora-font-size-sm)",fontWeight:"var(--aurora-font-weight-medium)",width:i.width},children:p?a.jsxs("button",{"data-aurora-reduced-motion":"transition",type:"button",ref:r=>{W.current[c]=r},"aria-label":Gn,"aria-keyshortcuts":_n,disabled:T,onClick:r=>{const x=Date.now()-z.current,Q=r.detail===0&&He.current===c&&z.current>0&&x<=et;_(),!Q&&ze()},onMouseEnter:()=>{T||Ae(c)},onMouseLeave:()=>{Ae(r=>r===c?null:r),A(r=>r===c?null:r)},onPointerDown:r=>{T||r.pointerType==="mouse"||r.ctrlKey||typeof r.button=="number"&&r.button!==0||(N.current=!1,$(x=>x===c?null:x),A(c))},onPointerUp:r=>{r.pointerType!=="mouse"&&(typeof r.button!="number"||r.button===0)&&A(x=>x===c?null:x)},onMouseDown:r=>{T||r.button!==0||r.ctrlKey||(N.current=!1,$(x=>x===c?null:x),A(c))},onMouseUp:r=>{r.button===0&&A(x=>x===c?null:x)},onPointerCancel:()=>{A(r=>r===c?null:r)},onFocus:()=>{if(T){$(r=>r===c?null:r);return}$(r=>ra(W.current[c],N.current)?c:r===c?null:r)},onBlur:()=>{$(r=>r===c?null:r),A(r=>r===c?null:r)},onKeyDown:r=>{var Q,Ge,_e,Ye,Je;if(N.current=!0,r.altKey||r.ctrlKey||r.metaKey)return;if(r.key==="Home"){const k=I[0];if(!k)return;r.preventDefault(),(Q=W.current[k])==null||Q.focus();return}if(r.key==="End"){const k=I[I.length-1];if(!k)return;r.preventDefault(),(Ge=W.current[k])==null||Ge.focus();return}if(r.key==="PageDown"||r.key==="PageUp"){const k=I.indexOf(c);if(k<0)return;const Qe=r.key==="PageDown"?1:-1,M=Math.max(0,Math.min(I.length-1,k+Qe));if(M===k)return;r.preventDefault();const Ce=I[M];(_e=W.current[Ce])==null||_e.focus();return}if(r.key==="ArrowLeft"||r.key==="ArrowRight"){const k=I.indexOf(c);if(k<0)return;const M=(r.currentTarget.ownerDocument.defaultView??window).getComputedStyle(r.currentTarget).direction,Ce=(Ye=r.currentTarget.closest("[dir]"))==null?void 0:Ye.getAttribute("dir"),Jn=(M==="rtl"||M==="ltr"?M:Ce==="rtl"?"rtl":"ltr")==="rtl"?"ArrowLeft":"ArrowRight",Qn=r.key===Jn?1:-1,Xe=Math.max(0,Math.min(I.length-1,k+Qn));if(Xe===k)return;r.preventDefault();const Xn=I[Xe];(Je=W.current[Xn])==null||Je.focus();return}if(!ot(r.key)||oa(r)||(r.preventDefault(),r.repeat))return;A(c),He.current=c,z.current=Date.now();const x=r.currentTarget.ownerDocument.defaultView??window;P.current!==null&&(G.current??x).clearTimeout(P.current),G.current=x,P.current=x.setTimeout(()=>{_()},et),ze()},onKeyUp:r=>{r.altKey||r.ctrlKey||r.metaKey||ot(r.key)&&A(x=>x===c?null:x)},style:{border:Yn?"1px solid color-mix(in srgb, var(--aurora-accent-default) 48%, transparent)":"1px solid transparent",borderRadius:"var(--aurora-radius-sm)",background:Oe?"color-mix(in srgb, var(--aurora-surface-elevated) 68%, var(--aurora-surface-default))":Ve?"color-mix(in srgb, var(--aurora-surface-elevated) 86%, var(--aurora-surface-default))":"transparent",font:"inherit",cursor:T?"not-allowed":"pointer",display:"inline-flex",alignItems:"center",gap:6,padding:"2px 6px",color:T?"color-mix(in srgb, var(--aurora-text-secondary) 88%, var(--aurora-text-primary))":"inherit",boxShadow:Ue?"0 0 0 3px color-mix(in srgb, var(--aurora-focus-ring) 42%, transparent)":"none",transform:Oe?"translateY(1px)":"translateY(0)",transition:"background-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), border-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), box-shadow var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), transform var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard)"},children:[i.header,a.jsx("span",{"aria-hidden":"true",children:E==="asc"?"▲":E==="desc"?"▼":"↕"})]}):i.header},c)})})}),a.jsx("tbody",{children:D?a.jsx("tr",{children:a.jsx("td",{colSpan:qe,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:L})})}):q.length===0?a.jsx("tr",{children:a.jsx("td",{colSpan:qe,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:K})})}):q.map((i,d)=>{const m=i.row,c=String(i.sourceIndex),p=Un[i.sourceIndex]??c;return a.jsx("tr",{style:{background:d%2===0?"transparent":"var(--aurora-surface-elevated)"},children:t.map((B,H)=>{const E=B.render?B.render(m,d,i.sourceIndex):String(m[String(B.key)]??""),F=Y[H]??`${String(B.key)}__index-${H}`,j={padding:"10px 12px",borderBottom:"1px solid var(--aurora-border-default)",color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",textAlign:B.align??"left"};return B.rowHeader?a.jsx("th",{scope:"row",style:{...j,fontWeight:"var(--aurora-font-weight-medium)"},children:E},F):a.jsx("td",{style:j,children:E},F)})},p)})})]})]})}function at({columnHeader:t,nextDirection:e}){return`${t} sort ${e==="asc"?"ascending":"descending"}`}function aa({columnHeader:t,direction:e}){return`Sorted by ${t} ${e==="asc"?"ascending":"descending"}.`}function ot(t){return t==="Enter"||t===" "||t==="Space"||t==="Spacebar"}function oa(t){const e=t.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function ra(t,e){if(!t)return e;try{return t.matches(":focus-visible")}catch{return e}}function je(t){if(typeof t=="string")return t;if(typeof t=="number")return String(t);if(Array.isArray(t))return Fe(t.map(o=>je(o)).filter(o=>o.length>0).join(" "));if(!u.isValidElement(t))return"";const e=t.props;if(e["aria-hidden"]===!0||e["aria-hidden"]==="true")return"";if(typeof e["aria-label"]=="string"){const o=Fe(e["aria-label"]);if(o.length>0)return o}return je(e.children)}function Fe(t){return t.replace(/\s+/g," ").trim()}function Ke(t,e){return typeof t=="string"&&t.trim().length>0?t.trim():e}y.__docgenInfo={description:"",methods:[],displayName:"Table",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: keyof T | string;
...
}`,computed:!1}},onSortChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(key: string, direction: TableSortDirection) => void",signature:{arguments:[{type:{name:"string"},name:"key"},{type:{name:"union",raw:'"asc" | "desc"',elements:[{name:"literal",value:'"asc"'},{name:"literal",value:'"desc"'}]},name:"direction"}],return:{name:"void"}}},description:""}}};const v=[{id:"BTN-102",component:"Button",owner:"Design System",status:"ready"},{id:"DLG-210",component:"Dialog",owner:"Platform UI",status:"review"},{id:"AIP-501",component:"PromptInput",owner:"AI UX",status:"blocked"}],f=[{key:"id",header:"Issue",width:120,sortable:!0,rowHeader:!0},{key:"component",header:"Component",sortable:!0},{key:"owner",header:"Owner",sortable:!0},{key:"status",header:"Status",width:140,sortable:!0,sortAccessor:t=>t.status,render:t=>{const e=t.status==="ready"?"success":t.status==="review"?"default":"danger";return a.jsx(ea,{tone:e,children:t.status})}}];function rt(t,e){const o=new KeyboardEvent("keydown",{key:e,bubbles:!0});Object.defineProperty(o,"isComposing",{value:!0}),Object.defineProperty(o,"keyCode",{value:229}),t.dispatchEvent(o)}function st(t,e){const o=new KeyboardEvent("keydown",{key:e,bubbles:!0});Object.defineProperty(o,"keyCode",{value:229}),t.dispatchEvent(o)}function sa(){const[t,e]=u.useState(!1);return a.jsxs(w,{maxWidth:"min(100%, 840px)",gap:10,children:[a.jsx("button",{type:"button",onClick:()=>e(o=>!o),children:"Toggle loading"}),a.jsx(y,{columns:f,data:v,loading:t,loadingContent:"Syncing release feed...",defaultSortKey:"id"})]})}const va={title:"Data/Table",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:"Table accepts typed column definitions and custom cell renderers for status-heavy ops screens."}}}},X={render:()=>a.jsx(w,{maxWidth:"min(100%, 840px)",gap:10,children:a.jsx(y,{caption:"Release readiness board",columns:f,data:v,rowKey:t=>t.id,defaultSortKey:"id"})})},Z={render:()=>a.jsx(w,{maxWidth:"min(100%, 840px)",gap:10,children:a.jsx(y,{caption:"Release readiness board",columns:f,data:v,rowKey:t=>t.id,defaultSortKey:"id",defaultSortDirection:"desc"})}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("columnheader",{name:/Issue/}),s=e.getAllByRole("rowheader")[0];await n(o).toHaveAttribute("aria-sort","descending"),await n(s).toHaveTextContent("DLG-210"),await n(e.getByRole("button",{name:"Issue sort ascending"})).toBeInTheDocument()}},ee={render:()=>{const t=[...f,{key:"action",header:"Action",width:160,render:e=>a.jsx(Zn,{size:"sm",variant:"outline",onClick:o=>o.preventDefault(),"aria-label":`Open ${e.id}`,children:"Open Ticket"})}];return a.jsx(y,{columns:t,data:v,rowKey:e=>e.id})}},te={render:()=>a.jsx(w,{maxWidth:"min(100%, 780px)",children:a.jsx(y,{columns:f,data:[],emptyContent:"No release items yet."})}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("button",{name:"Issue sort ascending"});await n(e.getByText("No release items yet.")).toBeInTheDocument(),await n(e.getByRole("status")).toHaveTextContent("No release items yet."),await n(o).toBeDisabled(),await n(o).not.toHaveAttribute("aria-keyshortcuts")}},ne={render:()=>a.jsx(w,{maxWidth:"min(100%, 780px)",children:a.jsx(y,{columns:f,data:[{id:"BTN-102",component:"Button",owner:"Design System",status:"ready"}],defaultSortKey:"id"})}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("columnheader",{name:/Issue/});await n(o).not.toHaveAttribute("aria-sort"),await n(e.queryByRole("status")).not.toBeInTheDocument(),await n(e.getByRole("button",{name:"Issue sort descending"})).toBeDisabled()}},ae={render:()=>a.jsx(w,{maxWidth:"min(100%, 780px)",children:a.jsx(y,{columns:[{key:"id",header:"Issue",sortable:!0,rowHeader:!0},{key:"component",header:"Component"},{key:"owner",header:"Owner"},{key:"status",header:"Status"}],data:v,defaultSortKey:"id",rowKey:t=>t.id})}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("button",{name:"Issue sort descending"});await n(o).toHaveAttribute("aria-keyshortcuts","Enter Space"),o.focus(),await l.keyboard("{ArrowRight}"),await n(o).toHaveFocus(),await n(e.getByRole("columnheader",{name:/Issue/})).toHaveAttribute("aria-sort","ascending")}},oe={render:()=>a.jsxs(w,{maxWidth:"min(100%, 840px)",gap:10,children:[a.jsx(y,{columns:[{key:"id",header:"Issue"},{key:"component",header:"Component"},{key:"owner",header:"Owner"},{key:"status",header:"Status"}],data:v}),a.jsx("button",{type:"button",children:"After table"})]}),play:async({canvasElement:t})=>{const e=b(t),o=t.querySelector("[data-aurora-table-scroll-container]");await n(o).not.toBeNull(),await n(o).toHaveAttribute("tabindex","0"),await l.tab(),await n(o).toHaveFocus(),await l.tab(),await n(e.getByRole("button",{name:"After table"})).toHaveFocus()}},re={render:()=>a.jsxs(w,{maxWidth:"min(100%, 840px)",gap:10,children:[a.jsx("p",{style:C,children:"Sort button hides focus ring on pointer focus, then restores focus-visible ring when users return with keyboard Tab navigation."}),a.jsx("button",{type:"button",children:"Before table"}),a.jsx(y,{columns:f,data:v,defaultSortKey:"id"})]}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("button",{name:"Before table"}),s=e.getByRole("button",{name:"Issue sort descending"});g.mouseDown(s),s.focus(),await l.click(o),await l.tab(),await n(s).toHaveFocus(),await n(s.style.boxShadow).toContain("0 0 0 3px")}},se={render:()=>a.jsxs(w,{maxWidth:"min(100%, 840px)",gap:10,children:[a.jsx("p",{style:C,children:"Sort button hides focus ring on pointer focus, then reverse keyboard navigation (Shift+Tab) restores focus-visible ring for the sortable header."}),a.jsx(y,{columns:f,data:v,defaultSortKey:"id"}),a.jsx("button",{type:"button",children:"After table"})]}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("button",{name:"Status sort ascending"}),s=e.getByRole("button",{name:"After table"});g.mouseDown(o),o.focus(),await l.click(s),await l.tab({shift:!0}),await n(o).toHaveFocus(),await n(o.style.boxShadow).toContain("0 0 0 3px")}},ie={render:()=>a.jsx(w,{maxWidth:"min(100%, 780px)",children:a.jsx(y,{columns:f,data:v,loading:!0,loadingContent:"Syncing release feed...",defaultSortKey:"id"})}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("table",{name:"Data table"}),s=e.getByRole("button",{name:"Issue sort descending"}),S=e.getByRole("columnheader",{name:/Issue/});await n(o).toHaveAttribute("aria-busy","true"),await n(e.getByText("Syncing release feed...")).toBeInTheDocument(),await n(e.queryByRole("rowheader",{name:"BTN-102"})).not.toBeInTheDocument(),await n(s).toBeDisabled(),await n(s).not.toHaveAttribute("aria-keyshortcuts"),await n(S).not.toHaveAttribute("aria-sort")}},ce={render:()=>a.jsx(sa,{}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("button",{name:"Toggle loading"}),s=e.getByRole("button",{name:"Issue sort descending"});g.mouseDown(s),await l.click(o);const S=e.getByRole("button",{name:"Issue sort descending"});await n(S).toBeDisabled(),await n(S.style.transform).toContain("translateY(0"),await n(S.style.boxShadow).toBe("none")}},ue={render:function(){const[e,o]=u.useState("id asc");return a.jsxs(w,{maxWidth:"min(100%, 840px)",gap:10,children:[a.jsxs("p",{style:C,children:["Active sort: ",a.jsx("strong",{"data-testid":"primary-pointer-sort-state",children:e})]}),a.jsx("button",{type:"button",children:"Before table"}),a.jsx(y,{columns:f,data:v,defaultSortKey:"id",onSortChange:(s,S)=>o(`${s} ${S}`)})]})},play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("button",{name:"Before table"}),s=e.getByRole("button",{name:"Issue sort descending"}),S=e.getByTestId("primary-pointer-sort-state");await l.click(o),await l.tab(),await n(s).toHaveFocus(),await n(s.style.boxShadow).toContain("0 0 0 3px"),g.mouseDown(s,{button:2}),g.mouseUp(s,{button:2}),await n(s.style.boxShadow).toContain("0 0 0 3px"),await n(S).toHaveTextContent("id asc"),g.mouseDown(s,{button:0}),await n(s.style.transform).toContain("translateY(1px)"),g.pointerCancel(s),await n(s.style.transform).toContain("translateY(0"),await n(S).toHaveTextContent("id asc"),g.pointerDown(s,{pointerType:"touch",button:0}),await n(s.style.transform).toContain("translateY(1px)"),g.pointerUp(s,{pointerType:"touch",button:0}),await n(s.style.transform).toContain("translateY(0"),await n(S).toHaveTextContent("id asc"),await l.click(s),await n(S).toHaveTextContent("id desc")}},le={render:()=>a.jsx(w,{maxWidth:"min(100%, 780px)",children:a.jsx(y,{ariaLabel:"Release checklist table",columns:f,data:v,rowKey:t=>t.id})}),play:async({canvasElement:t})=>{const e=b(t);await n(e.getByRole("table",{name:"Release checklist table"})).toBeInTheDocument()}},de={render:()=>a.jsx(w,{maxWidth:"min(100%, 780px)",children:a.jsx(y,{columns:f,data:v,rowKey:t=>t.id})}),play:async({canvasElement:t})=>{const e=b(t);await n(e.getByRole("table",{name:"Data table"})).toBeInTheDocument()}},me={render:()=>a.jsxs(w,{maxWidth:"min(100%, 780px)",gap:10,children:[a.jsx("h3",{id:"release-board-heading",style:{margin:0},children:"Release board metrics"}),a.jsx(y,{ariaLabelledBy:"release-board-heading",ariaLabel:"Fallback table label",columns:f,data:v,rowKey:t=>t.id})]}),play:async({canvasElement:t})=>{const o=b(t).getByRole("table",{name:"Release board metrics"});await n(o).toHaveAttribute("aria-labelledby","release-board-heading"),await n(o).not.toHaveAttribute("aria-label")}},ye={render:()=>a.jsx(w,{maxWidth:"min(100%, 780px)",children:a.jsx(y,{columns:[{key:"component",header:"Component",rowHeader:!0,sortable:!0},{key:"owner",header:"Owner",sortable:!0},{key:"status",header:"Status",sortable:!0}],data:v,rowKey:t=>t.id,defaultSortKey:"component"})}),play:async({canvasElement:t})=>{const e=b(t);await n(e.getByRole("rowheader",{name:"Button"})).toBeInTheDocument(),await n(e.getByRole("rowheader",{name:"Dialog"})).toBeInTheDocument()}};function ia(){const[t,e]=u.useState("id asc");return a.jsxs(w,{maxWidth:"min(100%, 840px)",gap:8,children:[a.jsxs("p",{style:C,children:["Active sort: ",a.jsx("strong",{style:Le,children:t})]}),a.jsx(y,{columns:f,data:v,defaultSortKey:"id",onSortChange:(o,s)=>e(`${o} ${s}`)})]})}const pe={render:()=>a.jsx(ia,{}),play:async({canvasElement:t})=>{const e=b(t),o=t.querySelector("[data-aurora-table-scroll-container]");await n(o).not.toBeNull(),await n(o).not.toHaveAttribute("tabindex");const s=e.getByRole("button",{name:"Issue sort descending"});await n(s).toHaveAttribute("aria-keyshortcuts","Enter Space Home End PageDown PageUp ArrowLeft ArrowRight"),s.focus(),await l.keyboard("{ArrowRight}");const S=e.getByRole("button",{name:"Component sort ascending"});await n(S).toHaveFocus(),await l.keyboard("{ArrowLeft}"),await n(s).toHaveFocus(),await l.keyboard("{End}");const Te=e.getByRole("button",{name:"Status sort ascending"});await n(Te).toHaveFocus(),await l.keyboard("{Home}"),await n(s).toHaveFocus(),await l.keyboard("{PageDown}");const D=e.getByRole("button",{name:"Component sort ascending"});await n(D).toHaveFocus(),await l.keyboard("{PageUp}"),await n(s).toHaveFocus(),await l.keyboard("{Enter}"),await n(e.getByText("id desc")).toBeInTheDocument(),await n(e.getByRole("status")).toHaveTextContent("Sorted by Issue descending.");const L=e.getByRole("button",{name:"Issue sort ascending"}),K=L.closest("th");await n(K).toHaveAttribute("aria-sort","descending"),g.keyDown(L,{key:"Enter",repeat:!0}),await n(e.getByText("id desc")).toBeInTheDocument(),await n(K).toHaveAttribute("aria-sort","descending"),L.focus(),g.keyDown(L,{key:"Space",repeat:!0}),await n(e.getByText("id desc")).toBeInTheDocument(),await n(K).toHaveAttribute("aria-sort","descending"),await l.keyboard("{Space}"),await n(e.getByText("id asc")).toBeInTheDocument(),await n(K).toHaveAttribute("aria-sort","ascending"),await n(e.getByRole("status")).toHaveTextContent("Sorted by Issue ascending.");const R=e.getByRole("button",{name:"Issue sort descending"});R.focus(),g.keyDown(R,{key:"ArrowRight",ctrlKey:!0}),g.keyDown(R,{key:"ArrowLeft",metaKey:!0}),g.keyDown(R,{key:"End",ctrlKey:!0}),g.keyDown(R,{key:"Home",altKey:!0}),g.keyDown(R,{key:"PageDown",metaKey:!0}),g.keyDown(R,{key:"PageUp",ctrlKey:!0}),await n(R).toHaveFocus(),g.keyDown(R,{key:"Enter",ctrlKey:!0}),g.keyDown(R,{key:"Space",metaKey:!0}),await n(e.getByText("id asc")).toBeInTheDocument(),await n(K).toHaveAttribute("aria-sort","ascending"),await l.keyboard("{Shift>}{Enter}{/Shift}"),await Ze(()=>{n(e.getByText("id desc")).toBeInTheDocument(),n(K).toHaveAttribute("aria-sort","descending")}),e.getByRole("button",{name:"Issue sort ascending"}).focus(),await l.keyboard("{Shift>}{Space}{/Shift}"),await Ze(()=>{n(e.getByText("id asc")).toBeInTheDocument(),n(K).toHaveAttribute("aria-sort","ascending")})}},we={render:()=>a.jsxs(w,{maxWidth:"min(100%, 840px)",gap:8,children:[a.jsx("p",{style:C,children:"In RTL layout, ArrowLeft/ArrowRight sortable-header traversal follows visual column order."}),a.jsx("div",{dir:"rtl",children:a.jsx(y,{columns:f,data:v,defaultSortKey:"id"})})]}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("button",{name:"Issue sort descending"}),s=e.getByRole("button",{name:"Component sort ascending"});o.focus(),g.keyDown(o,{key:"ArrowLeft",ctrlKey:!0}),g.keyDown(o,{key:"ArrowRight",metaKey:!0}),g.keyDown(o,{key:"ArrowLeft",altKey:!0}),await n(o).toHaveFocus(),await l.keyboard("{ArrowRight}"),await n(o).toHaveFocus(),await l.keyboard("{ArrowLeft}"),await n(s).toHaveFocus(),await l.keyboard("{ArrowRight}"),await n(o).toHaveFocus()}};function ca(){const[t,e]=u.useState("id asc");return a.jsxs(w,{maxWidth:"min(100%, 840px)",gap:8,children:[a.jsx("p",{style:C,children:"IME composition guards Enter and Space so sortable headers do not toggle while users confirm CJK input."}),a.jsxs("p",{style:C,children:["Active sort: ",a.jsx("strong",{style:Le,children:t})]}),a.jsx(y,{columns:f,data:v,defaultSortKey:"id",onSortChange:(o,s)=>e(`${o} ${s}`)})]})}const be={render:()=>a.jsx(ca,{}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("columnheader",{name:/Issue/}),s=e.getByRole("button",{name:"Issue sort descending"});await n(e.getByText("id asc")).toBeInTheDocument(),await n(o).toHaveAttribute("aria-sort","ascending"),rt(s,"Enter"),await n(e.getByText("id asc")).toBeInTheDocument(),await n(o).toHaveAttribute("aria-sort","ascending"),rt(s,"Space"),await n(e.getByText("id asc")).toBeInTheDocument(),await n(o).toHaveAttribute("aria-sort","ascending"),st(s,"Enter"),await n(e.getByText("id asc")).toBeInTheDocument(),await n(o).toHaveAttribute("aria-sort","ascending"),st(s,"Space"),await n(e.getByText("id asc")).toBeInTheDocument(),await n(o).toHaveAttribute("aria-sort","ascending"),s.focus(),await l.keyboard("{Enter}"),await n(e.getByText("id desc")).toBeInTheDocument(),await n(o).toHaveAttribute("aria-sort","descending")}},ge={render:()=>a.jsx(w,{maxWidth:"min(100%, 780px)",children:a.jsx(y,{columns:f,data:v,defaultSortKey:"id",getSortAriaLabel:({columnHeader:t,nextDirection:e})=>`按${e==="asc"?"升序":"降序"}排序：${t}`,getSortStatusText:({columnHeader:t,direction:e})=>`当前排序：${t}（${e==="asc"?"升序":"降序"}）`})}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("button",{name:"按降序排序：Issue"});await n(e.getByRole("status")).toHaveTextContent("当前排序：Issue（升序）"),await l.click(o),await n(e.getByRole("button",{name:"按升序排序：Issue"})).toBeInTheDocument(),await n(e.getByRole("status")).toHaveTextContent("当前排序：Issue（降序）")}},ve={render:()=>a.jsx(w,{maxWidth:"min(100%, 780px)",children:a.jsx(y,{columns:[{key:"releasedAt",header:a.jsx("span",{"aria-hidden":"true",children:"📅"}),sortLabel:"Release date",sortable:!0},{key:"component",header:"Component",sortable:!0},{key:"owner",header:"Owner"}],data:[{releasedAt:"2026-03-19",component:"Dialog",owner:"Platform UI"},{releasedAt:"2026-01-10",component:"Button",owner:"Design System"}],defaultSortKey:"releasedAt"})}),play:async({canvasElement:t})=>{const e=b(t);await n(e.getByRole("status")).toHaveTextContent("Sorted by Release date ascending.");const o=e.getByRole("button",{name:"Release date sort descending"});await l.click(o),await n(e.getByRole("button",{name:"Release date sort ascending"})).toBeInTheDocument(),await n(e.getByRole("status")).toHaveTextContent("Sorted by Release date descending.")}},he={render:()=>a.jsx(w,{maxWidth:"min(100%, 780px)",children:a.jsx(y,{columns:[{key:"status",header:a.jsxs("span",{children:[a.jsx("span",{"aria-hidden":"true",children:"🚦"})," Release status"]}),sortable:!0},{key:"component",header:"Component",sortable:!0}],data:[{status:"Review",component:"Dialog"},{status:"Ready",component:"Button"}],defaultSortKey:"status"})}),play:async({canvasElement:t})=>{const e=b(t);await n(e.getByRole("status")).toHaveTextContent("Sorted by Release status ascending.");const o=e.getByRole("button",{name:"Release status sort descending"});await l.click(o),await n(e.getByRole("button",{name:"Release status sort ascending"})).toBeInTheDocument()}},xe={render:()=>a.jsx(w,{maxWidth:"min(100%, 780px)",children:a.jsx(y,{columns:[{key:"status",header:a.jsx("span",{"aria-label":"Release status",children:a.jsx("span",{"aria-hidden":"true",children:"🚦"})}),sortable:!0},{key:"component",header:"Component",sortable:!0}],data:[{status:"Review",component:"Dialog"},{status:"Ready",component:"Button"}],defaultSortKey:"status"})}),play:async({canvasElement:t})=>{const e=b(t);await n(e.getByRole("status")).toHaveTextContent("Sorted by Release status ascending.");const o=e.getByRole("button",{name:"Release status sort descending"});await l.click(o),await n(e.getByRole("button",{name:"Release status sort ascending"})).toBeInTheDocument()}},Se={render:()=>{const t=[{key:"component",header:"Component",sortable:!0},{key:"status",header:"Status",width:140}];return a.jsx(w,{maxWidth:"min(100%, 620px)",children:a.jsx(y,{columns:t,data:v,defaultSortKey:"status"})})},play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("columnheader",{name:"Component"}),s=e.getByRole("columnheader",{name:"Status"});await n(o).not.toHaveAttribute("aria-sort"),await n(s).not.toHaveAttribute("aria-sort"),await n(e.queryByRole("button",{name:/Status sort/})).not.toBeInTheDocument(),await n(e.getAllByRole("cell")[0]).toHaveTextContent("Button")}};function ua(){const[t,e]=u.useState(!1),o=u.useMemo(()=>[{key:"component",header:"Component",sortable:!0,rowHeader:!0},{key:"status",header:"Status",sortable:t,width:140}],[t]);return a.jsxs(w,{maxWidth:"min(100%, 760px)",gap:8,children:[a.jsx("p",{style:C,children:"Async column schema can enable a previously unavailable default sort key after rerender."}),a.jsxs("p",{style:C,children:["Status column sortable:"," ",a.jsx("strong",{"data-testid":"table-status-sortable",style:Le,children:t?"yes":"no"})]}),a.jsx("button",{type:"button",onClick:()=>e(!0),children:"Load status sortable schema"}),a.jsx(y,{columns:o,data:v,rowKey:s=>s.id,defaultSortKey:"status"})]})}const fe={render:()=>a.jsx(ua,{}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("button",{name:"Load status sortable schema"}),s=e.getByRole("columnheader",{name:"Status"});await n(e.getByTestId("table-status-sortable")).toHaveTextContent("no"),await n(s).not.toHaveAttribute("aria-sort"),await n(e.getAllByRole("rowheader")[0]).toHaveTextContent("Button"),await n(e.queryByRole("status")).not.toBeInTheDocument(),await l.click(o),await n(e.getByTestId("table-status-sortable")).toHaveTextContent("yes"),await n(s).toHaveAttribute("aria-sort","ascending"),await n(e.getByRole("button",{name:"Status sort descending"})).toBeEnabled(),await n(e.getAllByRole("rowheader")[0]).toHaveTextContent("PromptInput"),await n(e.getByRole("status")).toHaveTextContent("Sorted by Status ascending.")}},Nn=v.map(t=>({...t,note:""})),$n=[{key:"component",header:"Component",sortable:!0},{key:"note",header:"QA Note",render:t=>a.jsx("input",{defaultValue:t.note,"aria-label":`${t.id} note`,style:{width:"100%",borderRadius:6,border:"1px solid var(--aurora-border-default)",background:"var(--aurora-surface-default)",color:"var(--aurora-text-primary)",padding:"6px 8px"}})}],Be={render:()=>a.jsx(w,{maxWidth:"min(100%, 720px)",children:a.jsx(y,{columns:$n,data:Nn,defaultSortKey:"component"})}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("textbox",{name:"BTN-102 note"});await l.type(o,"persist me"),await l.click(e.getByRole("button",{name:"Component sort descending"})),await n(e.getByRole("textbox",{name:"BTN-102 note"})).toHaveValue("persist me")}},Re={render:()=>a.jsx(w,{maxWidth:"min(100%, 720px)",children:a.jsx(y,{columns:$n,data:Nn,defaultSortKey:"component",rowKey:(t,e)=>`${e}-${t.id}`})}),play:async({canvasElement:t})=>{const e=b(t),o=e.getByRole("textbox",{name:"BTN-102 note"});await l.type(o,"persist me"),await l.click(e.getByRole("button",{name:"Component sort descending"})),await n(e.getByRole("textbox",{name:"BTN-102 note"})).toHaveValue("persist me")}},la=[{key:"Alpha",score:1},{key:"Beta",score:2},{key:"Gamma",score:3}],ke={render:()=>a.jsxs(w,{maxWidth:"min(100%, 760px)",gap:8,children:[a.jsx("p",{style:C,children:"`render(row, rowIndex, sourceIndex)` exposes both sorted row position and source-data position."}),a.jsx(y,{columns:[{key:"key",header:"Item",sortable:!0,render:(t,e,o)=>`${t.key} (visual:${e}, source:${o})`},{key:"score",header:"Score",sortable:!0}],data:la,defaultSortKey:"score"})]}),play:async({canvasElement:t})=>{const e=b(t);await l.click(e.getByRole("button",{name:"Score sort descending"})),await n(e.getByRole("cell",{name:"Gamma (visual:0, source:2)"})).toBeInTheDocument(),await n(e.getByRole("cell",{name:"Alpha (visual:2, source:0)"})).toBeInTheDocument()}};var it,ct,ut;X.parameters={...X.parameters,docs:{...(it=X.parameters)==null?void 0:it.docs,source:{originalSource:`{
  ...
  play: async ({
    ...
    await expect(sortButton.style.transform).toContain("translateY(1px)");
    fireEvent.pointerUp(sortButton, {
      pointerType: "touch",
      button: 0
    });
    await expect(sortButton.style.transform).toContain("translateY(0");
