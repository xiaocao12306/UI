import{j as o}from"./jsx-runtime-BjG_zV1W.js";import{r as c}from"./index-BWu4c2F4.js";import{B as I}from"./Button-B21ouHNm.js";import{P as Za}from"./Popover-CI5AwEb2.js";import{D as eo}from"./Dialog-Cbs75tsL.js";import{I as to}from"./Input-DCFTlK0_.js";import{within as u,userEvent as i,expect as n,fireEvent as g,waitFor as H}from"./index-DgAF9SIF.js";import{b as v,s as y,a as b}from"./storyShowcase-DlKirntE.js";import"./focusTabbable-gnwmp6b7.js";import"./bodyScrollLock-DU3WNas9.js";import"./index-DlVbWVVj.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";function m({open:a,onOpenChange:e,commands:t,title:s="Command Palette",description:l="Quickly search and execute workspace actions.",ariaLabel:p,ariaLabelledBy:w,searchAriaLabel:B="Search commands",resultsAriaLabel:$="Command results",closeOnSelect:Je=!0,clearQueryOnEscape:Ke=!0,closeOnEscape:U=!0,closeOnOutsidePointer:Xe=!0,onEscapeKeyDown:Ne,onSearchKeyDown:Me,onCloseButtonKeyDown:qa,onPointerDownOutside:Fe,closeLabel:Ka,placeholder:Na="Search commands...",loading:E=!1,loadingContent:V="Loading commands...",emptyMessage:Ze="No commands found.",disabledResultsMessage:et="Matching commands are currently unavailable.",onQueryChange:C,onCloseReason:R,getResultsStatusText:tt=ao}){const[D,$e]=c.useState(""),[G,T]=c.useState(0),Ma=c.useRef(null),N=c.useRef(null),z=c.useRef(null),nt=c.useRef(a);c.useRef(null),c.useRef(null),c.useRef(null);const L=c.useId(),Ue=c.useId(),at=c.useId(),ot=c.useRef(null),Fa=j(B,"Search commands"),$a=j($,"Command results"),Ua=j(Ka,"Close command palette"),st=j(w),Va=st===void 0?j(p):void 0,rt=c.useMemo(()=>oo(V),[V]),Ga=_e(V)?V:"Loading commands...",za=_e(Ze)?Ze:"No commands found.",Qa=_e(et)?et:"Matching commands are currently unavailable.",Q=c.useCallback(r=>{z.current=r,R==null||R(r)},[R]),ct=c.useCallback(r=>{Q(r),e(!1),z.current=null},[Q,e]),_a=c.useCallback(r=>{!r&&a&&z.current===null&&(R==null||R("close-button")),z.current=null,e(r)},[R,e,a]);c.useEffect(()=>{!a&&nt.current&&($e(r=>(r.length>0&&(C==null||C("")),"")),T(0)),nt.current=a},[C,a]),c.useEffect(()=>{},[t]),c.useEffect(()=>{},[t]),c.useEffect(()=>{},[t]);const Ve=c.useMemo(()=>yt(D.trim()),[D]),Ge=c.useMemo(()=>{const r=new Map;return t.forEach(d=>{r.set(d.key,(r.get(d.key)??0)+1)}),t.map((d,k)=>({item:d,renderKey:(r.get(d.key)??0)>1?`${d.key}__source-${k}`:d.key}))},[t]),_=c.useMemo(()=>Ve?Ge.filter(({item:r})=>{const k=[pt(r),...r.keywords??[]].join(" ");return yt(k).includes(Ve)}):Ge,[Ge,Ve]),h=c.useMemo(()=>_.map(r=>r.item),[_]),q=c.useMemo(()=>_.map(r=>r.renderKey),[_]),M=c.useMemo(()=>h.reduce((r,d)=>d.disabled?r:r+1,0),[h]),it=!E&&h.length>0&&M===0,S=!E&&M>1,lt=!E&&M>0,ze=!E&&h.length>0,Wa=c.useMemo(()=>{const r=[];return S&&r.push("ArrowDown","ArrowUp","Home","End","PageDown","PageUp"),lt&&r.push("Enter"),(U||Ke&&D.length>0)&&r.push("Escape"),r.length>0?r.join(" "):void 0},[lt,S,Ke,U,D.length]),Ya=c.useMemo(()=>E?rt:tt({query:D,visibleCount:h.length,enabledCount:M,totalCount:t.length}),[t.length,M,h.length,tt,E,D,rt]),Ja=it?`${Ue} ${at}`:Ue,A=c.useMemo(()=>h.reduce((r,d,k)=>(d.disabled||r.push(k),r),[]),[h]),P=A[0]??-1,dt=A[A.length-1]??-1,f=c.useMemo(()=>{if(G<0)return-1;const r=h[G];return!r||r.disabled?-1:G},[G,h]);c.useEffect(()=>{if(h.length===0){N.current=null,T(-1);return}const r=N.current;if(r){const d=q.findIndex((k,O)=>{var W;return!((W=h[O])!=null&&W.disabled)&&k===r});if(d>=0){T(d);return}}T(P),N.current=P>=0?q[P]??null:null},[h,q,P]),c.useEffect(()=>{if(f<0){N.current=null;return}N.current=q[f]??null},[q,f]),c.useEffect(()=>{if(!a||f<0)return;const r=ot.current;if(!r)return;const d=r.ownerDocument.getElementById(`${L}-option-${f}`);!d||!r.contains(d)||typeof d.scrollIntoView=="function"&&d.scrollIntoView({block:"nearest"})},[L,a,f]);const Qe=c.useCallback(r=>{const d=h[r];!d||d.disabled||d.onSelect&&(d.onSelect(),Je&&ct("item-select"))},[Je,ct,h]),ut=r=>{var k;if(h.length===0)return;let d=f<0?r===1?-1:0:f;for(let O=0;O<h.length;O+=1)if(d=(d+r+h.length)%h.length,!((k=h[d])!=null&&k.disabled)){T(d);return}},mt=r=>{if(A.length===0)return;const d=A.indexOf(f);if(d<0){T(r===1?P:dt);return}const k=Math.min(A.length-1,Math.max(0,d+r*5));T(A[k]??P)};return o.jsx(eo,{open:a,onOpenChange:_a,title:s,description:l,ariaLabel:Va,ariaLabelledBy:st,closeLabel:Ua,size:"md",closeOnEscape:U,closeOnOutsidePointer:Xe,onCloseButtonKeyDown:qa,onEscapeKeyDown:r=>{Ne==null||Ne(r),!(r.defaultPrevented||!U)&&Q("escape-key")},onPointerDownOutside:r=>{Fe==null||Fe(r),!(r.defaultPrevented||!Xe)&&Q("outside-pointer")},children:o.jsxs("div",{style:{display:"grid",gap:10},children:[o.jsx(to,{ref:Ma,"data-autofocus":"",role:"combobox","aria-busy":E||void 0,"aria-expanded":ze,"aria-haspopup":"listbox","aria-autocomplete":"list","aria-controls":ze?L:void 0,"aria-activedescendant":!E&&f>=0?`${L}-option-${f}`:void 0,"aria-describedby":Ja,"aria-keyshortcuts":Wa,placeholder:Na,value:D,onChange:r=>{$e(r.target.value),C==null||C(r.target.value)},onKeyDown:r=>{if(Me==null||Me(r),!no(r)&&!r.defaultPrevented&&!(r.altKey||r.ctrlKey||r.metaKey)){if(r.key==="Escape"){if(r.repeat)return;Ke&&D.length>0&&(r.preventDefault(),$e(""),C==null||C(""));return}if(r.key==="ArrowDown"){if(!S)return;r.preventDefault(),ut(1);return}if(r.key==="ArrowUp"){if(!S)return;r.preventDefault(),ut(-1);return}if(r.key==="Home"){if(!S||!wt(r))return;r.preventDefault(),T(P);return}if(r.key==="End"){if(!S||!wt(r))return;r.preventDefault(),T(dt);return}if(r.key==="PageDown"){if(!S)return;r.preventDefault(),mt(1);return}if(r.key==="PageUp"){if(!S)return;r.preventDefault(),mt(-1);return}if(r.key==="Enter"&&!E&&f>=0){if(r.preventDefault(),r.repeat)return;Qe(f)}}},"aria-label":Fa}),o.jsx("p",{id:Ue,role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:Ya}),E?o.jsx("p",{"data-testid":"command-palette-loading-content",style:{margin:0,color:"var(--aurora-text-secondary)"},children:Ga}):ze?o.jsxs(o.Fragment,{children:[o.jsx("div",{id:L,ref:ot,role:"listbox","aria-label":$a,style:{maxHeight:280,overflow:"auto",display:"grid",gap:4},children:h.map((r,d)=>{const k=d===f,O=j(r.ariaLabelledBy),W=F(r.label).trim().length>0,Xa=O?void 0:j(r.ariaLabel,W?void 0:pt(r));return o.jsx("div",{id:`${L}-option-${d}`,role:"option","aria-selected":k,"aria-disabled":r.disabled||void 0,"aria-labelledby":O,"aria-label":Xa,"aria-keyshortcuts":r.disabled?void 0:"Enter Space","aria-posinset":d+1,"aria-setsize":h.length,tabIndex:-1,onPointerDown:x=>{x.pointerType==="mouse"||!so(x.button)||x.ctrlKey||x.preventDefault()},onMouseDown:x=>{x.button!==0||x.ctrlKey||x.preventDefault()},onMouseEnter:()=>{r.disabled||T(d)},onClick:()=>{r.disabled||Qe(d)},onKeyDown:x=>{if(!r.disabled&&!x.defaultPrevented&&!(x.altKey||x.ctrlKey||x.metaKey)&&(x.key==="Enter"||x.key===" "||x.key==="Space"||x.key==="Spacebar")){if(x.preventDefault(),x.repeat)return;Qe(d)}},style:{border:"1px solid var(--aurora-border-default)",background:k?"color-mix(in srgb, var(--aurora-accent-default) 14%, var(--aurora-surface-default))":"var(--aurora-surface-default)",color:r.disabled?"color-mix(in srgb, var(--aurora-text-secondary) 60%, transparent)":"var(--aurora-text-primary)",borderRadius:8,height:36,padding:"0 10px",textAlign:"left",cursor:r.disabled?"not-allowed":"pointer"},children:r.label},q[d]??`${r.key}__source-fallback-${d}`)})}),it?o.jsx("p",{id:at,"data-testid":"command-palette-disabled-results-message",style:{margin:0,color:"var(--aurora-text-secondary)",fontSize:13},children:Qa}):null]}):o.jsx("p",{style:{margin:0,color:"var(--aurora-text-secondary)"},children:za})]})})}function pt(a){if(typeof a.textValue=="string"){const e=K(a.textValue);if(e.length>0)return e}if(typeof a.ariaLabel=="string"){const e=K(a.ariaLabel);if(e.length>0)return e}return K(F(a.label))}function yt(a){return a.normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/\s+/g," ").trim().toLowerCase()}function no(a){const e=a.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function wt(a){if(a.key!=="Home"&&a.key!=="End")return!0;const e=a.currentTarget,t=e.selectionStart,s=e.selectionEnd;return t===null||s===null?!0:t!==s?!1:a.key==="Home"?t===0:s===e.value.length}function ao({query:a,visibleCount:e,enabledCount:t,totalCount:s}){const l=a.trim();return l.length===0?t!==s?`${t} of ${s} command${s===1?"":"s"} available.`:`${s} command${s===1?"":"s"} available.`:e===0?`No commands match "${l}".`:t===0?`No enabled commands match "${l}".`:t!==e?`${t} of ${e} matching command${t===1?"":"s"} available for "${l}".`:`${e} command${e===1?"":"s"} found for "${l}".`}function oo(a){const e=K(F(a));return e.length>0?e:"Loading commands..."}function _e(a){return a==null||typeof a=="boolean"?!1:typeof a=="string"?a.trim().length>0:!0}function F(a){if(typeof a=="string")return a;if(typeof a=="number")return String(a);if(Array.isArray(a))return K(a.map(t=>F(t)).filter(t=>t.length>0).join(" "));if(!c.isValidElement(a))return"";const e=a.props;return e["aria-hidden"]===!0||e["aria-hidden"]==="true"?"":typeof e["aria-label"]=="string"&&e["aria-label"].trim().length>0?K(e["aria-label"]):F(e.children)}function j(a,e){return typeof a=="string"&&a.trim().length>0?a.trim():e}function so(a){return typeof a!="number"||a<=0}function K(a){return a.replace(/\s+/g," ").trim()}m.__docgenInfo={description:"",methods:[],displayName:"CommandPalette",props:{open:{required:!0,tsType:{name:"boolean"},description:""},onOpenChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""},commands:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: string;
...
}`,...(vt=(gt=Y.parameters)==null?void 0:gt.docs)==null?void 0:vt.source}}};var ht,xt,kt;J.parameters={...J.parameters,docs:{...(ht=J.parameters)==null?void 0:ht.docs,source:{originalSource:`{
...
}`,...(Et=(ft=X.parameters)==null?void 0:ft.docs)==null?void 0:Et.source}}};var Ct,Tt,Rt;Z.parameters={...Z.parameters,docs:{...(Ct=Z.parameters)==null?void 0:Ct.docs,source:{originalSource:`{
...
}`,...(Pt=(At=te.parameters)==null?void 0:At.docs)==null?void 0:Pt.source}}};var Ot,jt,Lt;ne.parameters={...ne.parameters,docs:{...(Ot=ne.parameters)==null?void 0:Ot.docs,source:{originalSource:`{
  args: {
    open: true,
    emptyMessage: "   ",
    onOpenChange: () => {},
...
}`,...(Lt=(jt=ne.parameters)==null?void 0:jt.docs)==null?void 0:Lt.source}}};var qt,Kt,Nt;ae.parameters={...ae.parameters,docs:{...(qt=ae.parameters)==null?void 0:qt.docs,source:{originalSource:`{
  args: {
    open: true,
    loading: true,
    loadingContent: 0,
...
}`,...($t=(Ft=oe.parameters)==null?void 0:Ft.docs)==null?void 0:$t.source}}};var Ut,Vt,Gt;se.parameters={...se.parameters,docs:{...(Ut=se.parameters)==null?void 0:Ut.docs,source:{originalSource:`{
...
}`,...(Gt=(Vt=se.parameters)==null?void 0:Vt.docs)==null?void 0:Gt.source}}};var zt,Qt,_t;re.parameters={...re.parameters,docs:{...(zt=re.parameters)==null?void 0:zt.docs,source:{originalSource:`{
  render: () => <QueryTelemetryPalette />,
  play: async ({
    canvasElement
  }) => {
...
}`,...(_t=(Qt=re.parameters)==null?void 0:Qt.docs)==null?void 0:_t.source}}};var Wt,Yt,Jt;ce.parameters={...ce.parameters,docs:{...(Wt=ce.parameters)==null?void 0:Wt.docs,source:{originalSource:`{
...
}`,...(Hn=(In=ve.parameters)==null?void 0:In.docs)==null?void 0:Hn.source}}};var An,Pn,On;he.parameters={...he.parameters,docs:{...(An=he.parameters)==null?void 0:An.docs,source:{originalSource:`{
...
}`,...(On=(Pn=he.parameters)==null?void 0:Pn.docs)==null?void 0:On.source}}};var jn,Ln,qn;xe.parameters={...xe.parameters,docs:{...(jn=xe.parameters)==null?void 0:jn.docs,source:{originalSource:`{
...
}`,...(qn=(Ln=xe.parameters)==null?void 0:Ln.docs)==null?void 0:qn.source}}};var Kn,Nn,Mn;ke.parameters={...ke.parameters,docs:{...(Kn=ke.parameters)==null?void 0:Kn.docs,source:{originalSource:`{
...
}`,...(Un=($n=Be.parameters)==null?void 0:$n.docs)==null?void 0:Un.source}}};var Vn,Gn,zn;fe.parameters={...fe.parameters,docs:{...(Vn=fe.parameters)==null?void 0:Vn.docs,source:{originalSource:`{
...
}`,...(zn=(Gn=fe.parameters)==null?void 0:Gn.docs)==null?void 0:zn.source}}};var Qn,_n,Wn;Ee.parameters={...Ee.parameters,docs:{...(Qn=Ee.parameters)==null?void 0:Qn.docs,source:{originalSource:`{
...
}`,...(Wn=(_n=Ee.parameters)==null?void 0:_n.docs)==null?void 0:Wn.source}}};var Yn,Jn,Xn;Ce.parameters={...Ce.parameters,docs:{...(Yn=Ce.parameters)==null?void 0:Yn.docs,source:{originalSource:`{
...
}`,...(ba=(wa=He.parameters)==null?void 0:wa.docs)==null?void 0:ba.source}}};var ga,va,ha;Ae.parameters={...Ae.parameters,docs:{...(ga=Ae.parameters)==null?void 0:ga.docs,source:{originalSource:`{
...
}`,...(ha=(va=Ae.parameters)==null?void 0:va.docs)==null?void 0:ha.source}}};var xa,ka,Ba;Pe.parameters={...Pe.parameters,docs:{...(xa=Pe.parameters)==null?void 0:xa.docs,source:{originalSource:`{
...
}`,...(Ba=(ka=Pe.parameters)==null?void 0:ka.docs)==null?void 0:Ba.source}}};var fa,Ea,Ca;Oe.parameters={...Oe.parameters,docs:{...(fa=Oe.parameters)==null?void 0:fa.docs,source:{originalSource:`{
...
}`,...(Da=(Ra=je.parameters)==null?void 0:Ra.docs)==null?void 0:Da.source}}};var Sa,Ia,Ha;Le.parameters={...Le.parameters,docs:{...(Sa=Le.parameters)==null?void 0:Sa.docs,source:{originalSource:`{
...
}`,...(Ha=(Ia=Le.parameters)==null?void 0:Ia.docs)==null?void 0:Ha.source}}};var Aa,Pa,Oa;qe.parameters={...qe.parameters,docs:{...(Aa=qe.parameters)==null?void 0:Aa.docs,source:{originalSource:`{
