...
`,e.jsxs(n.li,{children:["For icon-only buttons, provide ",e.jsx(n.code,{children:"aria-label"})," or ",e.jsx(n.code,{children:"aria-labelledby"})," on the button itself; inline child ",e.jsx(n.code,{children:"aria-label"})," is treated as fallback only, and decorative glyph text should remain ",e.jsx(n.code,{children:"aria-hidden"}),"."]}),`
