import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{r as n}from"./index-BWu4c2F4.js";import{f as Se}from"./FieldStyles-CQy9UjBZ.js";import{a as we}from"./a11y-CU5SQrEA.js";import{B as ke}from"./Badge-ZJmMstsz.js";import{within as x,expect as u,userEvent as T}from"./index-DgAF9SIF.js";import{s as E,S as je}from"./storyShowcase-Bw5VyCj0.js";const i=n.forwardRef(function({style:r,invalid:o,disabled:s,onFocus:l,onBlur:d,onMouseEnter:p,onMouseLeave:F,onMouseDown:A,onPointerDown:B,"aria-invalid":pe,"aria-label":ve,"aria-labelledby":be,"aria-keyshortcuts":me,children:H,...ye},y){const O=n.useRef(null);n.useRef(null);const[I,L]=n.useState(!1),[P,f]=n.useState(!1),[_,C]=n.useState(!1),h=n.useRef(!1),q=we(o,pe),D=q!==void 0,v=!!s,U=K(be),fe=U?void 0:K(ve),he=v?void 0:K(me)??"ArrowDown ArrowUp",xe=n.useMemo(()=>Re(H),[H]);n.useEffect(()=>{},[xe]),n.useEffect(()=>{v&&(L(!1),f(!1),C(!1))},[v]),n.useEffect(()=>{var z;const t=((z=O.current)==null?void 0:z.ownerDocument)??document,N=c=>{c.metaKey||c.altKey||c.ctrlKey||(h.current=!0)},b=c=>{"button"in c&&typeof c.button=="number"&&c.button!==0||"ctrlKey"in c&&c.ctrlKey||(h.current=!1)};return t.addEventListener("keydown",N,!0),t.addEventListener("pointerdown",b,!0),t.addEventListener("mousedown",b,!0),t.addEventListener("touchstart",b,!0),()=>{t.removeEventListener("keydown",N,!0),t.removeEventListener("pointerdown",b,!0),t.removeEventListener("mousedown",b,!0),t.removeEventListener("touchstart",b,!0)}},[]);const ge=n.useCallback(t=>{if(O.current=t,typeof y=="function"){y(t);return}y&&(y.current=t)},[y]);return e.jsx("select",{ref:ge,...ye,disabled:s,"aria-label":fe,"aria-labelledby":U,"aria-invalid":q,"aria-keyshortcuts":he,"data-invalid":D?"true":void 0,"data-focused":I?"true":void 0,"data-focus-visible":P?"true":void 0,"data-hovered":_?"true":void 0,"data-aurora-reduced-motion":"transition",style:{...Se,transition:"border-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), box-shadow var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), background-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard)",borderColor:D?"var(--aurora-color-red-500)":I||_&&!v?"var(--aurora-border-strong)":"var(--aurora-input-border)",boxShadow:I&&P&&!v?`0 0 0 3px ${D?"color-mix(in srgb, var(--aurora-color-red-500) 25%, transparent)":"color-mix(in srgb, var(--aurora-input-focus-ring) 38%, transparent)"}`:"none",background:s?"color-mix(in srgb, var(--aurora-input-bg) 80%, var(--aurora-surface-elevated))":"var(--aurora-input-bg)",color:s?"color-mix(in srgb, var(--aurora-input-text) 60%, transparent)":"var(--aurora-input-text)",cursor:s?"not-allowed":"pointer",...r},onFocus:t=>{L(!0),f(Ve(t.currentTarget,h.current)),l==null||l(t)},onBlur:t=>{L(!1),f(!1),d==null||d(t)},onMouseDown:t=>{t.button===0&&!t.ctrlKey&&(h.current=!1,f(!1)),A==null||A(t)},onPointerDown:t=>{t.button===0&&!t.ctrlKey&&(h.current=!1,f(!1)),B==null||B(t)},onMouseEnter:t=>{v||C(!0),p==null||p(t)},onMouseLeave:t=>{C(!1),F==null||F(t)},children:H})});function K(a){if(typeof a!="string")return;const r=a.trim();return r.length>0?r:void 0}function Ve(a,r){try{return a.matches(":focus-visible")||r}catch{return r}}function Re(a){const r=[],o=s=>{n.Children.forEach(s,l=>{if(!n.isValidElement(l))return;const d=typeof l.type=="string"?l.type:null;if(d==="option"){const p=Ee(l.props.value);p!==void 0&&r.push(p);return}if(d==="optgroup"){o(l.props.children);return}o(l.props.children)})};return o(a),r}function Ee(a){if(a!=null)return String(a)}i.__docgenInfo={description:"",methods:[],displayName:"Select",props:{invalid:{required:!1,tsType:{name:"boolean"},description:""}}};function m({children:a,gap:r=10}){return e.jsx(je,{maxWidth:"min(100%, 360px)",gap:r,children:a})}const Ke={title:"Form/Select",component:i,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:"Select provides native option picking with Aurora token styling, invalid semantics, and disabled boundaries."}}}};function Fe(){const[a,r]=n.useState("react");return e.jsxs(m,{children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[e.jsx("span",{style:{color:"var(--aurora-text-primary)"},children:"Selected"}),e.jsx(ke,{children:a})]}),e.jsxs(i,{"aria-label":"Framework select",value:a,onChange:o=>r(o.target.value),children:[e.jsx("option",{value:"react",children:"React"}),e.jsx("option",{value:"vue",children:"Vue"}),e.jsx("option",{value:"svelte",children:"Svelte"})]})]})}const g={render:()=>e.jsx(Fe,{}),play:async({canvasElement:a})=>{const o=x(a).getByRole("combobox",{name:"Framework select"});await T.selectOptions(o,"vue"),await u(o).toHaveValue("vue")}},S={render:()=>e.jsxs(m,{gap:8,children:[e.jsxs(i,{"aria-label":"Environment select",invalid:!0,defaultValue:"","aria-describedby":"environment-error",children:[e.jsx("option",{value:"",disabled:!0,children:"Select environment"}),e.jsx("option",{value:"prod",children:"Production"}),e.jsx("option",{value:"stage",children:"Staging"})]}),e.jsx("p",{id:"environment-error",style:{...E,color:"color-mix(in srgb, var(--aurora-color-red-500) 86%, var(--aurora-text-primary))"},children:"Environment is required before deployment."})]})},w={render:()=>e.jsxs(m,{gap:8,children:[e.jsx("label",{htmlFor:"storybook-select-blank-label",style:E,children:"Framework label"}),e.jsxs(i,{id:"storybook-select-blank-label","aria-label":"   ",defaultValue:"react",children:[e.jsx("option",{value:"react",children:"React"}),e.jsx("option",{value:"vue",children:"Vue"})]})]}),play:async({canvasElement:a})=>{const o=x(a).getByRole("combobox",{name:"Framework label"});await u(o).not.toHaveAttribute("aria-label")}},k={render:()=>e.jsxs(m,{gap:8,children:[e.jsx("p",{id:"storybook-select-heading",style:E,children:"Framework heading"}),e.jsxs(i,{"aria-label":"Framework fallback name","aria-labelledby":"storybook-select-heading",defaultValue:"react",children:[e.jsx("option",{value:"react",children:"React"}),e.jsx("option",{value:"vue",children:"Vue"})]})]}),play:async({canvasElement:a})=>{const o=x(a).getByRole("combobox",{name:"Framework heading"});await u(o).toHaveAttribute("aria-labelledby","storybook-select-heading"),await u(o).not.toHaveAttribute("aria-label")}},j={args:{"aria-label":"Disabled framework select",disabled:!0,defaultValue:"react",children:[e.jsx("option",{value:"react",children:"React"},"react"),e.jsx("option",{value:"vue",children:"Vue"},"vue")]}},V={render:()=>e.jsxs(m,{gap:8,children:[e.jsxs(i,{"aria-label":"Actionable select shortcuts",defaultValue:"react",children:[e.jsx("option",{value:"react",children:"React"}),e.jsx("option",{value:"vue",children:"Vue"})]}),e.jsxs(i,{"aria-label":"Disabled select shortcuts",disabled:!0,defaultValue:"react",children:[e.jsx("option",{value:"react",children:"React"}),e.jsx("option",{value:"vue",children:"Vue"})]})]}),play:async({canvasElement:a})=>{const r=x(a);await u(r.getByRole("combobox",{name:"Actionable select shortcuts"})).toHaveAttribute("aria-keyshortcuts","ArrowDown ArrowUp"),await u(r.getByRole("combobox",{name:"Disabled select shortcuts"})).not.toHaveAttribute("aria-keyshortcuts")}},R={render:()=>e.jsxs(m,{gap:8,children:[e.jsx("p",{style:E,children:"Click the trigger first, then press Tab to verify keyboard re-entry restores select focus-visible state."}),e.jsx("button",{type:"button",children:"Before select"}),e.jsxs(i,{"aria-label":"Focus intent select",defaultValue:"react",children:[e.jsx("option",{value:"react",children:"React"}),e.jsx("option",{value:"vue",children:"Vue"})]})]}),play:async({canvasElement:a})=>{const r=x(a),o=await r.findByRole("button",{name:"Before select"}),s=r.getByRole("combobox",{name:"Focus intent select"});await T.click(o),await T.tab(),await u(s).toHaveFocus(),await u(s).toHaveAttribute("data-focus-visible","true")}};var W,$,G;g.parameters={...g.parameters,docs:{...(W=g.parameters)==null?void 0:W.docs,source:{originalSource:`{
...
}`,...(de=(ue=R.parameters)==null?void 0:ue.docs)==null?void 0:de.source}}};const Te=["Controlled","InvalidState","BlankAriaLabelFallback","LabelledByPrecedence","DisabledState","ShortcutHintPrecision","FocusIntentReentry"];export{w as BlankAriaLabelFallback,g as Controlled,j as DisabledState,R as FocusIntentReentry,S as InvalidState,k as LabelledByPrecedence,V as ShortcutHintPrecision,Te as __namedExportsOrder,Ke as default};
