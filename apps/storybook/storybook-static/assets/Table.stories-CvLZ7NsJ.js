import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{B as Ue}from"./Button-DeQ1OHWt.js";import{r as z}from"./index-BWu4c2F4.js";import{B as Qe}from"./Badge-fH5xjxKG.js";import{within as y,expect as n,userEvent as h}from"./index-DgAF9SIF.js";const Xe=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"});function Je(e,t,r){if(!t)return null;const d=e.find(x=>String(x.key)===t);return d!=null&&d.sortable?{key:t,direction:r}:null}function c({columns:e,data:t,rowKey:r,caption:d,ariaLabel:x,ariaLabelledBy:G,loading:B=!1,loadingContent:Fe="Loading data...",emptyContent:Ge="No data available.",defaultSortKey:Oe,defaultSortDirection:We="asc",getSortAriaLabel:_e=Ye,getSortStatusText:O=Ze,onSortChange:F}){const Me=G?void 0:x??(d?void 0:"Data table"),[l,Pe]=z.useState(()=>Je(e,Oe,We)),f=z.useMemo(()=>{const s=t.map((m,o)=>({row:m,sourceIndex:o}));if(!l)return s;const i=e.find(m=>String(m.key)===l.key);if(!(i!=null&&i.sortable))return s;const u=i.sortAccessor??(m=>{const o=m[String(i.key)];return o instanceof Date||typeof o=="number"||typeof o=="string"?o:String(o??"")});return s.sort((m,o)=>{const g=u(m.row),w=u(o.row);if(typeof g=="string"&&typeof w=="string"){const v=Xe.compare(g,w);return v!==0?l.direction==="asc"?v:-v:m.sourceIndex-o.sourceIndex}const S=g instanceof Date?g.getTime():g,R=w instanceof Date?w.getTime():w;return S<R?l.direction==="asc"?-1:1:S>R?l.direction==="asc"?1:-1:m.sourceIndex-o.sourceIndex})},[e,t,l]),W=z.useMemo(()=>{if(B||f.length<=1||!l)return"";const s=e.find(u=>String(u.key)===l.key);if(!(s!=null&&s.sortable))return"";const i=typeof s.header=="string"?s.header:String(s.key);return O({columnKey:l.key,columnHeader:i,direction:l.direction})},[e,O,B,l,f.length]),_=Math.max(e.length,1);return a.jsxs("div",{style:{border:"1px solid var(--aurora-border-default)",borderRadius:"var(--aurora-radius-md)",overflow:"auto"},children:[W?a.jsx("p",{role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:W}):null,a.jsxs("table",{"aria-label":Me,"aria-labelledby":G,"aria-busy":B||void 0,style:{width:"100%",borderCollapse:"collapse",minWidth:560},children:[d?a.jsx("caption",{style:{textAlign:"left",padding:"10px 12px",color:"var(--aurora-text-secondary)",fontSize:"var(--aurora-font-size-sm)",borderBottom:"1px solid var(--aurora-border-default)"},children:d}):null,a.jsx("thead",{children:a.jsx("tr",{children:e.map(s=>{const i=String(s.key),u=(l==null?void 0:l.key)===i&&f.length>1?l.direction:void 0,m=!!s.sortable,o=u?u==="asc"?"ascending":"descending":void 0,g=s.align??"left",w=typeof s.header=="string"?s.header:i,S=u==="asc"?"desc":"asc",R=_e({columnKey:i,columnHeader:w,nextDirection:S}),v=B||f.length<=1,M=()=>{v||(Pe({key:i,direction:S}),F==null||F(i,S))};return a.jsx("th",{scope:"col","aria-sort":o,style:{textAlign:g,color:"var(--aurora-text-secondary)",background:"var(--aurora-surface-elevated)",borderBottom:"1px solid var(--aurora-border-default)",padding:"10px 12px",fontSize:"var(--aurora-font-size-sm)",fontWeight:"var(--aurora-font-weight-medium)",width:s.width},children:m?a.jsxs("button",{type:"button","aria-label":R,disabled:v,onClick:M,onKeyDown:P=>{et(P.key)&&(P.preventDefault(),M())},style:{border:0,background:"transparent",color:"inherit",font:"inherit",cursor:v?"not-allowed":"pointer",display:"inline-flex",alignItems:"center",gap:6,padding:0,opacity:v?.64:1},children:[s.header,a.jsx("span",{"aria-hidden":"true",children:u==="asc"?"▲":u==="desc"?"▼":"↕"})]}):s.header},i)})})}),a.jsx("tbody",{children:B?a.jsx("tr",{children:a.jsx("td",{colSpan:_,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:Fe})})}):f.length===0?a.jsx("tr",{children:a.jsx("td",{colSpan:_,style:{padding:"16px 12px",color:"var(--aurora-text-secondary)",textAlign:"center"},children:a.jsx("span",{role:"status","aria-live":"polite",children:Ge})})}):f.map((s,i)=>{const u=s.row,m=String(s.sourceIndex);return a.jsx("tr",{style:{background:i%2===0?"transparent":"var(--aurora-surface-elevated)"},children:e.map(o=>{const g=o.render?o.render(u,i,s.sourceIndex):String(u[String(o.key)]??""),w={padding:"10px 12px",borderBottom:"1px solid var(--aurora-border-default)",color:"var(--aurora-text-primary)",fontSize:"var(--aurora-font-size-sm)",textAlign:o.align??"left"};return o.rowHeader?a.jsx("th",{scope:"row",style:{...w,fontWeight:"var(--aurora-font-weight-medium)"},children:g},String(o.key)):a.jsx("td",{style:w,children:g},String(o.key))})},r?r(u,s.sourceIndex):m)})})]})]})}function Ye({columnHeader:e,nextDirection:t}){return`${e} sort ${t==="asc"?"ascending":"descending"}`}function Ze({columnHeader:e,direction:t}){return`Sorted by ${e} ${t==="asc"?"ascending":"descending"}.`}function et(e){return e===" "||e==="Space"||e==="Spacebar"}c.__docgenInfo={description:"",methods:[],displayName:"Table",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: keyof T | string;
...
}`,...(ce=(ie=H.parameters)==null?void 0:ie.docs)==null?void 0:ce.source}}};var le,de,ue;A.parameters={...A.parameters,docs:{...(le=A.parameters)==null?void 0:le.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 780
  }}>
...
}`,...(ue=(de=A.parameters)==null?void 0:de.docs)==null?void 0:ue.source}}};var me,ye,pe;j.parameters={...j.parameters,docs:{...(me=j.parameters)==null?void 0:me.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 780
  }}>
...
}`,...(pe=(ye=j.parameters)==null?void 0:ye.docs)==null?void 0:pe.source}}};var ge,we,be;K.parameters={...K.parameters,docs:{...(ge=K.parameters)==null?void 0:ge.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 780,
    display: "grid",
    gap: 10
...
}`,...(Be=(Se=N.parameters)==null?void 0:Se.docs)==null?void 0:Be.source}}};var Re,Te,ke;E.parameters={...E.parameters,docs:{...(Re=E.parameters)==null?void 0:Re.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 780
  }}>
...
}`,...(ke=(Te=E.parameters)==null?void 0:Te.docs)==null?void 0:ke.source}}};var Ie,De,He;q.parameters={...q.parameters,docs:{...(Ie=q.parameters)==null?void 0:Ie.docs,source:{originalSource:`{
  render: () => {
...
}`,...(He=(De=q.parameters)==null?void 0:De.docs)==null?void 0:He.source}}};var Ae,je,Ke;$.parameters={...$.parameters,docs:{...(Ae=$.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 720
  }}>
...
}`,...(Ke=(je=$.parameters)==null?void 0:je.docs)==null?void 0:Ke.source}}};var Ce,Ne,Ee;L.parameters={...L.parameters,docs:{...(Ce=L.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 720
  }}>
