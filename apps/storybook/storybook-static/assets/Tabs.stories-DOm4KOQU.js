import{j as s}from"./jsx-runtime-BjG_zV1W.js";import{r as u}from"./index-BWu4c2F4.js";import{B as za}from"./Button-BhfMIoQv.js";import{B as ja}from"./Badge-ZJmMstsz.js";import{within as y,expect as t,userEvent as l,fireEvent as D}from"./index-DgAF9SIF.js";import{s as R,S as xe}from"./storyShowcase-Bw5VyCj0.js";function ke(a){return a.reduce((e,n,o)=>(e[n.key]=o,e),{})}function Ua(a,e,n,o){var v,k;if(a.length===0)return-1;const i=(v=a[e])!=null&&v.disabled?-1:e;let d=e;for(let f=0;f<a.length;f+=1){if(d+=n,o)d<0?d=a.length-1:d>=a.length&&(d=0);else if(d<0||d>=a.length)return i;if(!((k=a[d])!=null&&k.disabled))return d}return i}function $a(a){return a.findIndex(e=>!e.disabled)}function Ga(a){var e;for(let n=a.length-1;n>=0;n-=1)if(!((e=a[n])!=null&&e.disabled))return n;return-1}function Ya(a,e,n){var o,i,d,v;if(!Array.isArray(a)||a.length===0||typeof e!="number"||Number.isNaN(e))return n;for(let k=0;k<a.length;k+=1){const f=e+k;if(f>=0&&f<a.length&&!((o=a[f])!=null&&o.disabled))return((i=a[f])==null?void 0:i.key)??n;if(k===0)continue;const B=e-k;if(B>=0&&B<a.length&&!((d=a[B])!=null&&d.disabled))return((v=a[B])==null?void 0:v.key)??n}return n}function p({items:a,value:e,defaultValue:n,ariaLabel:o="Tabs",ariaLabelledBy:i,orientation:d="horizontal",activationMode:v="automatic",loop:k=!0,onValueChange:f}){var ye;const B=u.useId(),oe=u.useRef(null),re=u.useRef([]),V=u.useRef(null),S=u.useRef(null),A=u.useRef(null);u.useRef(null),u.useRef(null),u.useRef(null);const C=u.useRef(!0),[Ia,Da]=u.useState(()=>ke(a)),F=(ye=a.find(r=>!r.disabled))==null?void 0:ye.key,[ie,de]=u.useState(n??F),[Va,ce]=u.useState(null),[Fa,j]=u.useState(null),[Ma,L]=u.useState(null),Pa=be(o,"Tabs"),pe=be(i);u.useEffect(()=>{},[a]),u.useEffect(()=>{},[a]),u.useEffect(()=>{Da(ke(a))},[a]),u.useEffect(()=>{},[a,e]),u.useEffect(()=>{var g;const r=((g=oe.current)==null?void 0:g.ownerDocument)??document,b=E=>{E.metaKey||E.altKey||E.ctrlKey||(C.current=!0)},w=()=>{C.current=!1};return r.addEventListener("keydown",b,!0),r.addEventListener("pointerdown",w,!0),r.addEventListener("mousedown",w,!0),r.addEventListener("touchstart",w,!0),()=>{r.removeEventListener("keydown",b,!0),r.removeEventListener("pointerdown",w,!0),r.removeEventListener("mousedown",w,!0),r.removeEventListener("touchstart",w,!0)}},[]);const M=e??ie,le=a.find(r=>r.key===M),T=le&&!le.disabled?M:e===void 0&&M&&!le?Ya(a,Ia[M],F):F,[ve,I]=u.useState(T),Ka=a.some(r=>r.key===ve&&!r.disabled)?ve:T;u.useEffect(()=>{e===void 0&&T!==ie&&de(T)},[T,ie,e]),u.useEffect(()=>{I(T)},[T]),u.useEffect(()=>()=>{S.current!==null&&(A.current??window).clearTimeout(S.current)},[]),u.useEffect(()=>{const r=new Set(a.filter(b=>!b.disabled).map(b=>b.key));ce(b=>b&&!r.has(b)?null:b),j(b=>b&&!r.has(b)?null:b),L(b=>b&&!r.has(b)?null:b)},[a]);const Na=u.useCallback(()=>{V.current=null,S.current!==null&&((A.current??window).clearTimeout(S.current),S.current=null),A.current=null},[]),ue=u.useCallback(r=>{const b=a.find(w=>w.key===r);!b||b.disabled||r===T||(e===void 0&&de(r),f==null||f(r))},[T,a,f,e]);return s.jsxs("div",{style:{display:"grid",gap:10},children:[s.jsx("div",{ref:oe,role:"tablist","aria-label":pe?void 0:Pa,"aria-labelledby":pe,"aria-orientation":d,"aria-disabled":F?void 0:!0,onBlurCapture:r=>{const b=r.relatedTarget;b&&r.currentTarget.contains(b)||I(T)},style:{display:"flex",gap:6,flexWrap:d==="horizontal"?"wrap":"nowrap",flexDirection:d==="vertical"?"column":"row"},children:a.map((r,b)=>{const w=r.key===T,g=!!r.disabled,E=!g&&Va===r.key,we=!g&&Fa===r.key,me=!g&&Ma===r.key,Oa=E||me,qa=be(r.ariaLabel);return s.jsx("button",{ref:c=>{re.current[b]=c},id:`${B}-tab-${b}`,type:"button",role:"tab","aria-label":qa,"aria-selected":w,"aria-controls":`${B}-panel-${b}`,"aria-disabled":g||void 0,"aria-keyshortcuts":v==="manual"&&!g?"Enter Space":void 0,tabIndex:Ka===r.key?0:-1,disabled:g,onClick:c=>{I(r.key);const x=v==="manual"&&c.detail===0&&V.current===r.key;Na(),!x&&ue(r.key)},onMouseEnter:()=>{g||ce(r.key)},onMouseLeave:()=>{ce(c=>c===r.key?null:c),j(c=>c===r.key?null:c)},onMouseDown:c=>{g||c.button===0&&(C.current=!1,L(x=>x===r.key?null:x),j(r.key))},onMouseUp:c=>{c.button===0&&j(x=>x===r.key?null:x)},onFocus:()=>{if(I(r.key),g){L(c=>c===r.key?null:c);return}L(c=>Za(re.current[b],C.current)?r.key:c===r.key?null:c)},onBlur:()=>{L(c=>c===r.key?null:c),j(c=>c===r.key?null:c)},onKeyDown:c=>{if(C.current=!0,c.altKey||c.ctrlKey||c.metaKey)return;if(v==="manual"&&_a(c.key)){if(Ja(c)||(c.preventDefault(),c.repeat))return;V.current=r.key;const h=c.currentTarget.ownerDocument.defaultView??window;S.current!==null&&(A.current??h).clearTimeout(S.current),A.current=h,S.current=h.setTimeout(()=>{V.current=null,S.current=null,A.current=null},0),ue(r.key);return}const x=h=>{var fe,Te;const P=(fe=a[h])==null?void 0:fe.key;P&&(I(P),v==="automatic"&&ue(P),(Te=re.current[h])==null||Te.focus())};if(c.key==="Home"){c.preventDefault();const h=$a(a);x(h);return}if(c.key==="End"){c.preventDefault();const h=Ga(a);x(h);return}const ge=Qa({orientation:d,key:c.key,isRtl:d==="horizontal"&&Xa(oe.current)});if(!ge)return;c.preventDefault();const Wa=Ua(a,b,ge,k);x(Wa)},style:{height:34,borderRadius:"var(--aurora-radius-md)",border:w?"1px solid var(--aurora-accent-default)":Oa?"1px solid color-mix(in srgb, var(--aurora-accent-default) 52%, var(--aurora-border-default))":"1px solid var(--aurora-border-default)",background:w?"color-mix(in srgb, var(--aurora-accent-default) 14%, transparent)":we?"color-mix(in srgb, var(--aurora-surface-elevated) 70%, var(--aurora-surface-default))":E?"color-mix(in srgb, var(--aurora-surface-elevated) 86%, var(--aurora-surface-default))":"var(--aurora-surface-default)",color:g?"color-mix(in srgb, var(--aurora-text-secondary) 64%, transparent)":"var(--aurora-text-primary)",padding:"0 12px",cursor:g?"not-allowed":"pointer",boxShadow:me?"0 0 0 3px color-mix(in srgb, var(--aurora-focus-ring) 42%, transparent)":"none",transform:we?"translateY(1px)":"translateY(0)",transition:"background-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), border-color var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), box-shadow var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard), transform var(--aurora-motion-duration-fast) var(--aurora-motion-easing-standard)"},children:r.label},r.key)})}),a.map((r,b)=>{const w=r.key===T;return s.jsx("div",{id:`${B}-panel-${b}`,role:"tabpanel","aria-labelledby":`${B}-tab-${b}`,tabIndex:w?0:-1,hidden:!w,style:{display:w?void 0:"none",border:"1px solid var(--aurora-border-default)",borderRadius:"var(--aurora-radius-md)",padding:12,background:"var(--aurora-surface-default)"},children:r.content},r.key)})]})}function _a(a){return a==="Enter"||a===" "||a==="Space"||a==="Spacebar"}function Ja(a){const e=a.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function Qa({orientation:a,key:e,isRtl:n}){if(a==="vertical")return e==="ArrowDown"?1:e==="ArrowUp"?-1:void 0;if(e==="ArrowRight")return n?-1:1;if(e==="ArrowLeft")return n?1:-1}function Xa(a){if(!a)return!1;const e=a.closest("[dir]");return(e==null?void 0:e.dir)==="rtl"?!0:(e==null?void 0:e.dir)==="ltr"||typeof window>"u"?!1:window.getComputedStyle(a).direction==="rtl"}function Za(a,e){if(!a)return e;try{return a.matches(":focus-visible")}catch{return e}}function be(a,e){return typeof a=="string"&&a.trim().length>0?a.trim():e}p.__docgenInfo={description:"",methods:[],displayName:"Tabs",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: string;
  label: React.ReactNode;
  ariaLabel?: string;
  content: React.ReactNode;
  disabled?: boolean;
}`,signature:{properties:[{key:"key",value:{name:"string",required:!0}},{key:"label",value:{name:"ReactReactNode",raw:"React.ReactNode",required:!0}},{key:"ariaLabel",value:{name:"string",required:!1}},{key:"content",value:{name:"ReactReactNode",raw:"React.ReactNode",required:!0}},{key:"disabled",value:{name:"boolean",required:!1}}]}}],raw:"TabItem[]"},description:""},value:{required:!1,tsType:{name:"string"},description:""},defaultValue:{required:!1,tsType:{name:"string"},description:""},ariaLabel:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"Tabs"',computed:!1}},ariaLabelledBy:{required:!1,tsType:{name:"string"},description:""},orientation:{required:!1,tsType:{name:"union",raw:'"horizontal" | "vertical"',elements:[{name:"literal",value:'"horizontal"'},{name:"literal",value:'"vertical"'}]},description:"",defaultValue:{value:'"horizontal"',computed:!1}},activationMode:{required:!1,tsType:{name:"union",raw:'"automatic" | "manual"',elements:[{name:"literal",value:'"automatic"'},{name:"literal",value:'"manual"'}]},description:"",defaultValue:{value:'"automatic"',computed:!1}},loop:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},onValueChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""}}};const H=[{key:"spec",label:"Spec",content:"Token contract, component API, and test strategy are captured here before implementation."},{key:"build",label:"Build",content:"Run lint, typecheck, and unit tests for all affected packages, then update docs."},{key:"release",label:"Release",content:"Publish with changesets and validate Storybook + demo output as final quality gate."}],La={color:"var(--aurora-text-secondary)",fontSize:13},he="min(100%, 620px)";function m({children:a,gap:e=12,dir:n}){return n?s.jsx("div",{dir:n,children:s.jsx(xe,{maxWidth:he,gap:e,children:a})}):s.jsx(xe,{maxWidth:he,gap:e,children:a})}function Re(a,e){const n=new KeyboardEvent("keydown",{key:e,bubbles:!0});Object.defineProperty(n,"isComposing",{value:!0}),Object.defineProperty(n,"keyCode",{value:229}),a.dispatchEvent(n)}const dt={title:"Data/Tabs",component:p,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:"Tabs support horizontal/vertical keyboard navigation (Arrow/Home/End) and theme-aware state styling for data-heavy dashboards."}}},args:{items:H,defaultValue:"spec"}},K={};function et(){const[a,e]=u.useState("build");return s.jsxs(m,{gap:10,children:[s.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[s.jsx("span",{style:La,children:"Current stage"}),s.jsx(ja,{tone:"default",children:a})]}),s.jsx(p,{items:H,value:a,onValueChange:e})]})}function at(){const[a,e]=u.useState(!1);return s.jsxs(m,{children:[s.jsx("button",{type:"button",onClick:()=>e(!0),children:"Disable Build tab"}),s.jsx(p,{ariaLabel:"Disable visual reset tabs",defaultValue:"spec",items:[{key:"spec",label:"Spec",content:"Specification stage is active."},{key:"build",label:"Build",content:"Build stage is active.",disabled:a},{key:"release",label:"Release",content:"Release stage is active."}]})]})}function tt(){const[a,e]=u.useState(!1),n=a?[{key:"spec",label:"Spec",content:"Spec stage remains available."},{key:"release",label:"Release",content:"Release stage becomes the nearest fallback."}]:[{key:"spec",label:"Spec",content:"Spec stage remains available."},{key:"build",label:"Build",content:"Build stage is active before removal."},{key:"release",label:"Release",content:"Release stage becomes the nearest fallback."}];return s.jsxs(m,{children:[s.jsx(za,{size:"sm",variant:"outline",onClick:()=>e(!0),children:"Remove Build tab"}),s.jsx(p,{ariaLabel:"Removal fallback tabs",defaultValue:"build",items:n})]})}const N={render:()=>s.jsx(et,{}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tab",{name:"Release"}),o=e.getByRole("tab",{name:"Spec"});await l.click(n),await t(e.getByRole("tabpanel")).toHaveTextContent("Publish with changesets"),await t(n).toHaveFocus(),await l.keyboard("{Home}"),await t(o).toHaveAttribute("aria-selected","true"),await t(o).toHaveFocus()}},O={render:()=>s.jsxs(m,{children:[s.jsx("p",{style:R,children:"Pointer focus keeps ring hidden, then keyboard Tab navigation restores focus-visible ring for the active tab."}),s.jsx("button",{type:"button",children:"Before tabs"}),s.jsx(p,{ariaLabel:"Focus ring fallback tabs",defaultValue:"spec",items:H})]}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tab",{name:"Spec"}),o=e.getByRole("button",{name:"Before tabs"});D.mouseDown(n),n.focus(),await l.click(o),await l.tab(),await t(n).toHaveFocus(),await t(n.style.boxShadow).toContain("0 0 0 3px")}},q={render:()=>s.jsx(at,{}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("button",{name:"Disable Build tab"}),o=e.getByRole("tab",{name:"Build"});D.mouseDown(o),await l.click(n);const i=e.getByRole("tab",{name:"Build"});await t(i).toBeDisabled(),await t(i.style.transform).toContain("translateY(0"),await t(i.style.boxShadow).toBe("none")}},W={render:()=>s.jsx(tt,{}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("button",{name:"Remove Build tab"});await t(e.getByRole("tab",{name:"Build"})).toHaveAttribute("aria-selected","true"),await l.click(n);const o=e.getByRole("tab",{name:"Release"});await t(o).toHaveAttribute("aria-selected","true"),await t(o).toHaveAttribute("tabindex","0"),await t(e.getByRole("tabpanel")).toHaveTextContent("Release stage becomes the nearest fallback.")}},z={render:function(){const[e,n]=u.useState("spec"),[o,i]=u.useState(0);return s.jsxs(m,{gap:10,children:[s.jsxs("p",{style:R,children:["Active tab: ",s.jsx("strong",{"data-testid":"primary-pointer-active",children:e})," | Change count: ",s.jsx("strong",{"data-testid":"primary-pointer-count",children:o})]}),s.jsx("button",{type:"button",children:"Before tabs"}),s.jsx(p,{ariaLabel:"Primary pointer tabs",value:e,activationMode:"manual",items:H,onValueChange:d=>{n(d),i(v=>v+1)}})]})},play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("button",{name:"Before tabs"}),o=e.getByRole("tab",{name:"Spec"}),i=e.getByRole("tab",{name:"Build"}),d=e.getByTestId("primary-pointer-active"),v=e.getByTestId("primary-pointer-count");await l.click(n),await l.tab(),await t(o).toHaveFocus(),await l.keyboard("{ArrowRight}"),await t(i).toHaveFocus(),await t(i.style.boxShadow).toContain("0 0 0 3px"),D.mouseDown(i,{button:2}),D.mouseUp(i,{button:2}),await t(i.style.boxShadow).toContain("0 0 0 3px"),await t(d).toHaveTextContent("spec"),await t(v).toHaveTextContent("0"),await l.click(i),await t(d).toHaveTextContent("build"),await t(v).toHaveTextContent("1")}},U={render:()=>s.jsx(p,{ariaLabel:"Release stages",defaultValue:"spec",items:[{key:"spec",label:"Spec",content:"Specification stage is active."},{key:"security",label:"Security Review",content:"Security review is pending.",disabled:!0},{key:"release",label:"Release",content:"Release checklist is ready."}]})},$={render:()=>s.jsx(p,{ariaLabel:"All disabled release tabs",activationMode:"manual",items:[{key:"spec",label:"Spec",content:"Specification stage is disabled.",disabled:!0},{key:"release",label:"Release",content:"Release stage is disabled.",disabled:!0}]}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tablist",{name:"All disabled release tabs"});await t(n).toHaveAttribute("aria-disabled","true");const o=e.getAllByRole("tab");await t(o).toHaveLength(2),o.forEach(i=>{t(i).toBeDisabled(),t(i).not.toHaveAttribute("aria-keyshortcuts"),t(i).toHaveAttribute("aria-selected","false"),t(i).toHaveAttribute("tabindex","-1")})}},G={render:()=>s.jsxs(m,{children:[s.jsx("p",{style:R,children:"Keyboard: horizontal tabs use ArrowLeft/ArrowRight, vertical tabs use ArrowUp/ArrowDown. Home jumps to first enabled tab, End jumps to last enabled tab."}),s.jsx(p,{ariaLabel:"Keyboard guide tabs",defaultValue:"spec",items:[{key:"blocked",label:"Blocked",content:"Blocked tab",disabled:!0},{key:"spec",label:"Spec",content:"Specification stage."},{key:"review",label:"Review",content:"Review stage.",disabled:!0},{key:"release",label:"Release",content:"Release stage."}]})]}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tab",{name:"Spec"}),o=e.getByRole("tab",{name:"Release"}),i=e.getByRole("tab",{name:"Blocked"});await l.click(n),await t(n).toHaveAttribute("aria-selected","true"),await t(i).toHaveAttribute("aria-disabled","true"),await l.keyboard("{End}"),await t(o).toHaveAttribute("aria-selected","true"),await t(o).toHaveFocus(),await l.keyboard("{Home}"),await t(n).toHaveAttribute("aria-selected","true"),await t(n).toHaveFocus(),D.keyDown(n,{key:"End",ctrlKey:!0}),await t(n).toHaveAttribute("aria-selected","true"),await t(n).toHaveFocus()}},Y={render:()=>s.jsxs(m,{children:[s.jsxs("p",{style:R,children:["Set ",s.jsx("code",{children:"loop={false}"})," to keep Arrow navigation at tablist boundaries instead of wrapping."]}),s.jsx(p,{ariaLabel:"No loop tabs",defaultValue:"spec",loop:!1,items:H})]}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tab",{name:"Spec"}),o=e.getByRole("tab",{name:"Release"});await l.click(o),await l.keyboard("{ArrowRight}"),await t(o).toHaveFocus(),await t(o).toHaveAttribute("aria-selected","true"),await l.click(n),await l.keyboard("{ArrowLeft}"),await t(n).toHaveFocus(),await t(n).toHaveAttribute("aria-selected","true")}};function nt(){const a=u.useId();return s.jsxs(m,{gap:10,children:[s.jsx("h3",{id:a,style:{margin:0},children:"Release Stages"}),s.jsx(p,{ariaLabelledBy:a,items:H,defaultValue:"spec"})]})}function st(){return s.jsxs(m,{children:[s.jsxs("p",{style:R,children:["Icon tabs should expose explicit naming through ",s.jsx("code",{children:"items[].ariaLabel"})," so keyboard and screen-reader navigation stay clear."]}),s.jsx(p,{ariaLabel:"Icon label tabs",defaultValue:"overview",items:[{key:"overview",label:s.jsx("span",{"aria-hidden":"true",children:"🧭"}),ariaLabel:"Navigation overview",content:"Overview panel keeps icon-only tab naming explicit."},{key:"release",label:"Release",content:"Release panel remains text-labeled."}]})]})}const _={render:()=>s.jsx(nt,{}),play:async({canvasElement:a})=>{const e=y(a);await t(e.getByRole("tablist",{name:"Release Stages"})).toBeInTheDocument()}},J={render:()=>s.jsx(st,{}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tab",{name:"Navigation overview"});await t(n).toHaveAttribute("aria-selected","true"),await t(n).toHaveAttribute("aria-controls"),await t(e.getByRole("tabpanel")).toHaveTextContent("Overview panel keeps icon-only tab naming explicit.")}},Q={render:()=>s.jsx(m,{children:s.jsx(p,{ariaLabel:"Vertical workflow tabs",orientation:"vertical",defaultValue:"spec",items:[{key:"spec",label:"Spec",content:"Specification stage."},{key:"review",label:"Review",content:"Review stage.",disabled:!0},{key:"release",label:"Release",content:"Release stage."}]})}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tablist",{name:"Vertical workflow tabs"});await t(n).toHaveAttribute("aria-orientation","vertical");const o=e.getByRole("tab",{name:"Spec"});await l.click(o),await l.keyboard("{ArrowDown}"),await t(e.getByRole("tab",{name:"Release"})).toHaveAttribute("aria-selected","true")}},X={render:()=>s.jsxs(m,{dir:"rtl",children:[s.jsx("p",{style:R,children:"In RTL layouts, horizontal ArrowRight moves to the previous tab and ArrowLeft moves to the next tab."}),s.jsx(p,{ariaLabel:"RTL workflow tabs",defaultValue:"spec",items:H})]}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tab",{name:"Spec"}),o=e.getByRole("tab",{name:"Release"});await l.click(n),await t(e.getByRole("tabpanel")).toHaveTextContent("Token contract, component API"),await l.keyboard("{ArrowRight}"),await t(o).toHaveFocus(),await t(o).toHaveAttribute("aria-selected","true"),await l.keyboard("{ArrowLeft}"),await t(n).toHaveFocus(),await t(n).toHaveAttribute("aria-selected","true")}},Z={render:()=>s.jsxs(m,{children:[s.jsx("p",{style:R,children:"Manual mode keeps panel selection stable while arrows move focus; press Enter or Space to activate."}),s.jsx(p,{ariaLabel:"Manual activation tabs",activationMode:"manual",defaultValue:"spec",items:[{key:"spec",label:"Spec",content:"Specification stage."},{key:"build",label:"Build",content:"Build stage."},{key:"release",label:"Release",content:"Release stage."}]})]}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tab",{name:"Spec"}),o=e.getByRole("tab",{name:"Release"});await l.click(n),await t(e.getByRole("tabpanel")).toHaveTextContent("Specification stage."),await t(n).toHaveAttribute("aria-keyshortcuts","Enter Space"),await t(o).toHaveAttribute("aria-keyshortcuts","Enter Space"),await l.keyboard("{ArrowRight}"),await t(e.getByRole("tab",{name:"Build"})).toHaveFocus(),await t(e.getByRole("tabpanel")).toHaveTextContent("Specification stage."),await l.keyboard("{Enter}"),await t(e.getByRole("tabpanel")).toHaveTextContent("Build stage."),await l.keyboard("{End}"),await t(o).toHaveFocus(),await t(e.getByRole("tabpanel")).toHaveTextContent("Build stage."),o.focus(),await l.keyboard("{Space}"),await t(e.getByRole("tabpanel")).toHaveTextContent("Release stage.")}},ee={render:()=>s.jsxs(m,{children:[s.jsx("p",{style:R,children:"In manual mode, moving focus with arrows does not change selection. After leaving the tablist, roving focus returns to the selected tab for the next keyboard entry."}),s.jsx(p,{ariaLabel:"Manual blur reset tabs",activationMode:"manual",defaultValue:"spec",items:[{key:"spec",label:"Spec",content:"Specification stage."},{key:"build",label:"Build",content:"Build stage."},{key:"release",label:"Release",content:"Release stage."}]}),s.jsx("button",{type:"button",children:"Outside focus target"})]}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tab",{name:"Spec"}),o=e.getByRole("tab",{name:"Build"}),i=e.getByRole("button",{name:"Outside focus target"});await l.click(n),await l.keyboard("{ArrowRight}"),await t(o).toHaveFocus(),await t(n).toHaveAttribute("aria-selected","true"),await t(o).toHaveAttribute("aria-selected","false"),await t(n).toHaveAttribute("tabindex","-1"),await t(o).toHaveAttribute("tabindex","0"),await l.click(i),await t(i).toHaveFocus(),await t(n).toHaveAttribute("tabindex","0"),await t(o).toHaveAttribute("tabindex","-1")}},ae={render:()=>s.jsxs(m,{children:[s.jsx("p",{style:R,children:"In manual mode, Enter and Space are ignored while IME composition is active, so CJK confirmation does not activate a tab by accident."}),s.jsx(p,{ariaLabel:"Manual activation IME guard tabs",activationMode:"manual",defaultValue:"spec",items:[{key:"spec",label:"Spec",content:"Specification stage."},{key:"build",label:"Build",content:"Build stage."},{key:"release",label:"Release",content:"Release stage."}]})]}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tab",{name:"Spec"}),o=e.getByRole("tab",{name:"Build"});await l.click(n),await t(e.getByRole("tabpanel")).toHaveTextContent("Specification stage."),await l.keyboard("{ArrowRight}"),await t(o).toHaveFocus(),await t(o).toHaveAttribute("aria-selected","false"),Re(o,"Enter"),await t(e.getByRole("tabpanel")).toHaveTextContent("Specification stage."),await t(o).toHaveAttribute("aria-selected","false"),Re(o,"Space"),await t(e.getByRole("tabpanel")).toHaveTextContent("Specification stage."),await t(o).toHaveAttribute("aria-selected","false"),o.focus(),await t(o).toHaveFocus(),await l.keyboard("{Enter}"),await t(e.getByRole("tabpanel")).toHaveTextContent("Build stage."),await t(o).toHaveAttribute("aria-selected","true")}},te={render:()=>s.jsxs(m,{children:[s.jsx("p",{style:R,children:"Vertical + manual mode keeps selection stable while ArrowUp/ArrowDown move focus; Enter/Space activates."}),s.jsx(p,{ariaLabel:"Manual vertical release tabs",orientation:"vertical",activationMode:"manual",defaultValue:"backlog",items:[{key:"backlog",label:"Backlog",content:"Backlog scope and release intent."},{key:"review",label:"Review",content:"Review and signoff.",disabled:!0},{key:"ship",label:"Ship",content:"Ship checklist and release notes."}]})]}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tab",{name:"Backlog"}),o=e.getByRole("tab",{name:"Review"}),i=e.getByRole("tab",{name:"Ship"});await l.click(n),await t(e.getByRole("tabpanel")).toHaveTextContent("Backlog scope and release intent."),await t(n).toHaveAttribute("aria-keyshortcuts","Enter Space"),await t(i).toHaveAttribute("aria-keyshortcuts","Enter Space"),await t(o).toHaveAttribute("aria-disabled","true"),await t(o).not.toHaveAttribute("aria-keyshortcuts"),await l.keyboard("{ArrowDown}"),await t(i).toHaveFocus(),await t(e.getByRole("tabpanel")).toHaveTextContent("Backlog scope and release intent."),await l.keyboard("{Enter}"),await t(e.getByRole("tabpanel")).toHaveTextContent("Ship checklist and release notes.")}};function ot(){const[a,e]=u.useState("build"),[n,o]=u.useState(0);return s.jsxs(m,{gap:10,children:[s.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[s.jsx("span",{style:La,children:"Value change events"}),s.jsx(ja,{tone:"default","data-testid":"change-count",children:n})]}),s.jsx(p,{items:H,value:a,onValueChange:i=>{e(i),o(d=>d+1)}})]})}const ne={render:()=>s.jsx(ot,{}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tab",{name:"Build"}),o=e.getByRole("tab",{name:"Release"}),i=e.getByTestId("change-count");await l.click(n),await t(i).toHaveTextContent("0"),await l.click(o),await t(i).toHaveTextContent("1"),await l.click(o),await t(i).toHaveTextContent("1")}},se={render:()=>s.jsx(p,{items:H,defaultValue:"spec"}),play:async({canvasElement:a})=>{const e=y(a),n=e.getByRole("tab",{name:"Spec"}),o=e.getByRole("tab",{name:"Release"}),i=n.getAttribute("aria-controls"),d=o.getAttribute("aria-controls");await t(i).toBeTruthy(),await t(d).toBeTruthy(),await t(document.getElementById(i)).not.toBeNull(),await t(document.getElementById(d)).not.toBeNull();const v=document.getElementById(d);await t(v).toHaveAttribute("hidden"),await l.click(o),await t(v).not.toHaveAttribute("hidden")}};var Be,Se,He;K.parameters={...K.parameters,docs:{...(Be=K.parameters)==null?void 0:Be.docs,source:{originalSource:"{}",...(He=(Se=K.parameters)==null?void 0:Se.docs)==null?void 0:He.source}}};var Ae,Ee,Ce;N.parameters={...N.parameters,docs:{...(Ae=N.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
...
}`,...(Ce=(Ee=N.parameters)==null?void 0:Ee.docs)==null?void 0:Ce.source}}};var je,Le,Ie;O.parameters={...O.parameters,docs:{...(je=O.parameters)==null?void 0:je.docs,source:{originalSource:`{
  render: () => <TabsShowcase>
...
}`,...(Ie=(Le=O.parameters)==null?void 0:Le.docs)==null?void 0:Ie.source}}};var De,Ve,Fe;q.parameters={...q.parameters,docs:{...(De=q.parameters)==null?void 0:De.docs,source:{originalSource:`{
...
}`,...(Fe=(Ve=q.parameters)==null?void 0:Ve.docs)==null?void 0:Fe.source}}};var Me,Pe,Ke;W.parameters={...W.parameters,docs:{...(Me=W.parameters)==null?void 0:Me.docs,source:{originalSource:`{
...
}`,...(Ke=(Pe=W.parameters)==null?void 0:Pe.docs)==null?void 0:Ke.source}}};var Ne,Oe,qe;z.parameters={...z.parameters,docs:{...(Ne=z.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
...
}`,...(qe=(Oe=z.parameters)==null?void 0:Oe.docs)==null?void 0:qe.source}}};var We,ze,Ue;U.parameters={...U.parameters,docs:{...(We=U.parameters)==null?void 0:We.docs,source:{originalSource:`{
...
}`,...(Ue=(ze=U.parameters)==null?void 0:ze.docs)==null?void 0:Ue.source}}};var $e,Ge,Ye;$.parameters={...$.parameters,docs:{...($e=$.parameters)==null?void 0:$e.docs,source:{originalSource:`{
...
}`,...(Ye=(Ge=$.parameters)==null?void 0:Ge.docs)==null?void 0:Ye.source}}};var _e,Je,Qe;G.parameters={...G.parameters,docs:{...(_e=G.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  render: () => <TabsShowcase>
      <p style={storyMutedTextStyle}>
...
}`,...(Qe=(Je=G.parameters)==null?void 0:Je.docs)==null?void 0:Qe.source}}};var Xe,Ze,ea;Y.parameters={...Y.parameters,docs:{...(Xe=Y.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
  render: () => <TabsShowcase>
      <p style={storyMutedTextStyle}>
...
}`,...(ea=(Ze=Y.parameters)==null?void 0:Ze.docs)==null?void 0:ea.source}}};var aa,ta,na;_.parameters={..._.parameters,docs:{...(aa=_.parameters)==null?void 0:aa.docs,source:{originalSource:`{
...
}`,...(na=(ta=_.parameters)==null?void 0:ta.docs)==null?void 0:na.source}}};var sa,oa,ra;J.parameters={...J.parameters,docs:{...(sa=J.parameters)==null?void 0:sa.docs,source:{originalSource:`{
...
}`,...(ra=(oa=J.parameters)==null?void 0:oa.docs)==null?void 0:ra.source}}};var ia,ca,la;Q.parameters={...Q.parameters,docs:{...(ia=Q.parameters)==null?void 0:ia.docs,source:{originalSource:`{
  render: () => <TabsShowcase>
...
}`,...(la=(ca=Q.parameters)==null?void 0:ca.docs)==null?void 0:la.source}}};var ua,ba,da;X.parameters={...X.parameters,docs:{...(ua=X.parameters)==null?void 0:ua.docs,source:{originalSource:`{
...
}`,...(da=(ba=X.parameters)==null?void 0:ba.docs)==null?void 0:da.source}}};var pa,va,ya;Z.parameters={...Z.parameters,docs:{...(pa=Z.parameters)==null?void 0:pa.docs,source:{originalSource:`{
  render: () => <TabsShowcase>
      <p style={storyMutedTextStyle}>
...
}`,...(ya=(va=Z.parameters)==null?void 0:va.docs)==null?void 0:ya.source}}};var wa,ma,ga;ee.parameters={...ee.parameters,docs:{...(wa=ee.parameters)==null?void 0:wa.docs,source:{originalSource:`{
  render: () => <TabsShowcase>
      <p style={storyMutedTextStyle}>
...
}`,...(ga=(ma=ee.parameters)==null?void 0:ma.docs)==null?void 0:ga.source}}};var fa,Ta,xa;ae.parameters={...ae.parameters,docs:{...(fa=ae.parameters)==null?void 0:fa.docs,source:{originalSource:`{
  render: () => <TabsShowcase>
      <p style={storyMutedTextStyle}>
...
}`,...(xa=(Ta=ae.parameters)==null?void 0:Ta.docs)==null?void 0:xa.source}}};var ka,ha,Ra;te.parameters={...te.parameters,docs:{...(ka=te.parameters)==null?void 0:ka.docs,source:{originalSource:`{
  render: () => <TabsShowcase>
      <p style={storyMutedTextStyle}>
...
}`,...(Ra=(ha=te.parameters)==null?void 0:ha.docs)==null?void 0:Ra.source}}};var Ba,Sa,Ha;ne.parameters={...ne.parameters,docs:{...(Ba=ne.parameters)==null?void 0:Ba.docs,source:{originalSource:`{
...
}`,...(Ha=(Sa=ne.parameters)==null?void 0:Sa.docs)==null?void 0:Ha.source}}};var Aa,Ea,Ca;se.parameters={...se.parameters,docs:{...(Aa=se.parameters)==null?void 0:Aa.docs,source:{originalSource:`{
