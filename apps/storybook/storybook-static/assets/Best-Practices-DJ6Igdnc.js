...
`,e.jsx(n.li,{children:"For stacked notifications, rely on Escape handling that dismisses one toast per key press, always from latest opened to oldest."}),`
...
`,e.jsx(i,{of:D}),`
`,e.jsx(i,{of:A}),`
`,e.jsx(i,{of:C})]})}function re(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(o,{...s})}):o(s)}export{re as default};
