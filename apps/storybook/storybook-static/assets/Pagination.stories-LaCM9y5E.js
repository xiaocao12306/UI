import{j as t}from"./jsx-runtime-BjG_zV1W.js";import{r as d}from"./index-BWu4c2F4.js";import{B as W}from"./Badge-ZJmMstsz.js";import{within as R,expect as i,userEvent as B}from"./index-DgAF9SIF.js";function x(a,e,r){return Math.min(Math.max(a,e),r)}function q(a,e){const r=e-a+1;return Array.from({length:r},(o,c)=>a+c)}function Pe(a,e,r,o){const c=o*2+r*2+3;if(e<=c)return q(1,e);const l=Math.max(a-r,o+2),g=Math.min(a+r,e-o-1),u=[],$=q(1,o),C=q(e-o+1,e);u.push(...$),l>o+2?u.push("ellipsis-left"):o+1<l&&u.push(o+1);for(let m=l;m<=g;m+=1)u.push(m);return g<e-o-1?u.push("ellipsis-right"):g+1<e-o+1&&u.push(e-o),u.push(...C),u}function h({page:a,pageCount:e,onPageChange:r,siblingCount:o=1,boundaryCount:c=1,disabled:l=!1,showFirstLast:g=!0,ariaLabel:u="Pagination",ariaLabelledBy:$,getItemAriaLabel:C=O}){const m=d.useRef(null),w=d.useRef(null),be=V(u,"Pagination"),M=V($),D=Math.max(e,1),p=x(a,1,D),xe=e<=1?[]:Pe(p,e,o,c),_=x(p-1,1,D),N=x(p+1,1,D),T=!l&&e>1&&p>1,j=!l&&e>1&&p<e,f=d.useCallback((n,s)=>V(C(n,s),O(n,s)),[C]),y=n=>{if(l||e<=1)return;const s=x(n,1,e);s!==p&&r(s)};d.useEffect(()=>{var v;if(w.current===null)return;const n=w.current;w.current=null;const s=(v=m.current)==null?void 0:v.querySelector(`button[data-aurora-pagination-page="${n}"]`);s==null||s.focus()},[p]);const k=n=>{const s=x(n,1,e);if(s===p){w.current=null;return}w.current=s,y(s)},b=n=>{if(l)return;if(n.key==="Home")n.preventDefault(),k(1);else if(n.key==="End"){n.preventDefault(),k(D);return}const s=Be(n.key,n.currentTarget);s!==void 0&&(n.preventDefault(),k(p+s))};return e<=1?null:t.jsx("nav",{ref:m,"aria-label":M?void 0:be,"aria-labelledby":M,children:t.jsxs("ul",{style:{listStyle:"none",padding:0,margin:0,display:"flex",flexWrap:"wrap",gap:6,alignItems:"center"},children:[g?t.jsx("li",{children:t.jsx("button",{type:"button",disabled:!T,onClick:()=>y(1),onKeyDown:b,"aria-label":f("first",1),style:P(!1,!T),children:"«"})}):null,t.jsx("li",{children:t.jsx("button",{type:"button",disabled:!T,onClick:()=>y(_),onKeyDown:b,"aria-label":f("previous",_),style:P(!1,!T),children:"‹"})}),xe.map((n,s)=>{if(typeof n!="number")return t.jsx("li",{"aria-hidden":"true",style:{color:"var(--aurora-text-secondary)",minWidth:32,textAlign:"center"},children:"…"},`${n}-${s}`);const v=n===p;return t.jsx("li",{children:t.jsx("button",{type:"button",onClick:()=>y(n),disabled:l,onKeyDown:b,"data-aurora-pagination-page":n,"aria-current":v?"page":void 0,"aria-label":f(v?"current":"page",n),style:P(v,l),children:n})},n)}),t.jsx("li",{children:t.jsx("button",{type:"button",disabled:!j,onClick:()=>y(N),onKeyDown:b,"aria-label":f("next",N),style:P(!1,!j),children:"›"})}),g?t.jsx("li",{children:t.jsx("button",{type:"button",disabled:!j,onClick:()=>y(e),onKeyDown:b,"aria-label":f("last",e),style:P(!1,!j),children:"»"})}):null]})})}function Be(a,e){if(!(a!=="ArrowLeft"&&a!=="ArrowRight"))return Re(a,Ce(e))}function Re(a,e){return a==="ArrowRight"?e?-1:1:e?1:-1}function Ce(a){if(!a)return!1;const e=a.closest("[dir]");if((e==null?void 0:e.dir)==="rtl")return!0;if((e==null?void 0:e.dir)==="ltr")return!1;const r=a.ownerDocument.defaultView??(typeof window<"u"?window:null);return r?r.getComputedStyle(a).direction==="rtl":!1}function O(a,e){switch(a){case"first":return"Go to first page";case"last":return"Go to last page";case"previous":return"Go to previous page";case"next":return"Go to next page";case"current":return`Current page, ${e}`;default:return`Go to page ${e}`}}function P(a,e){return{minWidth:32,height:32,padding:"0 8px",borderRadius:"var(--aurora-radius-sm)",border:a?"1px solid var(--aurora-accent-default)":"1px solid var(--aurora-border-default)",background:a?"color-mix(in srgb, var(--aurora-accent-default) 12%, var(--aurora-surface-default))":"var(--aurora-surface-default)",color:e?"color-mix(in srgb, var(--aurora-text-secondary) 65%, transparent)":"var(--aurora-text-primary)",cursor:e?"not-allowed":"pointer",font:"inherit"}}function V(a,e){return typeof a=="string"&&a.trim().length>0?a.trim():e}h.__docgenInfo={description:"",methods:[],displayName:"Pagination",props:{page:{required:!0,tsType:{name:"number"},description:""},pageCount:{required:!0,tsType:{name:"number"},description:""},onPageChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(page: number) => void",signature:{arguments:[{type:{name:"number"},name:"page"}],return:{name:"void"}}},description:""},siblingCount:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},boundaryCount:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},showFirstLast:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},ariaLabel:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"Pagination"',computed:!1}},ariaLabelledBy:{required:!1,tsType:{name:"string"},description:""},getItemAriaLabel:{required:!1,tsType:{name:"signature",type:"function",raw:`(
...
}`,...(re=(ne=S.parameters)==null?void 0:ne.docs)==null?void 0:re.source}}};var oe,se,ie;E.parameters={...E.parameters,docs:{...(oe=E.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    page: 3,
    pageCount: 10,
    showFirstLast: false,
...
}`,...(ie=(se=E.parameters)==null?void 0:se.docs)==null?void 0:ie.source}}};var ce,le,ue;H.parameters={...H.parameters,docs:{...(ce=H.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  args: {
    page: 4,
    pageCount: 12,
    disabled: true,
