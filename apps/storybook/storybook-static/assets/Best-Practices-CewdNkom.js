...
`,e.jsx(n.li,{children:"For stacked notifications, rely on Escape handling that dismisses one toast per key press instead of closing all at once."}),`
...
`,e.jsx(i,{of:k}),`
`,e.jsx(i,{of:D}),`
`,e.jsx(i,{of:A})]})}function oe(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(o,{...s})}):o(s)}export{oe as default};
