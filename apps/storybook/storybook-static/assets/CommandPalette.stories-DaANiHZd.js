import{j as n}from"./jsx-runtime-BjG_zV1W.js";import{r as s}from"./index-BWu4c2F4.js";import{D as Ht}from"./Dialog-Cic3CN4O.js";import{I as jt}from"./Input-B0g8SV4q.js";import{within as y,expect as o,userEvent as i,fireEvent as R,waitFor as ce}from"./index-DgAF9SIF.js";import"./bodyScrollLock-CnEUF6y7.js";import"./index-DlVbWVVj.js";import"./DismissableLayer-BWoUnDZk.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";function p({open:a,onOpenChange:e,commands:t,title:c="Command Palette",description:l="Quickly search and execute workspace actions.",searchAriaLabel:m="Search commands",resultsAriaLabel:x="Command results",closeOnSelect:b=!0,clearQueryOnEscape:E=!0,closeOnEscape:S=!0,closeOnOutsidePointer:de=!0,onEscapeKeyDown:te,onPointerDownOutside:ae,closeLabel:Dt,placeholder:Rt="Search commands...",emptyMessage:It="No commands found.",onQueryChange:h,onCloseReason:k,getResultsStatusText:ue=Nt}){const[C,ne]=s.useState(""),[P,f]=s.useState(0),me=s.useRef(null),I=s.useRef(null),A=s.useRef(null),oe=s.useRef(a),D=s.useId(),pe=s.useId(),ye=s.useRef(null),H=s.useCallback(r=>{A.current=r,k==null||k(r)},[k]),we=s.useCallback(r=>{H(r),e(!1),A.current=null},[H,e]),St=s.useCallback(r=>{!r&&a&&A.current===null&&(k==null||k("close-button")),A.current=null,e(r)},[k,e,a]);s.useEffect(()=>{if(a){const r=globalThis.setTimeout(()=>{var d;(d=me.current)==null||d.focus()},0);return oe.current=a,()=>{globalThis.clearTimeout(r)}}else oe.current&&(ne(r=>(r.length>0&&(h==null||h("")),"")),f(0));oe.current=a},[h,a]);const re=s.useMemo(()=>xe(C.trim()),[C]),u=s.useMemo(()=>re?t.filter(r=>{const w=[Ot(r),...r.keywords??[]].join(" ");return xe(w).includes(re)}):t,[t,re]),j=s.useMemo(()=>u.reduce((r,d)=>d.disabled?r:r+1,0),[u]),se=u.length>0,Pt=s.useMemo(()=>{const r=["ArrowDown","ArrowUp","Home","End","PageDown","PageUp"];return j>0&&r.push("Enter"),(S||E&&C.length>0)&&r.push("Escape"),r.join(" ")},[E,S,j,C.length]),At=s.useMemo(()=>ue({query:C,visibleCount:u.length,enabledCount:j,totalCount:t.length}),[t.length,j,u.length,ue,C]),B=s.useMemo(()=>u.reduce((r,d,w)=>(d.disabled||r.push(w),r),[]),[u]),T=B[0]??-1,ge=B[B.length-1]??-1,g=s.useMemo(()=>{if(P<0)return-1;const r=u[P];return!r||r.disabled?-1:P},[P,u]);s.useEffect(()=>{var d;if(u.length===0){I.current=null,f(-1);return}const r=I.current;if(r){const w=u.findIndex(v=>!v.disabled&&v.key===r);if(w>=0){f(w);return}}f(T),I.current=T>=0?((d=u[T])==null?void 0:d.key)??null:null},[u,T]),s.useEffect(()=>{var r;if(g<0){I.current=null;return}I.current=((r=u[g])==null?void 0:r.key)??null},[u,g]),s.useEffect(()=>{if(!a||g<0)return;const r=ye.current,d=document.getElementById(`${D}-option-${g}`);!r||!d||!r.contains(d)||typeof d.scrollIntoView=="function"&&d.scrollIntoView({block:"nearest"})},[D,a,g]);const ie=s.useCallback(r=>{var w;const d=u[r];!d||d.disabled||((w=d.onSelect)==null||w.call(d),b&&we("item-select"))},[b,we,u]),ve=r=>{var w;if(u.length===0)return;let d=g<0?r===1?-1:0:g;for(let v=0;v<u.length;v+=1)if(d=(d+r+u.length)%u.length,!((w=u[d])!=null&&w.disabled)){f(d);return}},be=r=>{if(B.length===0)return;const d=B.indexOf(g);if(d<0){f(r===1?T:ge);return}const w=Math.min(B.length-1,Math.max(0,d+r*5));f(B[w]??T)};return n.jsx(Ht,{open:a,onOpenChange:St,title:c,description:l,closeLabel:Dt,size:"md",closeOnEscape:S,closeOnOutsidePointer:de,onEscapeKeyDown:r=>{te==null||te(r),!(r.defaultPrevented||!S)&&H("escape-key")},onPointerDownOutside:r=>{ae==null||ae(r),!(r.defaultPrevented||!de)&&H("outside-pointer")},children:n.jsxs("div",{style:{display:"grid",gap:10},children:[n.jsx(jt,{ref:me,"data-autofocus":"",role:"combobox","aria-expanded":se,"aria-haspopup":"listbox","aria-autocomplete":"list","aria-controls":se?D:void 0,"aria-activedescendant":g>=0?`${D}-option-${g}`:void 0,"aria-describedby":pe,"aria-keyshortcuts":Pt,placeholder:Rt,value:C,onChange:r=>{ne(r.target.value),h==null||h(r.target.value)},onKeyDown:r=>{if(!qt(r)){if(r.key==="Escape"&&E&&C.length>0){r.preventDefault(),ne(""),h==null||h("");return}if(r.key==="ArrowDown"){r.preventDefault(),ve(1);return}if(r.key==="ArrowUp"){r.preventDefault(),ve(-1);return}if(r.key==="Home"){r.preventDefault(),f(T);return}if(r.key==="End"){r.preventDefault(),f(ge);return}if(r.key==="PageDown"){r.preventDefault(),be(1);return}if(r.key==="PageUp"){r.preventDefault(),be(-1);return}if(r.key==="Enter"&&g>=0){if(r.preventDefault(),r.repeat)return;ie(g)}}},"aria-label":m}),n.jsx("p",{id:pe,role:"status","aria-live":"polite",style:{position:"absolute",width:1,height:1,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",border:0},children:At}),se?n.jsx("div",{id:D,ref:ye,role:"listbox","aria-label":x,style:{maxHeight:280,overflow:"auto",display:"grid",gap:4},children:u.map((r,d)=>{const w=d===g;return n.jsx("div",{id:`${D}-option-${d}`,role:"option","aria-selected":w,"aria-disabled":r.disabled||void 0,"aria-posinset":d+1,"aria-setsize":u.length,tabIndex:-1,onMouseDown:v=>{v.preventDefault()},onMouseEnter:()=>{r.disabled||f(d)},onClick:()=>{r.disabled||ie(d)},onKeyDown:v=>{r.disabled||(v.key==="Enter"||v.key===" "||v.key==="Space"||v.key==="Spacebar")&&(v.preventDefault(),ie(d))},style:{border:"1px solid var(--aurora-border-default)",background:w?"color-mix(in srgb, var(--aurora-accent-default) 14%, var(--aurora-surface-default))":"var(--aurora-surface-default)",color:r.disabled?"color-mix(in srgb, var(--aurora-text-secondary) 60%, transparent)":"var(--aurora-text-primary)",borderRadius:8,height:36,padding:"0 10px",textAlign:"left",cursor:r.disabled?"not-allowed":"pointer"},children:r.label},r.key)})}):n.jsx("p",{style:{margin:0,color:"var(--aurora-text-secondary)"},children:It})]})})}function Ot(a){return typeof a.textValue=="string"?a.textValue.trim():typeof a.label=="string"?a.label.trim():""}function xe(a){return a.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase()}function qt(a){const e=a.nativeEvent;return e.isComposing?!0:typeof e.keyCode=="number"&&e.keyCode===229}function Nt({query:a,visibleCount:e,enabledCount:t,totalCount:c}){const l=a.trim();return l.length===0?t!==c?`${t} of ${c} command${c===1?"":"s"} available.`:`${c} command${c===1?"":"s"} available.`:e===0?`No commands match "${l}".`:t===0?`No enabled commands match "${l}".`:t!==e?`${t} of ${e} matching command${t===1?"":"s"} available for "${l}".`:`${e} command${e===1?"":"s"} found for "${l}".`}p.__docgenInfo={description:"",methods:[],displayName:"CommandPalette",props:{open:{required:!0,tsType:{name:"boolean"},description:""},onOpenChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""},commands:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  key: string;
...
}`,...(ke=(fe=O.parameters)==null?void 0:fe.docs)==null?void 0:ke.source}}};var Ce,Be,Te;q.parameters={...q.parameters,docs:{...(Ce=q.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
...
}`,...(Te=(Be=q.parameters)==null?void 0:Be.docs)==null?void 0:Te.source}}};var Ee,De,Re;N.parameters={...N.parameters,docs:{...(Ee=N.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
...
}`,...(kt=(ft=Z.parameters)==null?void 0:ft.docs)==null?void 0:kt.source}}};var Ct,Bt,Tt;ee.parameters={...ee.parameters,docs:{...(Ct=ee.parameters)==null?void 0:Ct.docs,source:{originalSource:`{
