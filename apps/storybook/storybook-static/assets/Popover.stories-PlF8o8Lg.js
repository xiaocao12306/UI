import{j as t}from"./jsx-runtime-BjG_zV1W.js";import{r as i}from"./index-BWu4c2F4.js";import{B as ae}from"./Button-BMxlc9Nj.js";import{I as oe}from"./Input-D3M9Xqpz.js";import{P as u}from"./Popover-BqBUiUN9.js";import{within as l,expect as n,userEvent as r,fireEvent as v}from"./index-DgAF9SIF.js";import{s as re,a as se,S as ce}from"./storyShowcase-Bw5VyCj0.js";import"./FieldStyles-CQy9UjBZ.js";import"./a11y-CU5SQrEA.js";import"./DismissableLayer-DAyP3iyR.js";const g={...re},d={...se};function y({children:o}){return t.jsx(ce,{maxWidth:"min(100%, 620px)",gap:12,children:o})}const ke={title:"Overlay/Popover",component:u,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:"Popover supports controlled/uncontrolled mode with Escape and outside pointer dismissal. Use ArrowDown on trigger for keyboard open."}}},args:{triggerLabel:"Open Popover"}},m={args:{children:t.jsx("p",{style:{margin:0},children:"Popover content for quick context editing."})},play:async({canvasElement:o})=>{const e=l(o),a=await e.findByRole("button",{name:"Open Popover"});await n(a).toHaveAttribute("aria-keyshortcuts","ArrowDown"),await r.click(a),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument(),await n(a).not.toHaveAttribute("aria-keyshortcuts"),await r.keyboard("{Escape}"),await n(e.queryByRole("dialog",{name:"Popover content"})).not.toBeInTheDocument(),await n(a).toHaveAttribute("aria-keyshortcuts","ArrowDown"),a.focus(),await r.keyboard("{ArrowDown}"),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument(),await n(a).not.toHaveAttribute("aria-keyshortcuts")}};function ie(){const[o,e]=i.useState(0);return t.jsxs(y,{children:[t.jsxs("p",{style:g,children:["ArrowDown open calls:"," ",t.jsx("strong",{"data-testid":"popover-arrowdown-open-calls",style:d,children:o})]}),t.jsx(u,{triggerLabel:"ArrowDown Guard Popover",onOpenChange:a=>{a&&e(s=>s+1)},children:t.jsx("p",{style:{margin:0},children:"Only unmodified ArrowDown should open this popover."})})]})}const w={render:()=>t.jsx(ie,{}),play:async({canvasElement:o})=>{const e=l(o),a=await e.findByRole("button",{name:"ArrowDown Guard Popover"});await n(a).toHaveAttribute("aria-keyshortcuts","ArrowDown"),a.focus(),v.keyDown(a,{key:"ArrowDown",ctrlKey:!0}),v.keyDown(a,{key:"ArrowDown",altKey:!0}),v.keyDown(a,{key:"ArrowDown",metaKey:!0}),await n(e.queryByRole("dialog",{name:"Popover content"})).not.toBeInTheDocument(),await n(e.getByTestId("popover-arrowdown-open-calls")).toHaveTextContent("0"),await r.keyboard("{ArrowDown}"),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument(),await n(a).not.toHaveAttribute("aria-keyshortcuts"),await n(e.getByTestId("popover-arrowdown-open-calls")).toHaveTextContent("1")}},h={args:{triggerLabel:"Edit Name",children:t.jsxs("div",{style:{width:280,display:"grid",gap:8},children:[t.jsx("label",{htmlFor:"name",style:{fontSize:"var(--aurora-font-size-sm)",fontWeight:600},children:"Display name"}),t.jsx(oe,{id:"name",defaultValue:"Aurora Team"}),t.jsx(ae,{size:"sm",children:"Save"})]})}},x={args:{triggerLabel:"⋯",triggerAriaLabel:"More context actions",children:t.jsx("p",{style:{margin:0},children:"Quick context actions from icon trigger."})},play:async({canvasElement:o})=>{const e=l(o),a=await e.findByRole("button",{name:"More context actions"});await r.click(a),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument()}},T={args:{triggerLabel:"Review policy",closeOnEscape:!1,closeOnOutsidePointer:!1,children:t.jsx("p",{style:{margin:0},children:"This popover must be closed via trigger toggle."})},render:o=>t.jsxs(y,{children:[t.jsx(u,{...o}),t.jsx("button",{type:"button",children:"Outside target"})]}),play:async({canvasElement:o})=>{const e=l(o),a=await e.findByRole("button",{name:"Review policy"});await r.click(a),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument(),await r.keyboard("{Escape}"),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument(),await r.click(e.getByRole("button",{name:"Outside target"})),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument()}};function pe(){const[o,e]=i.useState(0),[a,s]=i.useState(0);return t.jsxs(y,{children:[t.jsxs("p",{style:g,children:["Escape guard calls:"," ",t.jsx("strong",{"data-testid":"popover-guard-escape-calls",style:d,children:o})]}),t.jsxs("p",{style:g,children:["Outside guard calls:"," ",t.jsx("strong",{"data-testid":"popover-guard-outside-calls",style:d,children:a})]}),t.jsx(u,{triggerLabel:"Guarded popover",onEscapeKeyDown:c=>{c.preventDefault(),e(p=>p+1)},onPointerDownOutside:c=>{c.preventDefault(),s(p=>p+1)},children:t.jsx("p",{style:{margin:0},children:"Dismiss hooks can block Escape/outside close paths."})}),t.jsx("button",{type:"button",children:"Guarded outside target"})]})}const B={args:{triggerLabel:"Guarded popover",children:t.jsx("p",{style:{margin:0},children:"Dismiss hooks can block Escape/outside close paths."})},render:()=>t.jsx(pe,{}),play:async({canvasElement:o})=>{const e=l(o),a=await e.findByRole("button",{name:"Guarded popover"}),s=e.getByRole("button",{name:"Guarded outside target"});await r.click(a),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument(),await r.keyboard("{Escape}"),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument(),await n(e.getByTestId("popover-guard-escape-calls")).toHaveTextContent("1"),await r.click(s),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument(),await n(e.getByTestId("popover-guard-outside-calls")).toHaveTextContent("1")}},D={args:{triggerLabel:"Focus Policy",children:t.jsx("p",{style:{margin:0},children:"Dismiss me by clicking outside."})},render:()=>t.jsxs(y,{children:[t.jsx(u,{triggerLabel:"Focus Policy",children:t.jsx("p",{style:{margin:0},children:"Dismiss me by clicking outside."})}),t.jsx("button",{type:"button",children:"Popover Next Focus Target"})]}),play:async({canvasElement:o})=>{const e=l(o),a=await e.findByRole("button",{name:"Focus Policy"});await r.click(a),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument();const s=e.getByRole("button",{name:"Popover Next Focus Target"});await r.click(s),await n(e.queryByRole("dialog",{name:"Popover content"})).not.toBeInTheDocument(),await n(s).toHaveFocus()}};function le(){const[o,e]=i.useState("none"),[a,s]=i.useState("none");return t.jsxs(y,{children:[t.jsxs("p",{style:g,children:["Last close reason:"," ",t.jsx("strong",{"data-testid":"popover-close-reason",style:d,children:o})]}),t.jsxs("p",{style:g,children:["Last close trace:"," ",t.jsx("strong",{"data-testid":"popover-close-trace",style:d,children:a})]}),t.jsx(u,{triggerLabel:"Telemetry popover",onOpenChange:c=>{c||s(p=>`${p} -> open:false`)},onCloseReason:c=>{e(c),s(`reason:${c}`)},children:t.jsx("p",{style:{margin:0},children:"Track trigger / Escape / outside close behavior."})}),t.jsx("button",{type:"button",children:"Outside target"})]})}const k={args:{triggerLabel:"Telemetry popover",children:t.jsx("p",{style:{margin:0},children:"Track trigger / Escape / outside close behavior."})},render:()=>t.jsx(le,{}),play:async({canvasElement:o})=>{const e=l(o),a=await e.findByRole("button",{name:"Telemetry popover"}),s=e.getByRole("button",{name:"Outside target"});await n(e.getByTestId("popover-close-reason")).toHaveTextContent("none"),await n(e.getByTestId("popover-close-trace")).toHaveTextContent("none"),await r.click(a),await r.keyboard("{Escape}"),await n(e.getByTestId("popover-close-reason")).toHaveTextContent("escape-key"),await n(e.getByTestId("popover-close-trace")).toHaveTextContent("reason:escape-key -> open:false"),await r.click(a),await r.click(s),await n(e.getByTestId("popover-close-reason")).toHaveTextContent("outside-pointer"),await n(e.getByTestId("popover-close-trace")).toHaveTextContent("reason:outside-pointer -> open:false"),await r.click(a),await r.click(a),await n(e.getByTestId("popover-close-reason")).toHaveTextContent("trigger-click"),await n(e.getByTestId("popover-close-trace")).toHaveTextContent("reason:trigger-click -> open:false")}};function ge(){const[o,e]=i.useState(!1),[a,s]=i.useState(0);return i.useEffect(()=>{const c=p=>{p.key==="Escape"&&p.preventDefault()};return document.addEventListener("keydown",c,!0),()=>{document.removeEventListener("keydown",c,!0)}},[]),t.jsxs(y,{children:[t.jsxs("p",{style:g,children:["Escape hook calls:"," ",t.jsx("strong",{"data-testid":"popover-escape-calls",style:d,children:a})]}),t.jsx(u,{triggerLabel:"Preempted popover",open:o,onOpenChange:e,onEscapeKeyDown:()=>s(c=>c+1),children:t.jsx("p",{style:{margin:0},children:"Escape should remain preempted by global handlers."})})]})}const b={args:{triggerLabel:"Preempted popover",children:t.jsx("p",{style:{margin:0},children:"Escape should remain preempted by global handlers."})},render:()=>t.jsx(ge,{}),play:async({canvasElement:o})=>{const e=l(o),a=o.ownerDocument,s=await e.findByRole("button",{name:"Preempted popover"});await r.click(s),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument(),v.keyDown(a,{key:"Escape",ctrlKey:!0}),v.keyDown(a,{key:"Escape",altKey:!0}),v.keyDown(a,{key:"Escape",metaKey:!0}),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument(),await n(e.getByTestId("popover-escape-calls")).toHaveTextContent("0"),await r.keyboard("{Escape}"),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument(),await n(e.getByTestId("popover-escape-calls")).toHaveTextContent("0")}};function de(){const[o,e]=i.useState(!1),[a,s]=i.useState(0),[c,p]=i.useState("none");return t.jsxs(y,{children:[t.jsxs("p",{style:g,children:["Escape hook calls:"," ",t.jsx("strong",{"data-testid":"popover-repeat-escape-calls",style:d,children:a})]}),t.jsxs("p",{style:g,children:["Last close reason:"," ",t.jsx("strong",{"data-testid":"popover-repeat-close-reason",style:d,children:c})]}),t.jsx(u,{triggerLabel:"Repeat Escape Popover",open:o,onOpenChange:e,onEscapeKeyDown:()=>s(ne=>ne+1),onCloseReason:p,children:t.jsx("p",{style:{margin:0},children:"Repeated Escape keydown should not close this popover."})})]})}const E={args:{triggerLabel:"Repeat Escape Popover",children:t.jsx("p",{style:{margin:0},children:"Repeated Escape keydown should not close this popover."})},render:()=>t.jsx(de,{}),play:async({canvasElement:o})=>{const e=l(o),a=o.ownerDocument,s=await e.findByRole("button",{name:"Repeat Escape Popover"});await r.click(s),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument(),v.keyDown(a,{key:"Escape",repeat:!0}),await n(e.getByRole("dialog",{name:"Popover content"})).toBeInTheDocument(),await n(e.getByTestId("popover-repeat-escape-calls")).toHaveTextContent("0"),await n(e.getByTestId("popover-repeat-close-reason")).toHaveTextContent("none"),await r.keyboard("{Escape}"),await n(e.queryByRole("dialog",{name:"Popover content"})).not.toBeInTheDocument(),await n(e.getByTestId("popover-repeat-escape-calls")).toHaveTextContent("1"),await n(e.getByTestId("popover-repeat-close-reason")).toHaveTextContent("escape-key")}};var P,R,f;m.parameters={...m.parameters,docs:{...(P=m.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    children: <p style={{
      margin: 0
...
}`,...(Q=(V=D.parameters)==null?void 0:V.docs)==null?void 0:Q.source}}};var _,$,U;k.parameters={...k.parameters,docs:{...(_=k.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
...
}`,...(U=($=k.parameters)==null?void 0:$.docs)==null?void 0:U.source}}};var J,X,Y;b.parameters={...b.parameters,docs:{...(J=b.parameters)==null?void 0:J.docs,source:{originalSource:`{
  args: {
...
}`,...(te=(ee=E.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};const be=["Default","TriggerArrowDownModifierGuard","WithInteractiveContent","IconTrigger","NonDismissible","DismissGuardHooks","OutsideDismissFocusTransfer","CloseReasonTelemetry","EscapePreemptedByGlobalHandler","EscapeRepeatGuard"];export{k as CloseReasonTelemetry,m as Default,B as DismissGuardHooks,b as EscapePreemptedByGlobalHandler,E as EscapeRepeatGuard,x as IconTrigger,T as NonDismissible,D as OutsideDismissFocusTransfer,w as TriggerArrowDownModifierGuard,h as WithInteractiveContent,be as __namedExportsOrder,ke as default};
