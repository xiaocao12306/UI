...
describe("Table", () => {
  ...
  it("skips sortable-header keyboard handling when keydown is preempted by local onSortKeyDown", () => {
    const onSortChange = vi.fn();
  ...
  it("applies sortable-header pressed offset for non-mouse primary pointer interactions", () => {
    render(
      <Table
        columns={[
          { key: "name", header: "Name", sortable: true },
  ...
  it("falls back blank custom sort status narration to default copy", () => {
    render(
      <Table
        columns={[
          { key: "name", header: "Name", sortable: true },
  ...
  it("falls back non-string custom sort status narration to default copy", () => {
    render(
      <Table
        columns={[
          { key: "name", header: "Name", sortable: true },
        ...
        defaultSortKey="name"
        getSortStatusText={() => 0 as unknown as string}
      />
    );
