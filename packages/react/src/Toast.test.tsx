...
describe("Toast", () => {
  ...
  it("treats blank-string action as non-actionable live region", () => {
    render(<Toast open title="Passive update" action="   " />);
  ...
  it("treats plain-string action as non-actionable live region", () => {
    render(<Toast open title="Passive update" action="Undo later" />);
  ...
  it("treats numeric action as non-actionable live region", () => {
    render(<Toast open title="Passive update" action={0} />);
  ...
  it("keeps keyboard pressed feedback idle when activation keydown is preempted upstream", () => {
    render(
      <div onKeyDownCapture={(event) => event.preventDefault()}>
        <Toast open title="Preempted keyboard pressable" duration={0} />
      </div>
    );
