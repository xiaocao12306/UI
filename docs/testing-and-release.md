...
- notes:
  ...
  - Storybook interaction suites refreshed to `32/32`, tests `163/163` all passed after adding CommandPalette localized results label + empty-state `aria-controls` lifecycle story coverage
