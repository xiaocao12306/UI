...
- notes:
  ...
  - Storybook interaction suites refreshed to `32/32`, tests `173/173` all passed after latest Dialog/Drawer telemetry + Popover story typecheck hardening + telemetry story expansion
